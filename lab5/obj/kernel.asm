...
ffffffffc0200036:	3ce50513          	addi	a0,a0,974 # ffffffffc02a7400 <buf>
ffffffffc020003a:	000b3617          	auipc	a2,0xb3
ffffffffc020003e:	92260613          	addi	a2,a2,-1758 # ffffffffc02b295c <end>
kern_init(void) {
...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	536060ef          	jal	ra,ffffffffc0206580 <memset>
...
ffffffffc0200056:	55e58593          	addi	a1,a1,1374 # ffffffffc02065b0 <etext+0x6>
ffffffffc020005a:	00006517          	auipc	a0,0x6
ffffffffc020005e:	57650513          	addi	a0,a0,1398 # ffffffffc02065d0 <etext+0x26>
...
ffffffffc020007a:	47f050ef          	jal	ra,ffffffffc0205cf8 <proc_init>
...
ffffffffc020008e:	603050ef          	jal	ra,ffffffffc0205e90 <cpu_idle>
...
ffffffffc02000ac:	53050513          	addi	a0,a0,1328 # ffffffffc02065d8 <etext+0x2e>
...
ffffffffc02000c2:	342b8b93          	addi	s7,s7,834 # ffffffffc02a7400 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc020011e:	2e650513          	addi	a0,a0,742 # ffffffffc02a7400 <buf>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	00e060ef          	jal	ra,ffffffffc0206182 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	7d9050ef          	jal	ra,ffffffffc0206182 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	3d650513          	addi	a0,a0,982 # ffffffffc02065e0 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc0200224:	3e050513          	addi	a0,a0,992 # ffffffffc0206600 <etext+0x56>
ffffffffc0200228:	f59ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020022c:	00006597          	auipc	a1,0x6
ffffffffc0200230:	37e58593          	addi	a1,a1,894 # ffffffffc02065aa <etext>
ffffffffc0200234:	00006517          	auipc	a0,0x6
ffffffffc0200238:	3ec50513          	addi	a0,a0,1004 # ffffffffc0206620 <etext+0x76>
ffffffffc020023c:	f45ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  edata  0x%08x (virtual)\n", edata);
ffffffffc0200240:	000a7597          	auipc	a1,0xa7
ffffffffc0200244:	1c058593          	addi	a1,a1,448 # ffffffffc02a7400 <buf>
ffffffffc0200248:	00006517          	auipc	a0,0x6
ffffffffc020024c:	3f850513          	addi	a0,a0,1016 # ffffffffc0206640 <etext+0x96>
ffffffffc0200250:	f31ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc0200254:	000b2597          	auipc	a1,0xb2
ffffffffc0200258:	70858593          	addi	a1,a1,1800 # ffffffffc02b295c <end>
ffffffffc020025c:	00006517          	auipc	a0,0x6
ffffffffc0200260:	40450513          	addi	a0,a0,1028 # ffffffffc0206660 <etext+0xb6>
ffffffffc0200264:	f1dff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200268:	000b3597          	auipc	a1,0xb3
ffffffffc020026c:	af358593          	addi	a1,a1,-1293 # ffffffffc02b2d5b <end+0x3ff>
...
ffffffffc020028e:	3f650513          	addi	a0,a0,1014 # ffffffffc0206680 <etext+0xd6>
}
...
ffffffffc020029c:	41860613          	addi	a2,a2,1048 # ffffffffc02066b0 <etext+0x106>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	42450513          	addi	a0,a0,1060 # ffffffffc02066c8 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc02002b8:	42c60613          	addi	a2,a2,1068 # ffffffffc02066e0 <etext+0x136>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	44458593          	addi	a1,a1,1092 # ffffffffc0206700 <etext+0x156>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	44450513          	addi	a0,a0,1092 # ffffffffc0206708 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	44660613          	addi	a2,a2,1094 # ffffffffc0206718 <etext+0x16e>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	46658593          	addi	a1,a1,1126 # ffffffffc0206740 <etext+0x196>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	42650513          	addi	a0,a0,1062 # ffffffffc0206708 <etext+0x15e>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	46260613          	addi	a2,a2,1122 # ffffffffc0206750 <etext+0x1a6>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	47a58593          	addi	a1,a1,1146 # ffffffffc0206770 <etext+0x1c6>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	40a50513          	addi	a0,a0,1034 # ffffffffc0206708 <etext+0x15e>
...
ffffffffc020033c:	44850513          	addi	a0,a0,1096 # ffffffffc0206780 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	44e50513          	addi	a0,a0,1102 # ffffffffc02067a8 <etext+0x1fe>
...
ffffffffc020037c:	45890913          	addi	s2,s2,1112 # ffffffffc02067d0 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	45848493          	addi	s1,s1,1112 # ffffffffc02067d8 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	456b0b13          	addi	s6,s6,1110 # ffffffffc02067e0 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	36ea0a13          	addi	s4,s4,878 # ffffffffc0206700 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	18a060ef          	jal	ra,ffffffffc020654c <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	176060ef          	jal	ra,ffffffffc020654c <strcmp>
...
ffffffffc0200414:	156060ef          	jal	ra,ffffffffc020656a <strchr>
...
ffffffffc0200452:	118060ef          	jal	ra,ffffffffc020656a <strchr>
...
ffffffffc0200470:	39450513          	addi	a0,a0,916 # ffffffffc0206800 <etext+0x256>
...
ffffffffc020047e:	44e30313          	addi	t1,t1,1102 # ffffffffc02b28c8 <is_panic>
...
ffffffffc0200530:	3af73623          	sd	a5,940(a4) # ffffffffc02b28d8 <timebase>
...
ffffffffc0200558:	3607be23          	sd	zero,892(a5) # ffffffffc02b28d0 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200566:	3767b783          	ld	a5,886(a5) # ffffffffc02b28d8 <timebase>
...
ffffffffc02005fc:	20878793          	addi	a5,a5,520 # ffffffffc02a7800 <ide>
    int iobase = secno * SECTSIZE;
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	783050ef          	jal	ra,ffffffffc0206592 <memcpy>
    return 0;
}
...
ffffffffc0200624:	1e050513          	addi	a0,a0,480 # ffffffffc02a7800 <ide>
                   size_t nsecs) {
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	75f050ef          	jal	ra,ffffffffc0206592 <memcpy>
    return 0;
}
...
ffffffffc020089e:	09648493          	addi	s1,s1,150 # ffffffffc02b2930 <check_mm_struct>
...
ffffffffc02008e4:	06073703          	ld	a4,96(a4) # ffffffffc02b2940 <current>
ffffffffc02008e8:	000b2797          	auipc	a5,0xb2
ffffffffc02008ec:	0607b783          	ld	a5,96(a5) # ffffffffc02b2948 <idleproc>
...
ffffffffc0200920:	0247b783          	ld	a5,36(a5) # ffffffffc02b2940 <current>
...
ffffffffc0200a0c:	ec868693          	addi	a3,a3,-312 # ffffffffc02b28d0 <ticks>
...
ffffffffc0200a24:	f207b783          	ld	a5,-224(a5) # ffffffffc02b2940 <current>
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	5fa0506f          	j	ffffffffc0206080 <syscall>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	53a050ef          	jal	ra,ffffffffc0206080 <syscall>
                kernel_execve_ret(tf,current->kstack+KSTACKSIZE);
ffffffffc0200b4a:	000b2797          	auipc	a5,0xb2
ffffffffc0200b4e:	df67b783          	ld	a5,-522(a5) # ffffffffc02b2940 <current>
...
ffffffffc0200c28:	d1c40413          	addi	s0,s0,-740 # ffffffffc02b2940 <current>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	2f80506f          	j	ffffffffc0205f94 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200ca0:	555d                	li	a0,-9
ffffffffc0200ca2:	638040ef          	jal	ra,ffffffffc02052da <do_exit>
            if (current->need_resched) {
...
ffffffffc0200e26:	9de78793          	addi	a5,a5,-1570 # ffffffffc02ae800 <free_area>
...
ffffffffc0200e38:	9dc56503          	lwu	a0,-1572(a0) # ffffffffc02ae810 <free_area+0x10>
...
ffffffffc0200e46:	9be40413          	addi	s0,s0,-1602 # ffffffffc02ae800 <free_area>
...
ffffffffc0200ed2:	a327b783          	ld	a5,-1486(a5) # ffffffffc02b2900 <pages>
...
ffffffffc0200eea:	a126b683          	ld	a3,-1518(a3) # ffffffffc02b28f8 <npage>
...
ffffffffc0200f28:	8e07a623          	sw	zero,-1812(a5) # ffffffffc02ae810 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc020100a:	8007a523          	sw	zero,-2038(a5) # ffffffffc02ae810 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc0201606:	1fe68693          	addi	a3,a3,510 # ffffffffc02ae800 <free_area>
...
ffffffffc0201732:	0d258593          	addi	a1,a1,210 # ffffffffc02ae800 <free_area>
...
ffffffffc020181e:	fe668693          	addi	a3,a3,-26 # ffffffffc02ae800 <free_area>
...
ffffffffc02018ea:	b0a60613          	addi	a2,a2,-1270 # ffffffffc02a73f0 <slobfree>
...
ffffffffc0201998:	f6c6b683          	ld	a3,-148(a3) # ffffffffc02b2900 <pages>
...
ffffffffc02019b4:	f4873703          	ld	a4,-184(a4) # ffffffffc02b28f8 <npage>
    return page2ppn(page) << PGSHIFT;
...
ffffffffc02019c2:	f526b683          	ld	a3,-174(a3) # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc0201a10:	9e490913          	addi	s2,s2,-1564 # ffffffffc02a73f0 <slobfree>
...
ffffffffc0201b4e:	d9678793          	addi	a5,a5,-618 # ffffffffc02b28e0 <bigblocks>
...
ffffffffc0201b8a:	d5a78793          	addi	a5,a5,-678 # ffffffffc02b28e0 <bigblocks>
...
ffffffffc0201bd0:	d147b783          	ld	a5,-748(a5) # ffffffffc02b28e0 <bigblocks>
    return 0;
...
ffffffffc0201bdc:	d0868693          	addi	a3,a3,-760 # ffffffffc02b28e0 <bigblocks>
...
ffffffffc0201c04:	d106b683          	ld	a3,-752(a3) # ffffffffc02b2910 <va_pa_offset>
ffffffffc0201c08:	8c15                	sub	s0,s0,a3
    if (PPN(pa) >= npage) {
ffffffffc0201c0a:	8031                	srli	s0,s0,0xc
ffffffffc0201c0c:	000b1797          	auipc	a5,0xb1
ffffffffc0201c10:	cec7b783          	ld	a5,-788(a5) # ffffffffc02b28f8 <npage>
...
ffffffffc0201c28:	cdc53503          	ld	a0,-804(a0) # ffffffffc02b2900 <pages>
...
ffffffffc0201c60:	c847b783          	ld	a5,-892(a5) # ffffffffc02b28e0 <bigblocks>
        return 1;
...
ffffffffc0201cf8:	c1490913          	addi	s2,s2,-1004 # ffffffffc02b2908 <pmm_manager>
        {
...
ffffffffc0201d02:	c2aa8a93          	addi	s5,s5,-982 # ffffffffc02b2928 <swap_init_ok>
...
ffffffffc0201d0e:	c26b0b13          	addi	s6,s6,-986 # ffffffffc02b2930 <check_mm_struct>
...
ffffffffc0201d7e:	b8e7b783          	ld	a5,-1138(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc0201d9a:	b727b783          	ld	a5,-1166(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc0201dbe:	b4e7b783          	ld	a5,-1202(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc0201dd4:	b387b783          	ld	a5,-1224(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc0201e1a:	ae2a0a13          	addi	s4,s4,-1310 # ffffffffc02b28f8 <npage>
    if (!(*pdep1 & PTE_V)) {
...
ffffffffc0201e34:	ad0b0b13          	addi	s6,s6,-1328 # ffffffffc02b2900 <pages>
...
ffffffffc0201e44:	ab8a0a13          	addi	s4,s4,-1352 # ffffffffc02b28f8 <npage>
...
ffffffffc0201e68:	aac7b783          	ld	a5,-1364(a5) # ffffffffc02b2910 <va_pa_offset>
ffffffffc0201e6c:	6605                	lui	a2,0x1
ffffffffc0201e6e:	4581                	li	a1,0
ffffffffc0201e70:	953e                	add	a0,a0,a5
ffffffffc0201e72:	70e040ef          	jal	ra,ffffffffc0206580 <memset>
    return page - pages + nbase;
...
ffffffffc0201ea0:	a74a8a93          	addi	s5,s5,-1420 # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc0201ed2:	a32b0b13          	addi	s6,s6,-1486 # ffffffffc02b2900 <pages>
...
ffffffffc0201f04:	67c040ef          	jal	ra,ffffffffc0206580 <memset>
    return page - pages + nbase;
...
ffffffffc0201fec:	91073703          	ld	a4,-1776(a4) # ffffffffc02b28f8 <npage>
...
ffffffffc0202004:	90053503          	ld	a0,-1792(a0) # ffffffffc02b2900 <pages>
...
ffffffffc0202054:	8a8c8c93          	addi	s9,s9,-1880 # ffffffffc02b28f8 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0202058:	000b1c17          	auipc	s8,0xb1
ffffffffc020205c:	8a8c0c13          	addi	s8,s8,-1880 # ffffffffc02b2900 <pages>
ffffffffc0202060:	fff80bb7          	lui	s7,0xfff80
        pmm_manager->free_pages(base, n);
ffffffffc0202064:	000b1d17          	auipc	s10,0xb1
ffffffffc0202068:	8a4d0d13          	addi	s10,s10,-1884 # ffffffffc02b2908 <pmm_manager>
...
ffffffffc02021b2:	74ad0d13          	addi	s10,s10,1866 # ffffffffc02b28f8 <npage>
    return KADDR(page2pa(page));
ffffffffc02021b6:	00ccdc93          	srli	s9,s9,0xc
    return &pages[PPN(pa) - nbase];
ffffffffc02021ba:	000b0717          	auipc	a4,0xb0
ffffffffc02021be:	74670713          	addi	a4,a4,1862 # ffffffffc02b2900 <pages>
        pmm_manager->free_pages(base, n);
ffffffffc02021c2:	000b0d97          	auipc	s11,0xb0
ffffffffc02021c6:	746d8d93          	addi	s11,s11,1862 # ffffffffc02b2908 <pmm_manager>
...
ffffffffc0202222:	6f280813          	addi	a6,a6,1778 # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc02022b6:	65e80813          	addi	a6,a6,1630 # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc02022c8:	63c70713          	addi	a4,a4,1596 # ffffffffc02b2900 <pages>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202300:	60470713          	addi	a4,a4,1540 # ffffffffc02b2900 <pages>
...
ffffffffc020234e:	5b670713          	addi	a4,a4,1462 # ffffffffc02b2900 <pages>
...
ffffffffc0202360:	5b480813          	addi	a6,a6,1460 # ffffffffc02b2910 <va_pa_offset>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202384:	58070713          	addi	a4,a4,1408 # ffffffffc02b2900 <pages>
                pgdir[PDX1(d1start)] = 0;
...
ffffffffc0202418:	4e473703          	ld	a4,1252(a4) # ffffffffc02b28f8 <npage>
...
ffffffffc020242c:	4d853503          	ld	a0,1240(a0) # ffffffffc02b2900 <pages>
...
ffffffffc020245a:	4b27b783          	ld	a5,1202(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc0202470:	49c7b783          	ld	a5,1180(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc02024bc:	44873703          	ld	a4,1096(a4) # ffffffffc02b2900 <pages>
...
ffffffffc02024f6:	40673703          	ld	a4,1030(a4) # ffffffffc02b28f8 <npage>
ffffffffc02024fa:	06e7ff63          	bgeu	a5,a4,ffffffffc0202578 <page_insert+0xf2>
    return &pages[PPN(pa) - nbase];
ffffffffc02024fe:	000b0a97          	auipc	s5,0xb0
ffffffffc0202502:	402a8a93          	addi	s5,s5,1026 # ffffffffc02b2900 <pages>
...
ffffffffc0202514:	01240c63          	beq	s0,s2,ffffffffc020252c <page_insert+0xa6>
    page->ref -= 1;
ffffffffc0202518:	00092783          	lw	a5,0(s2) # fffffffffff80000 <end+0x3fccd6a4>
...
ffffffffc020253c:	3d07b783          	ld	a5,976(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc020255a:	3b27b783          	ld	a5,946(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc0202596:	376b8b93          	addi	s7,s7,886 # ffffffffc02b2908 <pmm_manager>
void pmm_init(void) {
...
ffffffffc02025bc:	35898993          	addi	s3,s3,856 # ffffffffc02b2910 <va_pa_offset>
    npage = maxpa / PGSIZE;
ffffffffc02025c0:	000b0497          	auipc	s1,0xb0
ffffffffc02025c4:	33848493          	addi	s1,s1,824 # ffffffffc02b28f8 <npage>
    pmm_manager->init();
ffffffffc02025c8:	679c                	ld	a5,8(a5)
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02025ca:	000b0b17          	auipc	s6,0xb0
ffffffffc02025ce:	336b0b13          	addi	s6,s6,822 # ffffffffc02b2900 <pages>
    pmm_manager->init();
...
ffffffffc020260a:	35578793          	addi	a5,a5,853 # ffffffffc02b395b <end+0xfff>
...
ffffffffc0202674:	28090913          	addi	s2,s2,640 # ffffffffc02b28f0 <boot_pgdir>
    pmm_manager->check();
...
ffffffffc02026a6:	24d7b323          	sd	a3,582(a5) # ffffffffc02b28e8 <boot_cr3>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc02028fc:	0007b023          	sd	zero,0(a5) # fffffffffff80000 <end+0x3fccd6a4>
  asm volatile("sfence.vma");
...
ffffffffc02029a4:	62051d63          	bnez	a0,ffffffffc0202fde <pmm_init+0xa62>
    assert(page_ref(p) == 1);
ffffffffc02029a8:	000aa703          	lw	a4,0(s5) # fffffffffffff000 <end+0x3fd4c6a4>
...
ffffffffc02029de:	35d030ef          	jal	ra,ffffffffc020653a <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	363030ef          	jal	ra,ffffffffc020654c <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	2e5030ef          	jal	ra,ffffffffc0206504 <strlen>
...
ffffffffc0203160:	79cc8c93          	addi	s9,s9,1948 # ffffffffc02b28f8 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0203164:	000afc17          	auipc	s8,0xaf
ffffffffc0203168:	79cc0c13          	addi	s8,s8,1948 # ffffffffc02b2900 <pages>
    return page - pages + nbase;
...
ffffffffc0203216:	6fe70713          	addi	a4,a4,1790 # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc0203232:	360030ef          	jal	ra,ffffffffc0206592 <memcpy>
...
ffffffffc020337a:	5b27a783          	lw	a5,1458(a5) # ffffffffc02b2928 <swap_init_ok>
ffffffffc020337e:	c385                	beqz	a5,ffffffffc020339e <pgdir_alloc_page+0x52>
            if (check_mm_struct != NULL) {
ffffffffc0203380:	000af517          	auipc	a0,0xaf
ffffffffc0203384:	5b053503          	ld	a0,1456(a0) # ffffffffc02b2930 <check_mm_struct>
...
ffffffffc02033ba:	5527b783          	ld	a5,1362(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc02033d2:	53a7b783          	ld	a5,1338(a5) # ffffffffc02b2908 <pmm_manager>
...
ffffffffc0203446:	4d66b683          	ld	a3,1238(a3) # ffffffffc02b2918 <max_swap_offset>
...
ffffffffc020345c:	f5878793          	addi	a5,a5,-168 # ffffffffc02a73b0 <swap_manager_fifo>
     int r = sm->init();
ffffffffc0203460:	6798                	ld	a4,8(a5)
     sm = &swap_manager_fifo;
ffffffffc0203462:	000afb97          	auipc	s7,0xaf
ffffffffc0203466:	4beb8b93          	addi	s7,s7,1214 # ffffffffc02b2920 <sm>
...
ffffffffc02034a4:	36040413          	addi	s0,s0,864 # ffffffffc02ae800 <free_area>
ffffffffc02034a8:	638c                	ld	a1,0(a5)
          swap_init_ok = 1;
ffffffffc02034aa:	4785                	li	a5,1
ffffffffc02034ac:	000af717          	auipc	a4,0xaf
ffffffffc02034b0:	46f72e23          	sw	a5,1148(a4) # ffffffffc02b2928 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
...
ffffffffc0203504:	43078793          	addi	a5,a5,1072 # ffffffffc02b2930 <check_mm_struct>
...
ffffffffc0203512:	3e270713          	addi	a4,a4,994 # ffffffffc02b28f0 <boot_pgdir>
...
ffffffffc0203566:	2d648493          	addi	s1,s1,726 # ffffffffc02ae838 <check_rp>
ffffffffc020356a:	c17fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc020356e:	000ab997          	auipc	s3,0xab
ffffffffc0203572:	2ea98993          	addi	s3,s3,746 # ffffffffc02ae858 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
...
ffffffffc020359a:	2a2a0a13          	addi	s4,s4,674 # ffffffffc02ae838 <check_rp>
    elm->prev = elm->next = elm;
...
ffffffffc02035b0:	2607a223          	sw	zero,612(a5) # ffffffffc02ae810 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc02035e0:	3407ae23          	sw	zero,860(a5) # ffffffffc02b2938 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02035ee:	34e6a683          	lw	a3,846(a3) # ffffffffc02b2938 <pgfault_num>
ffffffffc02035f2:	4585                	li	a1,1
ffffffffc02035f4:	000af797          	auipc	a5,0xaf
ffffffffc02035f8:	34478793          	addi	a5,a5,836 # ffffffffc02b2938 <pgfault_num>
...
ffffffffc020366e:	1ee78793          	addi	a5,a5,494 # ffffffffc02ae858 <swap_in_seq_no>
ffffffffc0203672:	000ab717          	auipc	a4,0xab
ffffffffc0203676:	20e70713          	addi	a4,a4,526 # ffffffffc02ae880 <swap_out_seq_no>
ffffffffc020367a:	000ab617          	auipc	a2,0xab
ffffffffc020367e:	20660613          	addi	a2,a2,518 # ffffffffc02ae880 <swap_out_seq_no>
...
ffffffffc0203694:	18870713          	addi	a4,a4,392 # ffffffffc02ae818 <check_ptep>
ffffffffc0203698:	000ab697          	auipc	a3,0xab
ffffffffc020369c:	1a068693          	addi	a3,a3,416 # ffffffffc02ae838 <check_rp>
ffffffffc02036a0:	6585                	lui	a1,0x1
    if (PPN(pa) >= npage) {
ffffffffc02036a2:	000afc17          	auipc	s8,0xaf
ffffffffc02036a6:	256c0c13          	addi	s8,s8,598 # ffffffffc02b28f8 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02036aa:	000afc97          	auipc	s9,0xaf
ffffffffc02036ae:	256c8c93          	addi	s9,s9,598 # ffffffffc02b2900 <pages>
...
ffffffffc0203752:	1a278793          	addi	a5,a5,418 # ffffffffc02b28f0 <boot_pgdir>
ffffffffc0203756:	639c                	ld	a5,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0203758:	000c3703          	ld	a4,0(s8)
     check_mm_struct = NULL;
ffffffffc020375c:	000af697          	auipc	a3,0xaf
ffffffffc0203760:	1c06ba23          	sd	zero,468(a3) # ffffffffc02b2930 <check_mm_struct>
    return pa2page(PDE_ADDR(pde));
...
ffffffffc020378c:	1887b783          	ld	a5,392(a5) # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc0203b6c:	db87b783          	ld	a5,-584(a5) # ffffffffc02b2920 <sm>
...
ffffffffc0203b78:	dac7b783          	ld	a5,-596(a5) # ffffffffc02b2920 <sm>
...
ffffffffc0203ba4:	d8098993          	addi	s3,s3,-640 # ffffffffc02b2920 <sm>
...
ffffffffc0203d12:	b9a78793          	addi	a5,a5,-1126 # ffffffffc02ae8a8 <pra_list_head>
 */
static int
...
ffffffffc0203d5e:	bde92903          	lw	s2,-1058(s2) # ffffffffc02b2938 <pgfault_num>
...
ffffffffc0203d7c:	bc040413          	addi	s0,s0,-1088 # ffffffffc02b2938 <pgfault_num>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0204146:	7e67a783          	lw	a5,2022(a5) # ffffffffc02b2928 <swap_init_ok>
...
ffffffffc0204572:	fe87b683          	ld	a3,-24(a5) # ffffffffffffefe8 <end+0x3fd4c68c>
...
ffffffffc020466c:	2ca7b423          	sd	a0,712(a5) # ffffffffc02b2930 <check_mm_struct>
...
ffffffffc020467a:	27a4b483          	ld	s1,634(s1) # ffffffffc02b28f0 <boot_pgdir>
    assert(pgdir[0] == 0);
...
ffffffffc02046f2:	20aa8a93          	addi	s5,s5,522 # ffffffffc02b28f8 <npage>
...
ffffffffc0204726:	1ee9b983          	ld	s3,494(s3) # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc0204748:	1bc98993          	addi	s3,s3,444 # ffffffffc02b2900 <pages>
...
ffffffffc0204794:	1a07b023          	sd	zero,416(a5) # ffffffffc02b2930 <check_mm_struct>
...
ffffffffc0204a10:	f2c7a783          	lw	a5,-212(a5) # ffffffffc02b2938 <pgfault_num>
ffffffffc0204a14:	2785                	addiw	a5,a5,1
ffffffffc0204a16:	000ae717          	auipc	a4,0xae
ffffffffc0204a1a:	f2f72123          	sw	a5,-222(a4) # ffffffffc02b2938 <pgfault_num>
...
ffffffffc0204a46:	ee67a783          	lw	a5,-282(a5) # ffffffffc02b2928 <swap_init_ok>
...
ffffffffc0204b86:	d8a7bb23          	sd	a0,-618(a5) # ffffffffc02b2918 <max_swap_offset>
}
...
ffffffffc0204bb2:	d6a73703          	ld	a4,-662(a4) # ffffffffc02b2918 <max_swap_offset>
ffffffffc0204bb6:	04e7f563          	bgeu	a5,a4,ffffffffc0204c00 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204bba:	000ae617          	auipc	a2,0xae
ffffffffc0204bbe:	d4663603          	ld	a2,-698(a2) # ffffffffc02b2900 <pages>
...
ffffffffc0204bdc:	d206b683          	ld	a3,-736(a3) # ffffffffc02b28f8 <npage>
...
ffffffffc0204bf0:	d247b783          	ld	a5,-732(a5) # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc0204c40:	cdc73703          	ld	a4,-804(a4) # ffffffffc02b2918 <max_swap_offset>
ffffffffc0204c44:	04e7f563          	bgeu	a5,a4,ffffffffc0204c8e <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc0204c48:	000ae617          	auipc	a2,0xae
ffffffffc0204c4c:	cb863603          	ld	a2,-840(a2) # ffffffffc02b2900 <pages>
...
ffffffffc0204c6a:	c926b683          	ld	a3,-878(a3) # ffffffffc02b28f8 <npage>
...
ffffffffc0204c7e:	c967b783          	ld	a5,-874(a5) # ffffffffc02b2910 <va_pa_offset>
...
ffffffffc0204cc2:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204cc4:	616000ef          	jal	ra,ffffffffc02052da <do_exit>
...
ffffffffc0204cd6:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204cd8:	cd39                	beqz	a0,ffffffffc0204d36 <alloc_proc+0x6e>
     /*
...
ffffffffc0204cde:	e11c                	sd	a5,0(a0)
    proc->pid = -1;                        
    proc->runs = 0;                        
ffffffffc0204ce0:	00052423          	sw	zero,8(a0)
    proc->kstack = 0;
ffffffffc0204ce4:	00053823          	sd	zero,16(a0)
    proc->need_resched = 0;                 
ffffffffc0204ce8:	00053c23          	sd	zero,24(a0)
    proc->parent = NULL;                    
ffffffffc0204cec:	02053023          	sd	zero,32(a0)
    proc->mm = NULL;                       
ffffffffc0204cf0:	02053423          	sd	zero,40(a0)
    memset(&(proc->context), 0, sizeof(struct context));
ffffffffc0204cf4:	07000613          	li	a2,112
ffffffffc0204cf8:	4581                	li	a1,0
ffffffffc0204cfa:	03050513          	addi	a0,a0,48
ffffffffc0204cfe:	083010ef          	jal	ra,ffffffffc0206580 <memset>
    proc->tf = NULL;                        
    proc->cr3 = boot_cr3;                   
ffffffffc0204d02:	000ae797          	auipc	a5,0xae
ffffffffc0204d06:	be67b783          	ld	a5,-1050(a5) # ffffffffc02b28e8 <boot_cr3>
ffffffffc0204d0a:	f45c                	sd	a5,168(s0)
    proc->tf = NULL;                        
ffffffffc0204d0c:	0a043023          	sd	zero,160(s0)
    proc->flags = 0;                        
ffffffffc0204d10:	0a042823          	sw	zero,176(s0)
    for (int i = 0; i < PROC_NAME_LEN + 1; i++) {
ffffffffc0204d14:	0b440793          	addi	a5,s0,180
ffffffffc0204d18:	0c440713          	addi	a4,s0,196
    proc->name[i] =0; }
ffffffffc0204d1c:	00078023          	sb	zero,0(a5)
    for (int i = 0; i < PROC_NAME_LEN + 1; i++) {
ffffffffc0204d20:	0785                	addi	a5,a5,1
ffffffffc0204d22:	fee79de3          	bne	a5,a4,ffffffffc0204d1c <alloc_proc+0x54>
    proc->wait_state = 0;
...
ffffffffc0204d2e:	10043023          	sd	zero,256(s0)
    proc->yptr =  NULL;
ffffffffc0204d32:	0e043c23          	sd	zero,248(s0)
    }
    return proc;
}
...
forkret(void) {
    forkrets(current->tf);
ffffffffc0204d40:	000ae797          	auipc	a5,0xae
ffffffffc0204d44:	c007b783          	ld	a5,-1024(a5) # ffffffffc02b2940 <current>
ffffffffc0204d48:	73c8                	ld	a0,160(a5)
ffffffffc0204d4a:	82cfc06f          	j	ffffffffc0200d76 <forkrets>

ffffffffc0204d4e <user_main>:
...
ffffffffc0204d4e:	000ae797          	auipc	a5,0xae
ffffffffc0204d52:	bf27b783          	ld	a5,-1038(a5) # ffffffffc02b2940 <current>
ffffffffc0204d56:	43cc                	lw	a1,4(a5)
user_main(void *arg) {
ffffffffc0204d58:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d5a:	00003617          	auipc	a2,0x3
ffffffffc0204d5e:	60e60613          	addi	a2,a2,1550 # ffffffffc0208368 <default_pmm_manager+0x1068>
ffffffffc0204d62:	00003517          	auipc	a0,0x3
ffffffffc0204d66:	61650513          	addi	a0,a0,1558 # ffffffffc0208378 <default_pmm_manager+0x1078>
user_main(void *arg) {
ffffffffc0204d6a:	fc06                	sd	ra,56(sp)
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d6c:	c14fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc0204d70:	3fe06797          	auipc	a5,0x3fe06
ffffffffc0204d74:	c0878793          	addi	a5,a5,-1016 # a978 <_binary_obj___user_forktest_out_size>
ffffffffc0204d78:	e43e                	sd	a5,8(sp)
ffffffffc0204d7a:	00003517          	auipc	a0,0x3
ffffffffc0204d7e:	5ee50513          	addi	a0,a0,1518 # ffffffffc0208368 <default_pmm_manager+0x1068>
ffffffffc0204d82:	00046797          	auipc	a5,0x46
ffffffffc0204d86:	9ee78793          	addi	a5,a5,-1554 # ffffffffc024a770 <_binary_obj___user_forktest_out_start>
ffffffffc0204d8a:	f03e                	sd	a5,32(sp)
ffffffffc0204d8c:	f42a                	sd	a0,40(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204d8e:	e802                	sd	zero,16(sp)
ffffffffc0204d90:	774010ef          	jal	ra,ffffffffc0206504 <strlen>
ffffffffc0204d94:	ec2a                	sd	a0,24(sp)
    asm volatile(
ffffffffc0204d96:	4511                	li	a0,4
ffffffffc0204d98:	55a2                	lw	a1,40(sp)
ffffffffc0204d9a:	4662                	lw	a2,24(sp)
ffffffffc0204d9c:	5682                	lw	a3,32(sp)
ffffffffc0204d9e:	4722                	lw	a4,8(sp)
ffffffffc0204da0:	48a9                	li	a7,10
ffffffffc0204da2:	9002                	ebreak
ffffffffc0204da4:	c82a                	sw	a0,16(sp)
    cprintf("ret = %d\n", ret);
ffffffffc0204da6:	65c2                	ld	a1,16(sp)
ffffffffc0204da8:	00003517          	auipc	a0,0x3
ffffffffc0204dac:	5f850513          	addi	a0,a0,1528 # ffffffffc02083a0 <default_pmm_manager+0x10a0>
ffffffffc0204db0:	bd0fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
#else
    KERNEL_EXECVE(exit);
#endif
    panic("user_main execve failed.\n");
ffffffffc0204db4:	00003617          	auipc	a2,0x3
ffffffffc0204db8:	5fc60613          	addi	a2,a2,1532 # ffffffffc02083b0 <default_pmm_manager+0x10b0>
ffffffffc0204dbc:	34c00593          	li	a1,844
ffffffffc0204dc0:	00003517          	auipc	a0,0x3
ffffffffc0204dc4:	61050513          	addi	a0,a0,1552 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0204dc8:	eb2fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204dcc <put_pgdir>:
    return pa2page(PADDR(kva));
ffffffffc0204dcc:	6d14                	ld	a3,24(a0)
put_pgdir(struct mm_struct *mm) {
ffffffffc0204dce:	1141                	addi	sp,sp,-16
ffffffffc0204dd0:	e406                	sd	ra,8(sp)
ffffffffc0204dd2:	c02007b7          	lui	a5,0xc0200
ffffffffc0204dd6:	02f6ee63          	bltu	a3,a5,ffffffffc0204e12 <put_pgdir+0x46>
ffffffffc0204dda:	000ae517          	auipc	a0,0xae
ffffffffc0204dde:	b3653503          	ld	a0,-1226(a0) # ffffffffc02b2910 <va_pa_offset>
ffffffffc0204de2:	8e89                	sub	a3,a3,a0
    if (PPN(pa) >= npage) {
ffffffffc0204de4:	82b1                	srli	a3,a3,0xc
ffffffffc0204de6:	000ae797          	auipc	a5,0xae
ffffffffc0204dea:	b127b783          	ld	a5,-1262(a5) # ffffffffc02b28f8 <npage>
ffffffffc0204dee:	02f6fe63          	bgeu	a3,a5,ffffffffc0204e2a <put_pgdir+0x5e>
    return &pages[PPN(pa) - nbase];
ffffffffc0204df2:	00004517          	auipc	a0,0x4
ffffffffc0204df6:	e7653503          	ld	a0,-394(a0) # ffffffffc0208c68 <nbase>
}
ffffffffc0204dfa:	60a2                	ld	ra,8(sp)
ffffffffc0204dfc:	8e89                	sub	a3,a3,a0
ffffffffc0204dfe:	069a                	slli	a3,a3,0x6
    free_page(kva2page(mm->pgdir));
ffffffffc0204e00:	000ae517          	auipc	a0,0xae
ffffffffc0204e04:	b0053503          	ld	a0,-1280(a0) # ffffffffc02b2900 <pages>
ffffffffc0204e08:	4585                	li	a1,1
ffffffffc0204e0a:	9536                	add	a0,a0,a3
}
ffffffffc0204e0c:	0141                	addi	sp,sp,16
    free_page(kva2page(mm->pgdir));
ffffffffc0204e0e:	f65fc06f          	j	ffffffffc0201d72 <free_pages>
    return pa2page(PADDR(kva));
ffffffffc0204e12:	00002617          	auipc	a2,0x2
ffffffffc0204e16:	5ce60613          	addi	a2,a2,1486 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc0204e1a:	06e00593          	li	a1,110
ffffffffc0204e1e:	00002517          	auipc	a0,0x2
ffffffffc0204e22:	54250513          	addi	a0,a0,1346 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0204e26:	e54fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204e2a:	00002617          	auipc	a2,0x2
ffffffffc0204e2e:	5de60613          	addi	a2,a2,1502 # ffffffffc0207408 <default_pmm_manager+0x108>
ffffffffc0204e32:	06200593          	li	a1,98
ffffffffc0204e36:	00002517          	auipc	a0,0x2
ffffffffc0204e3a:	52a50513          	addi	a0,a0,1322 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0204e3e:	e3cfb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204e42 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204e42:	7179                	addi	sp,sp,-48
ffffffffc0204e44:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204e46:	000ae497          	auipc	s1,0xae
ffffffffc0204e4a:	afa48493          	addi	s1,s1,-1286 # ffffffffc02b2940 <current>
ffffffffc0204e4e:	6098                	ld	a4,0(s1)
proc_run(struct proc_struct *proc) {
ffffffffc0204e50:	f406                	sd	ra,40(sp)
ffffffffc0204e52:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204e54:	02a70763          	beq	a4,a0,ffffffffc0204e82 <proc_run+0x40>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204e58:	100027f3          	csrr	a5,sstatus
ffffffffc0204e5c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204e5e:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204e60:	ef85                	bnez	a5,ffffffffc0204e98 <proc_run+0x56>
...
ffffffffc0204e62:	755c                	ld	a5,168(a0)
ffffffffc0204e64:	56fd                	li	a3,-1
ffffffffc0204e66:	16fe                	slli	a3,a3,0x3f
ffffffffc0204e68:	83b1                	srli	a5,a5,0xc
        current = proc; 
ffffffffc0204e6a:	e088                	sd	a0,0(s1)
ffffffffc0204e6c:	8fd5                	or	a5,a5,a3
ffffffffc0204e6e:	18079073          	csrw	satp,a5
        switch_to(&(a->context), &(b->context)); 
ffffffffc0204e72:	03050593          	addi	a1,a0,48
ffffffffc0204e76:	03070513          	addi	a0,a4,48
ffffffffc0204e7a:	030010ef          	jal	ra,ffffffffc0205eaa <switch_to>
    if (flag) {
ffffffffc0204e7e:	00091763          	bnez	s2,ffffffffc0204e8c <proc_run+0x4a>
}
ffffffffc0204e82:	70a2                	ld	ra,40(sp)
ffffffffc0204e84:	7482                	ld	s1,32(sp)
ffffffffc0204e86:	6962                	ld	s2,24(sp)
ffffffffc0204e88:	6145                	addi	sp,sp,48
...
ffffffffc0204e92:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204e94:	facfb06f          	j	ffffffffc0200640 <intr_enable>
ffffffffc0204e98:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204e9a:	facfb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        struct proc_struct *a = current , *b = proc; 
ffffffffc0204e9e:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc0204ea0:	6522                	ld	a0,8(sp)
ffffffffc0204ea2:	4905                	li	s2,1
ffffffffc0204ea4:	bf7d                	j	ffffffffc0204e62 <proc_run+0x20>

ffffffffc0204ea6 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204ea6:	7159                	addi	sp,sp,-112
ffffffffc0204ea8:	e8ca                	sd	s2,80(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204eaa:	000ae917          	auipc	s2,0xae
ffffffffc0204eae:	aae90913          	addi	s2,s2,-1362 # ffffffffc02b2958 <nr_process>
ffffffffc0204eb2:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204eb6:	f486                	sd	ra,104(sp)
ffffffffc0204eb8:	f0a2                	sd	s0,96(sp)
ffffffffc0204eba:	eca6                	sd	s1,88(sp)
ffffffffc0204ebc:	e4ce                	sd	s3,72(sp)
ffffffffc0204ebe:	e0d2                	sd	s4,64(sp)
ffffffffc0204ec0:	fc56                	sd	s5,56(sp)
ffffffffc0204ec2:	f85a                	sd	s6,48(sp)
ffffffffc0204ec4:	f45e                	sd	s7,40(sp)
ffffffffc0204ec6:	f062                	sd	s8,32(sp)
ffffffffc0204ec8:	ec66                	sd	s9,24(sp)
ffffffffc0204eca:	e86a                	sd	s10,16(sp)
ffffffffc0204ecc:	e46e                	sd	s11,8(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204ece:	6785                	lui	a5,0x1
ffffffffc0204ed0:	32f75b63          	bge	a4,a5,ffffffffc0205206 <do_fork+0x360>
ffffffffc0204ed4:	8a2a                	mv	s4,a0
ffffffffc0204ed6:	89ae                	mv	s3,a1
ffffffffc0204ed8:	8432                	mv	s0,a2
    proc = alloc_proc();    
ffffffffc0204eda:	defff0ef          	jal	ra,ffffffffc0204cc8 <alloc_proc>
ffffffffc0204ede:	84aa                	mv	s1,a0
    if (proc == NULL) { 
ffffffffc0204ee0:	2c050363          	beqz	a0,ffffffffc02051a6 <do_fork+0x300>
    proc->parent = current;
ffffffffc0204ee4:	000aea97          	auipc	s5,0xae
ffffffffc0204ee8:	a5ca8a93          	addi	s5,s5,-1444 # ffffffffc02b2940 <current>
ffffffffc0204eec:	000ab783          	ld	a5,0(s5)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204ef0:	4509                	li	a0,2
    proc->parent = current;
ffffffffc0204ef2:	f09c                	sd	a5,32(s1)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204ef4:	dedfc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0204ef8:	2c050663          	beqz	a0,ffffffffc02051c4 <do_fork+0x31e>
    return page - pages + nbase;
ffffffffc0204efc:	000aed97          	auipc	s11,0xae
ffffffffc0204f00:	a04d8d93          	addi	s11,s11,-1532 # ffffffffc02b2900 <pages>
ffffffffc0204f04:	000db683          	ld	a3,0(s11)
    return KADDR(page2pa(page));
ffffffffc0204f08:	000aed17          	auipc	s10,0xae
ffffffffc0204f0c:	9f0d0d13          	addi	s10,s10,-1552 # ffffffffc02b28f8 <npage>
    return page - pages + nbase;
ffffffffc0204f10:	00004c97          	auipc	s9,0x4
ffffffffc0204f14:	d58cbc83          	ld	s9,-680(s9) # ffffffffc0208c68 <nbase>
ffffffffc0204f18:	40d506b3          	sub	a3,a0,a3
ffffffffc0204f1c:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204f1e:	5c7d                	li	s8,-1
ffffffffc0204f20:	000d3783          	ld	a5,0(s10)
    return page - pages + nbase;
ffffffffc0204f24:	96e6                	add	a3,a3,s9
    return KADDR(page2pa(page));
ffffffffc0204f26:	00cc5c13          	srli	s8,s8,0xc
ffffffffc0204f2a:	0186f733          	and	a4,a3,s8
    return page2ppn(page) << PGSHIFT;
ffffffffc0204f2e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204f30:	2ef77063          	bgeu	a4,a5,ffffffffc0205210 <do_fork+0x36a>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f34:	000ab703          	ld	a4,0(s5)
ffffffffc0204f38:	000aea97          	auipc	s5,0xae
ffffffffc0204f3c:	9d8a8a93          	addi	s5,s5,-1576 # ffffffffc02b2910 <va_pa_offset>
ffffffffc0204f40:	000ab783          	ld	a5,0(s5)
ffffffffc0204f44:	02873b83          	ld	s7,40(a4)
ffffffffc0204f48:	96be                	add	a3,a3,a5
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204f4a:	e894                	sd	a3,16(s1)
    if (oldmm == NULL) {
ffffffffc0204f4c:	020b8863          	beqz	s7,ffffffffc0204f7c <do_fork+0xd6>
    if (clone_flags & CLONE_VM) {
ffffffffc0204f50:	100a7a13          	andi	s4,s4,256
ffffffffc0204f54:	1c0a0163          	beqz	s4,ffffffffc0205116 <do_fork+0x270>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204f58:	030ba703          	lw	a4,48(s7)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f5c:	018bb783          	ld	a5,24(s7)
ffffffffc0204f60:	c02006b7          	lui	a3,0xc0200
ffffffffc0204f64:	2705                	addiw	a4,a4,1
ffffffffc0204f66:	02eba823          	sw	a4,48(s7)
    proc->mm = mm;
ffffffffc0204f6a:	0374b423          	sd	s7,40(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f6e:	2ad7ed63          	bltu	a5,a3,ffffffffc0205228 <do_fork+0x382>
ffffffffc0204f72:	000ab703          	ld	a4,0(s5)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f76:	6894                	ld	a3,16(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f78:	8f99                	sub	a5,a5,a4
ffffffffc0204f7a:	f4dc                	sd	a5,168(s1)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f7c:	6789                	lui	a5,0x2
ffffffffc0204f7e:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7ce0>
ffffffffc0204f82:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204f84:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f86:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
ffffffffc0204f88:	87b6                	mv	a5,a3
ffffffffc0204f8a:	12040893          	addi	a7,s0,288
ffffffffc0204f8e:	00063803          	ld	a6,0(a2)
ffffffffc0204f92:	6608                	ld	a0,8(a2)
ffffffffc0204f94:	6a0c                	ld	a1,16(a2)
ffffffffc0204f96:	6e18                	ld	a4,24(a2)
ffffffffc0204f98:	0107b023          	sd	a6,0(a5)
ffffffffc0204f9c:	e788                	sd	a0,8(a5)
ffffffffc0204f9e:	eb8c                	sd	a1,16(a5)
ffffffffc0204fa0:	ef98                	sd	a4,24(a5)
ffffffffc0204fa2:	02060613          	addi	a2,a2,32
ffffffffc0204fa6:	02078793          	addi	a5,a5,32
ffffffffc0204faa:	ff1612e3          	bne	a2,a7,ffffffffc0204f8e <do_fork+0xe8>
    proc->tf->gpr.a0 = 0;
ffffffffc0204fae:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x1e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204fb2:	12098f63          	beqz	s3,ffffffffc02050f0 <do_fork+0x24a>
ffffffffc0204fb6:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204fba:	00000797          	auipc	a5,0x0
ffffffffc0204fbe:	d8678793          	addi	a5,a5,-634 # ffffffffc0204d40 <forkret>
ffffffffc0204fc2:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204fc4:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204fc6:	100027f3          	csrr	a5,sstatus
ffffffffc0204fca:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204fcc:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204fce:	14079063          	bnez	a5,ffffffffc020510e <do_fork+0x268>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204fd2:	000a2817          	auipc	a6,0xa2
ffffffffc0204fd6:	42680813          	addi	a6,a6,1062 # ffffffffc02a73f8 <last_pid.1>
ffffffffc0204fda:	00082783          	lw	a5,0(a6)
ffffffffc0204fde:	6709                	lui	a4,0x2
ffffffffc0204fe0:	0017851b          	addiw	a0,a5,1
ffffffffc0204fe4:	00a82023          	sw	a0,0(a6)
ffffffffc0204fe8:	08e55d63          	bge	a0,a4,ffffffffc0205082 <do_fork+0x1dc>
    if (last_pid >= next_safe) {
ffffffffc0204fec:	000a2317          	auipc	t1,0xa2
ffffffffc0204ff0:	41030313          	addi	t1,t1,1040 # ffffffffc02a73fc <next_safe.0>
ffffffffc0204ff4:	00032783          	lw	a5,0(t1)
ffffffffc0204ff8:	000ae417          	auipc	s0,0xae
ffffffffc0204ffc:	8c040413          	addi	s0,s0,-1856 # ffffffffc02b28b8 <proc_list>
ffffffffc0205000:	08f55963          	bge	a0,a5,ffffffffc0205092 <do_fork+0x1ec>
    proc->pid = get_pid(); 
ffffffffc0205004:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0205006:	45a9                	li	a1,10
ffffffffc0205008:	2501                	sext.w	a0,a0
ffffffffc020500a:	0f6010ef          	jal	ra,ffffffffc0206100 <hash32>
ffffffffc020500e:	02051793          	slli	a5,a0,0x20
ffffffffc0205012:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205016:	000aa797          	auipc	a5,0xaa
ffffffffc020501a:	8a278793          	addi	a5,a5,-1886 # ffffffffc02ae8b8 <hash_list>
ffffffffc020501e:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0205020:	650c                	ld	a1,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205022:	7094                	ld	a3,32(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0205024:	0d848793          	addi	a5,s1,216
    prev->next = next->prev = elm;
ffffffffc0205028:	e19c                	sd	a5,0(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc020502a:	6410                	ld	a2,8(s0)
    prev->next = next->prev = elm;
ffffffffc020502c:	e51c                	sd	a5,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc020502e:	7af8                	ld	a4,240(a3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0205030:	0c848793          	addi	a5,s1,200
    elm->next = next;
ffffffffc0205034:	f0ec                	sd	a1,224(s1)
    elm->prev = prev;
ffffffffc0205036:	ece8                	sd	a0,216(s1)
    prev->next = next->prev = elm;
ffffffffc0205038:	e21c                	sd	a5,0(a2)
ffffffffc020503a:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc020503c:	e8f0                	sd	a2,208(s1)
    elm->prev = prev;
ffffffffc020503e:	e4e0                	sd	s0,200(s1)
    proc->yptr = NULL;
ffffffffc0205040:	0e04bc23          	sd	zero,248(s1)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205044:	10e4b023          	sd	a4,256(s1)
ffffffffc0205048:	c311                	beqz	a4,ffffffffc020504c <do_fork+0x1a6>
        proc->optr->yptr = proc;
ffffffffc020504a:	ff64                	sd	s1,248(a4)
    nr_process ++;
ffffffffc020504c:	00092783          	lw	a5,0(s2)
    proc->parent->cptr = proc;
ffffffffc0205050:	fae4                	sd	s1,240(a3)
    nr_process ++;
ffffffffc0205052:	2785                	addiw	a5,a5,1
ffffffffc0205054:	00f92023          	sw	a5,0(s2)
    if (flag) {
ffffffffc0205058:	14099963          	bnez	s3,ffffffffc02051aa <do_fork+0x304>
    wakeup_proc(proc);
ffffffffc020505c:	8526                	mv	a0,s1
ffffffffc020505e:	6b7000ef          	jal	ra,ffffffffc0205f14 <wakeup_proc>
    ret = proc->pid;
...
ffffffffc020508e:	37230313          	addi	t1,t1,882 # ffffffffc02a73fc <next_safe.0>
    return listelm->next;
ffffffffc0205092:	000ae417          	auipc	s0,0xae
ffffffffc0205096:	82640413          	addi	s0,s0,-2010 # ffffffffc02b28b8 <proc_list>
...
ffffffffc02050aa:	108e0863          	beq	t3,s0,ffffffffc02051ba <do_fork+0x314>
ffffffffc02050ae:	88ae                	mv	a7,a1
ffffffffc02050b0:	87f2                	mv	a5,t3
ffffffffc02050b2:	6609                	lui	a2,0x2
ffffffffc02050b4:	a811                	j	ffffffffc02050c8 <do_fork+0x222>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02050b6:	00e6d663          	bge	a3,a4,ffffffffc02050c2 <do_fork+0x21c>
ffffffffc02050ba:	00c75463          	bge	a4,a2,ffffffffc02050c2 <do_fork+0x21c>
ffffffffc02050be:	863a                	mv	a2,a4
ffffffffc02050c0:	4885                	li	a7,1
ffffffffc02050c2:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02050c4:	00878d63          	beq	a5,s0,ffffffffc02050de <do_fork+0x238>
            if (proc->pid == last_pid) {
ffffffffc02050c8:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c84>
ffffffffc02050cc:	fed715e3          	bne	a4,a3,ffffffffc02050b6 <do_fork+0x210>
                if (++ last_pid >= next_safe) {
ffffffffc02050d0:	2685                	addiw	a3,a3,1
ffffffffc02050d2:	0cc6df63          	bge	a3,a2,ffffffffc02051b0 <do_fork+0x30a>
ffffffffc02050d6:	679c                	ld	a5,8(a5)
ffffffffc02050d8:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc02050da:	fe8797e3          	bne	a5,s0,ffffffffc02050c8 <do_fork+0x222>
ffffffffc02050de:	c581                	beqz	a1,ffffffffc02050e6 <do_fork+0x240>
ffffffffc02050e0:	00d82023          	sw	a3,0(a6)
ffffffffc02050e4:	8536                	mv	a0,a3
ffffffffc02050e6:	f0088fe3          	beqz	a7,ffffffffc0205004 <do_fork+0x15e>
ffffffffc02050ea:	00c32023          	sw	a2,0(t1)
ffffffffc02050ee:	bf19                	j	ffffffffc0205004 <do_fork+0x15e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02050f0:	89b6                	mv	s3,a3
ffffffffc02050f2:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02050f6:	00000797          	auipc	a5,0x0
ffffffffc02050fa:	c4a78793          	addi	a5,a5,-950 # ffffffffc0204d40 <forkret>
ffffffffc02050fe:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205100:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205102:	100027f3          	csrr	a5,sstatus
ffffffffc0205106:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205108:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020510a:	ec0784e3          	beqz	a5,ffffffffc0204fd2 <do_fork+0x12c>
        intr_disable();
ffffffffc020510e:	d38fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205112:	4985                	li	s3,1
ffffffffc0205114:	bd7d                	j	ffffffffc0204fd2 <do_fork+0x12c>
    if ((mm = mm_create()) == NULL) {
ffffffffc0205116:	80aff0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc020511a:	8b2a                	mv	s6,a0
ffffffffc020511c:	c151                	beqz	a0,ffffffffc02051a0 <do_fork+0x2fa>
    if ((page = alloc_page()) == NULL) {
ffffffffc020511e:	4505                	li	a0,1
ffffffffc0205120:	bc1fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc0205124:	c93d                	beqz	a0,ffffffffc020519a <do_fork+0x2f4>
    return page - pages + nbase;
ffffffffc0205126:	000db683          	ld	a3,0(s11)
    return KADDR(page2pa(page));
ffffffffc020512a:	000d3783          	ld	a5,0(s10)
    return page - pages + nbase;
ffffffffc020512e:	40d506b3          	sub	a3,a0,a3
ffffffffc0205132:	8699                	srai	a3,a3,0x6
ffffffffc0205134:	96e6                	add	a3,a3,s9
    return KADDR(page2pa(page));
ffffffffc0205136:	0186fc33          	and	s8,a3,s8
    return page2ppn(page) << PGSHIFT;
ffffffffc020513a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020513c:	0cfc7a63          	bgeu	s8,a5,ffffffffc0205210 <do_fork+0x36a>
ffffffffc0205140:	000aba03          	ld	s4,0(s5)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205144:	6605                	lui	a2,0x1
ffffffffc0205146:	000ad597          	auipc	a1,0xad
ffffffffc020514a:	7aa5b583          	ld	a1,1962(a1) # ffffffffc02b28f0 <boot_pgdir>
ffffffffc020514e:	9a36                	add	s4,s4,a3
ffffffffc0205150:	8552                	mv	a0,s4
ffffffffc0205152:	440010ef          	jal	ra,ffffffffc0206592 <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc0205156:	038b8c13          	addi	s8,s7,56
    mm->pgdir = pgdir;
ffffffffc020515a:	014b3c23          	sd	s4,24(s6)
...
ffffffffc0205160:	40fc37af          	amoor.d	a5,a5,(s8)
...
lock(lock_t *lock) {
    while (!try_lock(lock)) {
ffffffffc0205164:	8b85                	andi	a5,a5,1
ffffffffc0205166:	4a05                	li	s4,1
ffffffffc0205168:	c799                	beqz	a5,ffffffffc0205176 <do_fork+0x2d0>
        schedule();
ffffffffc020516a:	62b000ef          	jal	ra,ffffffffc0205f94 <schedule>
ffffffffc020516e:	414c37af          	amoor.d	a5,s4,(s8)
    while (!try_lock(lock)) {
ffffffffc0205172:	8b85                	andi	a5,a5,1
ffffffffc0205174:	fbfd                	bnez	a5,ffffffffc020516a <do_fork+0x2c4>
        ret = dup_mmap(mm, oldmm);
ffffffffc0205176:	85de                	mv	a1,s7
ffffffffc0205178:	855a                	mv	a0,s6
ffffffffc020517a:	a2eff0ef          	jal	ra,ffffffffc02043a8 <dup_mmap>
...
ffffffffc020517e:	57f9                	li	a5,-2
ffffffffc0205180:	60fc37af          	amoand.d	a5,a5,(s8)
...
ffffffffc0205186:	cfd5                	beqz	a5,ffffffffc0205242 <do_fork+0x39c>
good_mm:
ffffffffc0205188:	8bda                	mv	s7,s6
    if (ret != 0) {
ffffffffc020518a:	dc0507e3          	beqz	a0,ffffffffc0204f58 <do_fork+0xb2>
    exit_mmap(mm);
ffffffffc020518e:	855a                	mv	a0,s6
ffffffffc0205190:	ab2ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205194:	855a                	mv	a0,s6
ffffffffc0205196:	c37ff0ef          	jal	ra,ffffffffc0204dcc <put_pgdir>
    mm_destroy(mm);
ffffffffc020519a:	855a                	mv	a0,s6
ffffffffc020519c:	90aff0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    kfree(proc);
ffffffffc02051a0:	8526                	mv	a0,s1
ffffffffc02051a2:	a11fc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    ret = -E_NO_MEM;
ffffffffc02051a6:	5571                	li	a0,-4
    return ret;
ffffffffc02051a8:	bd75                	j	ffffffffc0205064 <do_fork+0x1be>
        intr_enable();
ffffffffc02051aa:	c96fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02051ae:	b57d                	j	ffffffffc020505c <do_fork+0x1b6>
                    if (last_pid >= MAX_PID) {
ffffffffc02051b0:	01d6c363          	blt	a3,t4,ffffffffc02051b6 <do_fork+0x310>
                        last_pid = 1;
ffffffffc02051b4:	4685                	li	a3,1
                    goto repeat;
ffffffffc02051b6:	4585                	li	a1,1
ffffffffc02051b8:	bdcd                	j	ffffffffc02050aa <do_fork+0x204>
ffffffffc02051ba:	c9a1                	beqz	a1,ffffffffc020520a <do_fork+0x364>
ffffffffc02051bc:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02051c0:	8536                	mv	a0,a3
ffffffffc02051c2:	b589                	j	ffffffffc0205004 <do_fork+0x15e>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02051c4:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc02051c6:	c02007b7          	lui	a5,0xc0200
ffffffffc02051ca:	0af6e463          	bltu	a3,a5,ffffffffc0205272 <do_fork+0x3cc>
ffffffffc02051ce:	000ad797          	auipc	a5,0xad
ffffffffc02051d2:	7427b783          	ld	a5,1858(a5) # ffffffffc02b2910 <va_pa_offset>
ffffffffc02051d6:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02051da:	83b1                	srli	a5,a5,0xc
ffffffffc02051dc:	000ad717          	auipc	a4,0xad
ffffffffc02051e0:	71c73703          	ld	a4,1820(a4) # ffffffffc02b28f8 <npage>
ffffffffc02051e4:	06e7fb63          	bgeu	a5,a4,ffffffffc020525a <do_fork+0x3b4>
    return &pages[PPN(pa) - nbase];
ffffffffc02051e8:	00004717          	auipc	a4,0x4
ffffffffc02051ec:	a8073703          	ld	a4,-1408(a4) # ffffffffc0208c68 <nbase>
ffffffffc02051f0:	8f99                	sub	a5,a5,a4
ffffffffc02051f2:	079a                	slli	a5,a5,0x6
ffffffffc02051f4:	000ad517          	auipc	a0,0xad
ffffffffc02051f8:	70c53503          	ld	a0,1804(a0) # ffffffffc02b2900 <pages>
ffffffffc02051fc:	4589                	li	a1,2
ffffffffc02051fe:	953e                	add	a0,a0,a5
ffffffffc0205200:	b73fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
}
ffffffffc0205204:	bf71                	j	ffffffffc02051a0 <do_fork+0x2fa>
    int ret = -E_NO_FREE_PROC;
ffffffffc0205206:	556d                	li	a0,-5
ffffffffc0205208:	bdb1                	j	ffffffffc0205064 <do_fork+0x1be>
    return last_pid;
ffffffffc020520a:	00082503          	lw	a0,0(a6)
ffffffffc020520e:	bbdd                	j	ffffffffc0205004 <do_fork+0x15e>
    return KADDR(page2pa(page));
ffffffffc0205210:	00002617          	auipc	a2,0x2
ffffffffc0205214:	12860613          	addi	a2,a2,296 # ffffffffc0207338 <default_pmm_manager+0x38>
ffffffffc0205218:	06900593          	li	a1,105
ffffffffc020521c:	00002517          	auipc	a0,0x2
ffffffffc0205220:	14450513          	addi	a0,a0,324 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0205224:	a56fb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0205228:	86be                	mv	a3,a5
ffffffffc020522a:	00002617          	auipc	a2,0x2
ffffffffc020522e:	1b660613          	addi	a2,a2,438 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc0205232:	16500593          	li	a1,357
ffffffffc0205236:	00003517          	auipc	a0,0x3
ffffffffc020523a:	19a50513          	addi	a0,a0,410 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc020523e:	a3cfb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("Unlock failed.\n");
ffffffffc0205242:	00003617          	auipc	a2,0x3
ffffffffc0205246:	1a660613          	addi	a2,a2,422 # ffffffffc02083e8 <default_pmm_manager+0x10e8>
ffffffffc020524a:	03100593          	li	a1,49
ffffffffc020524e:	00003517          	auipc	a0,0x3
ffffffffc0205252:	1aa50513          	addi	a0,a0,426 # ffffffffc02083f8 <default_pmm_manager+0x10f8>
ffffffffc0205256:	a24fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020525a:	00002617          	auipc	a2,0x2
ffffffffc020525e:	1ae60613          	addi	a2,a2,430 # ffffffffc0207408 <default_pmm_manager+0x108>
ffffffffc0205262:	06200593          	li	a1,98
ffffffffc0205266:	00002517          	auipc	a0,0x2
ffffffffc020526a:	0fa50513          	addi	a0,a0,250 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc020526e:	a0cfb0ef          	jal	ra,ffffffffc020047a <__panic>
    return pa2page(PADDR(kva));
ffffffffc0205272:	00002617          	auipc	a2,0x2
ffffffffc0205276:	16e60613          	addi	a2,a2,366 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc020527a:	06e00593          	li	a1,110
ffffffffc020527e:	00002517          	auipc	a0,0x2
ffffffffc0205282:	0e250513          	addi	a0,a0,226 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0205286:	9f4fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc020528a <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020528a:	7129                	addi	sp,sp,-320
ffffffffc020528c:	fa22                	sd	s0,304(sp)
ffffffffc020528e:	f626                	sd	s1,296(sp)
ffffffffc0205290:	f24a                	sd	s2,288(sp)
ffffffffc0205292:	84ae                	mv	s1,a1
ffffffffc0205294:	892a                	mv	s2,a0
ffffffffc0205296:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0205298:	4581                	li	a1,0
ffffffffc020529a:	12000613          	li	a2,288
ffffffffc020529e:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02052a0:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02052a2:	2de010ef          	jal	ra,ffffffffc0206580 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02052a6:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02052a8:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02052aa:	100027f3          	csrr	a5,sstatus
ffffffffc02052ae:	edd7f793          	andi	a5,a5,-291
ffffffffc02052b2:	1207e793          	ori	a5,a5,288
ffffffffc02052b6:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052b8:	860a                	mv	a2,sp
ffffffffc02052ba:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02052be:	00000797          	auipc	a5,0x0
ffffffffc02052c2:	a0278793          	addi	a5,a5,-1534 # ffffffffc0204cc0 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052c6:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02052c8:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052ca:	bddff0ef          	jal	ra,ffffffffc0204ea6 <do_fork>
}
ffffffffc02052ce:	70f2                	ld	ra,312(sp)
ffffffffc02052d0:	7452                	ld	s0,304(sp)
ffffffffc02052d2:	74b2                	ld	s1,296(sp)
ffffffffc02052d4:	7912                	ld	s2,288(sp)
ffffffffc02052d6:	6131                	addi	sp,sp,320
ffffffffc02052d8:	8082                	ret

ffffffffc02052da <do_exit>:
do_exit(int error_code) {
ffffffffc02052da:	7179                	addi	sp,sp,-48
ffffffffc02052dc:	f022                	sd	s0,32(sp)
    if (current == idleproc) {
ffffffffc02052de:	000ad417          	auipc	s0,0xad
ffffffffc02052e2:	66240413          	addi	s0,s0,1634 # ffffffffc02b2940 <current>
ffffffffc02052e6:	601c                	ld	a5,0(s0)
do_exit(int error_code) {
ffffffffc02052e8:	f406                	sd	ra,40(sp)
...
ffffffffc02052f0:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc02052f2:	000ad717          	auipc	a4,0xad
ffffffffc02052f6:	65673703          	ld	a4,1622(a4) # ffffffffc02b2948 <idleproc>
ffffffffc02052fa:	0ce78c63          	beq	a5,a4,ffffffffc02053d2 <do_exit+0xf8>
    if (current == initproc) {
ffffffffc02052fe:	000ad497          	auipc	s1,0xad
ffffffffc0205302:	65248493          	addi	s1,s1,1618 # ffffffffc02b2950 <initproc>
ffffffffc0205306:	6098                	ld	a4,0(s1)
ffffffffc0205308:	0ee78b63          	beq	a5,a4,ffffffffc02053fe <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc020530c:	0287b983          	ld	s3,40(a5)
ffffffffc0205310:	892a                	mv	s2,a0
    if (mm != NULL) {
ffffffffc0205312:	02098663          	beqz	s3,ffffffffc020533e <do_exit+0x64>
ffffffffc0205316:	000ad797          	auipc	a5,0xad
ffffffffc020531a:	5d27b783          	ld	a5,1490(a5) # ffffffffc02b28e8 <boot_cr3>
ffffffffc020531e:	577d                	li	a4,-1
ffffffffc0205320:	177e                	slli	a4,a4,0x3f
ffffffffc0205322:	83b1                	srli	a5,a5,0xc
ffffffffc0205324:	8fd9                	or	a5,a5,a4
ffffffffc0205326:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc020532a:	0309a783          	lw	a5,48(s3)
ffffffffc020532e:	fff7871b          	addiw	a4,a5,-1
ffffffffc0205332:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc0205336:	cb55                	beqz	a4,ffffffffc02053ea <do_exit+0x110>
        current->mm = NULL;
ffffffffc0205338:	601c                	ld	a5,0(s0)
ffffffffc020533a:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc020533e:	601c                	ld	a5,0(s0)
ffffffffc0205340:	470d                	li	a4,3
ffffffffc0205342:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc0205344:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205348:	100027f3          	csrr	a5,sstatus
ffffffffc020534c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020534e:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205350:	e3f9                	bnez	a5,ffffffffc0205416 <do_exit+0x13c>
        proc = current->parent;
ffffffffc0205352:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205354:	800007b7          	lui	a5,0x80000
ffffffffc0205358:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc020535a:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc020535c:	0ec52703          	lw	a4,236(a0)
ffffffffc0205360:	0af70f63          	beq	a4,a5,ffffffffc020541e <do_exit+0x144>
        while (current->cptr != NULL) {
ffffffffc0205364:	6018                	ld	a4,0(s0)
ffffffffc0205366:	7b7c                	ld	a5,240(a4)
ffffffffc0205368:	c3a1                	beqz	a5,ffffffffc02053a8 <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020536a:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020536e:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205370:	0985                	addi	s3,s3,1
ffffffffc0205372:	a021                	j	ffffffffc020537a <do_exit+0xa0>
        while (current->cptr != NULL) {
ffffffffc0205374:	6018                	ld	a4,0(s0)
ffffffffc0205376:	7b7c                	ld	a5,240(a4)
ffffffffc0205378:	cb85                	beqz	a5,ffffffffc02053a8 <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc020537a:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fc8>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020537e:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc0205380:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205382:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc0205384:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205388:	10e7b023          	sd	a4,256(a5)
ffffffffc020538c:	c311                	beqz	a4,ffffffffc0205390 <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc020538e:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205390:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc0205392:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc0205394:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205396:	fd271fe3          	bne	a4,s2,ffffffffc0205374 <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020539a:	0ec52783          	lw	a5,236(a0)
ffffffffc020539e:	fd379be3          	bne	a5,s3,ffffffffc0205374 <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc02053a2:	373000ef          	jal	ra,ffffffffc0205f14 <wakeup_proc>
ffffffffc02053a6:	b7f9                	j	ffffffffc0205374 <do_exit+0x9a>
    if (flag) {
ffffffffc02053a8:	020a1263          	bnez	s4,ffffffffc02053cc <do_exit+0xf2>
    schedule();
ffffffffc02053ac:	3e9000ef          	jal	ra,ffffffffc0205f94 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02053b0:	601c                	ld	a5,0(s0)
ffffffffc02053b2:	00003617          	auipc	a2,0x3
ffffffffc02053b6:	07e60613          	addi	a2,a2,126 # ffffffffc0208430 <default_pmm_manager+0x1130>
ffffffffc02053ba:	20200593          	li	a1,514
ffffffffc02053be:	43d4                	lw	a3,4(a5)
ffffffffc02053c0:	00003517          	auipc	a0,0x3
ffffffffc02053c4:	01050513          	addi	a0,a0,16 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02053c8:	8b2fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_enable();
ffffffffc02053cc:	a74fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02053d0:	bff1                	j	ffffffffc02053ac <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc02053d2:	00003617          	auipc	a2,0x3
ffffffffc02053d6:	03e60613          	addi	a2,a2,62 # ffffffffc0208410 <default_pmm_manager+0x1110>
ffffffffc02053da:	1d600593          	li	a1,470
ffffffffc02053de:	00003517          	auipc	a0,0x3
ffffffffc02053e2:	ff250513          	addi	a0,a0,-14 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02053e6:	894fb0ef          	jal	ra,ffffffffc020047a <__panic>
            exit_mmap(mm);
ffffffffc02053ea:	854e                	mv	a0,s3
ffffffffc02053ec:	856ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc02053f0:	854e                	mv	a0,s3
ffffffffc02053f2:	9dbff0ef          	jal	ra,ffffffffc0204dcc <put_pgdir>
            mm_destroy(mm);
ffffffffc02053f6:	854e                	mv	a0,s3
ffffffffc02053f8:	eaffe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc02053fc:	bf35                	j	ffffffffc0205338 <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc02053fe:	00003617          	auipc	a2,0x3
ffffffffc0205402:	02260613          	addi	a2,a2,34 # ffffffffc0208420 <default_pmm_manager+0x1120>
ffffffffc0205406:	1d900593          	li	a1,473
ffffffffc020540a:	00003517          	auipc	a0,0x3
ffffffffc020540e:	fc650513          	addi	a0,a0,-58 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205412:	868fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_disable();
ffffffffc0205416:	a30fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc020541a:	4a05                	li	s4,1
ffffffffc020541c:	bf1d                	j	ffffffffc0205352 <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc020541e:	2f7000ef          	jal	ra,ffffffffc0205f14 <wakeup_proc>
ffffffffc0205422:	b789                	j	ffffffffc0205364 <do_exit+0x8a>

ffffffffc0205424 <do_wait.part.0>:
do_wait(int pid, int *code_store) {
ffffffffc0205424:	715d                	addi	sp,sp,-80
ffffffffc0205426:	f84a                	sd	s2,48(sp)
ffffffffc0205428:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc020542a:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID) {
ffffffffc020542e:	6989                	lui	s3,0x2
do_wait(int pid, int *code_store) {
ffffffffc0205430:	fc26                	sd	s1,56(sp)
ffffffffc0205432:	f052                	sd	s4,32(sp)
ffffffffc0205434:	ec56                	sd	s5,24(sp)
ffffffffc0205436:	e85a                	sd	s6,16(sp)
ffffffffc0205438:	e45e                	sd	s7,8(sp)
ffffffffc020543a:	e486                	sd	ra,72(sp)
ffffffffc020543c:	e0a2                	sd	s0,64(sp)
ffffffffc020543e:	84aa                	mv	s1,a0
ffffffffc0205440:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc0205442:	000adb97          	auipc	s7,0xad
ffffffffc0205446:	4feb8b93          	addi	s7,s7,1278 # ffffffffc02b2940 <current>
    if (0 < pid && pid < MAX_PID) {
ffffffffc020544a:	00050b1b          	sext.w	s6,a0
ffffffffc020544e:	fff50a9b          	addiw	s5,a0,-1
ffffffffc0205452:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc0205454:	0905                	addi	s2,s2,1
    if (pid != 0) {
ffffffffc0205456:	ccbd                	beqz	s1,ffffffffc02054d4 <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205458:	0359e863          	bltu	s3,s5,ffffffffc0205488 <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020545c:	45a9                	li	a1,10
ffffffffc020545e:	855a                	mv	a0,s6
ffffffffc0205460:	4a1000ef          	jal	ra,ffffffffc0206100 <hash32>
ffffffffc0205464:	02051793          	slli	a5,a0,0x20
ffffffffc0205468:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020546c:	000a9797          	auipc	a5,0xa9
ffffffffc0205470:	44c78793          	addi	a5,a5,1100 # ffffffffc02ae8b8 <hash_list>
ffffffffc0205474:	953e                	add	a0,a0,a5
ffffffffc0205476:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205478:	a029                	j	ffffffffc0205482 <do_wait.part.0+0x5e>
            if (proc->pid == pid) {
ffffffffc020547a:	f2c42783          	lw	a5,-212(s0)
ffffffffc020547e:	02978163          	beq	a5,s1,ffffffffc02054a0 <do_wait.part.0+0x7c>
ffffffffc0205482:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list) {
ffffffffc0205484:	fe851be3          	bne	a0,s0,ffffffffc020547a <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc0205488:	5579                	li	a0,-2
}
ffffffffc020548a:	60a6                	ld	ra,72(sp)
ffffffffc020548c:	6406                	ld	s0,64(sp)
ffffffffc020548e:	74e2                	ld	s1,56(sp)
ffffffffc0205490:	7942                	ld	s2,48(sp)
ffffffffc0205492:	79a2                	ld	s3,40(sp)
ffffffffc0205494:	7a02                	ld	s4,32(sp)
ffffffffc0205496:	6ae2                	ld	s5,24(sp)
ffffffffc0205498:	6b42                	ld	s6,16(sp)
ffffffffc020549a:	6ba2                	ld	s7,8(sp)
ffffffffc020549c:	6161                	addi	sp,sp,80
ffffffffc020549e:	8082                	ret
        if (proc != NULL && proc->parent == current) {
ffffffffc02054a0:	000bb683          	ld	a3,0(s7)
ffffffffc02054a4:	f4843783          	ld	a5,-184(s0)
ffffffffc02054a8:	fed790e3          	bne	a5,a3,ffffffffc0205488 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054ac:	f2842703          	lw	a4,-216(s0)
ffffffffc02054b0:	478d                	li	a5,3
ffffffffc02054b2:	0ef70b63          	beq	a4,a5,ffffffffc02055a8 <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc02054b6:	4785                	li	a5,1
ffffffffc02054b8:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc02054ba:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc02054be:	2d7000ef          	jal	ra,ffffffffc0205f94 <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc02054c2:	000bb783          	ld	a5,0(s7)
ffffffffc02054c6:	0b07a783          	lw	a5,176(a5)
ffffffffc02054ca:	8b85                	andi	a5,a5,1
ffffffffc02054cc:	d7c9                	beqz	a5,ffffffffc0205456 <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc02054ce:	555d                	li	a0,-9
ffffffffc02054d0:	e0bff0ef          	jal	ra,ffffffffc02052da <do_exit>
        proc = current->cptr;
ffffffffc02054d4:	000bb683          	ld	a3,0(s7)
ffffffffc02054d8:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02054da:	d45d                	beqz	s0,ffffffffc0205488 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054dc:	470d                	li	a4,3
ffffffffc02054de:	a021                	j	ffffffffc02054e6 <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02054e0:	10043403          	ld	s0,256(s0)
ffffffffc02054e4:	d869                	beqz	s0,ffffffffc02054b6 <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054e6:	401c                	lw	a5,0(s0)
ffffffffc02054e8:	fee79ce3          	bne	a5,a4,ffffffffc02054e0 <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc) {
ffffffffc02054ec:	000ad797          	auipc	a5,0xad
ffffffffc02054f0:	45c7b783          	ld	a5,1116(a5) # ffffffffc02b2948 <idleproc>
ffffffffc02054f4:	0c878963          	beq	a5,s0,ffffffffc02055c6 <do_wait.part.0+0x1a2>
ffffffffc02054f8:	000ad797          	auipc	a5,0xad
ffffffffc02054fc:	4587b783          	ld	a5,1112(a5) # ffffffffc02b2950 <initproc>
ffffffffc0205500:	0cf40363          	beq	s0,a5,ffffffffc02055c6 <do_wait.part.0+0x1a2>
    if (code_store != NULL) {
ffffffffc0205504:	000a0663          	beqz	s4,ffffffffc0205510 <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc0205508:	0e842783          	lw	a5,232(s0)
ffffffffc020550c:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8bc0>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205510:	100027f3          	csrr	a5,sstatus
ffffffffc0205514:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205516:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205518:	e7c1                	bnez	a5,ffffffffc02055a0 <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc020551a:	6c70                	ld	a2,216(s0)
ffffffffc020551c:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc020551e:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc0205522:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc0205524:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0205526:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc0205528:	6470                	ld	a2,200(s0)
ffffffffc020552a:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc020552c:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020552e:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL) {
ffffffffc0205530:	c319                	beqz	a4,ffffffffc0205536 <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc0205532:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL) {
ffffffffc0205534:	7c7c                	ld	a5,248(s0)
ffffffffc0205536:	c3b5                	beqz	a5,ffffffffc020559a <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc0205538:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc020553c:	000ad717          	auipc	a4,0xad
ffffffffc0205540:	41c70713          	addi	a4,a4,1052 # ffffffffc02b2958 <nr_process>
ffffffffc0205544:	431c                	lw	a5,0(a4)
ffffffffc0205546:	37fd                	addiw	a5,a5,-1
ffffffffc0205548:	c31c                	sw	a5,0(a4)
    if (flag) {
ffffffffc020554a:	e5a9                	bnez	a1,ffffffffc0205594 <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc020554c:	6814                	ld	a3,16(s0)
ffffffffc020554e:	c02007b7          	lui	a5,0xc0200
ffffffffc0205552:	04f6ee63          	bltu	a3,a5,ffffffffc02055ae <do_wait.part.0+0x18a>
ffffffffc0205556:	000ad797          	auipc	a5,0xad
ffffffffc020555a:	3ba7b783          	ld	a5,954(a5) # ffffffffc02b2910 <va_pa_offset>
ffffffffc020555e:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc0205560:	82b1                	srli	a3,a3,0xc
ffffffffc0205562:	000ad797          	auipc	a5,0xad
ffffffffc0205566:	3967b783          	ld	a5,918(a5) # ffffffffc02b28f8 <npage>
ffffffffc020556a:	06f6fa63          	bgeu	a3,a5,ffffffffc02055de <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc020556e:	00003517          	auipc	a0,0x3
ffffffffc0205572:	6fa53503          	ld	a0,1786(a0) # ffffffffc0208c68 <nbase>
ffffffffc0205576:	8e89                	sub	a3,a3,a0
ffffffffc0205578:	069a                	slli	a3,a3,0x6
ffffffffc020557a:	000ad517          	auipc	a0,0xad
ffffffffc020557e:	38653503          	ld	a0,902(a0) # ffffffffc02b2900 <pages>
ffffffffc0205582:	9536                	add	a0,a0,a3
ffffffffc0205584:	4589                	li	a1,2
ffffffffc0205586:	fecfc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc020558a:	8522                	mv	a0,s0
ffffffffc020558c:	e26fc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    return 0;
ffffffffc0205590:	4501                	li	a0,0
ffffffffc0205592:	bde5                	j	ffffffffc020548a <do_wait.part.0+0x66>
        intr_enable();
ffffffffc0205594:	8acfb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205598:	bf55                	j	ffffffffc020554c <do_wait.part.0+0x128>
       proc->parent->cptr = proc->optr;
ffffffffc020559a:	701c                	ld	a5,32(s0)
ffffffffc020559c:	fbf8                	sd	a4,240(a5)
ffffffffc020559e:	bf79                	j	ffffffffc020553c <do_wait.part.0+0x118>
        intr_disable();
ffffffffc02055a0:	8a6fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02055a4:	4585                	li	a1,1
ffffffffc02055a6:	bf95                	j	ffffffffc020551a <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02055a8:	f2840413          	addi	s0,s0,-216
ffffffffc02055ac:	b781                	j	ffffffffc02054ec <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc02055ae:	00002617          	auipc	a2,0x2
ffffffffc02055b2:	e3260613          	addi	a2,a2,-462 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc02055b6:	06e00593          	li	a1,110
ffffffffc02055ba:	00002517          	auipc	a0,0x2
ffffffffc02055be:	da650513          	addi	a0,a0,-602 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc02055c2:	eb9fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc02055c6:	00003617          	auipc	a2,0x3
ffffffffc02055ca:	e8a60613          	addi	a2,a2,-374 # ffffffffc0208450 <default_pmm_manager+0x1150>
ffffffffc02055ce:	2fa00593          	li	a1,762
ffffffffc02055d2:	00003517          	auipc	a0,0x3
ffffffffc02055d6:	dfe50513          	addi	a0,a0,-514 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02055da:	ea1fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02055de:	00002617          	auipc	a2,0x2
ffffffffc02055e2:	e2a60613          	addi	a2,a2,-470 # ffffffffc0207408 <default_pmm_manager+0x108>
ffffffffc02055e6:	06200593          	li	a1,98
ffffffffc02055ea:	00002517          	auipc	a0,0x2
ffffffffc02055ee:	d7650513          	addi	a0,a0,-650 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc02055f2:	e89fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02055f6 <init_main>:
}

// init_main - the second kernel thread used to create user_main kernel threads
static int
init_main(void *arg) {
ffffffffc02055f6:	1141                	addi	sp,sp,-16
ffffffffc02055f8:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02055fa:	fb8fc0ef          	jal	ra,ffffffffc0201db2 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc02055fe:	d00fc0ef          	jal	ra,ffffffffc0201afe <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc0205602:	4601                	li	a2,0
ffffffffc0205604:	4581                	li	a1,0
ffffffffc0205606:	fffff517          	auipc	a0,0xfffff
ffffffffc020560a:	74850513          	addi	a0,a0,1864 # ffffffffc0204d4e <user_main>
ffffffffc020560e:	c7dff0ef          	jal	ra,ffffffffc020528a <kernel_thread>
    if (pid <= 0) {
ffffffffc0205612:	00a04563          	bgtz	a0,ffffffffc020561c <init_main+0x26>
ffffffffc0205616:	a071                	j	ffffffffc02056a2 <init_main+0xac>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc0205618:	17d000ef          	jal	ra,ffffffffc0205f94 <schedule>
    if (code_store != NULL) {
ffffffffc020561c:	4581                	li	a1,0
ffffffffc020561e:	4501                	li	a0,0
ffffffffc0205620:	e05ff0ef          	jal	ra,ffffffffc0205424 <do_wait.part.0>
    while (do_wait(0, NULL) == 0) {
ffffffffc0205624:	d975                	beqz	a0,ffffffffc0205618 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc0205626:	00003517          	auipc	a0,0x3
ffffffffc020562a:	e6a50513          	addi	a0,a0,-406 # ffffffffc0208490 <default_pmm_manager+0x1190>
ffffffffc020562e:	b53fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0205632:	000ad797          	auipc	a5,0xad
ffffffffc0205636:	31e7b783          	ld	a5,798(a5) # ffffffffc02b2950 <initproc>
ffffffffc020563a:	7bf8                	ld	a4,240(a5)
ffffffffc020563c:	e339                	bnez	a4,ffffffffc0205682 <init_main+0x8c>
ffffffffc020563e:	7ff8                	ld	a4,248(a5)
ffffffffc0205640:	e329                	bnez	a4,ffffffffc0205682 <init_main+0x8c>
ffffffffc0205642:	1007b703          	ld	a4,256(a5)
ffffffffc0205646:	ef15                	bnez	a4,ffffffffc0205682 <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc0205648:	000ad697          	auipc	a3,0xad
ffffffffc020564c:	3106a683          	lw	a3,784(a3) # ffffffffc02b2958 <nr_process>
ffffffffc0205650:	4709                	li	a4,2
ffffffffc0205652:	0ae69463          	bne	a3,a4,ffffffffc02056fa <init_main+0x104>
    return listelm->next;
ffffffffc0205656:	000ad697          	auipc	a3,0xad
ffffffffc020565a:	26268693          	addi	a3,a3,610 # ffffffffc02b28b8 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020565e:	6698                	ld	a4,8(a3)
ffffffffc0205660:	0c878793          	addi	a5,a5,200
ffffffffc0205664:	06f71b63          	bne	a4,a5,ffffffffc02056da <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0205668:	629c                	ld	a5,0(a3)
ffffffffc020566a:	04f71863          	bne	a4,a5,ffffffffc02056ba <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc020566e:	00003517          	auipc	a0,0x3
ffffffffc0205672:	f0a50513          	addi	a0,a0,-246 # ffffffffc0208578 <default_pmm_manager+0x1278>
ffffffffc0205676:	b0bfa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc020567a:	60a2                	ld	ra,8(sp)
ffffffffc020567c:	4501                	li	a0,0
ffffffffc020567e:	0141                	addi	sp,sp,16
ffffffffc0205680:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0205682:	00003697          	auipc	a3,0x3
ffffffffc0205686:	e3668693          	addi	a3,a3,-458 # ffffffffc02084b8 <default_pmm_manager+0x11b8>
ffffffffc020568a:	00001617          	auipc	a2,0x1
ffffffffc020568e:	5de60613          	addi	a2,a2,1502 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205692:	35f00593          	li	a1,863
ffffffffc0205696:	00003517          	auipc	a0,0x3
ffffffffc020569a:	d3a50513          	addi	a0,a0,-710 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc020569e:	dddfa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc02056a2:	00003617          	auipc	a2,0x3
ffffffffc02056a6:	dce60613          	addi	a2,a2,-562 # ffffffffc0208470 <default_pmm_manager+0x1170>
ffffffffc02056aa:	35700593          	li	a1,855
ffffffffc02056ae:	00003517          	auipc	a0,0x3
ffffffffc02056b2:	d2250513          	addi	a0,a0,-734 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02056b6:	dc5fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02056ba:	00003697          	auipc	a3,0x3
ffffffffc02056be:	e8e68693          	addi	a3,a3,-370 # ffffffffc0208548 <default_pmm_manager+0x1248>
ffffffffc02056c2:	00001617          	auipc	a2,0x1
ffffffffc02056c6:	5a660613          	addi	a2,a2,1446 # ffffffffc0206c68 <commands+0x450>
ffffffffc02056ca:	36200593          	li	a1,866
ffffffffc02056ce:	00003517          	auipc	a0,0x3
ffffffffc02056d2:	d0250513          	addi	a0,a0,-766 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02056d6:	da5fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02056da:	00003697          	auipc	a3,0x3
ffffffffc02056de:	e3e68693          	addi	a3,a3,-450 # ffffffffc0208518 <default_pmm_manager+0x1218>
ffffffffc02056e2:	00001617          	auipc	a2,0x1
ffffffffc02056e6:	58660613          	addi	a2,a2,1414 # ffffffffc0206c68 <commands+0x450>
ffffffffc02056ea:	36100593          	li	a1,865
ffffffffc02056ee:	00003517          	auipc	a0,0x3
ffffffffc02056f2:	ce250513          	addi	a0,a0,-798 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02056f6:	d85fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc02056fa:	00003697          	auipc	a3,0x3
ffffffffc02056fe:	e0e68693          	addi	a3,a3,-498 # ffffffffc0208508 <default_pmm_manager+0x1208>
ffffffffc0205702:	00001617          	auipc	a2,0x1
ffffffffc0205706:	56660613          	addi	a2,a2,1382 # ffffffffc0206c68 <commands+0x450>
ffffffffc020570a:	36000593          	li	a1,864
ffffffffc020570e:	00003517          	auipc	a0,0x3
ffffffffc0205712:	cc250513          	addi	a0,a0,-830 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205716:	d65fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc020571a <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020571a:	7171                	addi	sp,sp,-176
ffffffffc020571c:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020571e:	000add97          	auipc	s11,0xad
ffffffffc0205722:	222d8d93          	addi	s11,s11,546 # ffffffffc02b2940 <current>
ffffffffc0205726:	000db783          	ld	a5,0(s11)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020572a:	e54e                	sd	s3,136(sp)
ffffffffc020572c:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020572e:	0287b983          	ld	s3,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205732:	e94a                	sd	s2,144(sp)
ffffffffc0205734:	f4de                	sd	s7,104(sp)
ffffffffc0205736:	892a                	mv	s2,a0
ffffffffc0205738:	8bb2                	mv	s7,a2
ffffffffc020573a:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc020573c:	862e                	mv	a2,a1
ffffffffc020573e:	4681                	li	a3,0
ffffffffc0205740:	85aa                	mv	a1,a0
ffffffffc0205742:	854e                	mv	a0,s3
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205744:	f506                	sd	ra,168(sp)
ffffffffc0205746:	f122                	sd	s0,160(sp)
ffffffffc0205748:	e152                	sd	s4,128(sp)
ffffffffc020574a:	fcd6                	sd	s5,120(sp)
ffffffffc020574c:	f8da                	sd	s6,112(sp)
ffffffffc020574e:	f0e2                	sd	s8,96(sp)
ffffffffc0205750:	ece6                	sd	s9,88(sp)
ffffffffc0205752:	e8ea                	sd	s10,80(sp)
ffffffffc0205754:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205756:	b82ff0ef          	jal	ra,ffffffffc0204ad8 <user_mem_check>
ffffffffc020575a:	40050a63          	beqz	a0,ffffffffc0205b6e <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc020575e:	4641                	li	a2,16
ffffffffc0205760:	4581                	li	a1,0
ffffffffc0205762:	1808                	addi	a0,sp,48
ffffffffc0205764:	61d000ef          	jal	ra,ffffffffc0206580 <memset>
    memcpy(local_name, name, len);
ffffffffc0205768:	47bd                	li	a5,15
ffffffffc020576a:	8626                	mv	a2,s1
ffffffffc020576c:	1e97e263          	bltu	a5,s1,ffffffffc0205950 <do_execve+0x236>
ffffffffc0205770:	85ca                	mv	a1,s2
ffffffffc0205772:	1808                	addi	a0,sp,48
ffffffffc0205774:	61f000ef          	jal	ra,ffffffffc0206592 <memcpy>
    if (mm != NULL) {
ffffffffc0205778:	1e098363          	beqz	s3,ffffffffc020595e <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc020577c:	00002517          	auipc	a0,0x2
ffffffffc0205780:	30c50513          	addi	a0,a0,780 # ffffffffc0207a88 <default_pmm_manager+0x788>
ffffffffc0205784:	a35fa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc0205788:	000ad797          	auipc	a5,0xad
ffffffffc020578c:	1607b783          	ld	a5,352(a5) # ffffffffc02b28e8 <boot_cr3>
ffffffffc0205790:	577d                	li	a4,-1
ffffffffc0205792:	177e                	slli	a4,a4,0x3f
ffffffffc0205794:	83b1                	srli	a5,a5,0xc
ffffffffc0205796:	8fd9                	or	a5,a5,a4
ffffffffc0205798:	18079073          	csrw	satp,a5
ffffffffc020579c:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b90>
ffffffffc02057a0:	fff7871b          	addiw	a4,a5,-1
ffffffffc02057a4:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc02057a8:	2c070463          	beqz	a4,ffffffffc0205a70 <do_execve+0x356>
        current->mm = NULL;
ffffffffc02057ac:	000db783          	ld	a5,0(s11)
ffffffffc02057b0:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc02057b4:	96dfe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc02057b8:	84aa                	mv	s1,a0
ffffffffc02057ba:	1c050d63          	beqz	a0,ffffffffc0205994 <do_execve+0x27a>
    if ((page = alloc_page()) == NULL) {
ffffffffc02057be:	4505                	li	a0,1
ffffffffc02057c0:	d20fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc02057c4:	3a050963          	beqz	a0,ffffffffc0205b76 <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc02057c8:	000adc97          	auipc	s9,0xad
ffffffffc02057cc:	138c8c93          	addi	s9,s9,312 # ffffffffc02b2900 <pages>
ffffffffc02057d0:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc02057d4:	000adc17          	auipc	s8,0xad
ffffffffc02057d8:	124c0c13          	addi	s8,s8,292 # ffffffffc02b28f8 <npage>
    return page - pages + nbase;
ffffffffc02057dc:	00003717          	auipc	a4,0x3
ffffffffc02057e0:	48c73703          	ld	a4,1164(a4) # ffffffffc0208c68 <nbase>
ffffffffc02057e4:	40d506b3          	sub	a3,a0,a3
ffffffffc02057e8:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02057ea:	5afd                	li	s5,-1
ffffffffc02057ec:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc02057f0:	96ba                	add	a3,a3,a4
ffffffffc02057f2:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc02057f4:	00cad713          	srli	a4,s5,0xc
ffffffffc02057f8:	ec3a                	sd	a4,24(sp)
ffffffffc02057fa:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc02057fc:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02057fe:	38f77063          	bgeu	a4,a5,ffffffffc0205b7e <do_execve+0x464>
ffffffffc0205802:	000adb17          	auipc	s6,0xad
ffffffffc0205806:	10eb0b13          	addi	s6,s6,270 # ffffffffc02b2910 <va_pa_offset>
ffffffffc020580a:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc020580e:	6605                	lui	a2,0x1
ffffffffc0205810:	000ad597          	auipc	a1,0xad
ffffffffc0205814:	0e05b583          	ld	a1,224(a1) # ffffffffc02b28f0 <boot_pgdir>
ffffffffc0205818:	9936                	add	s2,s2,a3
ffffffffc020581a:	854a                	mv	a0,s2
ffffffffc020581c:	577000ef          	jal	ra,ffffffffc0206592 <memcpy>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205820:	7782                	ld	a5,32(sp)
ffffffffc0205822:	4398                	lw	a4,0(a5)
ffffffffc0205824:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc0205828:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc020582c:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9447>
ffffffffc0205830:	14f71863          	bne	a4,a5,ffffffffc0205980 <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205834:	7682                	ld	a3,32(sp)
ffffffffc0205836:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc020583a:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020583e:	00371793          	slli	a5,a4,0x3
ffffffffc0205842:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205844:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205846:	078e                	slli	a5,a5,0x3
ffffffffc0205848:	97ce                	add	a5,a5,s3
ffffffffc020584a:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc020584c:	00f9fc63          	bgeu	s3,a5,ffffffffc0205864 <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc0205850:	0009a783          	lw	a5,0(s3)
ffffffffc0205854:	4705                	li	a4,1
ffffffffc0205856:	14e78163          	beq	a5,a4,ffffffffc0205998 <do_execve+0x27e>
    for (; ph < ph_end; ph ++) {
ffffffffc020585a:	77a2                	ld	a5,40(sp)
ffffffffc020585c:	03898993          	addi	s3,s3,56
ffffffffc0205860:	fef9e8e3          	bltu	s3,a5,ffffffffc0205850 <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc0205864:	4701                	li	a4,0
ffffffffc0205866:	46ad                	li	a3,11
ffffffffc0205868:	00100637          	lui	a2,0x100
ffffffffc020586c:	7ff005b7          	lui	a1,0x7ff00
ffffffffc0205870:	8526                	mv	a0,s1
ffffffffc0205872:	a87fe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205876:	8a2a                	mv	s4,a0
ffffffffc0205878:	1e051263          	bnez	a0,ffffffffc0205a5c <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc020587c:	6c88                	ld	a0,24(s1)
ffffffffc020587e:	467d                	li	a2,31
ffffffffc0205880:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc0205884:	ac9fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205888:	38050363          	beqz	a0,ffffffffc0205c0e <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc020588c:	6c88                	ld	a0,24(s1)
ffffffffc020588e:	467d                	li	a2,31
ffffffffc0205890:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc0205894:	ab9fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205898:	34050b63          	beqz	a0,ffffffffc0205bee <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc020589c:	6c88                	ld	a0,24(s1)
ffffffffc020589e:	467d                	li	a2,31
ffffffffc02058a0:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc02058a4:	aa9fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058a8:	32050363          	beqz	a0,ffffffffc0205bce <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc02058ac:	6c88                	ld	a0,24(s1)
ffffffffc02058ae:	467d                	li	a2,31
ffffffffc02058b0:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc02058b4:	a99fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058b8:	2e050b63          	beqz	a0,ffffffffc0205bae <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc02058bc:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc02058be:	000db603          	ld	a2,0(s11)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02058c2:	6c94                	ld	a3,24(s1)
ffffffffc02058c4:	2785                	addiw	a5,a5,1
ffffffffc02058c6:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc02058c8:	f604                	sd	s1,40(a2)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02058ca:	c02007b7          	lui	a5,0xc0200
ffffffffc02058ce:	2cf6e463          	bltu	a3,a5,ffffffffc0205b96 <do_execve+0x47c>
ffffffffc02058d2:	000b3783          	ld	a5,0(s6)
ffffffffc02058d6:	577d                	li	a4,-1
ffffffffc02058d8:	177e                	slli	a4,a4,0x3f
ffffffffc02058da:	8e9d                	sub	a3,a3,a5
ffffffffc02058dc:	00c6d793          	srli	a5,a3,0xc
ffffffffc02058e0:	f654                	sd	a3,168(a2)
ffffffffc02058e2:	8fd9                	or	a5,a5,a4
ffffffffc02058e4:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc02058e8:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02058ea:	4581                	li	a1,0
ffffffffc02058ec:	12000613          	li	a2,288
ffffffffc02058f0:	8522                	mv	a0,s0
    uintptr_t sstatus = tf->status;
ffffffffc02058f2:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02058f6:	48b000ef          	jal	ra,ffffffffc0206580 <memset>
    tf->epc = elf->e_entry;
ffffffffc02058fa:	7782                	ld	a5,32(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02058fc:	000db903          	ld	s2,0(s11)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0205900:	edf4f493          	andi	s1,s1,-289
    tf->epc = elf->e_entry;
ffffffffc0205904:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;
ffffffffc0205906:	4785                	li	a5,1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205908:	0b490913          	addi	s2,s2,180 # ffffffff800000b4 <_binary_obj___user_exit_out_size+0xffffffff7fff4f7c>
    tf->gpr.sp = USTACKTOP;
ffffffffc020590c:	07fe                	slli	a5,a5,0x1f
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc020590e:	0204e493          	ori	s1,s1,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205912:	4641                	li	a2,16
ffffffffc0205914:	4581                	li	a1,0
    tf->gpr.sp = USTACKTOP;
ffffffffc0205916:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;
ffffffffc0205918:	10e43423          	sd	a4,264(s0)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc020591c:	10943023          	sd	s1,256(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205920:	854a                	mv	a0,s2
ffffffffc0205922:	45f000ef          	jal	ra,ffffffffc0206580 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205926:	463d                	li	a2,15
ffffffffc0205928:	180c                	addi	a1,sp,48
ffffffffc020592a:	854a                	mv	a0,s2
ffffffffc020592c:	467000ef          	jal	ra,ffffffffc0206592 <memcpy>
}
ffffffffc0205930:	70aa                	ld	ra,168(sp)
ffffffffc0205932:	740a                	ld	s0,160(sp)
ffffffffc0205934:	64ea                	ld	s1,152(sp)
ffffffffc0205936:	694a                	ld	s2,144(sp)
ffffffffc0205938:	69aa                	ld	s3,136(sp)
ffffffffc020593a:	7ae6                	ld	s5,120(sp)
ffffffffc020593c:	7b46                	ld	s6,112(sp)
ffffffffc020593e:	7ba6                	ld	s7,104(sp)
ffffffffc0205940:	7c06                	ld	s8,96(sp)
ffffffffc0205942:	6ce6                	ld	s9,88(sp)
ffffffffc0205944:	6d46                	ld	s10,80(sp)
ffffffffc0205946:	6da6                	ld	s11,72(sp)
ffffffffc0205948:	8552                	mv	a0,s4
ffffffffc020594a:	6a0a                	ld	s4,128(sp)
ffffffffc020594c:	614d                	addi	sp,sp,176
ffffffffc020594e:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc0205950:	463d                	li	a2,15
ffffffffc0205952:	85ca                	mv	a1,s2
ffffffffc0205954:	1808                	addi	a0,sp,48
ffffffffc0205956:	43d000ef          	jal	ra,ffffffffc0206592 <memcpy>
    if (mm != NULL) {
ffffffffc020595a:	e20991e3          	bnez	s3,ffffffffc020577c <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc020595e:	000db783          	ld	a5,0(s11)
ffffffffc0205962:	779c                	ld	a5,40(a5)
ffffffffc0205964:	e40788e3          	beqz	a5,ffffffffc02057b4 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc0205968:	00003617          	auipc	a2,0x3
ffffffffc020596c:	c3060613          	addi	a2,a2,-976 # ffffffffc0208598 <default_pmm_manager+0x1298>
ffffffffc0205970:	20c00593          	li	a1,524
ffffffffc0205974:	00003517          	auipc	a0,0x3
ffffffffc0205978:	a5c50513          	addi	a0,a0,-1444 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc020597c:	afffa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc0205980:	8526                	mv	a0,s1
ffffffffc0205982:	c4aff0ef          	jal	ra,ffffffffc0204dcc <put_pgdir>
    mm_destroy(mm);
ffffffffc0205986:	8526                	mv	a0,s1
ffffffffc0205988:	91ffe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc020598c:	5a61                	li	s4,-8
    do_exit(ret);
ffffffffc020598e:	8552                	mv	a0,s4
ffffffffc0205990:	94bff0ef          	jal	ra,ffffffffc02052da <do_exit>
    int ret = -E_NO_MEM;
ffffffffc0205994:	5a71                	li	s4,-4
ffffffffc0205996:	bfe5                	j	ffffffffc020598e <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc0205998:	0289b603          	ld	a2,40(s3)
ffffffffc020599c:	0209b783          	ld	a5,32(s3)
ffffffffc02059a0:	1cf66d63          	bltu	a2,a5,ffffffffc0205b7a <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc02059a4:	0049a783          	lw	a5,4(s3)
ffffffffc02059a8:	0017f693          	andi	a3,a5,1
ffffffffc02059ac:	c291                	beqz	a3,ffffffffc02059b0 <do_execve+0x296>
ffffffffc02059ae:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059b0:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059b4:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059b6:	e779                	bnez	a4,ffffffffc0205a84 <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc02059b8:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059ba:	c781                	beqz	a5,ffffffffc02059c2 <do_execve+0x2a8>
ffffffffc02059bc:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc02059c0:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc02059c2:	0026f793          	andi	a5,a3,2
ffffffffc02059c6:	e3f1                	bnez	a5,ffffffffc0205a8a <do_execve+0x370>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc02059c8:	0046f793          	andi	a5,a3,4
ffffffffc02059cc:	c399                	beqz	a5,ffffffffc02059d2 <do_execve+0x2b8>
ffffffffc02059ce:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc02059d2:	0109b583          	ld	a1,16(s3)
ffffffffc02059d6:	4701                	li	a4,0
ffffffffc02059d8:	8526                	mv	a0,s1
ffffffffc02059da:	91ffe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc02059de:	8a2a                	mv	s4,a0
ffffffffc02059e0:	ed35                	bnez	a0,ffffffffc0205a5c <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059e2:	0109bb83          	ld	s7,16(s3)
ffffffffc02059e6:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc02059e8:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059ec:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059f0:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059f4:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc02059f6:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059f8:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc02059fa:	054be963          	bltu	s7,s4,ffffffffc0205a4c <do_execve+0x332>
ffffffffc02059fe:	aa95                	j	ffffffffc0205b72 <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205a00:	6785                	lui	a5,0x1
ffffffffc0205a02:	415b8533          	sub	a0,s7,s5
ffffffffc0205a06:	9abe                	add	s5,s5,a5
ffffffffc0205a08:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205a0c:	015a7463          	bgeu	s4,s5,ffffffffc0205a14 <do_execve+0x2fa>
                size -= la - end;
ffffffffc0205a10:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0205a14:	000cb683          	ld	a3,0(s9)
ffffffffc0205a18:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205a1a:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205a1e:	40d406b3          	sub	a3,s0,a3
ffffffffc0205a22:	8699                	srai	a3,a3,0x6
ffffffffc0205a24:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205a26:	67e2                	ld	a5,24(sp)
ffffffffc0205a28:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205a2c:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205a2e:	14b87863          	bgeu	a6,a1,ffffffffc0205b7e <do_execve+0x464>
ffffffffc0205a32:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a36:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0205a38:	9bb2                	add	s7,s7,a2
ffffffffc0205a3a:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a3c:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205a3e:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a40:	353000ef          	jal	ra,ffffffffc0206592 <memcpy>
            start += size, from += size;
ffffffffc0205a44:	6622                	ld	a2,8(sp)
ffffffffc0205a46:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205a48:	054bf363          	bgeu	s7,s4,ffffffffc0205a8e <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205a4c:	6c88                	ld	a0,24(s1)
ffffffffc0205a4e:	866a                	mv	a2,s10
ffffffffc0205a50:	85d6                	mv	a1,s5
ffffffffc0205a52:	8fbfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a56:	842a                	mv	s0,a0
ffffffffc0205a58:	f545                	bnez	a0,ffffffffc0205a00 <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0205a5a:	5a71                	li	s4,-4
    exit_mmap(mm);
ffffffffc0205a5c:	8526                	mv	a0,s1
ffffffffc0205a5e:	9e5fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205a62:	8526                	mv	a0,s1
ffffffffc0205a64:	b68ff0ef          	jal	ra,ffffffffc0204dcc <put_pgdir>
    mm_destroy(mm);
ffffffffc0205a68:	8526                	mv	a0,s1
ffffffffc0205a6a:	83dfe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    return ret;
ffffffffc0205a6e:	b705                	j	ffffffffc020598e <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0205a70:	854e                	mv	a0,s3
ffffffffc0205a72:	9d1fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205a76:	854e                	mv	a0,s3
ffffffffc0205a78:	b54ff0ef          	jal	ra,ffffffffc0204dcc <put_pgdir>
            mm_destroy(mm);
ffffffffc0205a7c:	854e                	mv	a0,s3
ffffffffc0205a7e:	829fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205a82:	b32d                	j	ffffffffc02057ac <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a84:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a88:	fb95                	bnez	a5,ffffffffc02059bc <do_execve+0x2a2>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a8a:	4d5d                	li	s10,23
ffffffffc0205a8c:	bf35                	j	ffffffffc02059c8 <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205a8e:	0109b683          	ld	a3,16(s3)
ffffffffc0205a92:	0289b903          	ld	s2,40(s3)
ffffffffc0205a96:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205a98:	075bfd63          	bgeu	s7,s5,ffffffffc0205b12 <do_execve+0x3f8>
            if (start == end) {
ffffffffc0205a9c:	db790fe3          	beq	s2,s7,ffffffffc020585a <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205aa0:	6785                	lui	a5,0x1
ffffffffc0205aa2:	00fb8533          	add	a0,s7,a5
ffffffffc0205aa6:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205aaa:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205aae:	0b597d63          	bgeu	s2,s5,ffffffffc0205b68 <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0205ab2:	000cb683          	ld	a3,0(s9)
ffffffffc0205ab6:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205ab8:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0205abc:	40d406b3          	sub	a3,s0,a3
ffffffffc0205ac0:	8699                	srai	a3,a3,0x6
ffffffffc0205ac2:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205ac4:	67e2                	ld	a5,24(sp)
ffffffffc0205ac6:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205aca:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205acc:	0ac5f963          	bgeu	a1,a2,ffffffffc0205b7e <do_execve+0x464>
ffffffffc0205ad0:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205ad4:	8652                	mv	a2,s4
ffffffffc0205ad6:	4581                	li	a1,0
ffffffffc0205ad8:	96c2                	add	a3,a3,a6
ffffffffc0205ada:	9536                	add	a0,a0,a3
ffffffffc0205adc:	2a5000ef          	jal	ra,ffffffffc0206580 <memset>
            start += size;
ffffffffc0205ae0:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205ae4:	03597463          	bgeu	s2,s5,ffffffffc0205b0c <do_execve+0x3f2>
ffffffffc0205ae8:	d6e909e3          	beq	s2,a4,ffffffffc020585a <do_execve+0x140>
ffffffffc0205aec:	00003697          	auipc	a3,0x3
ffffffffc0205af0:	ad468693          	addi	a3,a3,-1324 # ffffffffc02085c0 <default_pmm_manager+0x12c0>
ffffffffc0205af4:	00001617          	auipc	a2,0x1
ffffffffc0205af8:	17460613          	addi	a2,a2,372 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205afc:	26100593          	li	a1,609
ffffffffc0205b00:	00003517          	auipc	a0,0x3
ffffffffc0205b04:	8d050513          	addi	a0,a0,-1840 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205b08:	973fa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205b0c:	ff5710e3          	bne	a4,s5,ffffffffc0205aec <do_execve+0x3d2>
ffffffffc0205b10:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205b12:	d52bf4e3          	bgeu	s7,s2,ffffffffc020585a <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205b16:	6c88                	ld	a0,24(s1)
ffffffffc0205b18:	866a                	mv	a2,s10
ffffffffc0205b1a:	85d6                	mv	a1,s5
ffffffffc0205b1c:	831fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205b20:	842a                	mv	s0,a0
ffffffffc0205b22:	dd05                	beqz	a0,ffffffffc0205a5a <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205b24:	6785                	lui	a5,0x1
ffffffffc0205b26:	415b8533          	sub	a0,s7,s5
ffffffffc0205b2a:	9abe                	add	s5,s5,a5
ffffffffc0205b2c:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205b30:	01597463          	bgeu	s2,s5,ffffffffc0205b38 <do_execve+0x41e>
                size -= la - end;
ffffffffc0205b34:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0205b38:	000cb683          	ld	a3,0(s9)
ffffffffc0205b3c:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205b3e:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205b42:	40d406b3          	sub	a3,s0,a3
ffffffffc0205b46:	8699                	srai	a3,a3,0x6
ffffffffc0205b48:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b4a:	67e2                	ld	a5,24(sp)
ffffffffc0205b4c:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b50:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b52:	02b87663          	bgeu	a6,a1,ffffffffc0205b7e <do_execve+0x464>
ffffffffc0205b56:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b5a:	4581                	li	a1,0
            start += size;
ffffffffc0205b5c:	9bb2                	add	s7,s7,a2
ffffffffc0205b5e:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b60:	9536                	add	a0,a0,a3
ffffffffc0205b62:	21f000ef          	jal	ra,ffffffffc0206580 <memset>
ffffffffc0205b66:	b775                	j	ffffffffc0205b12 <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205b68:	417a8a33          	sub	s4,s5,s7
ffffffffc0205b6c:	b799                	j	ffffffffc0205ab2 <do_execve+0x398>
        return -E_INVAL;
ffffffffc0205b6e:	5a75                	li	s4,-3
ffffffffc0205b70:	b3c1                	j	ffffffffc0205930 <do_execve+0x216>
        while (start < end) {
ffffffffc0205b72:	86de                	mv	a3,s7
ffffffffc0205b74:	bf39                	j	ffffffffc0205a92 <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0205b76:	5a71                	li	s4,-4
ffffffffc0205b78:	bdc5                	j	ffffffffc0205a68 <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0205b7a:	5a61                	li	s4,-8
ffffffffc0205b7c:	b5c5                	j	ffffffffc0205a5c <do_execve+0x342>
ffffffffc0205b7e:	00001617          	auipc	a2,0x1
ffffffffc0205b82:	7ba60613          	addi	a2,a2,1978 # ffffffffc0207338 <default_pmm_manager+0x38>
ffffffffc0205b86:	06900593          	li	a1,105
ffffffffc0205b8a:	00001517          	auipc	a0,0x1
ffffffffc0205b8e:	7d650513          	addi	a0,a0,2006 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0205b92:	8e9fa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205b96:	00002617          	auipc	a2,0x2
ffffffffc0205b9a:	84a60613          	addi	a2,a2,-1974 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc0205b9e:	27c00593          	li	a1,636
ffffffffc0205ba2:	00003517          	auipc	a0,0x3
ffffffffc0205ba6:	82e50513          	addi	a0,a0,-2002 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205baa:	8d1fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bae:	00003697          	auipc	a3,0x3
ffffffffc0205bb2:	b2a68693          	addi	a3,a3,-1238 # ffffffffc02086d8 <default_pmm_manager+0x13d8>
ffffffffc0205bb6:	00001617          	auipc	a2,0x1
ffffffffc0205bba:	0b260613          	addi	a2,a2,178 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205bbe:	27700593          	li	a1,631
ffffffffc0205bc2:	00003517          	auipc	a0,0x3
ffffffffc0205bc6:	80e50513          	addi	a0,a0,-2034 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205bca:	8b1fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bce:	00003697          	auipc	a3,0x3
ffffffffc0205bd2:	ac268693          	addi	a3,a3,-1342 # ffffffffc0208690 <default_pmm_manager+0x1390>
ffffffffc0205bd6:	00001617          	auipc	a2,0x1
ffffffffc0205bda:	09260613          	addi	a2,a2,146 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205bde:	27600593          	li	a1,630
ffffffffc0205be2:	00002517          	auipc	a0,0x2
ffffffffc0205be6:	7ee50513          	addi	a0,a0,2030 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205bea:	891fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bee:	00003697          	auipc	a3,0x3
ffffffffc0205bf2:	a5a68693          	addi	a3,a3,-1446 # ffffffffc0208648 <default_pmm_manager+0x1348>
ffffffffc0205bf6:	00001617          	auipc	a2,0x1
ffffffffc0205bfa:	07260613          	addi	a2,a2,114 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205bfe:	27500593          	li	a1,629
ffffffffc0205c02:	00002517          	auipc	a0,0x2
ffffffffc0205c06:	7ce50513          	addi	a0,a0,1998 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205c0a:	871fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205c0e:	00003697          	auipc	a3,0x3
ffffffffc0205c12:	9f268693          	addi	a3,a3,-1550 # ffffffffc0208600 <default_pmm_manager+0x1300>
ffffffffc0205c16:	00001617          	auipc	a2,0x1
ffffffffc0205c1a:	05260613          	addi	a2,a2,82 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205c1e:	27400593          	li	a1,628
ffffffffc0205c22:	00002517          	auipc	a0,0x2
ffffffffc0205c26:	7ae50513          	addi	a0,a0,1966 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205c2a:	851fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205c2e <do_yield>:
    current->need_resched = 1;
ffffffffc0205c2e:	000ad797          	auipc	a5,0xad
ffffffffc0205c32:	d127b783          	ld	a5,-750(a5) # ffffffffc02b2940 <current>
ffffffffc0205c36:	4705                	li	a4,1
ffffffffc0205c38:	ef98                	sd	a4,24(a5)
}
ffffffffc0205c3a:	4501                	li	a0,0
ffffffffc0205c3c:	8082                	ret

ffffffffc0205c3e <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205c3e:	1101                	addi	sp,sp,-32
ffffffffc0205c40:	e822                	sd	s0,16(sp)
ffffffffc0205c42:	e426                	sd	s1,8(sp)
ffffffffc0205c44:	ec06                	sd	ra,24(sp)
ffffffffc0205c46:	842e                	mv	s0,a1
ffffffffc0205c48:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205c4a:	c999                	beqz	a1,ffffffffc0205c60 <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205c4c:	000ad797          	auipc	a5,0xad
ffffffffc0205c50:	cf47b783          	ld	a5,-780(a5) # ffffffffc02b2940 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205c54:	7788                	ld	a0,40(a5)
ffffffffc0205c56:	4685                	li	a3,1
ffffffffc0205c58:	4611                	li	a2,4
ffffffffc0205c5a:	e7ffe0ef          	jal	ra,ffffffffc0204ad8 <user_mem_check>
ffffffffc0205c5e:	c909                	beqz	a0,ffffffffc0205c70 <do_wait+0x32>
ffffffffc0205c60:	85a2                	mv	a1,s0
}
ffffffffc0205c62:	6442                	ld	s0,16(sp)
ffffffffc0205c64:	60e2                	ld	ra,24(sp)
ffffffffc0205c66:	8526                	mv	a0,s1
ffffffffc0205c68:	64a2                	ld	s1,8(sp)
ffffffffc0205c6a:	6105                	addi	sp,sp,32
ffffffffc0205c6c:	fb8ff06f          	j	ffffffffc0205424 <do_wait.part.0>
ffffffffc0205c70:	60e2                	ld	ra,24(sp)
ffffffffc0205c72:	6442                	ld	s0,16(sp)
ffffffffc0205c74:	64a2                	ld	s1,8(sp)
ffffffffc0205c76:	5575                	li	a0,-3
ffffffffc0205c78:	6105                	addi	sp,sp,32
ffffffffc0205c7a:	8082                	ret

ffffffffc0205c7c <do_kill>:
do_kill(int pid) {
ffffffffc0205c7c:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c7e:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205c80:	e406                	sd	ra,8(sp)
ffffffffc0205c82:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c84:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205c88:	17f9                	addi	a5,a5,-2
ffffffffc0205c8a:	02e7e963          	bltu	a5,a4,ffffffffc0205cbc <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205c8e:	842a                	mv	s0,a0
ffffffffc0205c90:	45a9                	li	a1,10
ffffffffc0205c92:	2501                	sext.w	a0,a0
ffffffffc0205c94:	46c000ef          	jal	ra,ffffffffc0206100 <hash32>
ffffffffc0205c98:	02051793          	slli	a5,a0,0x20
ffffffffc0205c9c:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205ca0:	000a9797          	auipc	a5,0xa9
ffffffffc0205ca4:	c1878793          	addi	a5,a5,-1000 # ffffffffc02ae8b8 <hash_list>
ffffffffc0205ca8:	953e                	add	a0,a0,a5
ffffffffc0205caa:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205cac:	a029                	j	ffffffffc0205cb6 <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205cae:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205cb2:	00870b63          	beq	a4,s0,ffffffffc0205cc8 <do_kill+0x4c>
ffffffffc0205cb6:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205cb8:	fef51be3          	bne	a0,a5,ffffffffc0205cae <do_kill+0x32>
    return -E_INVAL;
ffffffffc0205cbc:	5475                	li	s0,-3
}
ffffffffc0205cbe:	60a2                	ld	ra,8(sp)
ffffffffc0205cc0:	8522                	mv	a0,s0
ffffffffc0205cc2:	6402                	ld	s0,0(sp)
ffffffffc0205cc4:	0141                	addi	sp,sp,16
ffffffffc0205cc6:	8082                	ret
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205cc8:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205ccc:	00177693          	andi	a3,a4,1
ffffffffc0205cd0:	e295                	bnez	a3,ffffffffc0205cf4 <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205cd2:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205cd4:	00176713          	ori	a4,a4,1
ffffffffc0205cd8:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205cdc:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205cde:	fe06d0e3          	bgez	a3,ffffffffc0205cbe <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205ce2:	f2878513          	addi	a0,a5,-216
ffffffffc0205ce6:	22e000ef          	jal	ra,ffffffffc0205f14 <wakeup_proc>
}
...
ffffffffc0205cf2:	8082                	ret
        return -E_KILLED;
ffffffffc0205cf4:	545d                	li	s0,-9
ffffffffc0205cf6:	b7e1                	j	ffffffffc0205cbe <do_kill+0x42>
...
void
proc_init(void) {
ffffffffc0205cf8:	1101                	addi	sp,sp,-32
ffffffffc0205cfa:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0205cfc:	000ad797          	auipc	a5,0xad
ffffffffc0205d00:	bbc78793          	addi	a5,a5,-1092 # ffffffffc02b28b8 <proc_list>
ffffffffc0205d04:	ec06                	sd	ra,24(sp)
ffffffffc0205d06:	e822                	sd	s0,16(sp)
ffffffffc0205d08:	e04a                	sd	s2,0(sp)
ffffffffc0205d0a:	000a9497          	auipc	s1,0xa9
ffffffffc0205d0e:	bae48493          	addi	s1,s1,-1106 # ffffffffc02ae8b8 <hash_list>
ffffffffc0205d12:	e79c                	sd	a5,8(a5)
ffffffffc0205d14:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205d16:	000ad717          	auipc	a4,0xad
ffffffffc0205d1a:	ba270713          	addi	a4,a4,-1118 # ffffffffc02b28b8 <proc_list>
ffffffffc0205d1e:	87a6                	mv	a5,s1
ffffffffc0205d20:	e79c                	sd	a5,8(a5)
ffffffffc0205d22:	e39c                	sd	a5,0(a5)
ffffffffc0205d24:	07c1                	addi	a5,a5,16
ffffffffc0205d26:	fef71de3          	bne	a4,a5,ffffffffc0205d20 <proc_init+0x28>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205d2a:	f9ffe0ef          	jal	ra,ffffffffc0204cc8 <alloc_proc>
ffffffffc0205d2e:	000ad917          	auipc	s2,0xad
ffffffffc0205d32:	c1a90913          	addi	s2,s2,-998 # ffffffffc02b2948 <idleproc>
ffffffffc0205d36:	00a93023          	sd	a0,0(s2)
ffffffffc0205d3a:	0e050f63          	beqz	a0,ffffffffc0205e38 <proc_init+0x140>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205d3e:	4789                	li	a5,2
ffffffffc0205d40:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d42:	00003797          	auipc	a5,0x3
ffffffffc0205d46:	2be78793          	addi	a5,a5,702 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d4a:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d4e:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205d50:	4785                	li	a5,1
ffffffffc0205d52:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d54:	4641                	li	a2,16
ffffffffc0205d56:	4581                	li	a1,0
ffffffffc0205d58:	8522                	mv	a0,s0
ffffffffc0205d5a:	027000ef          	jal	ra,ffffffffc0206580 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205d5e:	463d                	li	a2,15
ffffffffc0205d60:	00003597          	auipc	a1,0x3
ffffffffc0205d64:	9d858593          	addi	a1,a1,-1576 # ffffffffc0208738 <default_pmm_manager+0x1438>
ffffffffc0205d68:	8522                	mv	a0,s0
ffffffffc0205d6a:	029000ef          	jal	ra,ffffffffc0206592 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205d6e:	000ad717          	auipc	a4,0xad
ffffffffc0205d72:	bea70713          	addi	a4,a4,-1046 # ffffffffc02b2958 <nr_process>
ffffffffc0205d76:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0205d78:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d7c:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205d7e:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d80:	4581                	li	a1,0
ffffffffc0205d82:	00000517          	auipc	a0,0x0
ffffffffc0205d86:	87450513          	addi	a0,a0,-1932 # ffffffffc02055f6 <init_main>
    nr_process ++;
ffffffffc0205d8a:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205d8c:	000ad797          	auipc	a5,0xad
ffffffffc0205d90:	bad7ba23          	sd	a3,-1100(a5) # ffffffffc02b2940 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d94:	cf6ff0ef          	jal	ra,ffffffffc020528a <kernel_thread>
ffffffffc0205d98:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205d9a:	08a05363          	blez	a0,ffffffffc0205e20 <proc_init+0x128>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205d9e:	6789                	lui	a5,0x2
ffffffffc0205da0:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205da4:	17f9                	addi	a5,a5,-2
ffffffffc0205da6:	2501                	sext.w	a0,a0
ffffffffc0205da8:	02e7e363          	bltu	a5,a4,ffffffffc0205dce <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205dac:	45a9                	li	a1,10
ffffffffc0205dae:	352000ef          	jal	ra,ffffffffc0206100 <hash32>
ffffffffc0205db2:	02051793          	slli	a5,a0,0x20
ffffffffc0205db6:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205dba:	96a6                	add	a3,a3,s1
ffffffffc0205dbc:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205dbe:	a029                	j	ffffffffc0205dc8 <proc_init+0xd0>
            if (proc->pid == pid) {
ffffffffc0205dc0:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c94>
ffffffffc0205dc4:	04870b63          	beq	a4,s0,ffffffffc0205e1a <proc_init+0x122>
    return listelm->next;
ffffffffc0205dc8:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205dca:	fef69be3          	bne	a3,a5,ffffffffc0205dc0 <proc_init+0xc8>
    return NULL;
ffffffffc0205dce:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205dd0:	0b478493          	addi	s1,a5,180
ffffffffc0205dd4:	4641                	li	a2,16
ffffffffc0205dd6:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205dd8:	000ad417          	auipc	s0,0xad
ffffffffc0205ddc:	b7840413          	addi	s0,s0,-1160 # ffffffffc02b2950 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205de0:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205de2:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205de4:	79c000ef          	jal	ra,ffffffffc0206580 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205de8:	463d                	li	a2,15
ffffffffc0205dea:	00003597          	auipc	a1,0x3
ffffffffc0205dee:	97658593          	addi	a1,a1,-1674 # ffffffffc0208760 <default_pmm_manager+0x1460>
ffffffffc0205df2:	8526                	mv	a0,s1
ffffffffc0205df4:	79e000ef          	jal	ra,ffffffffc0206592 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205df8:	00093783          	ld	a5,0(s2)
ffffffffc0205dfc:	cbb5                	beqz	a5,ffffffffc0205e70 <proc_init+0x178>
ffffffffc0205dfe:	43dc                	lw	a5,4(a5)
ffffffffc0205e00:	eba5                	bnez	a5,ffffffffc0205e70 <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e02:	601c                	ld	a5,0(s0)
ffffffffc0205e04:	c7b1                	beqz	a5,ffffffffc0205e50 <proc_init+0x158>
ffffffffc0205e06:	43d8                	lw	a4,4(a5)
ffffffffc0205e08:	4785                	li	a5,1
ffffffffc0205e0a:	04f71363          	bne	a4,a5,ffffffffc0205e50 <proc_init+0x158>
}
ffffffffc0205e0e:	60e2                	ld	ra,24(sp)
ffffffffc0205e10:	6442                	ld	s0,16(sp)
ffffffffc0205e12:	64a2                	ld	s1,8(sp)
ffffffffc0205e14:	6902                	ld	s2,0(sp)
ffffffffc0205e16:	6105                	addi	sp,sp,32
ffffffffc0205e18:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205e1a:	f2878793          	addi	a5,a5,-216
ffffffffc0205e1e:	bf4d                	j	ffffffffc0205dd0 <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0205e20:	00003617          	auipc	a2,0x3
ffffffffc0205e24:	92060613          	addi	a2,a2,-1760 # ffffffffc0208740 <default_pmm_manager+0x1440>
ffffffffc0205e28:	38200593          	li	a1,898
ffffffffc0205e2c:	00002517          	auipc	a0,0x2
ffffffffc0205e30:	5a450513          	addi	a0,a0,1444 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205e34:	e46fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e38:	00003617          	auipc	a2,0x3
ffffffffc0205e3c:	8e860613          	addi	a2,a2,-1816 # ffffffffc0208720 <default_pmm_manager+0x1420>
ffffffffc0205e40:	37400593          	li	a1,884
ffffffffc0205e44:	00002517          	auipc	a0,0x2
ffffffffc0205e48:	58c50513          	addi	a0,a0,1420 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205e4c:	e2efa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e50:	00003697          	auipc	a3,0x3
ffffffffc0205e54:	94068693          	addi	a3,a3,-1728 # ffffffffc0208790 <default_pmm_manager+0x1490>
ffffffffc0205e58:	00001617          	auipc	a2,0x1
ffffffffc0205e5c:	e1060613          	addi	a2,a2,-496 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205e60:	38900593          	li	a1,905
ffffffffc0205e64:	00002517          	auipc	a0,0x2
ffffffffc0205e68:	56c50513          	addi	a0,a0,1388 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205e6c:	e0efa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e70:	00003697          	auipc	a3,0x3
ffffffffc0205e74:	8f868693          	addi	a3,a3,-1800 # ffffffffc0208768 <default_pmm_manager+0x1468>
ffffffffc0205e78:	00001617          	auipc	a2,0x1
ffffffffc0205e7c:	df060613          	addi	a2,a2,-528 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205e80:	38800593          	li	a1,904
ffffffffc0205e84:	00002517          	auipc	a0,0x2
ffffffffc0205e88:	54c50513          	addi	a0,a0,1356 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205e8c:	deefa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205e90 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205e90:	1141                	addi	sp,sp,-16
ffffffffc0205e92:	e022                	sd	s0,0(sp)
ffffffffc0205e94:	e406                	sd	ra,8(sp)
ffffffffc0205e96:	000ad417          	auipc	s0,0xad
ffffffffc0205e9a:	aaa40413          	addi	s0,s0,-1366 # ffffffffc02b2940 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205e9e:	6018                	ld	a4,0(s0)
ffffffffc0205ea0:	6f1c                	ld	a5,24(a4)
ffffffffc0205ea2:	dffd                	beqz	a5,ffffffffc0205ea0 <cpu_idle+0x10>
            schedule();
ffffffffc0205ea4:	0f0000ef          	jal	ra,ffffffffc0205f94 <schedule>
ffffffffc0205ea8:	bfdd                	j	ffffffffc0205e9e <cpu_idle+0xe>

ffffffffc0205eaa <switch_to>:
.text
...
ffffffffc0205eaa:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0205eae:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0205eb2:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0205eb4:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0205eb6:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0205eba:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0205ebe:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0205ec2:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0205ec6:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205eca:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205ece:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205ed2:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0205ed6:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205eda:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205ede:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205ee2:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0205ee6:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0205ee8:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205eea:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205eee:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205ef2:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205ef6:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205efa:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205efe:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205f02:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205f06:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205f0a:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205f0e:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0205f12:	8082                	ret

ffffffffc0205f14 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0205f14:	4118                	lw	a4,0(a0)
wakeup_proc(struct proc_struct *proc) {
ffffffffc0205f16:	1101                	addi	sp,sp,-32
ffffffffc0205f18:	ec06                	sd	ra,24(sp)
ffffffffc0205f1a:	e822                	sd	s0,16(sp)
ffffffffc0205f1c:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f1e:	478d                	li	a5,3
ffffffffc0205f20:	04f70b63          	beq	a4,a5,ffffffffc0205f76 <wakeup_proc+0x62>
ffffffffc0205f24:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f26:	100027f3          	csrr	a5,sstatus
ffffffffc0205f2a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205f2c:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f2e:	ef9d                	bnez	a5,ffffffffc0205f6c <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f30:	4789                	li	a5,2
ffffffffc0205f32:	02f70163          	beq	a4,a5,ffffffffc0205f54 <wakeup_proc+0x40>
            proc->state = PROC_RUNNABLE;
ffffffffc0205f36:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0205f38:	0e042623          	sw	zero,236(s0)
    if (flag) {
ffffffffc0205f3c:	e491                	bnez	s1,ffffffffc0205f48 <wakeup_proc+0x34>
        else {
...
ffffffffc0205f3e:	60e2                	ld	ra,24(sp)
ffffffffc0205f40:	6442                	ld	s0,16(sp)
ffffffffc0205f42:	64a2                	ld	s1,8(sp)
...
ffffffffc0205f4e:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f50:	ef0fa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f54:	00003617          	auipc	a2,0x3
ffffffffc0205f58:	89c60613          	addi	a2,a2,-1892 # ffffffffc02087f0 <default_pmm_manager+0x14f0>
ffffffffc0205f5c:	45c9                	li	a1,18
ffffffffc0205f5e:	00003517          	auipc	a0,0x3
ffffffffc0205f62:	87a50513          	addi	a0,a0,-1926 # ffffffffc02087d8 <default_pmm_manager+0x14d8>
ffffffffc0205f66:	d7cfa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0205f6a:	bfc9                	j	ffffffffc0205f3c <wakeup_proc+0x28>
        intr_disable();
ffffffffc0205f6c:	edafa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f70:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205f72:	4485                	li	s1,1
ffffffffc0205f74:	bf75                	j	ffffffffc0205f30 <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f76:	00003697          	auipc	a3,0x3
ffffffffc0205f7a:	84268693          	addi	a3,a3,-1982 # ffffffffc02087b8 <default_pmm_manager+0x14b8>
ffffffffc0205f7e:	00001617          	auipc	a2,0x1
ffffffffc0205f82:	cea60613          	addi	a2,a2,-790 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205f86:	45a5                	li	a1,9
ffffffffc0205f88:	00003517          	auipc	a0,0x3
ffffffffc0205f8c:	85050513          	addi	a0,a0,-1968 # ffffffffc02087d8 <default_pmm_manager+0x14d8>
ffffffffc0205f90:	ceafa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205f94 <schedule>:

void
schedule(void) {
ffffffffc0205f94:	1141                	addi	sp,sp,-16
ffffffffc0205f96:	e406                	sd	ra,8(sp)
...
ffffffffc0205fa2:	efbd                	bnez	a5,ffffffffc0206020 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0205fa4:	000ad897          	auipc	a7,0xad
ffffffffc0205fa8:	99c8b883          	ld	a7,-1636(a7) # ffffffffc02b2940 <current>
ffffffffc0205fac:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205fb0:	000ad517          	auipc	a0,0xad
ffffffffc0205fb4:	99853503          	ld	a0,-1640(a0) # ffffffffc02b2948 <idleproc>
ffffffffc0205fb8:	04a88e63          	beq	a7,a0,ffffffffc0206014 <schedule+0x80>
ffffffffc0205fbc:	0c888693          	addi	a3,a7,200
ffffffffc0205fc0:	000ad617          	auipc	a2,0xad
ffffffffc0205fc4:	8f860613          	addi	a2,a2,-1800 # ffffffffc02b28b8 <proc_list>
        le = last;
ffffffffc0205fc8:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0205fcc:	4809                	li	a6,2
ffffffffc0205fce:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0205fd0:	00c78863          	beq	a5,a2,ffffffffc0205fe0 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fd4:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0205fd8:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fdc:	03070163          	beq	a4,a6,ffffffffc0205ffe <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0205fe0:	fef697e3          	bne	a3,a5,ffffffffc0205fce <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0205fe4:	ed89                	bnez	a1,ffffffffc0205ffe <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
...
ffffffffc0205fea:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0205fec:	00a88463          	beq	a7,a0,ffffffffc0205ff4 <schedule+0x60>
            proc_run(next);
ffffffffc0205ff0:	e53fe0ef          	jal	ra,ffffffffc0204e42 <proc_run>
    if (flag) {
ffffffffc0205ff4:	e819                	bnez	s0,ffffffffc020600a <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0205ffc:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0205ffe:	4198                	lw	a4,0(a1)
ffffffffc0206000:	4789                	li	a5,2
ffffffffc0206002:	fef712e3          	bne	a4,a5,ffffffffc0205fe6 <schedule+0x52>
ffffffffc0206006:	852e                	mv	a0,a1
ffffffffc0206008:	bff9                	j	ffffffffc0205fe6 <schedule+0x52>
}
ffffffffc020600a:	6402                	ld	s0,0(sp)
ffffffffc020600c:	60a2                	ld	ra,8(sp)
ffffffffc020600e:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0206010:	e30fa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206014:	000ad617          	auipc	a2,0xad
ffffffffc0206018:	8a460613          	addi	a2,a2,-1884 # ffffffffc02b28b8 <proc_list>
ffffffffc020601c:	86b2                	mv	a3,a2
ffffffffc020601e:	b76d                	j	ffffffffc0205fc8 <schedule+0x34>
        intr_disable();
ffffffffc0206020:	e26fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0206024:	4405                	li	s0,1
ffffffffc0206026:	bfbd                	j	ffffffffc0205fa4 <schedule+0x10>

ffffffffc0206028 <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc0206028:	000ad797          	auipc	a5,0xad
ffffffffc020602c:	9187b783          	ld	a5,-1768(a5) # ffffffffc02b2940 <current>
}
ffffffffc0206030:	43c8                	lw	a0,4(a5)
ffffffffc0206032:	8082                	ret

ffffffffc0206034 <sys_pgdir>:
...
ffffffffc020603c:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc020603e:	978fa0ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
...
ffffffffc020604a <sys_kill>:
    return do_kill(pid);
ffffffffc020604a:	4108                	lw	a0,0(a0)
ffffffffc020604c:	c31ff06f          	j	ffffffffc0205c7c <do_kill>

ffffffffc0206050 <sys_yield>:
    return do_yield();
ffffffffc0206050:	bdfff06f          	j	ffffffffc0205c2e <do_yield>

ffffffffc0206054 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0206054:	6d14                	ld	a3,24(a0)
ffffffffc0206056:	6910                	ld	a2,16(a0)
ffffffffc0206058:	650c                	ld	a1,8(a0)
ffffffffc020605a:	6108                	ld	a0,0(a0)
ffffffffc020605c:	ebeff06f          	j	ffffffffc020571a <do_execve>

ffffffffc0206060 <sys_wait>:
    return do_wait(pid, store);
ffffffffc0206060:	650c                	ld	a1,8(a0)
ffffffffc0206062:	4108                	lw	a0,0(a0)
ffffffffc0206064:	bdbff06f          	j	ffffffffc0205c3e <do_wait>

ffffffffc0206068 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc0206068:	000ad797          	auipc	a5,0xad
ffffffffc020606c:	8d87b783          	ld	a5,-1832(a5) # ffffffffc02b2940 <current>
ffffffffc0206070:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc0206072:	4501                	li	a0,0
ffffffffc0206074:	6a0c                	ld	a1,16(a2)
ffffffffc0206076:	e31fe06f          	j	ffffffffc0204ea6 <do_fork>

ffffffffc020607a <sys_exit>:
    return do_exit(error_code);
ffffffffc020607a:	4108                	lw	a0,0(a0)
ffffffffc020607c:	a5eff06f          	j	ffffffffc02052da <do_exit>

ffffffffc0206080 <syscall>:
};
...
void
syscall(void) {
ffffffffc0206080:	715d                	addi	sp,sp,-80
ffffffffc0206082:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206084:	000ad497          	auipc	s1,0xad
ffffffffc0206088:	8bc48493          	addi	s1,s1,-1860 # ffffffffc02b2940 <current>
ffffffffc020608c:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc020608e:	e0a2                	sd	s0,64(sp)
ffffffffc0206090:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206092:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc0206094:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc0206096:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc0206098:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc020609c:	0327ee63          	bltu	a5,s2,ffffffffc02060d8 <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc02060a0:	00391713          	slli	a4,s2,0x3
ffffffffc02060a4:	00002797          	auipc	a5,0x2
ffffffffc02060a8:	7b478793          	addi	a5,a5,1972 # ffffffffc0208858 <syscalls>
ffffffffc02060ac:	97ba                	add	a5,a5,a4
ffffffffc02060ae:	639c                	ld	a5,0(a5)
ffffffffc02060b0:	c785                	beqz	a5,ffffffffc02060d8 <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc02060b2:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc02060b4:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc02060b6:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc02060b8:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc02060ba:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc02060bc:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc02060be:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc02060c0:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc02060c2:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc02060c4:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060c6:	0028                	addi	a0,sp,8
ffffffffc02060c8:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc02060ca:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060cc:	e828                	sd	a0,80(s0)
}
ffffffffc02060ce:	6406                	ld	s0,64(sp)
ffffffffc02060d0:	74e2                	ld	s1,56(sp)
ffffffffc02060d2:	7942                	ld	s2,48(sp)
ffffffffc02060d4:	6161                	addi	sp,sp,80
ffffffffc02060d6:	8082                	ret
    print_trapframe(tf);
ffffffffc02060d8:	8522                	mv	a0,s0
ffffffffc02060da:	f5afa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02060de:	609c                	ld	a5,0(s1)
ffffffffc02060e0:	86ca                	mv	a3,s2
ffffffffc02060e2:	00002617          	auipc	a2,0x2
ffffffffc02060e6:	72e60613          	addi	a2,a2,1838 # ffffffffc0208810 <default_pmm_manager+0x1510>
ffffffffc02060ea:	43d8                	lw	a4,4(a5)
ffffffffc02060ec:	06200593          	li	a1,98
ffffffffc02060f0:	0b478793          	addi	a5,a5,180
ffffffffc02060f4:	00002517          	auipc	a0,0x2
ffffffffc02060f8:	74c50513          	addi	a0,a0,1868 # ffffffffc0208840 <default_pmm_manager+0x1540>
ffffffffc02060fc:	b7efa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0206100 <hash32>:
 *
...
ffffffffc0206100:	9e3707b7          	lui	a5,0x9e370
ffffffffc0206104:	2785                	addiw	a5,a5,1
ffffffffc0206106:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc020610a:	02000793          	li	a5,32
ffffffffc020610e:	9f8d                	subw	a5,a5,a1
}
ffffffffc0206110:	00f5553b          	srlw	a0,a0,a5
ffffffffc0206114:	8082                	ret

ffffffffc0206116 <printnum>:
 * */
static void
...
ffffffffc0206116:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020611a:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc020611c:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206120:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0206122:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206126:	f022                	sd	s0,32(sp)
ffffffffc0206128:	ec26                	sd	s1,24(sp)
ffffffffc020612a:	e84a                	sd	s2,16(sp)
ffffffffc020612c:	f406                	sd	ra,40(sp)
ffffffffc020612e:	e44e                	sd	s3,8(sp)
ffffffffc0206130:	84aa                	mv	s1,a0
ffffffffc0206132:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0206134:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0206138:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc020613a:	03067e63          	bgeu	a2,a6,ffffffffc0206176 <printnum+0x60>
ffffffffc020613e:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0206140:	00805763          	blez	s0,ffffffffc020614e <printnum+0x38>
ffffffffc0206144:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0206146:	85ca                	mv	a1,s2
ffffffffc0206148:	854e                	mv	a0,s3
ffffffffc020614a:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc020614c:	fc65                	bnez	s0,ffffffffc0206144 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020614e:	1a02                	slli	s4,s4,0x20
ffffffffc0206150:	00003797          	auipc	a5,0x3
ffffffffc0206154:	80878793          	addi	a5,a5,-2040 # ffffffffc0208958 <syscalls+0x100>
ffffffffc0206158:	020a5a13          	srli	s4,s4,0x20
ffffffffc020615c:	9a3e                	add	s4,s4,a5
...
ffffffffc020615e:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206160:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0206164:	70a2                	ld	ra,40(sp)
ffffffffc0206166:	69a2                	ld	s3,8(sp)
ffffffffc0206168:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020616a:	85ca                	mv	a1,s2
ffffffffc020616c:	87a6                	mv	a5,s1
}
ffffffffc020616e:	6942                	ld	s2,16(sp)
ffffffffc0206170:	64e2                	ld	s1,24(sp)
ffffffffc0206172:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206174:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0206176:	03065633          	divu	a2,a2,a6
ffffffffc020617a:	8722                	mv	a4,s0
ffffffffc020617c:	f9bff0ef          	jal	ra,ffffffffc0206116 <printnum>
ffffffffc0206180:	b7f9                	j	ffffffffc020614e <printnum+0x38>

ffffffffc0206182 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0206182:	7119                	addi	sp,sp,-128
ffffffffc0206184:	f4a6                	sd	s1,104(sp)
ffffffffc0206186:	f0ca                	sd	s2,96(sp)
ffffffffc0206188:	ecce                	sd	s3,88(sp)
ffffffffc020618a:	e8d2                	sd	s4,80(sp)
ffffffffc020618c:	e4d6                	sd	s5,72(sp)
ffffffffc020618e:	e0da                	sd	s6,64(sp)
ffffffffc0206190:	fc5e                	sd	s7,56(sp)
ffffffffc0206192:	f06a                	sd	s10,32(sp)
ffffffffc0206194:	fc86                	sd	ra,120(sp)
ffffffffc0206196:	f8a2                	sd	s0,112(sp)
ffffffffc0206198:	f862                	sd	s8,48(sp)
ffffffffc020619a:	f466                	sd	s9,40(sp)
ffffffffc020619c:	ec6e                	sd	s11,24(sp)
ffffffffc020619e:	892a                	mv	s2,a0
ffffffffc02061a0:	84ae                	mv	s1,a1
ffffffffc02061a2:	8d32                	mv	s10,a2
ffffffffc02061a4:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02061a6:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02061aa:	5b7d                	li	s6,-1
ffffffffc02061ac:	00002a97          	auipc	s5,0x2
ffffffffc02061b0:	7d8a8a93          	addi	s5,s5,2008 # ffffffffc0208984 <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02061b4:	00003b97          	auipc	s7,0x3
ffffffffc02061b8:	9ecb8b93          	addi	s7,s7,-1556 # ffffffffc0208ba0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061bc:	000d4503          	lbu	a0,0(s10)
ffffffffc02061c0:	001d0413          	addi	s0,s10,1
ffffffffc02061c4:	01350a63          	beq	a0,s3,ffffffffc02061d8 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02061c8:	c121                	beqz	a0,ffffffffc0206208 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02061ca:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061cc:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02061ce:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061d0:	fff44503          	lbu	a0,-1(s0)
ffffffffc02061d4:	ff351ae3          	bne	a0,s3,ffffffffc02061c8 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061d8:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02061dc:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02061e0:	4c81                	li	s9,0
ffffffffc02061e2:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02061e4:	5c7d                	li	s8,-1
ffffffffc02061e6:	5dfd                	li	s11,-1
ffffffffc02061e8:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02061ec:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061ee:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02061f2:	0ff5f593          	zext.b	a1,a1
ffffffffc02061f6:	00140d13          	addi	s10,s0,1
ffffffffc02061fa:	04b56263          	bltu	a0,a1,ffffffffc020623e <vprintfmt+0xbc>
ffffffffc02061fe:	058a                	slli	a1,a1,0x2
ffffffffc0206200:	95d6                	add	a1,a1,s5
ffffffffc0206202:	4194                	lw	a3,0(a1)
ffffffffc0206204:	96d6                	add	a3,a3,s5
ffffffffc0206206:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0206208:	70e6                	ld	ra,120(sp)
ffffffffc020620a:	7446                	ld	s0,112(sp)
ffffffffc020620c:	74a6                	ld	s1,104(sp)
ffffffffc020620e:	7906                	ld	s2,96(sp)
ffffffffc0206210:	69e6                	ld	s3,88(sp)
ffffffffc0206212:	6a46                	ld	s4,80(sp)
ffffffffc0206214:	6aa6                	ld	s5,72(sp)
ffffffffc0206216:	6b06                	ld	s6,64(sp)
ffffffffc0206218:	7be2                	ld	s7,56(sp)
ffffffffc020621a:	7c42                	ld	s8,48(sp)
ffffffffc020621c:	7ca2                	ld	s9,40(sp)
ffffffffc020621e:	7d02                	ld	s10,32(sp)
ffffffffc0206220:	6de2                	ld	s11,24(sp)
ffffffffc0206222:	6109                	addi	sp,sp,128
ffffffffc0206224:	8082                	ret
            padc = '0';
ffffffffc0206226:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0206228:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020622c:	846a                	mv	s0,s10
ffffffffc020622e:	00140d13          	addi	s10,s0,1
ffffffffc0206232:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0206236:	0ff5f593          	zext.b	a1,a1
ffffffffc020623a:	fcb572e3          	bgeu	a0,a1,ffffffffc02061fe <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020623e:	85a6                	mv	a1,s1
ffffffffc0206240:	02500513          	li	a0,37
ffffffffc0206244:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0206246:	fff44783          	lbu	a5,-1(s0)
ffffffffc020624a:	8d22                	mv	s10,s0
ffffffffc020624c:	f73788e3          	beq	a5,s3,ffffffffc02061bc <vprintfmt+0x3a>
ffffffffc0206250:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0206254:	1d7d                	addi	s10,s10,-1
ffffffffc0206256:	ff379de3          	bne	a5,s3,ffffffffc0206250 <vprintfmt+0xce>
ffffffffc020625a:	b78d                	j	ffffffffc02061bc <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc020625c:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0206260:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206264:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0206266:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020626a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020626e:	02d86463          	bltu	a6,a3,ffffffffc0206296 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0206272:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0206276:	002c169b          	slliw	a3,s8,0x2
ffffffffc020627a:	0186873b          	addw	a4,a3,s8
ffffffffc020627e:	0017171b          	slliw	a4,a4,0x1
ffffffffc0206282:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0206284:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0206288:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020628a:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020628e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206292:	fed870e3          	bgeu	a6,a3,ffffffffc0206272 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0206296:	f40ddce3          	bgez	s11,ffffffffc02061ee <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020629a:	8de2                	mv	s11,s8
ffffffffc020629c:	5c7d                	li	s8,-1
ffffffffc020629e:	bf81                	j	ffffffffc02061ee <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02062a0:	fffdc693          	not	a3,s11
ffffffffc02062a4:	96fd                	srai	a3,a3,0x3f
ffffffffc02062a6:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062aa:	00144603          	lbu	a2,1(s0)
ffffffffc02062ae:	2d81                	sext.w	s11,s11
ffffffffc02062b0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062b2:	bf35                	j	ffffffffc02061ee <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02062b4:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062b8:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02062bc:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062be:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02062c0:	bfd9                	j	ffffffffc0206296 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02062c2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062c4:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062c8:	01174463          	blt	a4,a7,ffffffffc02062d0 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02062cc:	1a088e63          	beqz	a7,ffffffffc0206488 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02062d0:	000a3603          	ld	a2,0(s4)
ffffffffc02062d4:	46c1                	li	a3,16
ffffffffc02062d6:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02062d8:	2781                	sext.w	a5,a5
ffffffffc02062da:	876e                	mv	a4,s11
ffffffffc02062dc:	85a6                	mv	a1,s1
ffffffffc02062de:	854a                	mv	a0,s2
ffffffffc02062e0:	e37ff0ef          	jal	ra,ffffffffc0206116 <printnum>
            break;
ffffffffc02062e4:	bde1                	j	ffffffffc02061bc <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02062e6:	000a2503          	lw	a0,0(s4)
ffffffffc02062ea:	85a6                	mv	a1,s1
ffffffffc02062ec:	0a21                	addi	s4,s4,8
ffffffffc02062ee:	9902                	jalr	s2
            break;
ffffffffc02062f0:	b5f1                	j	ffffffffc02061bc <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02062f2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062f4:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062f8:	01174463          	blt	a4,a7,ffffffffc0206300 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc02062fc:	18088163          	beqz	a7,ffffffffc020647e <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0206300:	000a3603          	ld	a2,0(s4)
ffffffffc0206304:	46a9                	li	a3,10
ffffffffc0206306:	8a2e                	mv	s4,a1
ffffffffc0206308:	bfc1                	j	ffffffffc02062d8 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020630a:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020630e:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206310:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206312:	bdf1                	j	ffffffffc02061ee <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0206314:	85a6                	mv	a1,s1
ffffffffc0206316:	02500513          	li	a0,37
ffffffffc020631a:	9902                	jalr	s2
            break;
ffffffffc020631c:	b545                	j	ffffffffc02061bc <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020631e:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0206322:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206324:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206326:	b5e1                	j	ffffffffc02061ee <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0206328:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020632a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020632e:	01174463          	blt	a4,a7,ffffffffc0206336 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0206332:	14088163          	beqz	a7,ffffffffc0206474 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0206336:	000a3603          	ld	a2,0(s4)
ffffffffc020633a:	46a1                	li	a3,8
ffffffffc020633c:	8a2e                	mv	s4,a1
ffffffffc020633e:	bf69                	j	ffffffffc02062d8 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0206340:	03000513          	li	a0,48
ffffffffc0206344:	85a6                	mv	a1,s1
ffffffffc0206346:	e03e                	sd	a5,0(sp)
ffffffffc0206348:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc020634a:	85a6                	mv	a1,s1
ffffffffc020634c:	07800513          	li	a0,120
ffffffffc0206350:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206352:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0206354:	6782                	ld	a5,0(sp)
ffffffffc0206356:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206358:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020635c:	bfb5                	j	ffffffffc02062d8 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020635e:	000a3403          	ld	s0,0(s4)
ffffffffc0206362:	008a0713          	addi	a4,s4,8
ffffffffc0206366:	e03a                	sd	a4,0(sp)
ffffffffc0206368:	14040263          	beqz	s0,ffffffffc02064ac <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc020636c:	0fb05763          	blez	s11,ffffffffc020645a <vprintfmt+0x2d8>
ffffffffc0206370:	02d00693          	li	a3,45
ffffffffc0206374:	0cd79163          	bne	a5,a3,ffffffffc0206436 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206378:	00044783          	lbu	a5,0(s0)
ffffffffc020637c:	0007851b          	sext.w	a0,a5
ffffffffc0206380:	cf85                	beqz	a5,ffffffffc02063b8 <vprintfmt+0x236>
ffffffffc0206382:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206386:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020638a:	000c4563          	bltz	s8,ffffffffc0206394 <vprintfmt+0x212>
ffffffffc020638e:	3c7d                	addiw	s8,s8,-1
ffffffffc0206390:	036c0263          	beq	s8,s6,ffffffffc02063b4 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0206394:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206396:	0e0c8e63          	beqz	s9,ffffffffc0206492 <vprintfmt+0x310>
ffffffffc020639a:	3781                	addiw	a5,a5,-32
ffffffffc020639c:	0ef47b63          	bgeu	s0,a5,ffffffffc0206492 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02063a0:	03f00513          	li	a0,63
ffffffffc02063a4:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063a6:	000a4783          	lbu	a5,0(s4)
ffffffffc02063aa:	3dfd                	addiw	s11,s11,-1
ffffffffc02063ac:	0a05                	addi	s4,s4,1
ffffffffc02063ae:	0007851b          	sext.w	a0,a5
ffffffffc02063b2:	ffe1                	bnez	a5,ffffffffc020638a <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02063b4:	01b05963          	blez	s11,ffffffffc02063c6 <vprintfmt+0x244>
...
ffffffffc02063c0:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02063c2:	fe0d9be3          	bnez	s11,ffffffffc02063b8 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02063c6:	6a02                	ld	s4,0(sp)
ffffffffc02063c8:	bbd5                	j	ffffffffc02061bc <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02063ca:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02063cc:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02063d0:	01174463          	blt	a4,a7,ffffffffc02063d8 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02063d4:	08088d63          	beqz	a7,ffffffffc020646e <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02063d8:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02063dc:	0a044d63          	bltz	s0,ffffffffc0206496 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02063e0:	8622                	mv	a2,s0
ffffffffc02063e2:	8a66                	mv	s4,s9
ffffffffc02063e4:	46a9                	li	a3,10
ffffffffc02063e6:	bdcd                	j	ffffffffc02062d8 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02063e8:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063ec:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02063ee:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02063f0:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02063f4:	8fb5                	xor	a5,a5,a3
ffffffffc02063f6:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063fa:	02d74163          	blt	a4,a3,ffffffffc020641c <vprintfmt+0x29a>
ffffffffc02063fe:	00369793          	slli	a5,a3,0x3
ffffffffc0206402:	97de                	add	a5,a5,s7
ffffffffc0206404:	639c                	ld	a5,0(a5)
ffffffffc0206406:	cb99                	beqz	a5,ffffffffc020641c <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0206408:	86be                	mv	a3,a5
ffffffffc020640a:	00000617          	auipc	a2,0x0
ffffffffc020640e:	1ce60613          	addi	a2,a2,462 # ffffffffc02065d8 <etext+0x2e>
ffffffffc0206412:	85a6                	mv	a1,s1
ffffffffc0206414:	854a                	mv	a0,s2
ffffffffc0206416:	0ce000ef          	jal	ra,ffffffffc02064e4 <printfmt>
ffffffffc020641a:	b34d                	j	ffffffffc02061bc <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020641c:	00002617          	auipc	a2,0x2
ffffffffc0206420:	55c60613          	addi	a2,a2,1372 # ffffffffc0208978 <syscalls+0x120>
ffffffffc0206424:	85a6                	mv	a1,s1
ffffffffc0206426:	854a                	mv	a0,s2
ffffffffc0206428:	0bc000ef          	jal	ra,ffffffffc02064e4 <printfmt>
ffffffffc020642c:	bb41                	j	ffffffffc02061bc <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020642e:	00002417          	auipc	s0,0x2
ffffffffc0206432:	54240413          	addi	s0,s0,1346 # ffffffffc0208970 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206436:	85e2                	mv	a1,s8
ffffffffc0206438:	8522                	mv	a0,s0
ffffffffc020643a:	e43e                	sd	a5,8(sp)
ffffffffc020643c:	0e2000ef          	jal	ra,ffffffffc020651e <strnlen>
ffffffffc0206440:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0206444:	01b05b63          	blez	s11,ffffffffc020645a <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0206448:	67a2                	ld	a5,8(sp)
ffffffffc020644a:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020644e:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0206450:	85a6                	mv	a1,s1
ffffffffc0206452:	8552                	mv	a0,s4
ffffffffc0206454:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206456:	fe0d9ce3          	bnez	s11,ffffffffc020644e <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020645a:	00044783          	lbu	a5,0(s0)
ffffffffc020645e:	00140a13          	addi	s4,s0,1
ffffffffc0206462:	0007851b          	sext.w	a0,a5
ffffffffc0206466:	d3a5                	beqz	a5,ffffffffc02063c6 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206468:	05e00413          	li	s0,94
ffffffffc020646c:	bf39                	j	ffffffffc020638a <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc020646e:	000a2403          	lw	s0,0(s4)
ffffffffc0206472:	b7ad                	j	ffffffffc02063dc <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0206474:	000a6603          	lwu	a2,0(s4)
ffffffffc0206478:	46a1                	li	a3,8
ffffffffc020647a:	8a2e                	mv	s4,a1
ffffffffc020647c:	bdb1                	j	ffffffffc02062d8 <vprintfmt+0x156>
ffffffffc020647e:	000a6603          	lwu	a2,0(s4)
ffffffffc0206482:	46a9                	li	a3,10
ffffffffc0206484:	8a2e                	mv	s4,a1
ffffffffc0206486:	bd89                	j	ffffffffc02062d8 <vprintfmt+0x156>
ffffffffc0206488:	000a6603          	lwu	a2,0(s4)
ffffffffc020648c:	46c1                	li	a3,16
ffffffffc020648e:	8a2e                	mv	s4,a1
ffffffffc0206490:	b5a1                	j	ffffffffc02062d8 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0206492:	9902                	jalr	s2
ffffffffc0206494:	bf09                	j	ffffffffc02063a6 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0206496:	85a6                	mv	a1,s1
ffffffffc0206498:	02d00513          	li	a0,45
ffffffffc020649c:	e03e                	sd	a5,0(sp)
ffffffffc020649e:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02064a0:	6782                	ld	a5,0(sp)
ffffffffc02064a2:	8a66                	mv	s4,s9
ffffffffc02064a4:	40800633          	neg	a2,s0
ffffffffc02064a8:	46a9                	li	a3,10
ffffffffc02064aa:	b53d                	j	ffffffffc02062d8 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02064ac:	03b05163          	blez	s11,ffffffffc02064ce <vprintfmt+0x34c>
ffffffffc02064b0:	02d00693          	li	a3,45
ffffffffc02064b4:	f6d79de3          	bne	a5,a3,ffffffffc020642e <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02064b8:	00002417          	auipc	s0,0x2
ffffffffc02064bc:	4b840413          	addi	s0,s0,1208 # ffffffffc0208970 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064c0:	02800793          	li	a5,40
ffffffffc02064c4:	02800513          	li	a0,40
ffffffffc02064c8:	00140a13          	addi	s4,s0,1
ffffffffc02064cc:	bd6d                	j	ffffffffc0206386 <vprintfmt+0x204>
ffffffffc02064ce:	00002a17          	auipc	s4,0x2
ffffffffc02064d2:	4a3a0a13          	addi	s4,s4,1187 # ffffffffc0208971 <syscalls+0x119>
ffffffffc02064d6:	02800513          	li	a0,40
ffffffffc02064da:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02064de:	05e00413          	li	s0,94
ffffffffc02064e2:	b565                	j	ffffffffc020638a <vprintfmt+0x208>

ffffffffc02064e4 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064e4:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02064e6:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064ea:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064ec:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064ee:	ec06                	sd	ra,24(sp)
ffffffffc02064f0:	f83a                	sd	a4,48(sp)
ffffffffc02064f2:	fc3e                	sd	a5,56(sp)
ffffffffc02064f4:	e0c2                	sd	a6,64(sp)
ffffffffc02064f6:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc02064f8:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064fa:	c89ff0ef          	jal	ra,ffffffffc0206182 <vprintfmt>
}
ffffffffc02064fe:	60e2                	ld	ra,24(sp)
ffffffffc0206500:	6161                	addi	sp,sp,80
ffffffffc0206502:	8082                	ret

ffffffffc0206504 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0206504:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0206508:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020650a:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020650c:	cb81                	beqz	a5,ffffffffc020651c <strlen+0x18>
        cnt ++;
ffffffffc020650e:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0206510:	00a707b3          	add	a5,a4,a0
ffffffffc0206514:	0007c783          	lbu	a5,0(a5)
ffffffffc0206518:	fbfd                	bnez	a5,ffffffffc020650e <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc020651e:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206520:	e589                	bnez	a1,ffffffffc020652a <strnlen+0xc>
ffffffffc0206522:	a811                	j	ffffffffc0206536 <strnlen+0x18>
        cnt ++;
ffffffffc0206524:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206526:	00f58863          	beq	a1,a5,ffffffffc0206536 <strnlen+0x18>
ffffffffc020652a:	00f50733          	add	a4,a0,a5
ffffffffc020652e:	00074703          	lbu	a4,0(a4)
ffffffffc0206532:	fb6d                	bnez	a4,ffffffffc0206524 <strnlen+0x6>
ffffffffc0206534:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0206536:	852e                	mv	a0,a1
ffffffffc0206538:	8082                	ret

ffffffffc020653a <strcpy>:
char *
...
ffffffffc0206540:	0785                	addi	a5,a5,1
ffffffffc0206542:	0585                	addi	a1,a1,1
ffffffffc0206544:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0206548:	fb75                	bnez	a4,ffffffffc020653c <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0206550:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206554:	cb89                	beqz	a5,ffffffffc0206566 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0206556:	0505                	addi	a0,a0,1
ffffffffc0206558:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020655a:	fee789e3          	beq	a5,a4,ffffffffc020654c <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020655e:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0206562:	9d19                	subw	a0,a0,a4
ffffffffc0206564:	8082                	ret
ffffffffc0206566:	4501                	li	a0,0
ffffffffc0206568:	bfed                	j	ffffffffc0206562 <strcmp+0x16>

ffffffffc020656a <strchr>:
...
ffffffffc020656e:	c799                	beqz	a5,ffffffffc020657c <strchr+0x12>
        if (*s == c) {
ffffffffc0206570:	00f58763          	beq	a1,a5,ffffffffc020657e <strchr+0x14>
    while (*s != '\0') {
ffffffffc0206574:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0206578:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020657a:	fbfd                	bnez	a5,ffffffffc0206570 <strchr+0x6>
    }
    return NULL;
ffffffffc020657c:	4501                	li	a0,0
}
ffffffffc020657e:	8082                	ret

ffffffffc0206580 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0206580:	ca01                	beqz	a2,ffffffffc0206590 <memset+0x10>
ffffffffc0206582:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0206584:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0206586:	0785                	addi	a5,a5,1
ffffffffc0206588:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020658c:	fec79de3          	bne	a5,a2,ffffffffc0206586 <memset+0x6>
    }
    return s;
...
ffffffffc0206592 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0206592:	ca19                	beqz	a2,ffffffffc02065a8 <memcpy+0x16>
ffffffffc0206594:	962e                	add	a2,a2,a1
    char *d = dst;
...
ffffffffc02065a0:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02065a4:	fec59ae3          	bne	a1,a2,ffffffffc0206598 <memcpy+0x6>
    }
    return dst;

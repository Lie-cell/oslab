...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	428040ef          	jal	ra,ffffffffc0204472 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	45258593          	addi	a1,a1,1106 # ffffffffc02044a0 <etext+0x4>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	46a50513          	addi	a0,a0,1130 # ffffffffc02044c0 <etext+0x24>
...
ffffffffc020006e:	6d4030ef          	jal	ra,ffffffffc0203742 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	713030ef          	jal	ra,ffffffffc0203fc0 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	6dd030ef          	jal	ra,ffffffffc0203fc0 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	3c450513          	addi	a0,a0,964 # ffffffffc02044c8 <etext+0x2c>
void print_kerninfo(void) {
...
ffffffffc020011e:	3ce50513          	addi	a0,a0,974 # ffffffffc02044e8 <etext+0x4c>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	37658593          	addi	a1,a1,886 # ffffffffc020449c <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	3da50513          	addi	a0,a0,986 # ffffffffc0204508 <etext+0x6c>
...
ffffffffc0200146:	3e650513          	addi	a0,a0,998 # ffffffffc0204528 <etext+0x8c>
...
ffffffffc020015a:	3f250513          	addi	a0,a0,1010 # ffffffffc0204548 <etext+0xac>
...
ffffffffc0200188:	3e450513          	addi	a0,a0,996 # ffffffffc0204568 <etext+0xcc>
}
...
ffffffffc0200196:	40660613          	addi	a2,a2,1030 # ffffffffc0204598 <etext+0xfc>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	41250513          	addi	a0,a0,1042 # ffffffffc02045b0 <etext+0x114>
void print_stackframe(void) {
...
ffffffffc02001b2:	41a60613          	addi	a2,a2,1050 # ffffffffc02045c8 <etext+0x12c>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	43258593          	addi	a1,a1,1074 # ffffffffc02045e8 <etext+0x14c>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	43250513          	addi	a0,a0,1074 # ffffffffc02045f0 <etext+0x154>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	43460613          	addi	a2,a2,1076 # ffffffffc0204600 <etext+0x164>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	45458593          	addi	a1,a1,1108 # ffffffffc0204628 <etext+0x18c>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	41450513          	addi	a0,a0,1044 # ffffffffc02045f0 <etext+0x154>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	45060613          	addi	a2,a2,1104 # ffffffffc0204638 <etext+0x19c>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	46858593          	addi	a1,a1,1128 # ffffffffc0204658 <etext+0x1bc>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	3f850513          	addi	a0,a0,1016 # ffffffffc02045f0 <etext+0x154>
...
ffffffffc0200236:	43650513          	addi	a0,a0,1078 # ffffffffc0204668 <etext+0x1cc>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	43c50513          	addi	a0,a0,1084 # ffffffffc0204690 <etext+0x1f4>
...
ffffffffc020026e:	48ec0c13          	addi	s8,s8,1166 # ffffffffc02046f8 <commands>
...
ffffffffc020027e:	43e48493          	addi	s1,s1,1086 # ffffffffc02046b8 <etext+0x21c>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	43cb0b13          	addi	s6,s6,1084 # ffffffffc02046c0 <etext+0x224>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	35ca0a13          	addi	s4,s4,860 # ffffffffc02045e8 <etext+0x14c>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	0aa040ef          	jal	ra,ffffffffc0204342 <readline>
...
ffffffffc02002b2:	44ad0d13          	addi	s10,s10,1098 # ffffffffc02046f8 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	182040ef          	jal	ra,ffffffffc020443e <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	16e040ef          	jal	ra,ffffffffc020443e <strcmp>
...
ffffffffc020030e:	14e040ef          	jal	ra,ffffffffc020445c <strchr>
...
ffffffffc020034c:	110040ef          	jal	ra,ffffffffc020445c <strchr>
...
ffffffffc020036a:	37a50513          	addi	a0,a0,890 # ffffffffc02046e0 <etext+0x244>
...
ffffffffc02003a6:	39e50513          	addi	a0,a0,926 # ffffffffc0204740 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003fa:	36a50513          	addi	a0,a0,874 # ffffffffc0204760 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	7cd030ef          	jal	ra,ffffffffc0204484 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	7a9030ef          	jal	ra,ffffffffc0204484 <memcpy>
    return 0;
}
...
ffffffffc0200528:	25c50513          	addi	a0,a0,604 # ffffffffc0204780 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7d20306f          	j	ffffffffc0203d1a <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	25460613          	addi	a2,a2,596 # ffffffffc02047a0 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	26050513          	addi	a0,a0,608 # ffffffffc02047b8 <commands+0xc0>
...
ffffffffc020058e:	24650513          	addi	a0,a0,582 # ffffffffc02047d0 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	37650513          	addi	a0,a0,886 # ffffffffc0204ab8 <commands+0x3c0>
}
...
ffffffffc020075a:	37a50513          	addi	a0,a0,890 # ffffffffc0204ad0 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	37a50513          	addi	a0,a0,890 # ffffffffc0204ae8 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	38250513          	addi	a0,a0,898 # ffffffffc0204b00 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	38a50513          	addi	a0,a0,906 # ffffffffc0204b18 <commands+0x420>
...
ffffffffc02007a6:	38e50513          	addi	a0,a0,910 # ffffffffc0204b30 <commands+0x438>
}
...
ffffffffc02007c2:	43a70713          	addi	a4,a4,1082 # ffffffffc0204bf8 <commands+0x500>
...
ffffffffc02007d4:	3d850513          	addi	a0,a0,984 # ffffffffc0204ba8 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	3ac50513          	addi	a0,a0,940 # ffffffffc0204b88 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	36050513          	addi	a0,a0,864 # ffffffffc0204b48 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	37450513          	addi	a0,a0,884 # ffffffffc0204b68 <commands+0x470>
...
ffffffffc020082a:	3b250513          	addi	a0,a0,946 # ffffffffc0204bd8 <commands+0x4e0>
...
ffffffffc020083e:	38e50513          	addi	a0,a0,910 # ffffffffc0204bc8 <commands+0x4d0>
}
...
ffffffffc0200860:	58470713          	addi	a4,a4,1412 # ffffffffc0204de0 <commands+0x6e8>
...
ffffffffc0200872:	55a50513          	addi	a0,a0,1370 # ffffffffc0204dc8 <commands+0x6d0>
...
ffffffffc0200894:	39850513          	addi	a0,a0,920 # ffffffffc0204c28 <commands+0x530>
}
...
ffffffffc02008a8:	3a450513          	addi	a0,a0,932 # ffffffffc0204c48 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	3ba50513          	addi	a0,a0,954 # ffffffffc0204c68 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	3c850513          	addi	a0,a0,968 # ffffffffc0204c80 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	3ce50513          	addi	a0,a0,974 # ffffffffc0204c90 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	3e450513          	addi	a0,a0,996 # ffffffffc0204cb0 <commands+0x5b8>
...
ffffffffc02008ee:	3de60613          	addi	a2,a2,990 # ffffffffc0204cc8 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	ec250513          	addi	a0,a0,-318 # ffffffffc02047b8 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	3e650513          	addi	a0,a0,998 # ffffffffc0204ce8 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	3f450513          	addi	a0,a0,1012 # ffffffffc0204d00 <commands+0x608>
...
ffffffffc0200998:	33460613          	addi	a2,a2,820 # ffffffffc0204cc8 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	e1850513          	addi	a0,a0,-488 # ffffffffc02047b8 <commands+0xc0>
...
ffffffffc02009c4:	30860613          	addi	a2,a2,776 # ffffffffc0204cc8 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	dec50513          	addi	a0,a0,-532 # ffffffffc02047b8 <commands+0xc0>
...
ffffffffc0200b6e:	84e5b583          	ld	a1,-1970(a1) # ffffffffc02063b8 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00006617          	auipc	a2,0x6
ffffffffc0200b7a:	84a63603          	ld	a2,-1974(a2) # ffffffffc02063c0 <nbase>
...
ffffffffc0200dc6:	05e68693          	addi	a3,a3,94 # ffffffffc0204e20 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	06660613          	addi	a2,a2,102 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	07250513          	addi	a0,a0,114 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	0fe68693          	addi	a3,a3,254 # ffffffffc0204ee0 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	04660613          	addi	a2,a2,70 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	05250513          	addi	a0,a0,82 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	10668693          	addi	a3,a3,262 # ffffffffc0204f08 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	02660613          	addi	a2,a2,38 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	03250513          	addi	a0,a0,50 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	12668693          	addi	a3,a3,294 # ffffffffc0204f48 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	00660613          	addi	a2,a2,6 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	01250513          	addi	a0,a0,18 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	18e68693          	addi	a3,a3,398 # ffffffffc0204fd0 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	fe660613          	addi	a2,a2,-26 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	ff250513          	addi	a0,a0,-14 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	01e68693          	addi	a3,a3,30 # ffffffffc0204e80 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	fc660613          	addi	a2,a2,-58 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	fd250513          	addi	a0,a0,-46 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	13e68693          	addi	a3,a3,318 # ffffffffc0204fc0 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	fa660613          	addi	a2,a2,-90 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	fb250513          	addi	a0,a0,-78 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	10668693          	addi	a3,a3,262 # ffffffffc0204fa8 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	f8660613          	addi	a2,a2,-122 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	f9250513          	addi	a0,a0,-110 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	0c668693          	addi	a3,a3,198 # ffffffffc0204f88 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	f6660613          	addi	a2,a2,-154 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	f7250513          	addi	a0,a0,-142 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	13668693          	addi	a3,a3,310 # ffffffffc0205018 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	f4660613          	addi	a2,a2,-186 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	f5250513          	addi	a0,a0,-174 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	10668693          	addi	a3,a3,262 # ffffffffc0205008 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	f2660613          	addi	a2,a2,-218 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	f3250513          	addi	a0,a0,-206 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	08668693          	addi	a3,a3,134 # ffffffffc0204fa8 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	f0660613          	addi	a2,a2,-250 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	f1250513          	addi	a0,a0,-238 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	0a668693          	addi	a3,a3,166 # ffffffffc0204fe8 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	ee660613          	addi	a2,a2,-282 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	ef250513          	addi	a0,a0,-270 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	f1e68693          	addi	a3,a3,-226 # ffffffffc0204e80 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	ec660613          	addi	a2,a2,-314 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	ed250513          	addi	a0,a0,-302 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	02668693          	addi	a3,a3,38 # ffffffffc0204fa8 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	ea660613          	addi	a2,a2,-346 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	eb250513          	addi	a0,a0,-334 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	f1e68693          	addi	a3,a3,-226 # ffffffffc0204ec0 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	e8660613          	addi	a2,a2,-378 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	e9250513          	addi	a0,a0,-366 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	ede68693          	addi	a3,a3,-290 # ffffffffc0204ea0 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	e6660613          	addi	a2,a2,-410 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	e7250513          	addi	a0,a0,-398 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	ede68693          	addi	a3,a3,-290 # ffffffffc0204ec0 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	e4660613          	addi	a2,a2,-442 # ffffffffc0204e30 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	e5250513          	addi	a0,a0,-430 # ffffffffc0204e48 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	16668693          	addi	a3,a3,358 # ffffffffc0205168 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	e2660613          	addi	a2,a2,-474 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	e3250513          	addi	a0,a0,-462 # ffffffffc0204e48 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	fe668693          	addi	a3,a3,-26 # ffffffffc0205008 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	e0660613          	addi	a2,a2,-506 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	e1250513          	addi	a0,a0,-494 # ffffffffc0204e48 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	f6668693          	addi	a3,a3,-154 # ffffffffc0204fa8 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	de660613          	addi	a2,a2,-538 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	df250513          	addi	a0,a0,-526 # ffffffffc0204e48 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	f0668693          	addi	a3,a3,-250 # ffffffffc0204f68 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	dc660613          	addi	a2,a2,-570 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	dd250513          	addi	a0,a0,-558 # ffffffffc0204e48 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	0a668693          	addi	a3,a3,166 # ffffffffc0205128 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	da660613          	addi	a2,a2,-602 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	db250513          	addi	a0,a0,-590 # ffffffffc0204e48 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	06668693          	addi	a3,a3,102 # ffffffffc0205108 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	d8660613          	addi	a2,a2,-634 # ffffffffc0204e30 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	d9250513          	addi	a0,a0,-622 # ffffffffc0204e48 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	01e68693          	addi	a3,a3,30 # ffffffffc02050e0 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	d6660613          	addi	a2,a2,-666 # ffffffffc0204e30 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	d7250513          	addi	a0,a0,-654 # ffffffffc0204e48 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	fd668693          	addi	a3,a3,-42 # ffffffffc02050b8 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	d4660613          	addi	a2,a2,-698 # ffffffffc0204e30 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	d5250513          	addi	a0,a0,-686 # ffffffffc0204e48 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	fa668693          	addi	a3,a3,-90 # ffffffffc02050a8 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	d2660613          	addi	a2,a2,-730 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	d3250513          	addi	a0,a0,-718 # ffffffffc0204e48 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	e8668693          	addi	a3,a3,-378 # ffffffffc0204fa8 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	d0660613          	addi	a2,a2,-762 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	d1250513          	addi	a0,a0,-750 # ffffffffc0204e48 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	f4668693          	addi	a3,a3,-186 # ffffffffc0205088 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	ce660613          	addi	a2,a2,-794 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	cf250513          	addi	a0,a0,-782 # ffffffffc0204e48 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	ef668693          	addi	a3,a3,-266 # ffffffffc0205058 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	cc660613          	addi	a2,a2,-826 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	cd250513          	addi	a0,a0,-814 # ffffffffc0204e48 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	ebe68693          	addi	a3,a3,-322 # ffffffffc0205040 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	ca660613          	addi	a2,a2,-858 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	cb250513          	addi	a0,a0,-846 # ffffffffc0204e48 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	e0668693          	addi	a3,a3,-506 # ffffffffc0204fa8 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	c8660613          	addi	a2,a2,-890 # ffffffffc0204e30 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	c9250513          	addi	a0,a0,-878 # ffffffffc0204e48 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	e6668693          	addi	a3,a3,-410 # ffffffffc0205028 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	c6660613          	addi	a2,a2,-922 # ffffffffc0204e30 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	c7250513          	addi	a0,a0,-910 # ffffffffc0204e48 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	f6668693          	addi	a3,a3,-154 # ffffffffc0205148 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	c4660613          	addi	a2,a2,-954 # ffffffffc0204e30 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	c5250513          	addi	a0,a0,-942 # ffffffffc0204e48 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	f7668693          	addi	a3,a3,-138 # ffffffffc0205178 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	c2660613          	addi	a2,a2,-986 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	c3250513          	addi	a0,a0,-974 # ffffffffc0204e48 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	c3e68693          	addi	a3,a3,-962 # ffffffffc0204e60 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	c0660613          	addi	a2,a2,-1018 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	c1250513          	addi	a0,a0,-1006 # ffffffffc0204e48 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	c5e68693          	addi	a3,a3,-930 # ffffffffc0204ea0 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	be660613          	addi	a2,a2,-1050 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	bf250513          	addi	a0,a0,-1038 # ffffffffc0204e48 <commands+0x750>
...
ffffffffc020139e:	df668693          	addi	a3,a3,-522 # ffffffffc0205190 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	a8e60613          	addi	a2,a2,-1394 # ffffffffc0204e30 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	a9a50513          	addi	a0,a0,-1382 # ffffffffc0204e48 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	dce68693          	addi	a3,a3,-562 # ffffffffc0205188 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	a6e60613          	addi	a2,a2,-1426 # ffffffffc0204e30 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	a7a50513          	addi	a0,a0,-1414 # ffffffffc0204e48 <commands+0x750>
...
ffffffffc0201476:	d1668693          	addi	a3,a3,-746 # ffffffffc0205188 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	9b660613          	addi	a2,a2,-1610 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	9c250513          	addi	a0,a0,-1598 # ffffffffc0204e48 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	c7068693          	addi	a3,a3,-912 # ffffffffc02051b8 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	8e060613          	addi	a2,a2,-1824 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	8ec50513          	addi	a0,a0,-1812 # ffffffffc0204e48 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	c2068693          	addi	a3,a3,-992 # ffffffffc0205188 <commands+0xa90>
ffffffffc0201570:	00004617          	auipc	a2,0x4
ffffffffc0201574:	8c060613          	addi	a2,a2,-1856 # ffffffffc0204e30 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00004517          	auipc	a0,0x4
ffffffffc0201580:	8cc50513          	addi	a0,a0,-1844 # ffffffffc0204e48 <commands+0x750>
...
ffffffffc020158e:	c8e60613          	addi	a2,a2,-882 # ffffffffc0205218 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	ca250513          	addi	a0,a0,-862 # ffffffffc0205238 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	ca260613          	addi	a2,a2,-862 # ffffffffc0205248 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	c8650513          	addi	a0,a0,-890 # ffffffffc0205238 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201722:	c9ab3b03          	ld	s6,-870(s6) # ffffffffc02063b8 <error_string+0x38>
...
ffffffffc0201760:	513020ef          	jal	ra,ffffffffc0204472 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	becb3b03          	ld	s6,-1044(s6) # ffffffffc02063b8 <error_string+0x38>
...
ffffffffc0201802:	471020ef          	jal	ra,ffffffffc0204472 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	a1260613          	addi	a2,a2,-1518 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	a2e50513          	addi	a0,a0,-1490 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	9fa60613          	addi	a2,a2,-1542 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	a1650513          	addi	a0,a0,-1514 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	9e060613          	addi	a2,a2,-1568 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	9fc50513          	addi	a0,a0,-1540 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	9c660613          	addi	a2,a2,-1594 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	9e250513          	addi	a0,a0,-1566 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	9c443403          	ld	s0,-1596(s0) # ffffffffc02063b8 <error_string+0x38>
...
ffffffffc0201aba:	72a78793          	addi	a5,a5,1834 # ffffffffc02051e0 <default_pmm_manager>
...
ffffffffc0201ac8:	7e450513          	addi	a0,a0,2020 # ffffffffc02052a8 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	7a050513          	addi	a0,a0,1952 # ffffffffc02052c0 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	7c050513          	addi	a0,a0,1984 # ffffffffc02052f0 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	7be50513          	addi	a0,a0,1982 # ffffffffc0205308 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	78250513          	addi	a0,a0,1922 # ffffffffc0205358 <default_pmm_manager+0x178>
...
ffffffffc0201dfe:	5becbc83          	ld	s9,1470(s9) # ffffffffc02063b8 <error_string+0x38>
...
ffffffffc0201ea2:	7a250513          	addi	a0,a0,1954 # ffffffffc0205640 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	82458593          	addi	a1,a1,-2012 # ffffffffc0205778 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	4cc020ef          	jal	ra,ffffffffc020442c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	4d2020ef          	jal	ra,ffffffffc020443e <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	450020ef          	jal	ra,ffffffffc02043f6 <strlen>
...
ffffffffc020209c:	75850513          	addi	a0,a0,1880 # ffffffffc02057f0 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	50268693          	addi	a3,a3,1282 # ffffffffc02056a0 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	c8a60613          	addi	a2,a2,-886 # ffffffffc0204e30 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	0e650513          	addi	a0,a0,230 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	4a268693          	addi	a3,a3,1186 # ffffffffc0205660 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	c6a60613          	addi	a2,a2,-918 # ffffffffc0204e30 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	0c650513          	addi	a0,a0,198 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	09060613          	addi	a2,a2,144 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	0ac50513          	addi	a0,a0,172 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	13460613          	addi	a2,a2,308 # ffffffffc0205330 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	09050513          	addi	a0,a0,144 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	11c60613          	addi	a2,a2,284 # ffffffffc0205330 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	07850513          	addi	a0,a0,120 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	16c68693          	addi	a3,a3,364 # ffffffffc0205398 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	bfc60613          	addi	a2,a2,-1028 # ffffffffc0204e30 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	05850513          	addi	a0,a0,88 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	12c68693          	addi	a3,a3,300 # ffffffffc0205378 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	bdc60613          	addi	a2,a2,-1060 # ffffffffc0204e30 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	03850513          	addi	a0,a0,56 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	1b868693          	addi	a3,a3,440 # ffffffffc0205428 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	bb860613          	addi	a2,a2,-1096 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	01450513          	addi	a0,a0,20 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	16868693          	addi	a3,a3,360 # ffffffffc02053f8 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	b9860613          	addi	a2,a2,-1128 # ffffffffc0204e30 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	ff450513          	addi	a0,a0,-12 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	12068693          	addi	a3,a3,288 # ffffffffc02053d0 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	b7860613          	addi	a2,a2,-1160 # ffffffffc0204e30 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	fd450513          	addi	a0,a0,-44 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	1e068693          	addi	a3,a3,480 # ffffffffc02054b0 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	b5860613          	addi	a2,a2,-1192 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02022f4:	26068693          	addi	a3,a3,608 # ffffffffc0205550 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	b3860613          	addi	a2,a2,-1224 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202314:	17868693          	addi	a3,a3,376 # ffffffffc0205488 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	b1860613          	addi	a2,a2,-1256 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202336:	f3e60613          	addi	a2,a2,-194 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	f5a50513          	addi	a0,a0,-166 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	19e68693          	addi	a3,a3,414 # ffffffffc02054e8 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	ade60613          	addi	a2,a2,-1314 # ffffffffc0204e30 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	f3a50513          	addi	a0,a0,-198 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	24668693          	addi	a3,a3,582 # ffffffffc02055b0 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	abe60613          	addi	a2,a2,-1346 # ffffffffc0204e30 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	f1a50513          	addi	a0,a0,-230 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	20e68693          	addi	a3,a3,526 # ffffffffc0205598 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	a9e60613          	addi	a2,a2,-1378 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02023ae:	1be68693          	addi	a3,a3,446 # ffffffffc0205568 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	a7e60613          	addi	a2,a2,-1410 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02023ce:	35668693          	addi	a3,a3,854 # ffffffffc0205720 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	a5e60613          	addi	a2,a2,-1442 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02023ee:	14e68693          	addi	a3,a3,334 # ffffffffc0205538 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	a3e60613          	addi	a2,a2,-1474 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc020240e:	11e68693          	addi	a3,a3,286 # ffffffffc0205528 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	a1e60613          	addi	a2,a2,-1506 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc020242e:	1f668693          	addi	a3,a3,502 # ffffffffc0205620 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	9fe60613          	addi	a2,a2,-1538 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc020244e:	0ce68693          	addi	a3,a3,206 # ffffffffc0205518 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	9de60613          	addi	a2,a2,-1570 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc020246e:	00668693          	addi	a3,a3,6 # ffffffffc0205470 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	9be60613          	addi	a2,a2,-1602 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc020248e:	13e68693          	addi	a3,a3,318 # ffffffffc02055c8 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	99e60613          	addi	a2,a2,-1634 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02024ae:	fae68693          	addi	a3,a3,-82 # ffffffffc0205458 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	97e60613          	addi	a2,a2,-1666 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02024ce:	da660613          	addi	a2,a2,-602 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	d6250513          	addi	a0,a0,-670 # ffffffffc0205238 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	11668693          	addi	a3,a3,278 # ffffffffc02055f8 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	94660613          	addi	a2,a2,-1722 # ffffffffc0204e30 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	da250513          	addi	a0,a0,-606 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	0ae68693          	addi	a3,a3,174 # ffffffffc02055b0 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	92660613          	addi	a2,a2,-1754 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	d8250513          	addi	a0,a0,-638 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	0be68693          	addi	a3,a3,190 # ffffffffc02055e0 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	90660613          	addi	a2,a2,-1786 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	d6250513          	addi	a0,a0,-670 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	06e68693          	addi	a3,a3,110 # ffffffffc02055b0 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202566:	1a668693          	addi	a3,a3,422 # ffffffffc0205708 <default_pmm_manager+0x528>
ffffffffc020256a:	00003617          	auipc	a2,0x3
ffffffffc020256e:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202586:	14e68693          	addi	a3,a3,334 # ffffffffc02056d0 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	8a660613          	addi	a2,a2,-1882 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02025a6:	11668693          	addi	a3,a3,278 # ffffffffc02056b8 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00003617          	auipc	a2,0x3
ffffffffc02025ae:	88660613          	addi	a2,a2,-1914 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02025c6:	05e68693          	addi	a3,a3,94 # ffffffffc0205620 <default_pmm_manager+0x440>
ffffffffc02025ca:	00003617          	auipc	a2,0x3
ffffffffc02025ce:	86660613          	addi	a2,a2,-1946 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc02025e6:	e7668693          	addi	a3,a3,-394 # ffffffffc0205458 <default_pmm_manager+0x278>
ffffffffc02025ea:	00003617          	auipc	a2,0x3
ffffffffc02025ee:	84660613          	addi	a2,a2,-1978 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202606:	c6e60613          	addi	a2,a2,-914 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	c8a50513          	addi	a0,a0,-886 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	e5668693          	addi	a3,a3,-426 # ffffffffc0205470 <default_pmm_manager+0x290>
ffffffffc0202622:	00003617          	auipc	a2,0x3
ffffffffc0202626:	80e60613          	addi	a2,a2,-2034 # ffffffffc0204e30 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	c6a50513          	addi	a0,a0,-918 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	eae68693          	addi	a3,a3,-338 # ffffffffc02054e8 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	7ee60613          	addi	a2,a2,2030 # ffffffffc0204e30 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	c4a50513          	addi	a0,a0,-950 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	16e68693          	addi	a3,a3,366 # ffffffffc02057c8 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	7ce60613          	addi	a2,a2,1998 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc020267e:	11668693          	addi	a3,a3,278 # ffffffffc0205790 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	7ae60613          	addi	a2,a2,1966 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc020269e:	0c668693          	addi	a3,a3,198 # ffffffffc0205760 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	78e60613          	addi	a2,a2,1934 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202724:	0f068693          	addi	a3,a3,240 # ffffffffc0205810 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	70860613          	addi	a2,a2,1800 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	b6450513          	addi	a0,a0,-1180 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	c186b683          	ld	a3,-1000(a3) # ffffffffc02063b8 <error_string+0x38>
...
ffffffffc02027dc:	05068693          	addi	a3,a3,80 # ffffffffc0205828 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	65060613          	addi	a2,a2,1616 # ffffffffc0204e30 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	aac50513          	addi	a0,a0,-1364 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	a7660613          	addi	a2,a2,-1418 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	a3250513          	addi	a0,a0,-1486 # ffffffffc0205238 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	03668693          	addi	a3,a3,54 # ffffffffc0205848 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	61660613          	addi	a2,a2,1558 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	a7250513          	addi	a0,a0,-1422 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	a6e60613          	addi	a2,a2,-1426 # ffffffffc0205330 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	96a50513          	addi	a0,a0,-1686 # ffffffffc0205238 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	f7e68693          	addi	a3,a3,-130 # ffffffffc0205858 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	54e60613          	addi	a2,a2,1358 # ffffffffc0204e30 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	9aa50513          	addi	a0,a0,-1622 # ffffffffc0205298 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	f2e68693          	addi	a3,a3,-210 # ffffffffc0205828 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	52e60613          	addi	a2,a2,1326 # ffffffffc0204e30 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	98a50513          	addi	a0,a0,-1654 # ffffffffc0205298 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	4b2010ef          	jal	ra,ffffffffc0203de8 <swapfs_init>
...
ffffffffc0202994:	f0850513          	addi	a0,a0,-248 # ffffffffc0205898 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	ed050513          	addi	a0,a0,-304 # ffffffffc02058b0 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	39b000ef          	jal	ra,ffffffffc0203586 <mm_create>
...
ffffffffc0202a20:	3af000ef          	jal	ra,ffffffffc02035ce <vma_create>
...
ffffffffc0202a2c:	411000ef          	jal	ra,ffffffffc020363c <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	ef050513          	addi	a0,a0,-272 # ffffffffc0205920 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	f2450513          	addi	a0,a0,-220 # ffffffffc0205970 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	f3850513          	addi	a0,a0,-200 # ffffffffc02059f8 <default_pmm_manager+0x818>
...
ffffffffc0202ba0:	824c0c13          	addi	s8,s8,-2012 # ffffffffc02063c0 <nbase>
...
ffffffffc0202c10:	e9450513          	addi	a0,a0,-364 # ffffffffc0205aa0 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	2d7000ef          	jal	ra,ffffffffc020370c <mm_destroy>
...
ffffffffc0202c62:	e7250513          	addi	a0,a0,-398 # ffffffffc0205ad0 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	e8650513          	addi	a0,a0,-378 # ffffffffc0205af0 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	1a468693          	addi	a3,a3,420 # ffffffffc0204e20 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	1ac60613          	addi	a2,a2,428 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202c8c:	0bb00593          	li	a1,187
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	bf850513          	addi	a0,a0,-1032 # ffffffffc0205888 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	ddc68693          	addi	a3,a3,-548 # ffffffffc0205a78 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	18c60613          	addi	a2,a2,396 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202cac:	0fb00593          	li	a1,251
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	bd850513          	addi	a0,a0,-1064 # ffffffffc0205888 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	58c60613          	addi	a2,a2,1420 # ffffffffc0205248 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	57050513          	addi	a0,a0,1392 # ffffffffc0205238 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	54460613          	addi	a2,a2,1348 # ffffffffc0205218 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	55850513          	addi	a0,a0,1368 # ffffffffc0205238 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	cc468693          	addi	a3,a3,-828 # ffffffffc02059b0 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	13c60613          	addi	a2,a2,316 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202cfc:	0dc00593          	li	a1,220
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	b8850513          	addi	a0,a0,-1144 # ffffffffc0205888 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	c8c68693          	addi	a3,a3,-884 # ffffffffc0205998 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	11c60613          	addi	a2,a2,284 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202d1c:	0db00593          	li	a1,219
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	b6850513          	addi	a0,a0,-1176 # ffffffffc0205888 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	b3c60613          	addi	a2,a2,-1220 # ffffffffc0205868 <default_pmm_manager+0x688>
ffffffffc0202d34:	02800593          	li	a1,40
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	b5050513          	addi	a0,a0,-1200 # ffffffffc0205888 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	d1c68693          	addi	a3,a3,-740 # ffffffffc0205a60 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	0e460613          	addi	a2,a2,228 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202d54:	0fa00593          	li	a1,250
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	b3050513          	addi	a0,a0,-1232 # ffffffffc0205888 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	cec68693          	addi	a3,a3,-788 # ffffffffc0205a50 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	0c460613          	addi	a2,a2,196 # ffffffffc0204e30 <commands+0x738>
ffffffffc0202d74:	09e00593          	li	a1,158
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	b1050513          	addi	a0,a0,-1264 # ffffffffc0205888 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	ccc68693          	addi	a3,a3,-820 # ffffffffc0205a50 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	0a460613          	addi	a2,a2,164 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202da8:	26468693          	addi	a3,a3,612 # ffffffffc0205008 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	08460613          	addi	a2,a2,132 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202dc8:	d0468693          	addi	a3,a3,-764 # ffffffffc0205ac8 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	06460613          	addi	a2,a2,100 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202de8:	b1c68693          	addi	a3,a3,-1252 # ffffffffc0205900 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	04460613          	addi	a2,a2,68 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202e08:	b0c68693          	addi	a3,a3,-1268 # ffffffffc0205910 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	02460613          	addi	a2,a2,36 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202e28:	b3468693          	addi	a3,a3,-1228 # ffffffffc0205958 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	00460613          	addi	a2,a2,4 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202e48:	01c68693          	addi	a3,a3,28 # ffffffffc0204e60 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	fe460613          	addi	a2,a2,-28 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202e68:	bcc68693          	addi	a3,a3,-1076 # ffffffffc0205a30 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	fc460613          	addi	a2,a2,-60 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202e88:	bac68693          	addi	a3,a3,-1108 # ffffffffc0205a30 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	fa460613          	addi	a2,a2,-92 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202ea8:	b9c68693          	addi	a3,a3,-1124 # ffffffffc0205a40 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	f8460613          	addi	a2,a2,-124 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202ec8:	b7c68693          	addi	a3,a3,-1156 # ffffffffc0205a40 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	f6460613          	addi	a2,a2,-156 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202ee8:	b3c68693          	addi	a3,a3,-1220 # ffffffffc0205a20 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	f4460613          	addi	a2,a2,-188 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202f08:	b1c68693          	addi	a3,a3,-1252 # ffffffffc0205a20 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	f2460613          	addi	a2,a2,-220 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202f28:	9b468693          	addi	a3,a3,-1612 # ffffffffc02058d8 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	f0460613          	addi	a2,a2,-252 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202f48:	9a468693          	addi	a3,a3,-1628 # ffffffffc02058e8 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	ee460613          	addi	a2,a2,-284 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202f68:	a6c68693          	addi	a3,a3,-1428 # ffffffffc02059d0 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	ec460613          	addi	a2,a2,-316 # ffffffffc0204e30 <commands+0x738>
...
ffffffffc0202fc8:	bacb0b13          	addi	s6,s6,-1108 # ffffffffc0205b70 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	b8cb8b93          	addi	s7,s7,-1140 # ffffffffc0205b58 <default_pmm_manager+0x978>
...
ffffffffc0203040:	67b000ef          	jal	ra,ffffffffc0203eba <swapfs_write>
...
ffffffffc0203082:	a9250513          	addi	a0,a0,-1390 # ffffffffc0205b10 <default_pmm_manager+0x930>
...
ffffffffc0203094:	ab068693          	addi	a3,a3,-1360 # ffffffffc0205b40 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	d9860613          	addi	a2,a2,-616 # ffffffffc0204e30 <commands+0x738>
ffffffffc02030a0:	06700593          	li	a1,103
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	7e450513          	addi	a0,a0,2020 # ffffffffc0205888 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	543000ef          	jal	ra,ffffffffc0203e20 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	ad850513          	addi	a0,a0,-1320 # ffffffffc0205bc0 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	aa668693          	addi	a3,a3,-1370 # ffffffffc0205bb0 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	d1e60613          	addi	a2,a2,-738 # ffffffffc0204e30 <commands+0x738>
ffffffffc020311a:	07d00593          	li	a1,125
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	76a50513          	addi	a0,a0,1898 # ffffffffc0205888 <default_pmm_manager+0x6a8>
...
ffffffffc0203152:	ab250513          	addi	a0,a0,-1358 # ffffffffc0205c00 <default_pmm_manager+0xa20>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc020317a:	3f292903          	lw	s2,1010(s2) # ffffffffc0211568 <pgfault_num>
...
ffffffffc0203188:	abc50513          	addi	a0,a0,-1348 # ffffffffc0205c40 <default_pmm_manager+0xa60>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0203198:	3d440413          	addi	s0,s0,980 # ffffffffc0211568 <pgfault_num>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02031ac:	ac050513          	addi	a0,a0,-1344 # ffffffffc0205c68 <default_pmm_manager+0xa88>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02031ca:	aca50513          	addi	a0,a0,-1334 # ffffffffc0205c90 <default_pmm_manager+0xab0>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc02031e6:	ad650513          	addi	a0,a0,-1322 # ffffffffc0205cb8 <default_pmm_manager+0xad8>
...
ffffffffc0203204:	a9050513          	addi	a0,a0,-1392 # ffffffffc0205c90 <default_pmm_manager+0xab0>
...
ffffffffc020321c:	a2850513          	addi	a0,a0,-1496 # ffffffffc0205c40 <default_pmm_manager+0xa60>
...
ffffffffc0203236:	a5e50513          	addi	a0,a0,-1442 # ffffffffc0205c90 <default_pmm_manager+0xab0>
...
ffffffffc0203250:	9b450513          	addi	a0,a0,-1612 # ffffffffc0205c00 <default_pmm_manager+0xa20>
...
ffffffffc020326a:	a0250513          	addi	a0,a0,-1534 # ffffffffc0205c68 <default_pmm_manager+0xa88>
...
ffffffffc0203284:	a3850513          	addi	a0,a0,-1480 # ffffffffc0205cb8 <default_pmm_manager+0xad8>
...
ffffffffc02032a2:	9a250513          	addi	a0,a0,-1630 # ffffffffc0205c40 <default_pmm_manager+0xa60>
...
ffffffffc02032e0:	77468693          	addi	a3,a3,1908 # ffffffffc0205a50 <default_pmm_manager+0x870>
ffffffffc02032e4:	00002617          	auipc	a2,0x2
ffffffffc02032e8:	b4c60613          	addi	a2,a2,-1204 # ffffffffc0204e30 <commands+0x738>
ffffffffc02032ec:	06500593          	li	a1,101
ffffffffc02032f0:	00003517          	auipc	a0,0x3
ffffffffc02032f4:	93850513          	addi	a0,a0,-1736 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc02032f8:	87cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==11);
ffffffffc02032fc:	00003697          	auipc	a3,0x3
ffffffffc0203300:	a6c68693          	addi	a3,a3,-1428 # ffffffffc0205d68 <default_pmm_manager+0xb88>
ffffffffc0203304:	00002617          	auipc	a2,0x2
ffffffffc0203308:	b2c60613          	addi	a2,a2,-1236 # ffffffffc0204e30 <commands+0x738>
ffffffffc020330c:	08700593          	li	a1,135
ffffffffc0203310:	00003517          	auipc	a0,0x3
ffffffffc0203314:	91850513          	addi	a0,a0,-1768 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc0203318:	85cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020331c:	00003697          	auipc	a3,0x3
ffffffffc0203320:	a2468693          	addi	a3,a3,-1500 # ffffffffc0205d40 <default_pmm_manager+0xb60>
ffffffffc0203324:	00002617          	auipc	a2,0x2
ffffffffc0203328:	b0c60613          	addi	a2,a2,-1268 # ffffffffc0204e30 <commands+0x738>
ffffffffc020332c:	08500593          	li	a1,133
ffffffffc0203330:	00003517          	auipc	a0,0x3
ffffffffc0203334:	8f850513          	addi	a0,a0,-1800 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc0203338:	83cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==10);
ffffffffc020333c:	00003697          	auipc	a3,0x3
ffffffffc0203340:	9f468693          	addi	a3,a3,-1548 # ffffffffc0205d30 <default_pmm_manager+0xb50>
ffffffffc0203344:	00002617          	auipc	a2,0x2
ffffffffc0203348:	aec60613          	addi	a2,a2,-1300 # ffffffffc0204e30 <commands+0x738>
ffffffffc020334c:	08300593          	li	a1,131
ffffffffc0203350:	00003517          	auipc	a0,0x3
ffffffffc0203354:	8d850513          	addi	a0,a0,-1832 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc0203358:	81cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==9);
ffffffffc020335c:	00003697          	auipc	a3,0x3
ffffffffc0203360:	9c468693          	addi	a3,a3,-1596 # ffffffffc0205d20 <default_pmm_manager+0xb40>
ffffffffc0203364:	00002617          	auipc	a2,0x2
ffffffffc0203368:	acc60613          	addi	a2,a2,-1332 # ffffffffc0204e30 <commands+0x738>
ffffffffc020336c:	08000593          	li	a1,128
ffffffffc0203370:	00003517          	auipc	a0,0x3
ffffffffc0203374:	8b850513          	addi	a0,a0,-1864 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc0203378:	ffdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==8);
ffffffffc020337c:	00003697          	auipc	a3,0x3
ffffffffc0203380:	99468693          	addi	a3,a3,-1644 # ffffffffc0205d10 <default_pmm_manager+0xb30>
ffffffffc0203384:	00002617          	auipc	a2,0x2
ffffffffc0203388:	aac60613          	addi	a2,a2,-1364 # ffffffffc0204e30 <commands+0x738>
ffffffffc020338c:	07d00593          	li	a1,125
ffffffffc0203390:	00003517          	auipc	a0,0x3
ffffffffc0203394:	89850513          	addi	a0,a0,-1896 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc0203398:	fddfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==7);
ffffffffc020339c:	00003697          	auipc	a3,0x3
ffffffffc02033a0:	96468693          	addi	a3,a3,-1692 # ffffffffc0205d00 <default_pmm_manager+0xb20>
ffffffffc02033a4:	00002617          	auipc	a2,0x2
ffffffffc02033a8:	a8c60613          	addi	a2,a2,-1396 # ffffffffc0204e30 <commands+0x738>
ffffffffc02033ac:	07a00593          	li	a1,122
ffffffffc02033b0:	00003517          	auipc	a0,0x3
ffffffffc02033b4:	87850513          	addi	a0,a0,-1928 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc02033b8:	fbdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc02033bc:	00003697          	auipc	a3,0x3
ffffffffc02033c0:	93468693          	addi	a3,a3,-1740 # ffffffffc0205cf0 <default_pmm_manager+0xb10>
ffffffffc02033c4:	00002617          	auipc	a2,0x2
ffffffffc02033c8:	a6c60613          	addi	a2,a2,-1428 # ffffffffc0204e30 <commands+0x738>
ffffffffc02033cc:	07700593          	li	a1,119
ffffffffc02033d0:	00003517          	auipc	a0,0x3
ffffffffc02033d4:	85850513          	addi	a0,a0,-1960 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc02033d8:	f9dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02033dc:	00003697          	auipc	a3,0x3
ffffffffc02033e0:	90468693          	addi	a3,a3,-1788 # ffffffffc0205ce0 <default_pmm_manager+0xb00>
ffffffffc02033e4:	00002617          	auipc	a2,0x2
ffffffffc02033e8:	a4c60613          	addi	a2,a2,-1460 # ffffffffc0204e30 <commands+0x738>
ffffffffc02033ec:	07400593          	li	a1,116
ffffffffc02033f0:	00003517          	auipc	a0,0x3
ffffffffc02033f4:	83850513          	addi	a0,a0,-1992 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc02033f8:	f7dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02033fc:	00003697          	auipc	a3,0x3
ffffffffc0203400:	8e468693          	addi	a3,a3,-1820 # ffffffffc0205ce0 <default_pmm_manager+0xb00>
ffffffffc0203404:	00002617          	auipc	a2,0x2
ffffffffc0203408:	a2c60613          	addi	a2,a2,-1492 # ffffffffc0204e30 <commands+0x738>
ffffffffc020340c:	07100593          	li	a1,113
ffffffffc0203410:	00003517          	auipc	a0,0x3
ffffffffc0203414:	81850513          	addi	a0,a0,-2024 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc0203418:	f5dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020341c:	00002697          	auipc	a3,0x2
ffffffffc0203420:	63468693          	addi	a3,a3,1588 # ffffffffc0205a50 <default_pmm_manager+0x870>
ffffffffc0203424:	00002617          	auipc	a2,0x2
ffffffffc0203428:	a0c60613          	addi	a2,a2,-1524 # ffffffffc0204e30 <commands+0x738>
ffffffffc020342c:	06e00593          	li	a1,110
ffffffffc0203430:	00002517          	auipc	a0,0x2
ffffffffc0203434:	7f850513          	addi	a0,a0,2040 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc0203438:	f3dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020343c:	00002697          	auipc	a3,0x2
ffffffffc0203440:	61468693          	addi	a3,a3,1556 # ffffffffc0205a50 <default_pmm_manager+0x870>
ffffffffc0203444:	00002617          	auipc	a2,0x2
ffffffffc0203448:	9ec60613          	addi	a2,a2,-1556 # ffffffffc0204e30 <commands+0x738>
ffffffffc020344c:	06b00593          	li	a1,107
ffffffffc0203450:	00002517          	auipc	a0,0x2
ffffffffc0203454:	7d850513          	addi	a0,a0,2008 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc0203458:	f1dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020345c:	00002697          	auipc	a3,0x2
ffffffffc0203460:	5f468693          	addi	a3,a3,1524 # ffffffffc0205a50 <default_pmm_manager+0x870>
ffffffffc0203464:	00002617          	auipc	a2,0x2
ffffffffc0203468:	9cc60613          	addi	a2,a2,-1588 # ffffffffc0204e30 <commands+0x738>
ffffffffc020346c:	06800593          	li	a1,104
ffffffffc0203470:	00002517          	auipc	a0,0x2
ffffffffc0203474:	7b850513          	addi	a0,a0,1976 # ffffffffc0205c28 <default_pmm_manager+0xa48>
...
ffffffffc0203480:	7504                	ld	s1,40(a0)
{
ffffffffc0203482:	ec06                	sd	ra,24(sp)
ffffffffc0203484:	e822                	sd	s0,16(sp)
         assert(head != NULL);
ffffffffc0203486:	c885                	beqz	s1,ffffffffc02034b6 <_lru_swap_out_victim+0x3a>
     assert(in_tick==0);
ffffffffc0203488:	e639                	bnez	a2,ffffffffc02034d6 <_lru_swap_out_victim+0x5a>
    cprintf("curr_ptr 0xffffffff%x\n",head->prev);
ffffffffc020348a:	842e                	mv	s0,a1
ffffffffc020348c:	608c                	ld	a1,0(s1)
ffffffffc020348e:	00003517          	auipc	a0,0x3
ffffffffc0203492:	90a50513          	addi	a0,a0,-1782 # ffffffffc0205d98 <default_pmm_manager+0xbb8>
ffffffffc0203496:	c25fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    struct Page * page = le2page(head->prev,pra_page_link);
ffffffffc020349a:	609c                	ld	a5,0(s1)
}
ffffffffc020349c:	60e2                	ld	ra,24(sp)
ffffffffc020349e:	64a2                	ld	s1,8(sp)
    __list_del(listelm->prev, listelm->next);
ffffffffc02034a0:	6394                	ld	a3,0(a5)
ffffffffc02034a2:	6798                	ld	a4,8(a5)
    struct Page * page = le2page(head->prev,pra_page_link);
ffffffffc02034a4:	fd078793          	addi	a5,a5,-48
    *ptr_page = page;
ffffffffc02034a8:	e01c                	sd	a5,0(s0)
}
ffffffffc02034aa:	6442                	ld	s0,16(sp)
    prev->next = next;
ffffffffc02034ac:	e698                	sd	a4,8(a3)
    next->prev = prev;
ffffffffc02034ae:	e314                	sd	a3,0(a4)
...
ffffffffc02034ba:	8c268693          	addi	a3,a3,-1854 # ffffffffc0205d78 <default_pmm_manager+0xb98>
ffffffffc02034be:	00002617          	auipc	a2,0x2
ffffffffc02034c2:	97260613          	addi	a2,a2,-1678 # ffffffffc0204e30 <commands+0x738>
ffffffffc02034c6:	05000593          	li	a1,80
ffffffffc02034ca:	00002517          	auipc	a0,0x2
ffffffffc02034ce:	75e50513          	addi	a0,a0,1886 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc02034d2:	ea3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc02034d6:	00003697          	auipc	a3,0x3
ffffffffc02034da:	8b268693          	addi	a3,a3,-1870 # ffffffffc0205d88 <default_pmm_manager+0xba8>
ffffffffc02034de:	00002617          	auipc	a2,0x2
ffffffffc02034e2:	95260613          	addi	a2,a2,-1710 # ffffffffc0204e30 <commands+0x738>
ffffffffc02034e6:	05100593          	li	a1,81
ffffffffc02034ea:	00002517          	auipc	a0,0x2
ffffffffc02034ee:	73e50513          	addi	a0,a0,1854 # ffffffffc0205c28 <default_pmm_manager+0xa48>
ffffffffc02034f2:	e83fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034f6 <_lru_map_swappable>:
    assert(entry != NULL && (list_entry_t*) mm->sm_priv != NULL);
ffffffffc02034f6:	7518                	ld	a4,40(a0)
ffffffffc02034f8:	c339                	beqz	a4,ffffffffc020353e <_lru_map_swappable+0x48>
    __list_add(elm, listelm, listelm->next);
ffffffffc02034fa:	6708                	ld	a0,8(a4)
ffffffffc02034fc:	03060693          	addi	a3,a2,48
    curr_ptr = curr_ptr->next;
ffffffffc0203500:	0000e817          	auipc	a6,0xe
ffffffffc0203504:	05880813          	addi	a6,a6,88 # ffffffffc0211558 <curr_ptr>
    prev->next = next->prev = elm;
ffffffffc0203508:	e114                	sd	a3,0(a0)
ffffffffc020350a:	e714                	sd	a3,8(a4)
    elm->next = next;
ffffffffc020350c:	fe08                	sd	a0,56(a2)
ffffffffc020350e:	671c                	ld	a5,8(a4)
    while(curr_ptr->next != (list_entry_t*) mm->sm_priv)
ffffffffc0203510:	4581                	li	a1,0
    elm->prev = prev;
ffffffffc0203512:	fa18                	sd	a4,48(a2)
    curr_ptr = curr_ptr->next;
ffffffffc0203514:	00f83023          	sd	a5,0(a6)
    while(curr_ptr->next != (list_entry_t*) mm->sm_priv)
ffffffffc0203518:	a021                	j	ffffffffc0203520 <_lru_map_swappable+0x2a>
    	if(curr_ptr == entry)
ffffffffc020351a:	4585                	li	a1,1
ffffffffc020351c:	00d78b63          	beq	a5,a3,ffffffffc0203532 <_lru_map_swappable+0x3c>
    while(curr_ptr->next != (list_entry_t*) mm->sm_priv)
ffffffffc0203520:	863e                	mv	a2,a5
ffffffffc0203522:	679c                	ld	a5,8(a5)
ffffffffc0203524:	fef71be3          	bne	a4,a5,ffffffffc020351a <_lru_map_swappable+0x24>
ffffffffc0203528:	c199                	beqz	a1,ffffffffc020352e <_lru_map_swappable+0x38>
ffffffffc020352a:	00c83023          	sd	a2,0(a6)
}
ffffffffc020352e:	4501                	li	a0,0
ffffffffc0203530:	8082                	ret
    prev->next = next;
ffffffffc0203532:	e708                	sd	a0,8(a4)
    next->prev = prev;
ffffffffc0203534:	e118                	sd	a4,0(a0)
ffffffffc0203536:	00f83023          	sd	a5,0(a6)
ffffffffc020353a:	4501                	li	a0,0
ffffffffc020353c:	8082                	ret
{
ffffffffc020353e:	1141                	addi	sp,sp,-16
    assert(entry != NULL && (list_entry_t*) mm->sm_priv != NULL);
ffffffffc0203540:	00003697          	auipc	a3,0x3
ffffffffc0203544:	87068693          	addi	a3,a3,-1936 # ffffffffc0205db0 <default_pmm_manager+0xbd0>
ffffffffc0203548:	00002617          	auipc	a2,0x2
ffffffffc020354c:	8e860613          	addi	a2,a2,-1816 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203550:	03400593          	li	a1,52
ffffffffc0203554:	00002517          	auipc	a0,0x2
ffffffffc0203558:	6d450513          	addi	a0,a0,1748 # ffffffffc0205c28 <default_pmm_manager+0xa48>
{
ffffffffc020355c:	e406                	sd	ra,8(sp)
    assert(entry != NULL && (list_entry_t*) mm->sm_priv != NULL);
ffffffffc020355e:	e17fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203562 <check_vma_overlap.part.0>:
}
...
ffffffffc0203562:	1141                	addi	sp,sp,-16
    assert(prev->vm_start < prev->vm_end);
    assert(prev->vm_end <= next->vm_start);
    assert(next->vm_start < next->vm_end);
ffffffffc0203564:	00003697          	auipc	a3,0x3
ffffffffc0203568:	89c68693          	addi	a3,a3,-1892 # ffffffffc0205e00 <default_pmm_manager+0xc20>
ffffffffc020356c:	00002617          	auipc	a2,0x2
ffffffffc0203570:	8c460613          	addi	a2,a2,-1852 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203574:	07d00593          	li	a1,125
ffffffffc0203578:	00003517          	auipc	a0,0x3
ffffffffc020357c:	8a850513          	addi	a0,a0,-1880 # ffffffffc0205e20 <default_pmm_manager+0xc40>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc0203580:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc0203582:	df3fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203586 <mm_create>:
mm_create(void) {
...
ffffffffc020358e:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203590:	9e8ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203594:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203596:	c105                	beqz	a0,ffffffffc02035b6 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc0203598:	e408                	sd	a0,8(s0)
ffffffffc020359a:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc020359c:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02035a0:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02035a4:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02035a8:	0000e797          	auipc	a5,0xe
ffffffffc02035ac:	fa87a783          	lw	a5,-88(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02035b0:	eb81                	bnez	a5,ffffffffc02035c0 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02035b2:	02053423          	sd	zero,40(a0)
}
...
ffffffffc02035be:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02035c0:	9c5ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc02035ce <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc02035ce:	1101                	addi	sp,sp,-32
ffffffffc02035d0:	e04a                	sd	s2,0(sp)
ffffffffc02035d2:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035d4:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc02035d8:	e822                	sd	s0,16(sp)
ffffffffc02035da:	e426                	sd	s1,8(sp)
ffffffffc02035dc:	ec06                	sd	ra,24(sp)
ffffffffc02035de:	84ae                	mv	s1,a1
ffffffffc02035e0:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035e2:	996ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc02035e6:	c509                	beqz	a0,ffffffffc02035f0 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc02035e8:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc02035ec:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02035ee:	ed00                	sd	s0,24(a0)
}
ffffffffc02035f0:	60e2                	ld	ra,24(sp)
ffffffffc02035f2:	6442                	ld	s0,16(sp)
ffffffffc02035f4:	64a2                	ld	s1,8(sp)
ffffffffc02035f6:	6902                	ld	s2,0(sp)
ffffffffc02035f8:	6105                	addi	sp,sp,32
...
ffffffffc0203610:	fe87b703          	ld	a4,-24(a5)
...
ffffffffc020363e:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
...
ffffffffc02036a8:	ebbff0ef          	jal	ra,ffffffffc0203562 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02036ac:	00002697          	auipc	a3,0x2
ffffffffc02036b0:	78468693          	addi	a3,a3,1924 # ffffffffc0205e30 <default_pmm_manager+0xc50>
ffffffffc02036b4:	00001617          	auipc	a2,0x1
ffffffffc02036b8:	77c60613          	addi	a2,a2,1916 # ffffffffc0204e30 <commands+0x738>
ffffffffc02036bc:	08400593          	li	a1,132
ffffffffc02036c0:	00002517          	auipc	a0,0x2
ffffffffc02036c4:	76050513          	addi	a0,a0,1888 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc02036c8:	cadfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02036cc:	00002697          	auipc	a3,0x2
ffffffffc02036d0:	7a468693          	addi	a3,a3,1956 # ffffffffc0205e70 <default_pmm_manager+0xc90>
ffffffffc02036d4:	00001617          	auipc	a2,0x1
ffffffffc02036d8:	75c60613          	addi	a2,a2,1884 # ffffffffc0204e30 <commands+0x738>
ffffffffc02036dc:	07c00593          	li	a1,124
ffffffffc02036e0:	00002517          	auipc	a0,0x2
ffffffffc02036e4:	74050513          	addi	a0,a0,1856 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc02036e8:	c8dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02036ec:	00002697          	auipc	a3,0x2
ffffffffc02036f0:	76468693          	addi	a3,a3,1892 # ffffffffc0205e50 <default_pmm_manager+0xc70>
ffffffffc02036f4:	00001617          	auipc	a2,0x1
ffffffffc02036f8:	73c60613          	addi	a2,a2,1852 # ffffffffc0204e30 <commands+0x738>
ffffffffc02036fc:	07b00593          	li	a1,123
ffffffffc0203700:	00002517          	auipc	a0,0x2
ffffffffc0203704:	72050513          	addi	a0,a0,1824 # ffffffffc0205e20 <default_pmm_manager+0xc40>
...
ffffffffc020370e:	e022                	sd	s0,0(sp)
ffffffffc0203710:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203712:	6508                	ld	a0,8(a0)
ffffffffc0203714:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203716:	00a40e63          	beq	s0,a0,ffffffffc0203732 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
...
ffffffffc0203728:	90aff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020372c:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020372e:	fea416e3          	bne	s0,a0,ffffffffc020371a <mm_destroy+0xe>
    }
...
ffffffffc0203736:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203738:	03000593          	li	a1,48
}
ffffffffc020373c:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020373e:	8f4ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc0203742 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203742:	715d                	addi	sp,sp,-80
ffffffffc0203744:	e486                	sd	ra,72(sp)
ffffffffc0203746:	f44e                	sd	s3,40(sp)
ffffffffc0203748:	f052                	sd	s4,32(sp)
ffffffffc020374a:	e0a2                	sd	s0,64(sp)
ffffffffc020374c:	fc26                	sd	s1,56(sp)
ffffffffc020374e:	f84a                	sd	s2,48(sp)
ffffffffc0203750:	ec56                	sd	s5,24(sp)
ffffffffc0203752:	e85a                	sd	s6,16(sp)
ffffffffc0203754:	e45e                	sd	s7,8(sp)
}
...
ffffffffc0203756:	f3dfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020375a:	89aa                	mv	s3,a0
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020375c:	f37fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203760:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203762:	03000513          	li	a0,48
ffffffffc0203766:	812ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc020376a:	56050863          	beqz	a0,ffffffffc0203cda <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc020376e:	e508                	sd	a0,8(a0)
ffffffffc0203770:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203772:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203776:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020377a:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020377e:	0000e797          	auipc	a5,0xe
ffffffffc0203782:	dd27a783          	lw	a5,-558(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203786:	84aa                	mv	s1,a0
ffffffffc0203788:	e7b9                	bnez	a5,ffffffffc02037d6 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc020378a:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc020378e:	03200413          	li	s0,50
ffffffffc0203792:	a811                	j	ffffffffc02037a6 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc0203794:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203796:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203798:	00053c23          	sd	zero,24(a0)
    assert(mm != NULL);
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc020379c:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020379e:	8526                	mv	a0,s1
ffffffffc02037a0:	e9dff0ef          	jal	ra,ffffffffc020363c <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02037a4:	cc05                	beqz	s0,ffffffffc02037dc <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02037a6:	03000513          	li	a0,48
ffffffffc02037aa:	fcffe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02037ae:	85aa                	mv	a1,a0
ffffffffc02037b0:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02037b4:	f165                	bnez	a0,ffffffffc0203794 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02037b6:	00002697          	auipc	a3,0x2
ffffffffc02037ba:	15a68693          	addi	a3,a3,346 # ffffffffc0205910 <default_pmm_manager+0x730>
ffffffffc02037be:	00001617          	auipc	a2,0x1
ffffffffc02037c2:	67260613          	addi	a2,a2,1650 # ffffffffc0204e30 <commands+0x738>
ffffffffc02037c6:	0ce00593          	li	a1,206
ffffffffc02037ca:	00002517          	auipc	a0,0x2
ffffffffc02037ce:	65650513          	addi	a0,a0,1622 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc02037d2:	ba3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02037d6:	faeff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02037da:	bf55                	j	ffffffffc020378e <vmm_init+0x4c>
ffffffffc02037dc:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037e0:	1f900913          	li	s2,505
ffffffffc02037e4:	a819                	j	ffffffffc02037fa <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc02037e6:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02037e8:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02037ea:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
...
ffffffffc02037f2:	e4bff0ef          	jal	ra,ffffffffc020363c <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037f6:	03240a63          	beq	s0,s2,ffffffffc020382a <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02037fa:	03000513          	li	a0,48
ffffffffc02037fe:	f7bfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203802:	85aa                	mv	a1,a0
ffffffffc0203804:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203808:	fd79                	bnez	a0,ffffffffc02037e6 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc020380a:	00002697          	auipc	a3,0x2
ffffffffc020380e:	10668693          	addi	a3,a3,262 # ffffffffc0205910 <default_pmm_manager+0x730>
ffffffffc0203812:	00001617          	auipc	a2,0x1
ffffffffc0203816:	61e60613          	addi	a2,a2,1566 # ffffffffc0204e30 <commands+0x738>
ffffffffc020381a:	0d400593          	li	a1,212
ffffffffc020381e:	00002517          	auipc	a0,0x2
ffffffffc0203822:	60250513          	addi	a0,a0,1538 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203826:	b4ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc020382a:	649c                	ld	a5,8(s1)
ffffffffc020382c:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc020382e:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203832:	2ef48463          	beq	s1,a5,ffffffffc0203b1a <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203836:	fe87b603          	ld	a2,-24(a5)
ffffffffc020383a:	ffe70693          	addi	a3,a4,-2
ffffffffc020383e:	26d61e63          	bne	a2,a3,ffffffffc0203aba <vmm_init+0x378>
ffffffffc0203842:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203846:	26e69a63          	bne	a3,a4,ffffffffc0203aba <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc020384a:	0715                	addi	a4,a4,5
ffffffffc020384c:	679c                	ld	a5,8(a5)
ffffffffc020384e:	feb712e3          	bne	a4,a1,ffffffffc0203832 <vmm_init+0xf0>
ffffffffc0203852:	4b1d                	li	s6,7
ffffffffc0203854:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203856:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc020385a:	85a2                	mv	a1,s0
ffffffffc020385c:	8526                	mv	a0,s1
ffffffffc020385e:	d9fff0ef          	jal	ra,ffffffffc02035fc <find_vma>
ffffffffc0203862:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203864:	2c050b63          	beqz	a0,ffffffffc0203b3a <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203868:	00140593          	addi	a1,s0,1
ffffffffc020386c:	8526                	mv	a0,s1
ffffffffc020386e:	d8fff0ef          	jal	ra,ffffffffc02035fc <find_vma>
ffffffffc0203872:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc0203874:	2e050363          	beqz	a0,ffffffffc0203b5a <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203878:	85da                	mv	a1,s6
ffffffffc020387a:	8526                	mv	a0,s1
ffffffffc020387c:	d81ff0ef          	jal	ra,ffffffffc02035fc <find_vma>
        assert(vma3 == NULL);
ffffffffc0203880:	2e051d63          	bnez	a0,ffffffffc0203b7a <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203884:	00340593          	addi	a1,s0,3
ffffffffc0203888:	8526                	mv	a0,s1
ffffffffc020388a:	d73ff0ef          	jal	ra,ffffffffc02035fc <find_vma>
        assert(vma4 == NULL);
ffffffffc020388e:	30051663          	bnez	a0,ffffffffc0203b9a <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc0203892:	00440593          	addi	a1,s0,4
ffffffffc0203896:	8526                	mv	a0,s1
ffffffffc0203898:	d65ff0ef          	jal	ra,ffffffffc02035fc <find_vma>
        assert(vma5 == NULL);
ffffffffc020389c:	30051f63          	bnez	a0,ffffffffc0203bba <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02038a0:	00893783          	ld	a5,8(s2)
ffffffffc02038a4:	24879b63          	bne	a5,s0,ffffffffc0203afa <vmm_init+0x3b8>
ffffffffc02038a8:	01093783          	ld	a5,16(s2)
ffffffffc02038ac:	25679763          	bne	a5,s6,ffffffffc0203afa <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02038b0:	008ab783          	ld	a5,8(s5)
ffffffffc02038b4:	22879363          	bne	a5,s0,ffffffffc0203ada <vmm_init+0x398>
ffffffffc02038b8:	010ab783          	ld	a5,16(s5)
ffffffffc02038bc:	21679f63          	bne	a5,s6,ffffffffc0203ada <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02038c0:	0415                	addi	s0,s0,5
ffffffffc02038c2:	0b15                	addi	s6,s6,5
ffffffffc02038c4:	f9741be3          	bne	s0,s7,ffffffffc020385a <vmm_init+0x118>
ffffffffc02038c8:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc02038ca:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc02038cc:	85a2                	mv	a1,s0
ffffffffc02038ce:	8526                	mv	a0,s1
ffffffffc02038d0:	d2dff0ef          	jal	ra,ffffffffc02035fc <find_vma>
ffffffffc02038d4:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc02038d8:	c90d                	beqz	a0,ffffffffc020390a <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc02038da:	6914                	ld	a3,16(a0)
ffffffffc02038dc:	6510                	ld	a2,8(a0)
ffffffffc02038de:	00002517          	auipc	a0,0x2
ffffffffc02038e2:	6b250513          	addi	a0,a0,1714 # ffffffffc0205f90 <default_pmm_manager+0xdb0>
ffffffffc02038e6:	fd4fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc02038ea:	00002697          	auipc	a3,0x2
ffffffffc02038ee:	6ce68693          	addi	a3,a3,1742 # ffffffffc0205fb8 <default_pmm_manager+0xdd8>
ffffffffc02038f2:	00001617          	auipc	a2,0x1
ffffffffc02038f6:	53e60613          	addi	a2,a2,1342 # ffffffffc0204e30 <commands+0x738>
ffffffffc02038fa:	0f600593          	li	a1,246
ffffffffc02038fe:	00002517          	auipc	a0,0x2
ffffffffc0203902:	52250513          	addi	a0,a0,1314 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203906:	a6ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc020390a:	147d                	addi	s0,s0,-1
ffffffffc020390c:	fd2410e3          	bne	s0,s2,ffffffffc02038cc <vmm_init+0x18a>
ffffffffc0203910:	a811                	j	ffffffffc0203924 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203912:	6118                	ld	a4,0(a0)
ffffffffc0203914:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203916:	03000593          	li	a1,48
ffffffffc020391a:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020391c:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020391e:	e398                	sd	a4,0(a5)
ffffffffc0203920:	f13fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203924:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203926:	fea496e3          	bne	s1,a0,ffffffffc0203912 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020392a:	03000593          	li	a1,48
ffffffffc020392e:	8526                	mv	a0,s1
ffffffffc0203930:	f03fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203934:	d5ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203938:	3caa1163          	bne	s4,a0,ffffffffc0203cfa <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020393c:	00002517          	auipc	a0,0x2
ffffffffc0203940:	6bc50513          	addi	a0,a0,1724 # ffffffffc0205ff8 <default_pmm_manager+0xe18>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203948:	d4bfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020394c:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020394e:	03000513          	li	a0,48
ffffffffc0203952:	e27fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203956:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203958:	2a050163          	beqz	a0,ffffffffc0203bfa <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020395c:	0000e797          	auipc	a5,0xe
ffffffffc0203960:	bf47a783          	lw	a5,-1036(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc0203964:	e508                	sd	a0,8(a0)
ffffffffc0203966:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203968:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020396c:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203970:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203974:	14079063          	bnez	a5,ffffffffc0203ab4 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc0203978:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020397c:	0000e917          	auipc	s2,0xe
ffffffffc0203980:	b9c93903          	ld	s2,-1124(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203984:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203988:	0000e717          	auipc	a4,0xe
ffffffffc020398c:	bc873c23          	sd	s0,-1064(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203990:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc0203994:	24079363          	bnez	a5,ffffffffc0203bda <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203998:	03000513          	li	a0,48
ffffffffc020399c:	dddfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02039a0:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02039a2:	28050063          	beqz	a0,ffffffffc0203c22 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02039a6:	002007b7          	lui	a5,0x200
ffffffffc02039aa:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02039ae:	4789                	li	a5,2
...
ffffffffc02039b0:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02039b2:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02039b6:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02039b8:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02039bc:	c81ff0ef          	jal	ra,ffffffffc020363c <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02039c0:	10000593          	li	a1,256
ffffffffc02039c4:	8522                	mv	a0,s0
ffffffffc02039c6:	c37ff0ef          	jal	ra,ffffffffc02035fc <find_vma>
ffffffffc02039ca:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02039ce:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02039d2:	26aa1863          	bne	s4,a0,ffffffffc0203c42 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc02039d6:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc02039da:	0785                	addi	a5,a5,1
ffffffffc02039dc:	fee79de3          	bne	a5,a4,ffffffffc02039d6 <vmm_init+0x294>
        sum += i;
ffffffffc02039e0:	6705                	lui	a4,0x1
ffffffffc02039e2:	10000793          	li	a5,256
ffffffffc02039e6:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02039ea:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02039ee:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc02039f2:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc02039f4:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc02039f6:	fec79ce3          	bne	a5,a2,ffffffffc02039ee <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc02039fa:	26071463          	bnez	a4,ffffffffc0203c62 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02039fe:	4581                	li	a1,0
ffffffffc0203a00:	854a                	mv	a0,s2
ffffffffc0203a02:	f1bfd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203a06:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203a0a:	0000e717          	auipc	a4,0xe
ffffffffc0203a0e:	b1673703          	ld	a4,-1258(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203a12:	078a                	slli	a5,a5,0x2
ffffffffc0203a14:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203a16:	26e7f663          	bgeu	a5,a4,ffffffffc0203c82 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203a1a:	00003717          	auipc	a4,0x3
ffffffffc0203a1e:	9a673703          	ld	a4,-1626(a4) # ffffffffc02063c0 <nbase>
ffffffffc0203a22:	8f99                	sub	a5,a5,a4
ffffffffc0203a24:	00379713          	slli	a4,a5,0x3
ffffffffc0203a28:	97ba                	add	a5,a5,a4
ffffffffc0203a2a:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203a2c:	0000e517          	auipc	a0,0xe
ffffffffc0203a30:	afc53503          	ld	a0,-1284(a0) # ffffffffc0211528 <pages>
ffffffffc0203a34:	953e                	add	a0,a0,a5
ffffffffc0203a36:	4585                	li	a1,1
ffffffffc0203a38:	c1bfd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203a3c:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203a3e:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203a42:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a46:	00a40e63          	beq	s0,a0,ffffffffc0203a62 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203a4a:	6118                	ld	a4,0(a0)
ffffffffc0203a4c:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203a4e:	03000593          	li	a1,48
ffffffffc0203a52:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203a54:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203a56:	e398                	sd	a4,0(a5)
ffffffffc0203a58:	ddbfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203a5c:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a5e:	fea416e3          	bne	s0,a0,ffffffffc0203a4a <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203a62:	03000593          	li	a1,48
ffffffffc0203a66:	8522                	mv	a0,s0
ffffffffc0203a68:	dcbfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc0203a6c:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203a6e:	0000e797          	auipc	a5,0xe
ffffffffc0203a72:	ae07b923          	sd	zero,-1294(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a76:	c1dfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203a7a:	22a49063          	bne	s1,a0,ffffffffc0203c9a <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203a7e:	00002517          	auipc	a0,0x2
ffffffffc0203a82:	5ca50513          	addi	a0,a0,1482 # ffffffffc0206048 <default_pmm_manager+0xe68>
ffffffffc0203a86:	e34fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a8a:	c09fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203a8e:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a90:	22a99563          	bne	s3,a0,ffffffffc0203cba <vmm_init+0x578>
}
ffffffffc0203a94:	6406                	ld	s0,64(sp)
ffffffffc0203a96:	60a6                	ld	ra,72(sp)
ffffffffc0203a98:	74e2                	ld	s1,56(sp)
ffffffffc0203a9a:	7942                	ld	s2,48(sp)
ffffffffc0203a9c:	79a2                	ld	s3,40(sp)
ffffffffc0203a9e:	7a02                	ld	s4,32(sp)
ffffffffc0203aa0:	6ae2                	ld	s5,24(sp)
ffffffffc0203aa2:	6b42                	ld	s6,16(sp)
ffffffffc0203aa4:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203aa6:	00002517          	auipc	a0,0x2
ffffffffc0203aaa:	5c250513          	addi	a0,a0,1474 # ffffffffc0206068 <default_pmm_manager+0xe88>
}
ffffffffc0203aae:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203ab0:	e0afc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203ab4:	cd0ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203ab8:	b5d1                	j	ffffffffc020397c <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203aba:	00002697          	auipc	a3,0x2
ffffffffc0203abe:	3ee68693          	addi	a3,a3,1006 # ffffffffc0205ea8 <default_pmm_manager+0xcc8>
ffffffffc0203ac2:	00001617          	auipc	a2,0x1
ffffffffc0203ac6:	36e60613          	addi	a2,a2,878 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203aca:	0dd00593          	li	a1,221
ffffffffc0203ace:	00002517          	auipc	a0,0x2
ffffffffc0203ad2:	35250513          	addi	a0,a0,850 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203ad6:	89ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203ada:	00002697          	auipc	a3,0x2
ffffffffc0203ade:	48668693          	addi	a3,a3,1158 # ffffffffc0205f60 <default_pmm_manager+0xd80>
ffffffffc0203ae2:	00001617          	auipc	a2,0x1
ffffffffc0203ae6:	34e60613          	addi	a2,a2,846 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203aea:	0ee00593          	li	a1,238
ffffffffc0203aee:	00002517          	auipc	a0,0x2
ffffffffc0203af2:	33250513          	addi	a0,a0,818 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203af6:	87ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203afa:	00002697          	auipc	a3,0x2
ffffffffc0203afe:	43668693          	addi	a3,a3,1078 # ffffffffc0205f30 <default_pmm_manager+0xd50>
ffffffffc0203b02:	00001617          	auipc	a2,0x1
ffffffffc0203b06:	32e60613          	addi	a2,a2,814 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203b0a:	0ed00593          	li	a1,237
ffffffffc0203b0e:	00002517          	auipc	a0,0x2
ffffffffc0203b12:	31250513          	addi	a0,a0,786 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203b16:	85ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203b1a:	00002697          	auipc	a3,0x2
ffffffffc0203b1e:	37668693          	addi	a3,a3,886 # ffffffffc0205e90 <default_pmm_manager+0xcb0>
ffffffffc0203b22:	00001617          	auipc	a2,0x1
ffffffffc0203b26:	30e60613          	addi	a2,a2,782 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203b2a:	0db00593          	li	a1,219
ffffffffc0203b2e:	00002517          	auipc	a0,0x2
ffffffffc0203b32:	2f250513          	addi	a0,a0,754 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203b36:	83ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203b3a:	00002697          	auipc	a3,0x2
ffffffffc0203b3e:	3a668693          	addi	a3,a3,934 # ffffffffc0205ee0 <default_pmm_manager+0xd00>
ffffffffc0203b42:	00001617          	auipc	a2,0x1
ffffffffc0203b46:	2ee60613          	addi	a2,a2,750 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203b4a:	0e300593          	li	a1,227
ffffffffc0203b4e:	00002517          	auipc	a0,0x2
ffffffffc0203b52:	2d250513          	addi	a0,a0,722 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203b56:	81ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203b5a:	00002697          	auipc	a3,0x2
ffffffffc0203b5e:	39668693          	addi	a3,a3,918 # ffffffffc0205ef0 <default_pmm_manager+0xd10>
ffffffffc0203b62:	00001617          	auipc	a2,0x1
ffffffffc0203b66:	2ce60613          	addi	a2,a2,718 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203b6a:	0e500593          	li	a1,229
ffffffffc0203b6e:	00002517          	auipc	a0,0x2
ffffffffc0203b72:	2b250513          	addi	a0,a0,690 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203b76:	ffefc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203b7a:	00002697          	auipc	a3,0x2
ffffffffc0203b7e:	38668693          	addi	a3,a3,902 # ffffffffc0205f00 <default_pmm_manager+0xd20>
ffffffffc0203b82:	00001617          	auipc	a2,0x1
ffffffffc0203b86:	2ae60613          	addi	a2,a2,686 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203b8a:	0e700593          	li	a1,231
ffffffffc0203b8e:	00002517          	auipc	a0,0x2
ffffffffc0203b92:	29250513          	addi	a0,a0,658 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203b96:	fdefc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203b9a:	00002697          	auipc	a3,0x2
ffffffffc0203b9e:	37668693          	addi	a3,a3,886 # ffffffffc0205f10 <default_pmm_manager+0xd30>
ffffffffc0203ba2:	00001617          	auipc	a2,0x1
ffffffffc0203ba6:	28e60613          	addi	a2,a2,654 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203baa:	0e900593          	li	a1,233
ffffffffc0203bae:	00002517          	auipc	a0,0x2
ffffffffc0203bb2:	27250513          	addi	a0,a0,626 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203bb6:	fbefc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203bba:	00002697          	auipc	a3,0x2
ffffffffc0203bbe:	36668693          	addi	a3,a3,870 # ffffffffc0205f20 <default_pmm_manager+0xd40>
ffffffffc0203bc2:	00001617          	auipc	a2,0x1
ffffffffc0203bc6:	26e60613          	addi	a2,a2,622 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203bca:	0eb00593          	li	a1,235
ffffffffc0203bce:	00002517          	auipc	a0,0x2
ffffffffc0203bd2:	25250513          	addi	a0,a0,594 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203bd6:	f9efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203bda:	00002697          	auipc	a3,0x2
ffffffffc0203bde:	d2668693          	addi	a3,a3,-730 # ffffffffc0205900 <default_pmm_manager+0x720>
ffffffffc0203be2:	00001617          	auipc	a2,0x1
ffffffffc0203be6:	24e60613          	addi	a2,a2,590 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203bea:	10d00593          	li	a1,269
ffffffffc0203bee:	00002517          	auipc	a0,0x2
ffffffffc0203bf2:	23250513          	addi	a0,a0,562 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203bf6:	f7efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203bfa:	00002697          	auipc	a3,0x2
ffffffffc0203bfe:	48668693          	addi	a3,a3,1158 # ffffffffc0206080 <default_pmm_manager+0xea0>
ffffffffc0203c02:	00001617          	auipc	a2,0x1
ffffffffc0203c06:	22e60613          	addi	a2,a2,558 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203c0a:	10a00593          	li	a1,266
ffffffffc0203c0e:	00002517          	auipc	a0,0x2
ffffffffc0203c12:	21250513          	addi	a0,a0,530 # ffffffffc0205e20 <default_pmm_manager+0xc40>
    check_mm_struct = mm_create();
ffffffffc0203c16:	0000e797          	auipc	a5,0xe
ffffffffc0203c1a:	9407b523          	sd	zero,-1718(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203c1e:	f56fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203c22:	00002697          	auipc	a3,0x2
ffffffffc0203c26:	cee68693          	addi	a3,a3,-786 # ffffffffc0205910 <default_pmm_manager+0x730>
ffffffffc0203c2a:	00001617          	auipc	a2,0x1
ffffffffc0203c2e:	20660613          	addi	a2,a2,518 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203c32:	11100593          	li	a1,273
ffffffffc0203c36:	00002517          	auipc	a0,0x2
ffffffffc0203c3a:	1ea50513          	addi	a0,a0,490 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203c3e:	f36fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c42:	00002697          	auipc	a3,0x2
ffffffffc0203c46:	3d668693          	addi	a3,a3,982 # ffffffffc0206018 <default_pmm_manager+0xe38>
ffffffffc0203c4a:	00001617          	auipc	a2,0x1
ffffffffc0203c4e:	1e660613          	addi	a2,a2,486 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203c52:	11600593          	li	a1,278
ffffffffc0203c56:	00002517          	auipc	a0,0x2
ffffffffc0203c5a:	1ca50513          	addi	a0,a0,458 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203c5e:	f16fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203c62:	00002697          	auipc	a3,0x2
ffffffffc0203c66:	3d668693          	addi	a3,a3,982 # ffffffffc0206038 <default_pmm_manager+0xe58>
ffffffffc0203c6a:	00001617          	auipc	a2,0x1
ffffffffc0203c6e:	1c660613          	addi	a2,a2,454 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203c72:	12000593          	li	a1,288
ffffffffc0203c76:	00002517          	auipc	a0,0x2
ffffffffc0203c7a:	1aa50513          	addi	a0,a0,426 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203c7e:	ef6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203c82:	00001617          	auipc	a2,0x1
ffffffffc0203c86:	59660613          	addi	a2,a2,1430 # ffffffffc0205218 <default_pmm_manager+0x38>
ffffffffc0203c8a:	06500593          	li	a1,101
ffffffffc0203c8e:	00001517          	auipc	a0,0x1
ffffffffc0203c92:	5aa50513          	addi	a0,a0,1450 # ffffffffc0205238 <default_pmm_manager+0x58>
ffffffffc0203c96:	edefc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c9a:	00002697          	auipc	a3,0x2
ffffffffc0203c9e:	33668693          	addi	a3,a3,822 # ffffffffc0205fd0 <default_pmm_manager+0xdf0>
ffffffffc0203ca2:	00001617          	auipc	a2,0x1
ffffffffc0203ca6:	18e60613          	addi	a2,a2,398 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203caa:	12e00593          	li	a1,302
ffffffffc0203cae:	00002517          	auipc	a0,0x2
ffffffffc0203cb2:	17250513          	addi	a0,a0,370 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203cb6:	ebefc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203cba:	00002697          	auipc	a3,0x2
ffffffffc0203cbe:	31668693          	addi	a3,a3,790 # ffffffffc0205fd0 <default_pmm_manager+0xdf0>
ffffffffc0203cc2:	00001617          	auipc	a2,0x1
ffffffffc0203cc6:	16e60613          	addi	a2,a2,366 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203cca:	0bd00593          	li	a1,189
ffffffffc0203cce:	00002517          	auipc	a0,0x2
ffffffffc0203cd2:	15250513          	addi	a0,a0,338 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203cd6:	e9efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203cda:	00002697          	auipc	a3,0x2
ffffffffc0203cde:	bfe68693          	addi	a3,a3,-1026 # ffffffffc02058d8 <default_pmm_manager+0x6f8>
ffffffffc0203ce2:	00001617          	auipc	a2,0x1
ffffffffc0203ce6:	14e60613          	addi	a2,a2,334 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203cea:	0c700593          	li	a1,199
ffffffffc0203cee:	00002517          	auipc	a0,0x2
ffffffffc0203cf2:	13250513          	addi	a0,a0,306 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203cf6:	e7efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203cfa:	00002697          	auipc	a3,0x2
ffffffffc0203cfe:	2d668693          	addi	a3,a3,726 # ffffffffc0205fd0 <default_pmm_manager+0xdf0>
ffffffffc0203d02:	00001617          	auipc	a2,0x1
ffffffffc0203d06:	12e60613          	addi	a2,a2,302 # ffffffffc0204e30 <commands+0x738>
ffffffffc0203d0a:	0fb00593          	li	a1,251
ffffffffc0203d0e:	00002517          	auipc	a0,0x2
ffffffffc0203d12:	11250513          	addi	a0,a0,274 # ffffffffc0205e20 <default_pmm_manager+0xc40>
ffffffffc0203d16:	e5efc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d1a <do_pgfault>:
...
ffffffffc0203d1a:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203d1c:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203d1e:	f022                	sd	s0,32(sp)
ffffffffc0203d20:	ec26                	sd	s1,24(sp)
ffffffffc0203d22:	f406                	sd	ra,40(sp)
ffffffffc0203d24:	e84a                	sd	s2,16(sp)
ffffffffc0203d26:	8432                	mv	s0,a2
ffffffffc0203d28:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203d2a:	8d3ff0ef          	jal	ra,ffffffffc02035fc <find_vma>

    pgfault_num++;
ffffffffc0203d2e:	0000e797          	auipc	a5,0xe
ffffffffc0203d32:	83a7a783          	lw	a5,-1990(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203d36:	2785                	addiw	a5,a5,1
ffffffffc0203d38:	0000e717          	auipc	a4,0xe
ffffffffc0203d3c:	82f72823          	sw	a5,-2000(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203d40:	c159                	beqz	a0,ffffffffc0203dc6 <do_pgfault+0xac>
ffffffffc0203d42:	651c                	ld	a5,8(a0)
ffffffffc0203d44:	08f46163          	bltu	s0,a5,ffffffffc0203dc6 <do_pgfault+0xac>
...
ffffffffc0203d48:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203d4a:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203d4c:	8b89                	andi	a5,a5,2
ffffffffc0203d4e:	ebb1                	bnez	a5,ffffffffc0203da2 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d50:	75fd                	lui	a1,0xfffff
...
ffffffffc0203d52:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d54:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203d56:	85a2                	mv	a1,s0
ffffffffc0203d58:	4605                	li	a2,1
ffffffffc0203d5a:	973fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203d5e:	610c                	ld	a1,0(a0)
ffffffffc0203d60:	c1b9                	beqz	a1,ffffffffc0203da6 <do_pgfault+0x8c>
...
ffffffffc0203d66:	7ee7a783          	lw	a5,2030(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203d6a:	c7bd                	beqz	a5,ffffffffc0203dd8 <do_pgfault+0xbe>
            struct Page *page = NULL;
            swap_in(mm, addr, &page); 
ffffffffc0203d6c:	85a2                	mv	a1,s0
ffffffffc0203d6e:	0030                	addi	a2,sp,8
ffffffffc0203d70:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203d72:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page); 
ffffffffc0203d74:	b3cff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
            page_insert(mm->pgdir, page, addr, perm); 
ffffffffc0203d78:	65a2                	ld	a1,8(sp)
ffffffffc0203d7a:	6c88                	ld	a0,24(s1)
ffffffffc0203d7c:	86ca                	mv	a3,s2
ffffffffc0203d7e:	8622                	mv	a2,s0
ffffffffc0203d80:	c37fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
...
ffffffffc0203d92:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203d94:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
...
ffffffffc0203da4:	b775                	j	ffffffffc0203d50 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203da6:	6c88                	ld	a0,24(s1)
ffffffffc0203da8:	864a                	mv	a2,s2
ffffffffc0203daa:	85a2                	mv	a1,s0
ffffffffc0203dac:	915fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203db0:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203db2:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203db4:	f3ed                	bnez	a5,ffffffffc0203d96 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203db6:	00002517          	auipc	a0,0x2
ffffffffc0203dba:	31250513          	addi	a0,a0,786 # ffffffffc02060c8 <default_pmm_manager+0xee8>
ffffffffc0203dbe:	afcfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203dc2:	5571                	li	a0,-4
            goto failed;
ffffffffc0203dc4:	bfc9                	j	ffffffffc0203d96 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203dc6:	85a2                	mv	a1,s0
ffffffffc0203dc8:	00002517          	auipc	a0,0x2
ffffffffc0203dcc:	2d050513          	addi	a0,a0,720 # ffffffffc0206098 <default_pmm_manager+0xeb8>
ffffffffc0203dd0:	aeafc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203dd4:	5575                	li	a0,-3
        goto failed;
ffffffffc0203dd6:	b7c1                	j	ffffffffc0203d96 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203dd8:	00002517          	auipc	a0,0x2
ffffffffc0203ddc:	31850513          	addi	a0,a0,792 # ffffffffc02060f0 <default_pmm_manager+0xf10>
ffffffffc0203de0:	adafc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203de4:	5571                	li	a0,-4
            goto failed;
ffffffffc0203de6:	bf45                	j	ffffffffc0203d96 <do_pgfault+0x7c>
...
ffffffffc0203dec:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203dee:	ea6fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203df2:	cd01                	beqz	a0,ffffffffc0203e0a <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203df4:	4505                	li	a0,1
ffffffffc0203df6:	ea4fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203dfa:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203dfc:	810d                	srli	a0,a0,0x3
ffffffffc0203dfe:	0000d797          	auipc	a5,0xd
ffffffffc0203e02:	74a7b123          	sd	a0,1858(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203e06:	0141                	addi	sp,sp,16
ffffffffc0203e08:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203e0a:	00002617          	auipc	a2,0x2
ffffffffc0203e0e:	30e60613          	addi	a2,a2,782 # ffffffffc0206118 <default_pmm_manager+0xf38>
ffffffffc0203e12:	45b5                	li	a1,13
ffffffffc0203e14:	00002517          	auipc	a0,0x2
ffffffffc0203e18:	32450513          	addi	a0,a0,804 # ffffffffc0206138 <default_pmm_manager+0xf58>
...
ffffffffc0203e28:	c3a5                	beqz	a5,ffffffffc0203e88 <swapfs_read+0x68>
ffffffffc0203e2a:	0000d717          	auipc	a4,0xd
ffffffffc0203e2e:	71673703          	ld	a4,1814(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e32:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e88 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e36:	0000d617          	auipc	a2,0xd
ffffffffc0203e3a:	6f263603          	ld	a2,1778(a2) # ffffffffc0211528 <pages>
ffffffffc0203e3e:	8d91                	sub	a1,a1,a2
ffffffffc0203e40:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e44:	00002597          	auipc	a1,0x2
ffffffffc0203e48:	5745b583          	ld	a1,1396(a1) # ffffffffc02063b8 <error_string+0x38>
ffffffffc0203e4c:	02b60633          	mul	a2,a2,a1
ffffffffc0203e50:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e54:	00002797          	auipc	a5,0x2
ffffffffc0203e58:	56c7b783          	ld	a5,1388(a5) # ffffffffc02063c0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e5c:	0000d717          	auipc	a4,0xd
ffffffffc0203e60:	6c473703          	ld	a4,1732(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e64:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e66:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e6a:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e6c:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e6e:	02e7f963          	bgeu	a5,a4,ffffffffc0203ea0 <swapfs_read+0x80>
}
ffffffffc0203e72:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e74:	0000d797          	auipc	a5,0xd
ffffffffc0203e78:	6c47b783          	ld	a5,1732(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203e7c:	46a1                	li	a3,8
ffffffffc0203e7e:	963e                	add	a2,a2,a5
ffffffffc0203e80:	4505                	li	a0,1
}
ffffffffc0203e82:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e84:	e1cfc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203e88:	86aa                	mv	a3,a0
ffffffffc0203e8a:	00002617          	auipc	a2,0x2
ffffffffc0203e8e:	2c660613          	addi	a2,a2,710 # ffffffffc0206150 <default_pmm_manager+0xf70>
ffffffffc0203e92:	45d1                	li	a1,20
ffffffffc0203e94:	00002517          	auipc	a0,0x2
ffffffffc0203e98:	2a450513          	addi	a0,a0,676 # ffffffffc0206138 <default_pmm_manager+0xf58>
ffffffffc0203e9c:	cd8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203ea0:	86b2                	mv	a3,a2
ffffffffc0203ea2:	06a00593          	li	a1,106
ffffffffc0203ea6:	00001617          	auipc	a2,0x1
ffffffffc0203eaa:	3ca60613          	addi	a2,a2,970 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc0203eae:	00001517          	auipc	a0,0x1
ffffffffc0203eb2:	38a50513          	addi	a0,a0,906 # ffffffffc0205238 <default_pmm_manager+0x58>
ffffffffc0203eb6:	cbefc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203eba <swapfs_write>:
...
ffffffffc0203ebe:	00855793          	srli	a5,a0,0x8
ffffffffc0203ec2:	c3a5                	beqz	a5,ffffffffc0203f22 <swapfs_write+0x68>
ffffffffc0203ec4:	0000d717          	auipc	a4,0xd
ffffffffc0203ec8:	67c73703          	ld	a4,1660(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203ecc:	04e7fb63          	bgeu	a5,a4,ffffffffc0203f22 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203ed0:	0000d617          	auipc	a2,0xd
ffffffffc0203ed4:	65863603          	ld	a2,1624(a2) # ffffffffc0211528 <pages>
ffffffffc0203ed8:	8d91                	sub	a1,a1,a2
ffffffffc0203eda:	4035d613          	srai	a2,a1,0x3
ffffffffc0203ede:	00002597          	auipc	a1,0x2
ffffffffc0203ee2:	4da5b583          	ld	a1,1242(a1) # ffffffffc02063b8 <error_string+0x38>
ffffffffc0203ee6:	02b60633          	mul	a2,a2,a1
ffffffffc0203eea:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203eee:	00002797          	auipc	a5,0x2
ffffffffc0203ef2:	4d27b783          	ld	a5,1234(a5) # ffffffffc02063c0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ef6:	0000d717          	auipc	a4,0xd
ffffffffc0203efa:	62a73703          	ld	a4,1578(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203efe:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203f00:	00c61793          	slli	a5,a2,0xc
ffffffffc0203f04:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203f06:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203f08:	02e7f963          	bgeu	a5,a4,ffffffffc0203f3a <swapfs_write+0x80>
}
ffffffffc0203f0c:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203f0e:	0000d797          	auipc	a5,0xd
ffffffffc0203f12:	62a7b783          	ld	a5,1578(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203f16:	46a1                	li	a3,8
ffffffffc0203f18:	963e                	add	a2,a2,a5
ffffffffc0203f1a:	4505                	li	a0,1
}
ffffffffc0203f1c:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203f1e:	da6fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203f22:	86aa                	mv	a3,a0
ffffffffc0203f24:	00002617          	auipc	a2,0x2
ffffffffc0203f28:	22c60613          	addi	a2,a2,556 # ffffffffc0206150 <default_pmm_manager+0xf70>
ffffffffc0203f2c:	45e5                	li	a1,25
ffffffffc0203f2e:	00002517          	auipc	a0,0x2
ffffffffc0203f32:	20a50513          	addi	a0,a0,522 # ffffffffc0206138 <default_pmm_manager+0xf58>
ffffffffc0203f36:	c3efc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203f3a:	86b2                	mv	a3,a2
ffffffffc0203f3c:	06a00593          	li	a1,106
ffffffffc0203f40:	00001617          	auipc	a2,0x1
ffffffffc0203f44:	33060613          	addi	a2,a2,816 # ffffffffc0205270 <default_pmm_manager+0x90>
ffffffffc0203f48:	00001517          	auipc	a0,0x1
ffffffffc0203f4c:	2f050513          	addi	a0,a0,752 # ffffffffc0205238 <default_pmm_manager+0x58>
ffffffffc0203f50:	c24fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203f54 <printnum>:
 * */
static void
...
ffffffffc0203f54:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f58:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203f5a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f5e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203f60:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f64:	f022                	sd	s0,32(sp)
ffffffffc0203f66:	ec26                	sd	s1,24(sp)
ffffffffc0203f68:	e84a                	sd	s2,16(sp)
ffffffffc0203f6a:	f406                	sd	ra,40(sp)
ffffffffc0203f6c:	e44e                	sd	s3,8(sp)
ffffffffc0203f6e:	84aa                	mv	s1,a0
ffffffffc0203f70:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203f72:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203f76:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203f78:	03067e63          	bgeu	a2,a6,ffffffffc0203fb4 <printnum+0x60>
ffffffffc0203f7c:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203f7e:	00805763          	blez	s0,ffffffffc0203f8c <printnum+0x38>
ffffffffc0203f82:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203f84:	85ca                	mv	a1,s2
ffffffffc0203f86:	854e                	mv	a0,s3
ffffffffc0203f88:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203f8a:	fc65                	bnez	s0,ffffffffc0203f82 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f8c:	1a02                	slli	s4,s4,0x20
ffffffffc0203f8e:	00002797          	auipc	a5,0x2
ffffffffc0203f92:	1e278793          	addi	a5,a5,482 # ffffffffc0206170 <default_pmm_manager+0xf90>
ffffffffc0203f96:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203f9a:	9a3e                	add	s4,s4,a5
}
ffffffffc0203f9c:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f9e:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203fa2:	70a2                	ld	ra,40(sp)
ffffffffc0203fa4:	69a2                	ld	s3,8(sp)
ffffffffc0203fa6:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203fa8:	85ca                	mv	a1,s2
ffffffffc0203faa:	87a6                	mv	a5,s1
}
ffffffffc0203fac:	6942                	ld	s2,16(sp)
ffffffffc0203fae:	64e2                	ld	s1,24(sp)
ffffffffc0203fb0:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203fb2:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203fb4:	03065633          	divu	a2,a2,a6
ffffffffc0203fb8:	8722                	mv	a4,s0
ffffffffc0203fba:	f9bff0ef          	jal	ra,ffffffffc0203f54 <printnum>
ffffffffc0203fbe:	b7f9                	j	ffffffffc0203f8c <printnum+0x38>

ffffffffc0203fc0 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203fc6:	ecce                	sd	s3,88(sp)
ffffffffc0203fc8:	e8d2                	sd	s4,80(sp)
ffffffffc0203fca:	e4d6                	sd	s5,72(sp)
ffffffffc0203fcc:	e0da                	sd	s6,64(sp)
ffffffffc0203fce:	fc5e                	sd	s7,56(sp)
ffffffffc0203fd0:	f06a                	sd	s10,32(sp)
ffffffffc0203fd2:	fc86                	sd	ra,120(sp)
ffffffffc0203fd4:	f8a2                	sd	s0,112(sp)
ffffffffc0203fd6:	f862                	sd	s8,48(sp)
ffffffffc0203fd8:	f466                	sd	s9,40(sp)
ffffffffc0203fda:	ec6e                	sd	s11,24(sp)
ffffffffc0203fdc:	892a                	mv	s2,a0
ffffffffc0203fde:	84ae                	mv	s1,a1
ffffffffc0203fe0:	8d32                	mv	s10,a2
ffffffffc0203fe2:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203fe4:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203fe8:	5b7d                	li	s6,-1
ffffffffc0203fea:	00002a97          	auipc	s5,0x2
ffffffffc0203fee:	1baa8a93          	addi	s5,s5,442 # ffffffffc02061a4 <default_pmm_manager+0xfc4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203ff2:	00002b97          	auipc	s7,0x2
ffffffffc0203ff6:	38eb8b93          	addi	s7,s7,910 # ffffffffc0206380 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203ffa:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203ffe:	001d0413          	addi	s0,s10,1
ffffffffc0204002:	01350a63          	beq	a0,s3,ffffffffc0204016 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204006:	c121                	beqz	a0,ffffffffc0204046 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc020400c:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020400e:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204012:	ff351ae3          	bne	a0,s3,ffffffffc0204006 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204016:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc020401a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc020401e:	4c81                	li	s9,0
ffffffffc0204020:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204022:	5c7d                	li	s8,-1
ffffffffc0204024:	5dfd                	li	s11,-1
ffffffffc0204026:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc020402a:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020402c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204030:	0ff5f593          	zext.b	a1,a1
ffffffffc0204034:	00140d13          	addi	s10,s0,1
ffffffffc0204038:	04b56263          	bltu	a0,a1,ffffffffc020407c <vprintfmt+0xbc>
ffffffffc020403c:	058a                	slli	a1,a1,0x2
ffffffffc020403e:	95d6                	add	a1,a1,s5
ffffffffc0204040:	4194                	lw	a3,0(a1)
ffffffffc0204042:	96d6                	add	a3,a3,s5
ffffffffc0204044:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204052:	6aa6                	ld	s5,72(sp)
ffffffffc0204054:	6b06                	ld	s6,64(sp)
ffffffffc0204056:	7be2                	ld	s7,56(sp)
ffffffffc0204058:	7c42                	ld	s8,48(sp)
ffffffffc020405a:	7ca2                	ld	s9,40(sp)
ffffffffc020405c:	7d02                	ld	s10,32(sp)
ffffffffc020405e:	6de2                	ld	s11,24(sp)
ffffffffc0204060:	6109                	addi	sp,sp,128
ffffffffc0204062:	8082                	ret
            padc = '0';
ffffffffc0204064:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204066:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020406a:	846a                	mv	s0,s10
ffffffffc020406c:	00140d13          	addi	s10,s0,1
ffffffffc0204070:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204074:	0ff5f593          	zext.b	a1,a1
ffffffffc0204078:	fcb572e3          	bgeu	a0,a1,ffffffffc020403c <vprintfmt+0x7c>
            putch('%', putdat);
...
ffffffffc0204088:	8d22                	mv	s10,s0
ffffffffc020408a:	f73788e3          	beq	a5,s3,ffffffffc0203ffa <vprintfmt+0x3a>
ffffffffc020408e:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204092:	1d7d                	addi	s10,s10,-1
ffffffffc0204094:	ff379de3          	bne	a5,s3,ffffffffc020408e <vprintfmt+0xce>
ffffffffc0204098:	b78d                	j	ffffffffc0203ffa <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc020409a:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc02040a4:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc02040a8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02040ac:	02d86463          	bltu	a6,a3,ffffffffc02040d4 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc02040b0:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc02040b4:	002c169b          	slliw	a3,s8,0x2
ffffffffc02040b8:	0186873b          	addw	a4,a3,s8
ffffffffc02040bc:	0017171b          	slliw	a4,a4,0x1
ffffffffc02040c0:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc02040c2:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc02040c6:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02040c8:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02040cc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02040d0:	fed870e3          	bgeu	a6,a3,ffffffffc02040b0 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02040d4:	f40ddce3          	bgez	s11,ffffffffc020402c <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02040d8:	8de2                	mv	s11,s8
ffffffffc02040da:	5c7d                	li	s8,-1
ffffffffc02040dc:	bf81                	j	ffffffffc020402c <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02040de:	fffdc693          	not	a3,s11
ffffffffc02040e2:	96fd                	srai	a3,a3,0x3f
ffffffffc02040e4:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040e8:	00144603          	lbu	a2,1(s0)
ffffffffc02040ec:	2d81                	sext.w	s11,s11
ffffffffc02040ee:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040f0:	bf35                	j	ffffffffc020402c <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02040f2:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040f6:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02040fa:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040fc:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02040fe:	bfd9                	j	ffffffffc02040d4 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204100:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204102:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204106:	01174463          	blt	a4,a7,ffffffffc020410e <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020410a:	1a088e63          	beqz	a7,ffffffffc02042c6 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc020410e:	000a3603          	ld	a2,0(s4)
ffffffffc0204112:	46c1                	li	a3,16
ffffffffc0204114:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204116:	2781                	sext.w	a5,a5
ffffffffc0204118:	876e                	mv	a4,s11
ffffffffc020411a:	85a6                	mv	a1,s1
ffffffffc020411c:	854a                	mv	a0,s2
ffffffffc020411e:	e37ff0ef          	jal	ra,ffffffffc0203f54 <printnum>
            break;
ffffffffc0204122:	bde1                	j	ffffffffc0203ffa <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204124:	000a2503          	lw	a0,0(s4)
ffffffffc0204128:	85a6                	mv	a1,s1
ffffffffc020412a:	0a21                	addi	s4,s4,8
ffffffffc020412c:	9902                	jalr	s2
            break;
ffffffffc020412e:	b5f1                	j	ffffffffc0203ffa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204130:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204132:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204136:	01174463          	blt	a4,a7,ffffffffc020413e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020413a:	18088163          	beqz	a7,ffffffffc02042bc <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020413e:	000a3603          	ld	a2,0(s4)
ffffffffc0204142:	46a9                	li	a3,10
ffffffffc0204144:	8a2e                	mv	s4,a1
ffffffffc0204146:	bfc1                	j	ffffffffc0204116 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204148:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020414c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020414e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204150:	bdf1                	j	ffffffffc020402c <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204152:	85a6                	mv	a1,s1
ffffffffc0204154:	02500513          	li	a0,37
ffffffffc0204158:	9902                	jalr	s2
            break;
ffffffffc020415a:	b545                	j	ffffffffc0203ffa <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020415c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204160:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204162:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204164:	b5e1                	j	ffffffffc020402c <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204166:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204168:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020416c:	01174463          	blt	a4,a7,ffffffffc0204174 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204170:	14088163          	beqz	a7,ffffffffc02042b2 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204174:	000a3603          	ld	a2,0(s4)
ffffffffc0204178:	46a1                	li	a3,8
ffffffffc020417a:	8a2e                	mv	s4,a1
ffffffffc020417c:	bf69                	j	ffffffffc0204116 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020417e:	03000513          	li	a0,48
ffffffffc0204182:	85a6                	mv	a1,s1
ffffffffc0204184:	e03e                	sd	a5,0(sp)
ffffffffc0204186:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204188:	85a6                	mv	a1,s1
ffffffffc020418a:	07800513          	li	a0,120
ffffffffc020418e:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204190:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204192:	6782                	ld	a5,0(sp)
ffffffffc0204194:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204196:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020419a:	bfb5                	j	ffffffffc0204116 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020419c:	000a3403          	ld	s0,0(s4)
ffffffffc02041a0:	008a0713          	addi	a4,s4,8
ffffffffc02041a4:	e03a                	sd	a4,0(sp)
ffffffffc02041a6:	14040263          	beqz	s0,ffffffffc02042ea <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02041aa:	0fb05763          	blez	s11,ffffffffc0204298 <vprintfmt+0x2d8>
ffffffffc02041ae:	02d00693          	li	a3,45
ffffffffc02041b2:	0cd79163          	bne	a5,a3,ffffffffc0204274 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041b6:	00044783          	lbu	a5,0(s0)
ffffffffc02041ba:	0007851b          	sext.w	a0,a5
ffffffffc02041be:	cf85                	beqz	a5,ffffffffc02041f6 <vprintfmt+0x236>
ffffffffc02041c0:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041c4:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041c8:	000c4563          	bltz	s8,ffffffffc02041d2 <vprintfmt+0x212>
ffffffffc02041cc:	3c7d                	addiw	s8,s8,-1
ffffffffc02041ce:	036c0263          	beq	s8,s6,ffffffffc02041f2 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02041d2:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041d4:	0e0c8e63          	beqz	s9,ffffffffc02042d0 <vprintfmt+0x310>
ffffffffc02041d8:	3781                	addiw	a5,a5,-32
ffffffffc02041da:	0ef47b63          	bgeu	s0,a5,ffffffffc02042d0 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02041de:	03f00513          	li	a0,63
ffffffffc02041e2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041e4:	000a4783          	lbu	a5,0(s4)
ffffffffc02041e8:	3dfd                	addiw	s11,s11,-1
ffffffffc02041ea:	0a05                	addi	s4,s4,1
ffffffffc02041ec:	0007851b          	sext.w	a0,a5
ffffffffc02041f0:	ffe1                	bnez	a5,ffffffffc02041c8 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02041f2:	01b05963          	blez	s11,ffffffffc0204204 <vprintfmt+0x244>
ffffffffc02041f6:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02041f8:	85a6                	mv	a1,s1
ffffffffc02041fa:	02000513          	li	a0,32
ffffffffc02041fe:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204200:	fe0d9be3          	bnez	s11,ffffffffc02041f6 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204204:	6a02                	ld	s4,0(sp)
ffffffffc0204206:	bbd5                	j	ffffffffc0203ffa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204208:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020420a:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc020420e:	01174463          	blt	a4,a7,ffffffffc0204216 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204212:	08088d63          	beqz	a7,ffffffffc02042ac <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204216:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020421a:	0a044d63          	bltz	s0,ffffffffc02042d4 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc020421e:	8622                	mv	a2,s0
ffffffffc0204220:	8a66                	mv	s4,s9
ffffffffc0204222:	46a9                	li	a3,10
ffffffffc0204224:	bdcd                	j	ffffffffc0204116 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204226:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020422a:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc020422c:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc020422e:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204232:	8fb5                	xor	a5,a5,a3
ffffffffc0204234:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204238:	02d74163          	blt	a4,a3,ffffffffc020425a <vprintfmt+0x29a>
ffffffffc020423c:	00369793          	slli	a5,a3,0x3
ffffffffc0204240:	97de                	add	a5,a5,s7
ffffffffc0204242:	639c                	ld	a5,0(a5)
ffffffffc0204244:	cb99                	beqz	a5,ffffffffc020425a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204246:	86be                	mv	a3,a5
ffffffffc0204248:	00002617          	auipc	a2,0x2
ffffffffc020424c:	f5860613          	addi	a2,a2,-168 # ffffffffc02061a0 <default_pmm_manager+0xfc0>
ffffffffc0204250:	85a6                	mv	a1,s1
ffffffffc0204252:	854a                	mv	a0,s2
ffffffffc0204254:	0ce000ef          	jal	ra,ffffffffc0204322 <printfmt>
ffffffffc0204258:	b34d                	j	ffffffffc0203ffa <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020425a:	00002617          	auipc	a2,0x2
ffffffffc020425e:	f3660613          	addi	a2,a2,-202 # ffffffffc0206190 <default_pmm_manager+0xfb0>
ffffffffc0204262:	85a6                	mv	a1,s1
ffffffffc0204264:	854a                	mv	a0,s2
ffffffffc0204266:	0bc000ef          	jal	ra,ffffffffc0204322 <printfmt>
ffffffffc020426a:	bb41                	j	ffffffffc0203ffa <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020426c:	00002417          	auipc	s0,0x2
ffffffffc0204270:	f1c40413          	addi	s0,s0,-228 # ffffffffc0206188 <default_pmm_manager+0xfa8>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204274:	85e2                	mv	a1,s8
ffffffffc0204276:	8522                	mv	a0,s0
ffffffffc0204278:	e43e                	sd	a5,8(sp)
ffffffffc020427a:	196000ef          	jal	ra,ffffffffc0204410 <strnlen>
ffffffffc020427e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204282:	01b05b63          	blez	s11,ffffffffc0204298 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204286:	67a2                	ld	a5,8(sp)
ffffffffc0204288:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
...
ffffffffc0204292:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204294:	fe0d9ce3          	bnez	s11,ffffffffc020428c <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204298:	00044783          	lbu	a5,0(s0)
ffffffffc020429c:	00140a13          	addi	s4,s0,1
ffffffffc02042a0:	0007851b          	sext.w	a0,a5
ffffffffc02042a4:	d3a5                	beqz	a5,ffffffffc0204204 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02042a6:	05e00413          	li	s0,94
ffffffffc02042aa:	bf39                	j	ffffffffc02041c8 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02042ac:	000a2403          	lw	s0,0(s4)
ffffffffc02042b0:	b7ad                	j	ffffffffc020421a <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02042b2:	000a6603          	lwu	a2,0(s4)
ffffffffc02042b6:	46a1                	li	a3,8
ffffffffc02042b8:	8a2e                	mv	s4,a1
ffffffffc02042ba:	bdb1                	j	ffffffffc0204116 <vprintfmt+0x156>
ffffffffc02042bc:	000a6603          	lwu	a2,0(s4)
ffffffffc02042c0:	46a9                	li	a3,10
ffffffffc02042c2:	8a2e                	mv	s4,a1
ffffffffc02042c4:	bd89                	j	ffffffffc0204116 <vprintfmt+0x156>
ffffffffc02042c6:	000a6603          	lwu	a2,0(s4)
ffffffffc02042ca:	46c1                	li	a3,16
ffffffffc02042cc:	8a2e                	mv	s4,a1
ffffffffc02042ce:	b5a1                	j	ffffffffc0204116 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02042d0:	9902                	jalr	s2
ffffffffc02042d2:	bf09                	j	ffffffffc02041e4 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02042d4:	85a6                	mv	a1,s1
ffffffffc02042d6:	02d00513          	li	a0,45
ffffffffc02042da:	e03e                	sd	a5,0(sp)
ffffffffc02042dc:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02042de:	6782                	ld	a5,0(sp)
ffffffffc02042e0:	8a66                	mv	s4,s9
ffffffffc02042e2:	40800633          	neg	a2,s0
ffffffffc02042e6:	46a9                	li	a3,10
ffffffffc02042e8:	b53d                	j	ffffffffc0204116 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02042ea:	03b05163          	blez	s11,ffffffffc020430c <vprintfmt+0x34c>
ffffffffc02042ee:	02d00693          	li	a3,45
ffffffffc02042f2:	f6d79de3          	bne	a5,a3,ffffffffc020426c <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02042f6:	00002417          	auipc	s0,0x2
ffffffffc02042fa:	e9240413          	addi	s0,s0,-366 # ffffffffc0206188 <default_pmm_manager+0xfa8>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02042fe:	02800793          	li	a5,40
ffffffffc0204302:	02800513          	li	a0,40
ffffffffc0204306:	00140a13          	addi	s4,s0,1
ffffffffc020430a:	bd6d                	j	ffffffffc02041c4 <vprintfmt+0x204>
ffffffffc020430c:	00002a17          	auipc	s4,0x2
ffffffffc0204310:	e7da0a13          	addi	s4,s4,-387 # ffffffffc0206189 <default_pmm_manager+0xfa9>
ffffffffc0204314:	02800513          	li	a0,40
ffffffffc0204318:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020431c:	05e00413          	li	s0,94
ffffffffc0204320:	b565                	j	ffffffffc02041c8 <vprintfmt+0x208>

ffffffffc0204322 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204322:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204324:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204328:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020432a:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020432c:	ec06                	sd	ra,24(sp)
ffffffffc020432e:	f83a                	sd	a4,48(sp)
ffffffffc0204330:	fc3e                	sd	a5,56(sp)
ffffffffc0204332:	e0c2                	sd	a6,64(sp)
ffffffffc0204334:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204336:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204338:	c89ff0ef          	jal	ra,ffffffffc0203fc0 <vprintfmt>
}
ffffffffc020433c:	60e2                	ld	ra,24(sp)
ffffffffc020433e:	6161                	addi	sp,sp,80
ffffffffc0204340:	8082                	ret

ffffffffc0204342 <readline>:
...
ffffffffc0204342:	715d                	addi	sp,sp,-80
ffffffffc0204344:	e486                	sd	ra,72(sp)
ffffffffc0204346:	e0a6                	sd	s1,64(sp)
ffffffffc0204348:	fc4a                	sd	s2,56(sp)
ffffffffc020434a:	f84e                	sd	s3,48(sp)
ffffffffc020434c:	f452                	sd	s4,40(sp)
ffffffffc020434e:	f056                	sd	s5,32(sp)
ffffffffc0204350:	ec5a                	sd	s6,24(sp)
ffffffffc0204352:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204354:	c901                	beqz	a0,ffffffffc0204364 <readline+0x22>
ffffffffc0204356:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204358:	00002517          	auipc	a0,0x2
ffffffffc020435c:	e4850513          	addi	a0,a0,-440 # ffffffffc02061a0 <default_pmm_manager+0xfc0>
ffffffffc0204360:	d5bfb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc0204364:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc0204366:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc0204368:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc020436a:	4aa9                	li	s5,10
ffffffffc020436c:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc020436e:	0000db97          	auipc	s7,0xd
ffffffffc0204372:	d8ab8b93          	addi	s7,s7,-630 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204376:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc020437a:	d79fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020437e:	00054a63          	bltz	a0,ffffffffc0204392 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204382:	00a95a63          	bge	s2,a0,ffffffffc0204396 <readline+0x54>
ffffffffc0204386:	029a5263          	bge	s4,s1,ffffffffc02043aa <readline+0x68>
        c = getchar();
ffffffffc020438a:	d69fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020438e:	fe055ae3          	bgez	a0,ffffffffc0204382 <readline+0x40>
            return NULL;
ffffffffc0204392:	4501                	li	a0,0
ffffffffc0204394:	a091                	j	ffffffffc02043d8 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc0204396:	03351463          	bne	a0,s3,ffffffffc02043be <readline+0x7c>
ffffffffc020439a:	e8a9                	bnez	s1,ffffffffc02043ec <readline+0xaa>
        c = getchar();
ffffffffc020439c:	d57fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02043a0:	fe0549e3          	bltz	a0,ffffffffc0204392 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02043a4:	fea959e3          	bge	s2,a0,ffffffffc0204396 <readline+0x54>
ffffffffc02043a8:	4481                	li	s1,0
            cputchar(c);
ffffffffc02043aa:	e42a                	sd	a0,8(sp)
ffffffffc02043ac:	d45fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02043b0:	6522                	ld	a0,8(sp)
ffffffffc02043b2:	009b87b3          	add	a5,s7,s1
ffffffffc02043b6:	2485                	addiw	s1,s1,1
ffffffffc02043b8:	00a78023          	sb	a0,0(a5)
ffffffffc02043bc:	bf7d                	j	ffffffffc020437a <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc02043be:	01550463          	beq	a0,s5,ffffffffc02043c6 <readline+0x84>
ffffffffc02043c2:	fb651ce3          	bne	a0,s6,ffffffffc020437a <readline+0x38>
            cputchar(c);
ffffffffc02043c6:	d2bfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc02043ca:	0000d517          	auipc	a0,0xd
ffffffffc02043ce:	d2e50513          	addi	a0,a0,-722 # ffffffffc02110f8 <buf>
ffffffffc02043d2:	94aa                	add	s1,s1,a0
ffffffffc02043d4:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02043d8:	60a6                	ld	ra,72(sp)
ffffffffc02043da:	6486                	ld	s1,64(sp)
ffffffffc02043dc:	7962                	ld	s2,56(sp)
ffffffffc02043de:	79c2                	ld	s3,48(sp)
ffffffffc02043e0:	7a22                	ld	s4,40(sp)
ffffffffc02043e2:	7a82                	ld	s5,32(sp)
ffffffffc02043e4:	6b62                	ld	s6,24(sp)
ffffffffc02043e6:	6bc2                	ld	s7,16(sp)
ffffffffc02043e8:	6161                	addi	sp,sp,80
ffffffffc02043ea:	8082                	ret
            cputchar(c);
ffffffffc02043ec:	4521                	li	a0,8
ffffffffc02043ee:	d03fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc02043f2:	34fd                	addiw	s1,s1,-1
ffffffffc02043f4:	b759                	j	ffffffffc020437a <readline+0x38>

ffffffffc02043f6 <strlen>:
...
strlen(const char *s) {
ffffffffc02043fa:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02043fc:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02043fe:	cb81                	beqz	a5,ffffffffc020440e <strlen+0x18>
        cnt ++;
ffffffffc0204400:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204402:	00a707b3          	add	a5,a4,a0
ffffffffc0204406:	0007c783          	lbu	a5,0(a5)
ffffffffc020440a:	fbfd                	bnez	a5,ffffffffc0204400 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204410:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204412:	e589                	bnez	a1,ffffffffc020441c <strnlen+0xc>
ffffffffc0204414:	a811                	j	ffffffffc0204428 <strnlen+0x18>
        cnt ++;
ffffffffc0204416:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204418:	00f58863          	beq	a1,a5,ffffffffc0204428 <strnlen+0x18>
ffffffffc020441c:	00f50733          	add	a4,a0,a5
ffffffffc0204420:	00074703          	lbu	a4,0(a4)
ffffffffc0204424:	fb6d                	bnez	a4,ffffffffc0204416 <strnlen+0x6>
ffffffffc0204426:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204428:	852e                	mv	a0,a1
ffffffffc020442a:	8082                	ret

ffffffffc020442c <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc020442c:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020442e:	0005c703          	lbu	a4,0(a1)
ffffffffc0204432:	0785                	addi	a5,a5,1
ffffffffc0204434:	0585                	addi	a1,a1,1
ffffffffc0204436:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020443a:	fb75                	bnez	a4,ffffffffc020442e <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020443e:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204442:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204446:	cb89                	beqz	a5,ffffffffc0204458 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204448:	0505                	addi	a0,a0,1
ffffffffc020444a:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020444c:	fee789e3          	beq	a5,a4,ffffffffc020443e <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204450:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204454:	9d19                	subw	a0,a0,a4
ffffffffc0204456:	8082                	ret
ffffffffc0204458:	4501                	li	a0,0
ffffffffc020445a:	bfed                	j	ffffffffc0204454 <strcmp+0x16>

ffffffffc020445c <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc020445c:	00054783          	lbu	a5,0(a0)
ffffffffc0204460:	c799                	beqz	a5,ffffffffc020446e <strchr+0x12>
        if (*s == c) {
ffffffffc0204462:	00f58763          	beq	a1,a5,ffffffffc0204470 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204466:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc020446a:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020446c:	fbfd                	bnez	a5,ffffffffc0204462 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204472:	ca01                	beqz	a2,ffffffffc0204482 <memset+0x10>
ffffffffc0204474:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204476:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204478:	0785                	addi	a5,a5,1
ffffffffc020447a:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020447e:	fec79de3          	bne	a5,a2,ffffffffc0204478 <memset+0x6>
    }
    return s;
...
ffffffffc0204484 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204484:	ca19                	beqz	a2,ffffffffc020449a <memcpy+0x16>
ffffffffc0204486:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204488:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc020448a:	0005c703          	lbu	a4,0(a1)
ffffffffc020448e:	0585                	addi	a1,a1,1
ffffffffc0204490:	0785                	addi	a5,a5,1
ffffffffc0204492:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204496:	fec59ae3          	bne	a1,a2,ffffffffc020448a <memcpy+0x6>
    }
    return dst;

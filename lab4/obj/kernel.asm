...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	6c3040ef          	jal	ra,ffffffffc0204f0c <memset>
...
ffffffffc0200056:	f0e58593          	addi	a1,a1,-242 # ffffffffc0204f60 <etext+0x6>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	f2650513          	addi	a0,a0,-218 # ffffffffc0204f80 <etext+0x26>
...
ffffffffc0200076:	1c1030ef          	jal	ra,ffffffffc0203a36 <vmm_init>
    proc_init();                // init process table
ffffffffc020007a:	678040ef          	jal	ra,ffffffffc02046f2 <proc_init>
...
ffffffffc020008e:	0b3040ef          	jal	ra,ffffffffc0204940 <cpu_idle>
...
ffffffffc02000ac:	ee050513          	addi	a0,a0,-288 # ffffffffc0204f88 <etext+0x2e>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	19b040ef          	jal	ra,ffffffffc0204b0e <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	165040ef          	jal	ra,ffffffffc0204b0e <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	dc650513          	addi	a0,a0,-570 # ffffffffc0204f90 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc02001e4:	dd050513          	addi	a0,a0,-560 # ffffffffc0204fb0 <etext+0x56>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d6e58593          	addi	a1,a1,-658 # ffffffffc0204f5a <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	ddc50513          	addi	a0,a0,-548 # ffffffffc0204fd0 <etext+0x76>
...
ffffffffc020020c:	de850513          	addi	a0,a0,-536 # ffffffffc0204ff0 <etext+0x96>
...
ffffffffc0200220:	df450513          	addi	a0,a0,-524 # ffffffffc0205010 <etext+0xb6>
...
ffffffffc020024e:	de650513          	addi	a0,a0,-538 # ffffffffc0205030 <etext+0xd6>
}
...
ffffffffc020025c:	e0860613          	addi	a2,a2,-504 # ffffffffc0205060 <etext+0x106>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	e1450513          	addi	a0,a0,-492 # ffffffffc0205078 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc0200278:	e1c60613          	addi	a2,a2,-484 # ffffffffc0205090 <etext+0x136>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	e3458593          	addi	a1,a1,-460 # ffffffffc02050b0 <etext+0x156>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	e3450513          	addi	a0,a0,-460 # ffffffffc02050b8 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	e3660613          	addi	a2,a2,-458 # ffffffffc02050c8 <etext+0x16e>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e5658593          	addi	a1,a1,-426 # ffffffffc02050f0 <etext+0x196>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	e1650513          	addi	a0,a0,-490 # ffffffffc02050b8 <etext+0x15e>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e5260613          	addi	a2,a2,-430 # ffffffffc0205100 <etext+0x1a6>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e6a58593          	addi	a1,a1,-406 # ffffffffc0205120 <etext+0x1c6>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	dfa50513          	addi	a0,a0,-518 # ffffffffc02050b8 <etext+0x15e>
...
ffffffffc02002fc:	e3850513          	addi	a0,a0,-456 # ffffffffc0205130 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	e3e50513          	addi	a0,a0,-450 # ffffffffc0205158 <etext+0x1fe>
...
ffffffffc0200340:	e8cc0c13          	addi	s8,s8,-372 # ffffffffc02051c8 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	e3c90913          	addi	s2,s2,-452 # ffffffffc0205180 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	e3c48493          	addi	s1,s1,-452 # ffffffffc0205188 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	e3ab0b13          	addi	s6,s6,-454 # ffffffffc0205190 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d52a0a13          	addi	s4,s4,-686 # ffffffffc02050b0 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	e48d0d13          	addi	s10,s10,-440 # ffffffffc02051c8 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	34b040ef          	jal	ra,ffffffffc0204ed8 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	337040ef          	jal	ra,ffffffffc0204ed8 <strcmp>
...
ffffffffc02003e0:	317040ef          	jal	ra,ffffffffc0204ef6 <strchr>
...
ffffffffc020041e:	2d9040ef          	jal	ra,ffffffffc0204ef6 <strchr>
...
ffffffffc020043c:	d7850513          	addi	a0,a0,-648 # ffffffffc02051b0 <etext+0x256>
...
ffffffffc0200478:	d9c50513          	addi	a0,a0,-612 # ffffffffc0205210 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	cf650513          	addi	a0,a0,-778 # ffffffffc0206180 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	d6850513          	addi	a0,a0,-664 # ffffffffc0205230 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	193040ef          	jal	ra,ffffffffc0204f1e <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	16f040ef          	jal	ra,ffffffffc0204f1e <memcpy>
    return 0;
}
...
ffffffffc02005fe:	c5650513          	addi	a0,a0,-938 # ffffffffc0205250 <commands+0x88>
...
ffffffffc020061c:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc020061e:	1ed0306f          	j	ffffffffc020400a <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc0200622:	00005617          	auipc	a2,0x5
ffffffffc0200626:	c4e60613          	addi	a2,a2,-946 # ffffffffc0205270 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	c5a50513          	addi	a0,a0,-934 # ffffffffc0205288 <commands+0xc0>
...
ffffffffc0200660:	c4450513          	addi	a0,a0,-956 # ffffffffc02052a0 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	c4c50513          	addi	a0,a0,-948 # ffffffffc02052b8 <commands+0xf0>
...
ffffffffc020067e:	c5650513          	addi	a0,a0,-938 # ffffffffc02052d0 <commands+0x108>
...
ffffffffc020068c:	c6050513          	addi	a0,a0,-928 # ffffffffc02052e8 <commands+0x120>
...
ffffffffc020069a:	c6a50513          	addi	a0,a0,-918 # ffffffffc0205300 <commands+0x138>
...
ffffffffc02006a8:	c7450513          	addi	a0,a0,-908 # ffffffffc0205318 <commands+0x150>
...
ffffffffc02006b6:	c7e50513          	addi	a0,a0,-898 # ffffffffc0205330 <commands+0x168>
...
ffffffffc02006c4:	c8850513          	addi	a0,a0,-888 # ffffffffc0205348 <commands+0x180>
...
ffffffffc02006d2:	c9250513          	addi	a0,a0,-878 # ffffffffc0205360 <commands+0x198>
...
ffffffffc02006e0:	c9c50513          	addi	a0,a0,-868 # ffffffffc0205378 <commands+0x1b0>
...
ffffffffc02006ee:	ca650513          	addi	a0,a0,-858 # ffffffffc0205390 <commands+0x1c8>
...
ffffffffc02006fc:	cb050513          	addi	a0,a0,-848 # ffffffffc02053a8 <commands+0x1e0>
...
ffffffffc020070a:	cba50513          	addi	a0,a0,-838 # ffffffffc02053c0 <commands+0x1f8>
...
ffffffffc0200718:	cc450513          	addi	a0,a0,-828 # ffffffffc02053d8 <commands+0x210>
...
ffffffffc0200726:	cce50513          	addi	a0,a0,-818 # ffffffffc02053f0 <commands+0x228>
...
ffffffffc0200734:	cd850513          	addi	a0,a0,-808 # ffffffffc0205408 <commands+0x240>
...
ffffffffc0200742:	ce250513          	addi	a0,a0,-798 # ffffffffc0205420 <commands+0x258>
...
ffffffffc0200750:	cec50513          	addi	a0,a0,-788 # ffffffffc0205438 <commands+0x270>
...
ffffffffc020075e:	cf650513          	addi	a0,a0,-778 # ffffffffc0205450 <commands+0x288>
...
ffffffffc020076c:	d0050513          	addi	a0,a0,-768 # ffffffffc0205468 <commands+0x2a0>
...
ffffffffc020077a:	d0a50513          	addi	a0,a0,-758 # ffffffffc0205480 <commands+0x2b8>
...
ffffffffc0200788:	d1450513          	addi	a0,a0,-748 # ffffffffc0205498 <commands+0x2d0>
...
ffffffffc0200796:	d1e50513          	addi	a0,a0,-738 # ffffffffc02054b0 <commands+0x2e8>
...
ffffffffc02007a4:	d2850513          	addi	a0,a0,-728 # ffffffffc02054c8 <commands+0x300>
...
ffffffffc02007b2:	d3250513          	addi	a0,a0,-718 # ffffffffc02054e0 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	d3c50513          	addi	a0,a0,-708 # ffffffffc02054f8 <commands+0x330>
...
ffffffffc02007ce:	d4650513          	addi	a0,a0,-698 # ffffffffc0205510 <commands+0x348>
...
ffffffffc02007dc:	d5050513          	addi	a0,a0,-688 # ffffffffc0205528 <commands+0x360>
...
ffffffffc02007ea:	d5a50513          	addi	a0,a0,-678 # ffffffffc0205540 <commands+0x378>
...
ffffffffc02007f8:	d6450513          	addi	a0,a0,-668 # ffffffffc0205558 <commands+0x390>
...
ffffffffc0200806:	d6e50513          	addi	a0,a0,-658 # ffffffffc0205570 <commands+0x3a8>
...
ffffffffc0200818:	d7450513          	addi	a0,a0,-652 # ffffffffc0205588 <commands+0x3c0>
}
...
ffffffffc020082c:	d7850513          	addi	a0,a0,-648 # ffffffffc02055a0 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	d7850513          	addi	a0,a0,-648 # ffffffffc02055b8 <commands+0x3f0>
...
ffffffffc0200854:	d8050513          	addi	a0,a0,-640 # ffffffffc02055d0 <commands+0x408>
...
ffffffffc0200864:	d8850513          	addi	a0,a0,-632 # ffffffffc02055e8 <commands+0x420>
...
ffffffffc0200878:	d8c50513          	addi	a0,a0,-628 # ffffffffc0205600 <commands+0x438>
}
...
ffffffffc0200894:	e3870713          	addi	a4,a4,-456 # ffffffffc02056c8 <commands+0x500>
...
ffffffffc02008a6:	dd650513          	addi	a0,a0,-554 # ffffffffc0205678 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	daa50513          	addi	a0,a0,-598 # ffffffffc0205658 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	d5e50513          	addi	a0,a0,-674 # ffffffffc0205618 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	d7250513          	addi	a0,a0,-654 # ffffffffc0205638 <commands+0x470>
...
ffffffffc02008fc:	db050513          	addi	a0,a0,-592 # ffffffffc02056a8 <commands+0x4e0>
...
ffffffffc0200910:	d8c50513          	addi	a0,a0,-628 # ffffffffc0205698 <commands+0x4d0>
}
...
ffffffffc0200932:	f8270713          	addi	a4,a4,-126 # ffffffffc02058b0 <commands+0x6e8>
...
ffffffffc0200944:	f5850513          	addi	a0,a0,-168 # ffffffffc0205898 <commands+0x6d0>
...
ffffffffc0200966:	d9650513          	addi	a0,a0,-618 # ffffffffc02056f8 <commands+0x530>
}
...
ffffffffc02009c0:	ddc60613          	addi	a2,a2,-548 # ffffffffc0205798 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00005517          	auipc	a0,0x5
ffffffffc02009cc:	8c050513          	addi	a0,a0,-1856 # ffffffffc0205288 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	de450513          	addi	a0,a0,-540 # ffffffffc02057b8 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	df250513          	addi	a0,a0,-526 # ffffffffc02057d0 <commands+0x608>
...
ffffffffc0200a6a:	d3260613          	addi	a2,a2,-718 # ffffffffc0205798 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00005517          	auipc	a0,0x5
ffffffffc0200a76:	81650513          	addi	a0,a0,-2026 # ffffffffc0205288 <commands+0xc0>
...
ffffffffc0200a96:	d0660613          	addi	a2,a2,-762 # ffffffffc0205798 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	7ea50513          	addi	a0,a0,2026 # ffffffffc0205288 <commands+0xc0>
...
ffffffffc0200c2e:	42e63603          	ld	a2,1070(a2) # ffffffffc0207058 <nbase>
...
ffffffffc0200e74:	a8068693          	addi	a3,a3,-1408 # ffffffffc02058f0 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	a8860613          	addi	a2,a2,-1400 # ffffffffc0205900 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	a9450513          	addi	a0,a0,-1388 # ffffffffc0205918 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	b2068693          	addi	a3,a3,-1248 # ffffffffc02059b0 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	a6860613          	addi	a2,a2,-1432 # ffffffffc0205900 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	a7450513          	addi	a0,a0,-1420 # ffffffffc0205918 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	b2868693          	addi	a3,a3,-1240 # ffffffffc02059d8 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	a4860613          	addi	a2,a2,-1464 # ffffffffc0205900 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	a5450513          	addi	a0,a0,-1452 # ffffffffc0205918 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	b4868693          	addi	a3,a3,-1208 # ffffffffc0205a18 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	a2860613          	addi	a2,a2,-1496 # ffffffffc0205900 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	a3450513          	addi	a0,a0,-1484 # ffffffffc0205918 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	bb068693          	addi	a3,a3,-1104 # ffffffffc0205aa0 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	a0860613          	addi	a2,a2,-1528 # ffffffffc0205900 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	a1450513          	addi	a0,a0,-1516 # ffffffffc0205918 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	a4068693          	addi	a3,a3,-1472 # ffffffffc0205950 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	9e860613          	addi	a2,a2,-1560 # ffffffffc0205900 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	9f450513          	addi	a0,a0,-1548 # ffffffffc0205918 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	b6068693          	addi	a3,a3,-1184 # ffffffffc0205a90 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	9c860613          	addi	a2,a2,-1592 # ffffffffc0205900 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	9d450513          	addi	a0,a0,-1580 # ffffffffc0205918 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	b2868693          	addi	a3,a3,-1240 # ffffffffc0205a78 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	9a860613          	addi	a2,a2,-1624 # ffffffffc0205900 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	9b450513          	addi	a0,a0,-1612 # ffffffffc0205918 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	ae868693          	addi	a3,a3,-1304 # ffffffffc0205a58 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	98860613          	addi	a2,a2,-1656 # ffffffffc0205900 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	99450513          	addi	a0,a0,-1644 # ffffffffc0205918 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	b5868693          	addi	a3,a3,-1192 # ffffffffc0205ae8 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	96860613          	addi	a2,a2,-1688 # ffffffffc0205900 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	97450513          	addi	a0,a0,-1676 # ffffffffc0205918 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	b2868693          	addi	a3,a3,-1240 # ffffffffc0205ad8 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	94860613          	addi	a2,a2,-1720 # ffffffffc0205900 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	95450513          	addi	a0,a0,-1708 # ffffffffc0205918 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	aa868693          	addi	a3,a3,-1368 # ffffffffc0205a78 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	92860613          	addi	a2,a2,-1752 # ffffffffc0205900 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	93450513          	addi	a0,a0,-1740 # ffffffffc0205918 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	ac868693          	addi	a3,a3,-1336 # ffffffffc0205ab8 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	90860613          	addi	a2,a2,-1784 # ffffffffc0205900 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	91450513          	addi	a0,a0,-1772 # ffffffffc0205918 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	94068693          	addi	a3,a3,-1728 # ffffffffc0205950 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	8e860613          	addi	a2,a2,-1816 # ffffffffc0205900 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	8f450513          	addi	a0,a0,-1804 # ffffffffc0205918 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	a4868693          	addi	a3,a3,-1464 # ffffffffc0205a78 <commands+0x8b0>
ffffffffc0201038:	00005617          	auipc	a2,0x5
ffffffffc020103c:	8c860613          	addi	a2,a2,-1848 # ffffffffc0205900 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00005517          	auipc	a0,0x5
ffffffffc0201048:	8d450513          	addi	a0,a0,-1836 # ffffffffc0205918 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	94068693          	addi	a3,a3,-1728 # ffffffffc0205990 <commands+0x7c8>
ffffffffc0201058:	00005617          	auipc	a2,0x5
ffffffffc020105c:	8a860613          	addi	a2,a2,-1880 # ffffffffc0205900 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00005517          	auipc	a0,0x5
ffffffffc0201068:	8b450513          	addi	a0,a0,-1868 # ffffffffc0205918 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	90068693          	addi	a3,a3,-1792 # ffffffffc0205970 <commands+0x7a8>
ffffffffc0201078:	00005617          	auipc	a2,0x5
ffffffffc020107c:	88860613          	addi	a2,a2,-1912 # ffffffffc0205900 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00005517          	auipc	a0,0x5
ffffffffc0201088:	89450513          	addi	a0,a0,-1900 # ffffffffc0205918 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	90068693          	addi	a3,a3,-1792 # ffffffffc0205990 <commands+0x7c8>
ffffffffc0201098:	00005617          	auipc	a2,0x5
ffffffffc020109c:	86860613          	addi	a2,a2,-1944 # ffffffffc0205900 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00005517          	auipc	a0,0x5
ffffffffc02010a8:	87450513          	addi	a0,a0,-1932 # ffffffffc0205918 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	b8868693          	addi	a3,a3,-1144 # ffffffffc0205c38 <commands+0xa70>
ffffffffc02010b8:	00005617          	auipc	a2,0x5
ffffffffc02010bc:	84860613          	addi	a2,a2,-1976 # ffffffffc0205900 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00005517          	auipc	a0,0x5
ffffffffc02010c8:	85450513          	addi	a0,a0,-1964 # ffffffffc0205918 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	a0868693          	addi	a3,a3,-1528 # ffffffffc0205ad8 <commands+0x910>
ffffffffc02010d8:	00005617          	auipc	a2,0x5
ffffffffc02010dc:	82860613          	addi	a2,a2,-2008 # ffffffffc0205900 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00005517          	auipc	a0,0x5
ffffffffc02010e8:	83450513          	addi	a0,a0,-1996 # ffffffffc0205918 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	98868693          	addi	a3,a3,-1656 # ffffffffc0205a78 <commands+0x8b0>
ffffffffc02010f8:	00005617          	auipc	a2,0x5
ffffffffc02010fc:	80860613          	addi	a2,a2,-2040 # ffffffffc0205900 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00005517          	auipc	a0,0x5
ffffffffc0201108:	81450513          	addi	a0,a0,-2028 # ffffffffc0205918 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	92868693          	addi	a3,a3,-1752 # ffffffffc0205a38 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	7e860613          	addi	a2,a2,2024 # ffffffffc0205900 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	7f450513          	addi	a0,a0,2036 # ffffffffc0205918 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	ac868693          	addi	a3,a3,-1336 # ffffffffc0205bf8 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	7c860613          	addi	a2,a2,1992 # ffffffffc0205900 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	7d450513          	addi	a0,a0,2004 # ffffffffc0205918 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	a8868693          	addi	a3,a3,-1400 # ffffffffc0205bd8 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	7a860613          	addi	a2,a2,1960 # ffffffffc0205900 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	7b450513          	addi	a0,a0,1972 # ffffffffc0205918 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	a4068693          	addi	a3,a3,-1472 # ffffffffc0205bb0 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	78860613          	addi	a2,a2,1928 # ffffffffc0205900 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	79450513          	addi	a0,a0,1940 # ffffffffc0205918 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	9f868693          	addi	a3,a3,-1544 # ffffffffc0205b88 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	76860613          	addi	a2,a2,1896 # ffffffffc0205900 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	77450513          	addi	a0,a0,1908 # ffffffffc0205918 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	9c868693          	addi	a3,a3,-1592 # ffffffffc0205b78 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	74860613          	addi	a2,a2,1864 # ffffffffc0205900 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	75450513          	addi	a0,a0,1876 # ffffffffc0205918 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00005697          	auipc	a3,0x5
ffffffffc02011d4:	8a868693          	addi	a3,a3,-1880 # ffffffffc0205a78 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	72860613          	addi	a2,a2,1832 # ffffffffc0205900 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	73450513          	addi	a0,a0,1844 # ffffffffc0205918 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	96868693          	addi	a3,a3,-1688 # ffffffffc0205b58 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	70860613          	addi	a2,a2,1800 # ffffffffc0205900 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	71450513          	addi	a0,a0,1812 # ffffffffc0205918 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	91868693          	addi	a3,a3,-1768 # ffffffffc0205b28 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	6e860613          	addi	a2,a2,1768 # ffffffffc0205900 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	6f450513          	addi	a0,a0,1780 # ffffffffc0205918 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	8e068693          	addi	a3,a3,-1824 # ffffffffc0205b10 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	6c860613          	addi	a2,a2,1736 # ffffffffc0205900 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	6d450513          	addi	a0,a0,1748 # ffffffffc0205918 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00005697          	auipc	a3,0x5
ffffffffc0201254:	82868693          	addi	a3,a3,-2008 # ffffffffc0205a78 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	6a860613          	addi	a2,a2,1704 # ffffffffc0205900 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	6b450513          	addi	a0,a0,1716 # ffffffffc0205918 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00005697          	auipc	a3,0x5
ffffffffc0201274:	88868693          	addi	a3,a3,-1912 # ffffffffc0205af8 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	68860613          	addi	a2,a2,1672 # ffffffffc0205900 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	69450513          	addi	a0,a0,1684 # ffffffffc0205918 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	98868693          	addi	a3,a3,-1656 # ffffffffc0205c18 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	66860613          	addi	a2,a2,1640 # ffffffffc0205900 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	67450513          	addi	a0,a0,1652 # ffffffffc0205918 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	99868693          	addi	a3,a3,-1640 # ffffffffc0205c48 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	64860613          	addi	a2,a2,1608 # ffffffffc0205900 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	65450513          	addi	a0,a0,1620 # ffffffffc0205918 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	66068693          	addi	a3,a3,1632 # ffffffffc0205930 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	62860613          	addi	a2,a2,1576 # ffffffffc0205900 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	63450513          	addi	a0,a0,1588 # ffffffffc0205918 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	68068693          	addi	a3,a3,1664 # ffffffffc0205970 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	60860613          	addi	a2,a2,1544 # ffffffffc0205900 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	61450513          	addi	a0,a0,1556 # ffffffffc0205918 <commands+0x750>
...
ffffffffc0201440:	82468693          	addi	a3,a3,-2012 # ffffffffc0205c60 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	4bc60613          	addi	a2,a2,1212 # ffffffffc0205900 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	4c850513          	addi	a0,a0,1224 # ffffffffc0205918 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	7fc68693          	addi	a3,a3,2044 # ffffffffc0205c58 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	49c60613          	addi	a2,a2,1180 # ffffffffc0205900 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	4a850513          	addi	a0,a0,1192 # ffffffffc0205918 <commands+0x750>
...
ffffffffc0201512:	74a68693          	addi	a3,a3,1866 # ffffffffc0205c58 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	3ea60613          	addi	a2,a2,1002 # ffffffffc0205900 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	3f650513          	addi	a0,a0,1014 # ffffffffc0205918 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	6a868693          	addi	a3,a3,1704 # ffffffffc0205c88 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	31860613          	addi	a2,a2,792 # ffffffffc0205900 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	32450513          	addi	a0,a0,804 # ffffffffc0205918 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	65868693          	addi	a3,a3,1624 # ffffffffc0205c58 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	2f860613          	addi	a2,a2,760 # ffffffffc0205900 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	30450513          	addi	a0,a0,772 # ffffffffc0205918 <commands+0x750>
...
ffffffffc02016f4:	9686b683          	ld	a3,-1688(a3) # ffffffffc0207058 <nbase>
...
ffffffffc0201724:	5c860613          	addi	a2,a2,1480 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	5e450513          	addi	a0,a0,1508 # ffffffffc0205d10 <default_pmm_manager+0x60>
...
ffffffffc0201812:	51268693          	addi	a3,a3,1298 # ffffffffc0205d20 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	0ea60613          	addi	a2,a2,234 # ffffffffc0205900 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	51e50513          	addi	a0,a0,1310 # ffffffffc0205d40 <default_pmm_manager+0x90>
...
ffffffffc0201834:	52850513          	addi	a0,a0,1320 # ffffffffc0205d58 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	53050513          	addi	a0,a0,1328 # ffffffffc0205d70 <default_pmm_manager+0xc0>
}
...
ffffffffc0201968:	6f453503          	ld	a0,1780(a0) # ffffffffc0207058 <nbase>
...
ffffffffc02019c6:	3f660613          	addi	a2,a2,1014 # ffffffffc0205db8 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	34250513          	addi	a0,a0,834 # ffffffffc0205d10 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	3b460613          	addi	a2,a2,948 # ffffffffc0205d90 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	32850513          	addi	a0,a0,808 # ffffffffc0205d10 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	3c260613          	addi	a2,a2,962 # ffffffffc0205db8 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	30e50513          	addi	a0,a0,782 # ffffffffc0205d10 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	3c660613          	addi	a2,a2,966 # ffffffffc0205dd8 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	2f250513          	addi	a0,a0,754 # ffffffffc0205d10 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	34e030ef          	jal	ra,ffffffffc0204f0c <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	2bc030ef          	jal	ra,ffffffffc0204f0c <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	04260613          	addi	a2,a2,66 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	14e50513          	addi	a0,a0,334 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	02a60613          	addi	a2,a2,42 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	13650513          	addi	a0,a0,310 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	01060613          	addi	a2,a2,16 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	11c50513          	addi	a0,a0,284 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	ff660613          	addi	a2,a2,-10 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	10250513          	addi	a0,a0,258 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	dc078793          	addi	a5,a5,-576 # ffffffffc0205cb0 <default_pmm_manager>
...
ffffffffc0201f02:	f1250513          	addi	a0,a0,-238 # ffffffffc0205e10 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	edc50513          	addi	a0,a0,-292 # ffffffffc0205e28 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	ed450513          	addi	a0,a0,-300 # ffffffffc0205e40 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	e9450513          	addi	a0,a0,-364 # ffffffffc0205e68 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	e9050513          	addi	a0,a0,-368 # ffffffffc0205e80 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	ed850513          	addi	a0,a0,-296 # ffffffffc0206168 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	f5a58593          	addi	a1,a1,-166 # ffffffffc02062a0 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	375020ef          	jal	ra,ffffffffc0204ec6 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	37b020ef          	jal	ra,ffffffffc0204ed8 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2fd020ef          	jal	ra,ffffffffc0204e90 <strlen>
...
ffffffffc0202458:	ec450513          	addi	a0,a0,-316 # ffffffffc0206318 <default_pmm_manager+0x668>
...
ffffffffc0202572:	c5a68693          	addi	a3,a3,-934 # ffffffffc02061c8 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	38a60613          	addi	a2,a2,906 # ffffffffc0205900 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00004517          	auipc	a0,0x4
ffffffffc0202586:	87e50513          	addi	a0,a0,-1922 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	bfa68693          	addi	a3,a3,-1030 # ffffffffc0206188 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	36a60613          	addi	a2,a2,874 # ffffffffc0205900 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00004517          	auipc	a0,0x4
ffffffffc02025a6:	85e50513          	addi	a0,a0,-1954 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	73860613          	addi	a2,a2,1848 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00004517          	auipc	a0,0x4
ffffffffc02025c0:	84450513          	addi	a0,a0,-1980 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	7c460613          	addi	a2,a2,1988 # ffffffffc0205d90 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00004517          	auipc	a0,0x4
ffffffffc02025dc:	82850513          	addi	a0,a0,-2008 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	7ac60613          	addi	a2,a2,1964 # ffffffffc0205d90 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00004517          	auipc	a0,0x4
ffffffffc02025f4:	81050513          	addi	a0,a0,-2032 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	8c468693          	addi	a3,a3,-1852 # ffffffffc0205ec0 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	2fc60613          	addi	a2,a2,764 # ffffffffc0205900 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	7f050513          	addi	a0,a0,2032 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00004697          	auipc	a3,0x4
ffffffffc0202620:	88468693          	addi	a3,a3,-1916 # ffffffffc0205ea0 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	2dc60613          	addi	a2,a2,732 # ffffffffc0205900 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	7d050513          	addi	a0,a0,2000 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc0202644:	91068693          	addi	a3,a3,-1776 # ffffffffc0205f50 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	2b860613          	addi	a2,a2,696 # ffffffffc0205900 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	7ac50513          	addi	a0,a0,1964 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205f20 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	29860613          	addi	a2,a2,664 # ffffffffc0205900 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	78c50513          	addi	a0,a0,1932 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00004697          	auipc	a3,0x4
ffffffffc0202684:	87868693          	addi	a3,a3,-1928 # ffffffffc0205ef8 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	27860613          	addi	a2,a2,632 # ffffffffc0205900 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	76c50513          	addi	a0,a0,1900 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	93868693          	addi	a3,a3,-1736 # ffffffffc0205fd8 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	25860613          	addi	a2,a2,600 # ffffffffc0205900 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	74c50513          	addi	a0,a0,1868 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	9b868693          	addi	a3,a3,-1608 # ffffffffc0206078 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	23860613          	addi	a2,a2,568 # ffffffffc0205900 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	72c50513          	addi	a0,a0,1836 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	8d068693          	addi	a3,a3,-1840 # ffffffffc0205fb0 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	21860613          	addi	a2,a2,536 # ffffffffc0205900 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	70c50513          	addi	a0,a0,1804 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc0202706:	5e660613          	addi	a2,a2,1510 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	6f250513          	addi	a0,a0,1778 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	8f668693          	addi	a3,a3,-1802 # ffffffffc0206010 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	1de60613          	addi	a2,a2,478 # ffffffffc0205900 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	6d250513          	addi	a0,a0,1746 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	99e68693          	addi	a3,a3,-1634 # ffffffffc02060d8 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	1be60613          	addi	a2,a2,446 # ffffffffc0205900 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	6b250513          	addi	a0,a0,1714 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	96668693          	addi	a3,a3,-1690 # ffffffffc02060c0 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	19e60613          	addi	a2,a2,414 # ffffffffc0205900 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	69250513          	addi	a0,a0,1682 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	91668693          	addi	a3,a3,-1770 # ffffffffc0206090 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	17e60613          	addi	a2,a2,382 # ffffffffc0205900 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	67250513          	addi	a0,a0,1650 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	aae68693          	addi	a3,a3,-1362 # ffffffffc0206248 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	15e60613          	addi	a2,a2,350 # ffffffffc0205900 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	65250513          	addi	a0,a0,1618 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00004697          	auipc	a3,0x4
ffffffffc02027be:	8a668693          	addi	a3,a3,-1882 # ffffffffc0206060 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	13e60613          	addi	a2,a2,318 # ffffffffc0205900 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	63250513          	addi	a0,a0,1586 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00004697          	auipc	a3,0x4
ffffffffc02027de:	87668693          	addi	a3,a3,-1930 # ffffffffc0206050 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	11e60613          	addi	a2,a2,286 # ffffffffc0205900 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	61250513          	addi	a0,a0,1554 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	94e68693          	addi	a3,a3,-1714 # ffffffffc0206148 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	0fe60613          	addi	a2,a2,254 # ffffffffc0205900 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	5f250513          	addi	a0,a0,1522 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00004697          	auipc	a3,0x4
ffffffffc020281e:	82668693          	addi	a3,a3,-2010 # ffffffffc0206040 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	0de60613          	addi	a2,a2,222 # ffffffffc0205900 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	5d250513          	addi	a0,a0,1490 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	75e68693          	addi	a3,a3,1886 # ffffffffc0205f98 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	0be60613          	addi	a2,a2,190 # ffffffffc0205900 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	5b250513          	addi	a0,a0,1458 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00004697          	auipc	a3,0x4
ffffffffc020285e:	89668693          	addi	a3,a3,-1898 # ffffffffc02060f0 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	09e60613          	addi	a2,a2,158 # ffffffffc0205900 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	59250513          	addi	a0,a0,1426 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	70668693          	addi	a3,a3,1798 # ffffffffc0205f80 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	07e60613          	addi	a2,a2,126 # ffffffffc0205900 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	57250513          	addi	a0,a0,1394 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	44e60613          	addi	a2,a2,1102 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	46a50513          	addi	a0,a0,1130 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00004697          	auipc	a3,0x4
ffffffffc02028b6:	86e68693          	addi	a3,a3,-1938 # ffffffffc0206120 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	04660613          	addi	a2,a2,70 # ffffffffc0205900 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	53a50513          	addi	a0,a0,1338 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00004697          	auipc	a3,0x4
ffffffffc02028d6:	80668693          	addi	a3,a3,-2042 # ffffffffc02060d8 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	02660613          	addi	a2,a2,38 # ffffffffc0205900 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	51a50513          	addi	a0,a0,1306 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00004697          	auipc	a3,0x4
ffffffffc02028f6:	81668693          	addi	a3,a3,-2026 # ffffffffc0206108 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	00660613          	addi	a2,a2,6 # ffffffffc0205900 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	4fa50513          	addi	a0,a0,1274 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	7c668693          	addi	a3,a3,1990 # ffffffffc02060d8 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	fe660613          	addi	a2,a2,-26 # ffffffffc0205900 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	4da50513          	addi	a0,a0,1242 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	8fe68693          	addi	a3,a3,-1794 # ffffffffc0206230 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	fc660613          	addi	a2,a2,-58 # ffffffffc0205900 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	4ba50513          	addi	a0,a0,1210 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00004697          	auipc	a3,0x4
ffffffffc0202956:	8a668693          	addi	a3,a3,-1882 # ffffffffc02061f8 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	fa660613          	addi	a2,a2,-90 # ffffffffc0205900 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	49a50513          	addi	a0,a0,1178 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00004697          	auipc	a3,0x4
ffffffffc0202976:	86e68693          	addi	a3,a3,-1938 # ffffffffc02061e0 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	f8660613          	addi	a2,a2,-122 # ffffffffc0205900 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	47a50513          	addi	a0,a0,1146 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	7b668693          	addi	a3,a3,1974 # ffffffffc0206148 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	f6660613          	addi	a2,a2,-154 # ffffffffc0205900 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	45a50513          	addi	a0,a0,1114 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	5ce68693          	addi	a3,a3,1486 # ffffffffc0205f80 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	f4660613          	addi	a2,a2,-186 # ffffffffc0205900 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	43a50513          	addi	a0,a0,1082 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	31660613          	addi	a2,a2,790 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	42250513          	addi	a0,a0,1058 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	5ae68693          	addi	a3,a3,1454 # ffffffffc0205f98 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	f0e60613          	addi	a2,a2,-242 # ffffffffc0205900 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	40250513          	addi	a0,a0,1026 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	60668693          	addi	a3,a3,1542 # ffffffffc0206010 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	eee60613          	addi	a2,a2,-274 # ffffffffc0205900 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	3e250513          	addi	a0,a0,994 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	8c668693          	addi	a3,a3,-1850 # ffffffffc02062f0 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	ece60613          	addi	a2,a2,-306 # ffffffffc0205900 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	3c250513          	addi	a0,a0,962 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00004697          	auipc	a3,0x4
ffffffffc0202a4e:	86e68693          	addi	a3,a3,-1938 # ffffffffc02062b8 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	eae60613          	addi	a2,a2,-338 # ffffffffc0205900 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	3a250513          	addi	a0,a0,930 # ffffffffc0205e00 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00004697          	auipc	a3,0x4
ffffffffc0202a6e:	81e68693          	addi	a3,a3,-2018 # ffffffffc0206288 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	e8e60613          	addi	a2,a2,-370 # ffffffffc0205900 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	38250513          	addi	a0,a0,898 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	84868693          	addi	a3,a3,-1976 # ffffffffc0206338 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	e0860613          	addi	a2,a2,-504 # ffffffffc0205900 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	2fc50513          	addi	a0,a0,764 # ffffffffc0205e00 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	26e60613          	addi	a2,a2,622 # ffffffffc0205db8 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	1ba50513          	addi	a0,a0,442 # ffffffffc0205d10 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202bde:	7a650513          	addi	a0,a0,1958 # ffffffffc0206380 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	76c50513          	addi	a0,a0,1900 # ffffffffc0206398 <default_pmm_manager+0x6e8>
ffffffffc0202c34:	d4cfd0ef          	jal	ra,ffffffffc0200180 <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc0202c38:	44b000ef          	jal	ra,ffffffffc0203882 <mm_create>
...
ffffffffc0202c70:	45b000ef          	jal	ra,ffffffffc02038ca <vma_create>
...
ffffffffc0202c7c:	4bd000ef          	jal	ra,ffffffffc0203938 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202c80:	00003517          	auipc	a0,0x3
ffffffffc0202c84:	78850513          	addi	a0,a0,1928 # ffffffffc0206408 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	7bc50513          	addi	a0,a0,1980 # ffffffffc0206458 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	7d050513          	addi	a0,a0,2000 # ffffffffc02064e0 <default_pmm_manager+0x830>
...
ffffffffc0202e2c:	23060613          	addi	a2,a2,560 # ffffffffc0207058 <nbase>
...
ffffffffc0202e58:	73450513          	addi	a0,a0,1844 # ffffffffc0206588 <default_pmm_manager+0x8d8>
...
ffffffffc0202e88:	381000ef          	jal	ra,ffffffffc0203a08 <mm_destroy>
...
ffffffffc0202f2c:	6b050513          	addi	a0,a0,1712 # ffffffffc02065d8 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	9b668693          	addi	a3,a3,-1610 # ffffffffc02058f0 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	9be60613          	addi	a2,a2,-1602 # ffffffffc0205900 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	42250513          	addi	a0,a0,1058 # ffffffffc0206370 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	e5a60613          	addi	a2,a2,-422 # ffffffffc0205db8 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	da650513          	addi	a0,a0,-602 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	5ea68693          	addi	a3,a3,1514 # ffffffffc0206560 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	98260613          	addi	a2,a2,-1662 # ffffffffc0205900 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	3e650513          	addi	a0,a0,998 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	4ea68693          	addi	a3,a3,1258 # ffffffffc0206480 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	96260613          	addi	a2,a2,-1694 # ffffffffc0205900 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	3c650513          	addi	a0,a0,966 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	39a60613          	addi	a2,a2,922 # ffffffffc0206350 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	3ae50513          	addi	a0,a0,942 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	57a68693          	addi	a3,a3,1402 # ffffffffc0206548 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	92a60613          	addi	a2,a2,-1750 # ffffffffc0205900 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	38e50513          	addi	a0,a0,910 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	dea60613          	addi	a2,a2,-534 # ffffffffc0205dd8 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	d1650513          	addi	a0,a0,-746 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	49268693          	addi	a3,a3,1170 # ffffffffc0206498 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	8f260613          	addi	a2,a2,-1806 # ffffffffc0205900 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	35650513          	addi	a0,a0,854 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	3aa68693          	addi	a3,a3,938 # ffffffffc02063d0 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	8d260613          	addi	a2,a2,-1838 # ffffffffc0205900 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	33650513          	addi	a0,a0,822 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	8ea68693          	addi	a3,a3,-1814 # ffffffffc0205930 <commands+0x768>
ffffffffc020304e:	00003617          	auipc	a2,0x3
ffffffffc0203052:	8b260613          	addi	a2,a2,-1870 # ffffffffc0205900 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	31650513          	addi	a0,a0,790 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	a7268693          	addi	a3,a3,-1422 # ffffffffc0205ad8 <commands+0x910>
ffffffffc020306e:	00003617          	auipc	a2,0x3
ffffffffc0203072:	89260613          	addi	a2,a2,-1902 # ffffffffc0205900 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	2f650513          	addi	a0,a0,758 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	36268693          	addi	a3,a3,866 # ffffffffc02063e8 <default_pmm_manager+0x738>
ffffffffc020308e:	00003617          	auipc	a2,0x3
ffffffffc0203092:	87260613          	addi	a2,a2,-1934 # ffffffffc0205900 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	2d650513          	addi	a0,a0,726 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	31a68693          	addi	a3,a3,794 # ffffffffc02063c0 <default_pmm_manager+0x710>
ffffffffc02030ae:	00003617          	auipc	a2,0x3
ffffffffc02030b2:	85260613          	addi	a2,a2,-1966 # ffffffffc0205900 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	2b650513          	addi	a0,a0,694 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	50268693          	addi	a3,a3,1282 # ffffffffc02065c8 <default_pmm_manager+0x918>
ffffffffc02030ce:	00003617          	auipc	a2,0x3
ffffffffc02030d2:	83260613          	addi	a2,a2,-1998 # ffffffffc0205900 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	29650513          	addi	a0,a0,662 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	c0260613          	addi	a2,a2,-1022 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	c1e50513          	addi	a0,a0,-994 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	4ba68693          	addi	a3,a3,1210 # ffffffffc02065b8 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	7fa60613          	addi	a2,a2,2042 # ffffffffc0205900 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	25e50513          	addi	a0,a0,606 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	3ea68693          	addi	a3,a3,1002 # ffffffffc0206508 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	7da60613          	addi	a2,a2,2010 # ffffffffc0205900 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	23e50513          	addi	a0,a0,574 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	37a68693          	addi	a3,a3,890 # ffffffffc02064b8 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	7ba60613          	addi	a2,a2,1978 # ffffffffc0205900 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	21e50513          	addi	a0,a0,542 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	2e268693          	addi	a3,a3,738 # ffffffffc0206440 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	79a60613          	addi	a2,a2,1946 # ffffffffc0205900 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	1fe50513          	addi	a0,a0,510 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	43268693          	addi	a3,a3,1074 # ffffffffc02065b0 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	77a60613          	addi	a2,a2,1914 # ffffffffc0205900 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	1de50513          	addi	a0,a0,478 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	25a68693          	addi	a3,a3,602 # ffffffffc02063f8 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	75a60613          	addi	a2,a2,1882 # ffffffffc0205900 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	1be50513          	addi	a0,a0,446 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	37a68693          	addi	a3,a3,890 # ffffffffc0206538 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	73a60613          	addi	a2,a2,1850 # ffffffffc0205900 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	19e50513          	addi	a0,a0,414 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	35a68693          	addi	a3,a3,858 # ffffffffc0206538 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	71a60613          	addi	a2,a2,1818 # ffffffffc0205900 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	17e50513          	addi	a0,a0,382 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	31a68693          	addi	a3,a3,794 # ffffffffc0206518 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	6fa60613          	addi	a2,a2,1786 # ffffffffc0205900 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	15e50513          	addi	a0,a0,350 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	2fa68693          	addi	a3,a3,762 # ffffffffc0206518 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	6da60613          	addi	a2,a2,1754 # ffffffffc0205900 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	13e50513          	addi	a0,a0,318 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	2ea68693          	addi	a3,a3,746 # ffffffffc0206528 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	6ba60613          	addi	a2,a2,1722 # ffffffffc0205900 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	11e50513          	addi	a0,a0,286 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	2ca68693          	addi	a3,a3,714 # ffffffffc0206528 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	69a60613          	addi	a2,a2,1690 # ffffffffc0205900 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	0fe50513          	addi	a0,a0,254 # ffffffffc0206370 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	28a68693          	addi	a3,a3,650 # ffffffffc0206508 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	67a60613          	addi	a2,a2,1658 # ffffffffc0205900 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	0de50513          	addi	a0,a0,222 # ffffffffc0206370 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	37ab0b13          	addi	s6,s6,890 # ffffffffc0206658 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	35ab8b93          	addi	s7,s7,858 # ffffffffc0206640 <default_pmm_manager+0x990>
...
ffffffffc020339c:	26050513          	addi	a0,a0,608 # ffffffffc02065f8 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	27e68693          	addi	a3,a3,638 # ffffffffc0206628 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	54e60613          	addi	a2,a2,1358 # ffffffffc0205900 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	fb250513          	addi	a0,a0,-78 # ffffffffc0206370 <default_pmm_manager+0x6c0>
...
ffffffffc0203406:	2a650513          	addi	a0,a0,678 # ffffffffc02066a8 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	27468693          	addi	a3,a3,628 # ffffffffc0206698 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	4d460613          	addi	a2,a2,1236 # ffffffffc0205900 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	f3850513          	addi	a0,a0,-200 # ffffffffc0206370 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	28050513          	addi	a0,a0,640 # ffffffffc02066e8 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	28a50513          	addi	a0,a0,650 # ffffffffc0206728 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	28e50513          	addi	a0,a0,654 # ffffffffc0206750 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	29850513          	addi	a0,a0,664 # ffffffffc0206778 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	2a450513          	addi	a0,a0,676 # ffffffffc02067a0 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	25e50513          	addi	a0,a0,606 # ffffffffc0206778 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	1f650513          	addi	a0,a0,502 # ffffffffc0206728 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	22c50513          	addi	a0,a0,556 # ffffffffc0206778 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	18250513          	addi	a0,a0,386 # ffffffffc02066e8 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	1d050513          	addi	a0,a0,464 # ffffffffc0206750 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	20650513          	addi	a0,a0,518 # ffffffffc02067a0 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	17050513          	addi	a0,a0,368 # ffffffffc0206728 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	f4268693          	addi	a3,a3,-190 # ffffffffc0206538 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	30260613          	addi	a2,a2,770 # ffffffffc0205900 <commands+0x738>
ffffffffc0203606:	05500593          	li	a1,85
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	10650513          	addi	a0,a0,262 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	23a68693          	addi	a3,a3,570 # ffffffffc0206850 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	2e260613          	addi	a2,a2,738 # ffffffffc0205900 <commands+0x738>
ffffffffc0203626:	07700593          	li	a1,119
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	0e650513          	addi	a0,a0,230 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	1f268693          	addi	a3,a3,498 # ffffffffc0206828 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	2c260613          	addi	a2,a2,706 # ffffffffc0205900 <commands+0x738>
ffffffffc0203646:	07500593          	li	a1,117
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	0c650513          	addi	a0,a0,198 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	1c268693          	addi	a3,a3,450 # ffffffffc0206818 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	2a260613          	addi	a2,a2,674 # ffffffffc0205900 <commands+0x738>
ffffffffc0203666:	07300593          	li	a1,115
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	0a650513          	addi	a0,a0,166 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	19268693          	addi	a3,a3,402 # ffffffffc0206808 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	28260613          	addi	a2,a2,642 # ffffffffc0205900 <commands+0x738>
ffffffffc0203686:	07000593          	li	a1,112
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	08650513          	addi	a0,a0,134 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	16268693          	addi	a3,a3,354 # ffffffffc02067f8 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	26260613          	addi	a2,a2,610 # ffffffffc0205900 <commands+0x738>
ffffffffc02036a6:	06d00593          	li	a1,109
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	06650513          	addi	a0,a0,102 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	13268693          	addi	a3,a3,306 # ffffffffc02067e8 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	24260613          	addi	a2,a2,578 # ffffffffc0205900 <commands+0x738>
ffffffffc02036c6:	06a00593          	li	a1,106
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	04650513          	addi	a0,a0,70 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	10268693          	addi	a3,a3,258 # ffffffffc02067d8 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	22260613          	addi	a2,a2,546 # ffffffffc0205900 <commands+0x738>
ffffffffc02036e6:	06700593          	li	a1,103
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	02650513          	addi	a0,a0,38 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	0d268693          	addi	a3,a3,210 # ffffffffc02067c8 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	20260613          	addi	a2,a2,514 # ffffffffc0205900 <commands+0x738>
ffffffffc0203706:	06400593          	li	a1,100
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	00650513          	addi	a0,a0,6 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	0b268693          	addi	a3,a3,178 # ffffffffc02067c8 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	1e260613          	addi	a2,a2,482 # ffffffffc0205900 <commands+0x738>
ffffffffc0203726:	06100593          	li	a1,97
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	fe650513          	addi	a0,a0,-26 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	e0268693          	addi	a3,a3,-510 # ffffffffc0206538 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	1c260613          	addi	a2,a2,450 # ffffffffc0205900 <commands+0x738>
ffffffffc0203746:	05e00593          	li	a1,94
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	fc650513          	addi	a0,a0,-58 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	de268693          	addi	a3,a3,-542 # ffffffffc0206538 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	1a260613          	addi	a2,a2,418 # ffffffffc0205900 <commands+0x738>
ffffffffc0203766:	05b00593          	li	a1,91
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	fa650513          	addi	a0,a0,-90 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	dc268693          	addi	a3,a3,-574 # ffffffffc0206538 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	18260613          	addi	a2,a2,386 # ffffffffc0205900 <commands+0x738>
ffffffffc0203786:	05800593          	li	a1,88
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	f8650513          	addi	a0,a0,-122 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203792:	cb5fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0203796 <_fifo_swap_out_victim>:
{
ffffffffc0203796:	1101                	addi	sp,sp,-32
ffffffffc0203798:	e822                	sd	s0,16(sp)
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc020379a:	7500                	ld	s0,40(a0)
{
ffffffffc020379c:	ec06                	sd	ra,24(sp)
ffffffffc020379e:	e426                	sd	s1,8(sp)
         assert(head != NULL);
ffffffffc02037a0:	c035                	beqz	s0,ffffffffc0203804 <_fifo_swap_out_victim+0x6e>
     assert(in_tick==0);
ffffffffc02037a2:	e229                	bnez	a2,ffffffffc02037e4 <_fifo_swap_out_victim+0x4e>
    cprintf("curr_ptr 0xffffffff%x\n",head->prev);
ffffffffc02037a4:	84ae                	mv	s1,a1
ffffffffc02037a6:	600c                	ld	a1,0(s0)
ffffffffc02037a8:	00003517          	auipc	a0,0x3
ffffffffc02037ac:	0d850513          	addi	a0,a0,216 # ffffffffc0206880 <default_pmm_manager+0xbd0>
ffffffffc02037b0:	9d1fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return listelm->prev;
ffffffffc02037b4:	601c                	ld	a5,0(s0)
    if (entry != head) {
ffffffffc02037b6:	00f40f63          	beq	s0,a5,ffffffffc02037d4 <_fifo_swap_out_victim+0x3e>
    __list_del(listelm->prev, listelm->next);
ffffffffc02037ba:	6394                	ld	a3,0(a5)
ffffffffc02037bc:	6798                	ld	a4,8(a5)
}
ffffffffc02037be:	60e2                	ld	ra,24(sp)
ffffffffc02037c0:	6442                	ld	s0,16(sp)
    prev->next = next;
ffffffffc02037c2:	e698                	sd	a4,8(a3)
    next->prev = prev;
ffffffffc02037c4:	e314                	sd	a3,0(a4)
        *ptr_page = le2page(entry, pra_page_link);
ffffffffc02037c6:	fd878793          	addi	a5,a5,-40
ffffffffc02037ca:	e09c                	sd	a5,0(s1)
}
ffffffffc02037cc:	4501                	li	a0,0
ffffffffc02037ce:	64a2                	ld	s1,8(sp)
ffffffffc02037d0:	6105                	addi	sp,sp,32
ffffffffc02037d2:	8082                	ret
ffffffffc02037d4:	60e2                	ld	ra,24(sp)
ffffffffc02037d6:	6442                	ld	s0,16(sp)
        *ptr_page = NULL;
ffffffffc02037d8:	0004b023          	sd	zero,0(s1)
}
ffffffffc02037dc:	4501                	li	a0,0
ffffffffc02037de:	64a2                	ld	s1,8(sp)
ffffffffc02037e0:	6105                	addi	sp,sp,32
ffffffffc02037e2:	8082                	ret
     assert(in_tick==0);
ffffffffc02037e4:	00003697          	auipc	a3,0x3
ffffffffc02037e8:	08c68693          	addi	a3,a3,140 # ffffffffc0206870 <default_pmm_manager+0xbc0>
ffffffffc02037ec:	00002617          	auipc	a2,0x2
ffffffffc02037f0:	11460613          	addi	a2,a2,276 # ffffffffc0205900 <commands+0x738>
ffffffffc02037f4:	04200593          	li	a1,66
ffffffffc02037f8:	00003517          	auipc	a0,0x3
ffffffffc02037fc:	f1850513          	addi	a0,a0,-232 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203800:	c47fc0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(head != NULL);
ffffffffc0203804:	00003697          	auipc	a3,0x3
ffffffffc0203808:	05c68693          	addi	a3,a3,92 # ffffffffc0206860 <default_pmm_manager+0xbb0>
ffffffffc020380c:	00002617          	auipc	a2,0x2
ffffffffc0203810:	0f460613          	addi	a2,a2,244 # ffffffffc0205900 <commands+0x738>
ffffffffc0203814:	04100593          	li	a1,65
ffffffffc0203818:	00003517          	auipc	a0,0x3
ffffffffc020381c:	ef850513          	addi	a0,a0,-264 # ffffffffc0206710 <default_pmm_manager+0xa60>
ffffffffc0203820:	c27fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0203824 <_fifo_map_swappable>:
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203824:	751c                	ld	a5,40(a0)
    assert(entry != NULL && head != NULL);
ffffffffc0203826:	cb91                	beqz	a5,ffffffffc020383a <_fifo_map_swappable+0x16>
    __list_add(elm, listelm, listelm->next);
ffffffffc0203828:	6794                	ld	a3,8(a5)
ffffffffc020382a:	02860713          	addi	a4,a2,40
}
ffffffffc020382e:	4501                	li	a0,0
    prev->next = next->prev = elm;
ffffffffc0203830:	e298                	sd	a4,0(a3)
ffffffffc0203832:	e798                	sd	a4,8(a5)
    elm->next = next;
ffffffffc0203834:	fa14                	sd	a3,48(a2)
    elm->prev = prev;
ffffffffc0203836:	f61c                	sd	a5,40(a2)
ffffffffc0203838:	8082                	ret
{
ffffffffc020383a:	1141                	addi	sp,sp,-16
    assert(entry != NULL && head != NULL);
ffffffffc020383c:	00003697          	auipc	a3,0x3
ffffffffc0203840:	05c68693          	addi	a3,a3,92 # ffffffffc0206898 <default_pmm_manager+0xbe8>
ffffffffc0203844:	00002617          	auipc	a2,0x2
ffffffffc0203848:	0bc60613          	addi	a2,a2,188 # ffffffffc0205900 <commands+0x738>
ffffffffc020384c:	03200593          	li	a1,50
ffffffffc0203850:	00003517          	auipc	a0,0x3
ffffffffc0203854:	ec050513          	addi	a0,a0,-320 # ffffffffc0206710 <default_pmm_manager+0xa60>
{
ffffffffc0203858:	e406                	sd	ra,8(sp)
    assert(entry != NULL && head != NULL);
ffffffffc020385a:	bedfc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020385e <check_vma_overlap.part.0>:
}
...
ffffffffc020385e:	1141                	addi	sp,sp,-16
    assert(prev->vm_start < prev->vm_end);
    assert(prev->vm_end <= next->vm_start);
    assert(next->vm_start < next->vm_end);
ffffffffc0203860:	00003697          	auipc	a3,0x3
ffffffffc0203864:	07068693          	addi	a3,a3,112 # ffffffffc02068d0 <default_pmm_manager+0xc20>
ffffffffc0203868:	00002617          	auipc	a2,0x2
ffffffffc020386c:	09860613          	addi	a2,a2,152 # ffffffffc0205900 <commands+0x738>
ffffffffc0203870:	07e00593          	li	a1,126
ffffffffc0203874:	00003517          	auipc	a0,0x3
ffffffffc0203878:	07c50513          	addi	a0,a0,124 # ffffffffc02068f0 <default_pmm_manager+0xc40>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc020387c:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc020387e:	bc9fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0203882 <mm_create>:
mm_create(void) {
ffffffffc0203882:	1141                	addi	sp,sp,-16
...
ffffffffc020388a:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020388c:	fc3fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203890:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203892:	c105                	beqz	a0,ffffffffc02038b2 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc0203894:	e408                	sd	a0,8(s0)
ffffffffc0203896:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc0203898:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020389c:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02038a0:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038a4:	00013797          	auipc	a5,0x13
ffffffffc02038a8:	cf47a783          	lw	a5,-780(a5) # ffffffffc0216598 <swap_init_ok>
ffffffffc02038ac:	eb81                	bnez	a5,ffffffffc02038bc <mm_create+0x3a>
...
ffffffffc02038ba:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038bc:	9e3ff0ef          	jal	ra,ffffffffc020329e <swap_init_mm>
}
ffffffffc02038c0:	60a2                	ld	ra,8(sp)
...
ffffffffc02038dc:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038de:	f71fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    if (vma != NULL) {
...
ffffffffc02038f8:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc02038fa:	c505                	beqz	a0,ffffffffc0203922 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc02038fc:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02038fe:	c501                	beqz	a0,ffffffffc0203906 <find_vma+0xe>
ffffffffc0203900:	651c                	ld	a5,8(a0)
ffffffffc0203902:	02f5f263          	bgeu	a1,a5,ffffffffc0203926 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203906:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc0203908:	00f68d63          	beq	a3,a5,ffffffffc0203922 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc020390c:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203910:	00e5e663          	bltu	a1,a4,ffffffffc020391c <find_vma+0x24>
ffffffffc0203914:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203918:	00e5ec63          	bltu	a1,a4,ffffffffc0203930 <find_vma+0x38>
ffffffffc020391c:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc020391e:	fef697e3          	bne	a3,a5,ffffffffc020390c <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203922:	4501                	li	a0,0
}
ffffffffc0203924:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203926:	691c                	ld	a5,16(a0)
ffffffffc0203928:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203906 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc020392c:	ea88                	sd	a0,16(a3)
ffffffffc020392e:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203930:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203934:	ea88                	sd	a0,16(a3)
ffffffffc0203936:	8082                	ret

ffffffffc0203938 <insert_vma_struct>:
...
ffffffffc0203938:	6590                	ld	a2,8(a1)
ffffffffc020393a:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc020393e:	1141                	addi	sp,sp,-16
ffffffffc0203940:	e406                	sd	ra,8(sp)
ffffffffc0203942:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203944:	01066763          	bltu	a2,a6,ffffffffc0203952 <insert_vma_struct+0x1a>
ffffffffc0203948:	a085                	j	ffffffffc02039a8 <insert_vma_struct+0x70>
...
ffffffffc020394e:	04e66863          	bltu	a2,a4,ffffffffc020399e <insert_vma_struct+0x66>
ffffffffc0203952:	86be                	mv	a3,a5
ffffffffc0203954:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0203956:	fef51ae3          	bne	a0,a5,ffffffffc020394a <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc020395a:	02a68463          	beq	a3,a0,ffffffffc0203982 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc020395e:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203962:	fe86b883          	ld	a7,-24(a3)
ffffffffc0203966:	08e8f163          	bgeu	a7,a4,ffffffffc02039e8 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020396a:	04e66f63          	bltu	a2,a4,ffffffffc02039c8 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc020396e:	00f50a63          	beq	a0,a5,ffffffffc0203982 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc0203972:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203976:	05076963          	bltu	a4,a6,ffffffffc02039c8 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc020397a:	ff07b603          	ld	a2,-16(a5)
ffffffffc020397e:	02c77363          	bgeu	a4,a2,ffffffffc02039a4 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc0203982:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc0203984:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc0203986:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc020398a:	e390                	sd	a2,0(a5)
ffffffffc020398c:	e690                	sd	a2,8(a3)
}
ffffffffc020398e:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc0203990:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203992:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc0203994:	0017079b          	addiw	a5,a4,1
ffffffffc0203998:	d11c                	sw	a5,32(a0)
}
ffffffffc020399a:	0141                	addi	sp,sp,16
ffffffffc020399c:	8082                	ret
    if (le_prev != list) {
ffffffffc020399e:	fca690e3          	bne	a3,a0,ffffffffc020395e <insert_vma_struct+0x26>
ffffffffc02039a2:	bfd1                	j	ffffffffc0203976 <insert_vma_struct+0x3e>
ffffffffc02039a4:	ebbff0ef          	jal	ra,ffffffffc020385e <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02039a8:	00003697          	auipc	a3,0x3
ffffffffc02039ac:	f5868693          	addi	a3,a3,-168 # ffffffffc0206900 <default_pmm_manager+0xc50>
ffffffffc02039b0:	00002617          	auipc	a2,0x2
ffffffffc02039b4:	f5060613          	addi	a2,a2,-176 # ffffffffc0205900 <commands+0x738>
ffffffffc02039b8:	08500593          	li	a1,133
ffffffffc02039bc:	00003517          	auipc	a0,0x3
ffffffffc02039c0:	f3450513          	addi	a0,a0,-204 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc02039c4:	a83fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02039c8:	00003697          	auipc	a3,0x3
ffffffffc02039cc:	f7868693          	addi	a3,a3,-136 # ffffffffc0206940 <default_pmm_manager+0xc90>
ffffffffc02039d0:	00002617          	auipc	a2,0x2
ffffffffc02039d4:	f3060613          	addi	a2,a2,-208 # ffffffffc0205900 <commands+0x738>
ffffffffc02039d8:	07d00593          	li	a1,125
ffffffffc02039dc:	00003517          	auipc	a0,0x3
ffffffffc02039e0:	f1450513          	addi	a0,a0,-236 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc02039e4:	a63fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039e8:	00003697          	auipc	a3,0x3
ffffffffc02039ec:	f3868693          	addi	a3,a3,-200 # ffffffffc0206920 <default_pmm_manager+0xc70>
ffffffffc02039f0:	00002617          	auipc	a2,0x2
ffffffffc02039f4:	f1060613          	addi	a2,a2,-240 # ffffffffc0205900 <commands+0x738>
ffffffffc02039f8:	07c00593          	li	a1,124
ffffffffc02039fc:	00003517          	auipc	a0,0x3
ffffffffc0203a00:	ef450513          	addi	a0,a0,-268 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203a04:	a43fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0203a08 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc0203a08:	1141                	addi	sp,sp,-16
ffffffffc0203a0a:	e022                	sd	s0,0(sp)
...
ffffffffc0203a12:	00a40c63          	beq	s0,a0,ffffffffc0203a2a <mm_destroy+0x22>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203a16:	6118                	ld	a4,0(a0)
ffffffffc0203a18:	651c                	ld	a5,8(a0)
        list_del(le);
...
ffffffffc0203a20:	edffd0ef          	jal	ra,ffffffffc02018fe <kfree>
    return listelm->next;
ffffffffc0203a24:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a26:	fea418e3          	bne	s0,a0,ffffffffc0203a16 <mm_destroy+0xe>
    }
    kfree(mm); //kfree mm
...
ffffffffc0203a2e:	60a2                	ld	ra,8(sp)
ffffffffc0203a30:	0141                	addi	sp,sp,16
    kfree(mm); //kfree mm
ffffffffc0203a32:	ecdfd06f          	j	ffffffffc02018fe <kfree>

ffffffffc0203a36 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203a36:	7139                	addi	sp,sp,-64
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203a38:	03000513          	li	a0,48
vmm_init(void) {
ffffffffc0203a3c:	fc06                	sd	ra,56(sp)
ffffffffc0203a3e:	f822                	sd	s0,48(sp)
ffffffffc0203a40:	f426                	sd	s1,40(sp)
...
ffffffffc0203a48:	e456                	sd	s5,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203a4a:	e05fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    if (mm != NULL) {
ffffffffc0203a4e:	58050e63          	beqz	a0,ffffffffc0203fea <vmm_init+0x5b4>
    elm->prev = elm->next = elm;
ffffffffc0203a52:	e508                	sd	a0,8(a0)
ffffffffc0203a54:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203a56:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203a5a:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203a5e:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a62:	00013797          	auipc	a5,0x13
ffffffffc0203a66:	b367a783          	lw	a5,-1226(a5) # ffffffffc0216598 <swap_init_ok>
ffffffffc0203a6a:	84aa                	mv	s1,a0
ffffffffc0203a6c:	e7b9                	bnez	a5,ffffffffc0203aba <vmm_init+0x84>
        else mm->sm_priv = NULL;
ffffffffc0203a6e:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc0203a72:	03200413          	li	s0,50
ffffffffc0203a76:	a811                	j	ffffffffc0203a8a <vmm_init+0x54>
        vma->vm_start = vm_start;
ffffffffc0203a78:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
...
ffffffffc0203a7c:	00052c23          	sw	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc0203a80:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203a82:	8526                	mv	a0,s1
ffffffffc0203a84:	eb5ff0ef          	jal	ra,ffffffffc0203938 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203a88:	cc05                	beqz	s0,ffffffffc0203ac0 <vmm_init+0x8a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203a8a:	03000513          	li	a0,48
ffffffffc0203a8e:	dc1fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203a92:	85aa                	mv	a1,a0
ffffffffc0203a94:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203a98:	f165                	bnez	a0,ffffffffc0203a78 <vmm_init+0x42>
        assert(vma != NULL);
ffffffffc0203a9a:	00003697          	auipc	a3,0x3
ffffffffc0203a9e:	95e68693          	addi	a3,a3,-1698 # ffffffffc02063f8 <default_pmm_manager+0x748>
ffffffffc0203aa2:	00002617          	auipc	a2,0x2
ffffffffc0203aa6:	e5e60613          	addi	a2,a2,-418 # ffffffffc0205900 <commands+0x738>
ffffffffc0203aaa:	0c900593          	li	a1,201
ffffffffc0203aae:	00003517          	auipc	a0,0x3
ffffffffc0203ab2:	e4250513          	addi	a0,a0,-446 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203ab6:	991fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203aba:	fe4ff0ef          	jal	ra,ffffffffc020329e <swap_init_mm>
ffffffffc0203abe:	bf55                	j	ffffffffc0203a72 <vmm_init+0x3c>
ffffffffc0203ac0:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203ac4:	1f900913          	li	s2,505
ffffffffc0203ac8:	a819                	j	ffffffffc0203ade <vmm_init+0xa8>
        vma->vm_start = vm_start;
...
ffffffffc0203ad6:	e63ff0ef          	jal	ra,ffffffffc0203938 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203ada:	03240a63          	beq	s0,s2,ffffffffc0203b0e <vmm_init+0xd8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203ade:	03000513          	li	a0,48
ffffffffc0203ae2:	d6dfd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203ae6:	85aa                	mv	a1,a0
ffffffffc0203ae8:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203aec:	fd79                	bnez	a0,ffffffffc0203aca <vmm_init+0x94>
        assert(vma != NULL);
ffffffffc0203aee:	00003697          	auipc	a3,0x3
ffffffffc0203af2:	90a68693          	addi	a3,a3,-1782 # ffffffffc02063f8 <default_pmm_manager+0x748>
ffffffffc0203af6:	00002617          	auipc	a2,0x2
ffffffffc0203afa:	e0a60613          	addi	a2,a2,-502 # ffffffffc0205900 <commands+0x738>
ffffffffc0203afe:	0cf00593          	li	a1,207
ffffffffc0203b02:	00003517          	auipc	a0,0x3
ffffffffc0203b06:	dee50513          	addi	a0,a0,-530 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203b0a:	93dfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return listelm->next;
...
ffffffffc0203b16:	30f48e63          	beq	s1,a5,ffffffffc0203e32 <vmm_init+0x3fc>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203b1a:	fe87b683          	ld	a3,-24(a5)
ffffffffc0203b1e:	ffe70613          	addi	a2,a4,-2
ffffffffc0203b22:	2ad61863          	bne	a2,a3,ffffffffc0203dd2 <vmm_init+0x39c>
ffffffffc0203b26:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203b2a:	2ae69463          	bne	a3,a4,ffffffffc0203dd2 <vmm_init+0x39c>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203b2e:	0715                	addi	a4,a4,5
ffffffffc0203b30:	679c                	ld	a5,8(a5)
ffffffffc0203b32:	feb712e3          	bne	a4,a1,ffffffffc0203b16 <vmm_init+0xe0>
...
ffffffffc0203b42:	db7ff0ef          	jal	ra,ffffffffc02038f8 <find_vma>
ffffffffc0203b46:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203b48:	34050563          	beqz	a0,ffffffffc0203e92 <vmm_init+0x45c>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203b4c:	00140593          	addi	a1,s0,1
ffffffffc0203b50:	8526                	mv	a0,s1
ffffffffc0203b52:	da7ff0ef          	jal	ra,ffffffffc02038f8 <find_vma>
ffffffffc0203b56:	89aa                	mv	s3,a0
        assert(vma2 != NULL);
ffffffffc0203b58:	34050d63          	beqz	a0,ffffffffc0203eb2 <vmm_init+0x47c>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203b5c:	85d2                	mv	a1,s4
ffffffffc0203b5e:	8526                	mv	a0,s1
ffffffffc0203b60:	d99ff0ef          	jal	ra,ffffffffc02038f8 <find_vma>
        assert(vma3 == NULL);
ffffffffc0203b64:	36051763          	bnez	a0,ffffffffc0203ed2 <vmm_init+0x49c>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203b68:	00340593          	addi	a1,s0,3
ffffffffc0203b6c:	8526                	mv	a0,s1
ffffffffc0203b6e:	d8bff0ef          	jal	ra,ffffffffc02038f8 <find_vma>
        assert(vma4 == NULL);
ffffffffc0203b72:	2e051063          	bnez	a0,ffffffffc0203e52 <vmm_init+0x41c>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc0203b76:	00440593          	addi	a1,s0,4
ffffffffc0203b7a:	8526                	mv	a0,s1
ffffffffc0203b7c:	d7dff0ef          	jal	ra,ffffffffc02038f8 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203b80:	2e051963          	bnez	a0,ffffffffc0203e72 <vmm_init+0x43c>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203b84:	00893783          	ld	a5,8(s2)
ffffffffc0203b88:	26879563          	bne	a5,s0,ffffffffc0203df2 <vmm_init+0x3bc>
ffffffffc0203b8c:	01093783          	ld	a5,16(s2)
ffffffffc0203b90:	27479163          	bne	a5,s4,ffffffffc0203df2 <vmm_init+0x3bc>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203b94:	0089b783          	ld	a5,8(s3)
ffffffffc0203b98:	26879d63          	bne	a5,s0,ffffffffc0203e12 <vmm_init+0x3dc>
ffffffffc0203b9c:	0109b783          	ld	a5,16(s3)
ffffffffc0203ba0:	27479963          	bne	a5,s4,ffffffffc0203e12 <vmm_init+0x3dc>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203ba4:	0415                	addi	s0,s0,5
ffffffffc0203ba6:	0a15                	addi	s4,s4,5
ffffffffc0203ba8:	f9541be3          	bne	s0,s5,ffffffffc0203b3e <vmm_init+0x108>
...
ffffffffc0203bb4:	d45ff0ef          	jal	ra,ffffffffc02038f8 <find_vma>
ffffffffc0203bb8:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203bbc:	c90d                	beqz	a0,ffffffffc0203bee <vmm_init+0x1b8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203bbe:	6914                	ld	a3,16(a0)
ffffffffc0203bc0:	6510                	ld	a2,8(a0)
ffffffffc0203bc2:	00003517          	auipc	a0,0x3
ffffffffc0203bc6:	e9e50513          	addi	a0,a0,-354 # ffffffffc0206a60 <default_pmm_manager+0xdb0>
ffffffffc0203bca:	db6fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203bce:	00003697          	auipc	a3,0x3
ffffffffc0203bd2:	eba68693          	addi	a3,a3,-326 # ffffffffc0206a88 <default_pmm_manager+0xdd8>
ffffffffc0203bd6:	00002617          	auipc	a2,0x2
ffffffffc0203bda:	d2a60613          	addi	a2,a2,-726 # ffffffffc0205900 <commands+0x738>
ffffffffc0203bde:	0f100593          	li	a1,241
ffffffffc0203be2:	00003517          	auipc	a0,0x3
ffffffffc0203be6:	d0e50513          	addi	a0,a0,-754 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203bea:	85dfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203bee:	147d                	addi	s0,s0,-1
ffffffffc0203bf0:	fd2410e3          	bne	s0,s2,ffffffffc0203bb0 <vmm_init+0x17a>
ffffffffc0203bf4:	a801                	j	ffffffffc0203c04 <vmm_init+0x1ce>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203bf6:	6118                	ld	a4,0(a0)
ffffffffc0203bf8:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link));  //kfree vma        
ffffffffc0203bfa:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203bfc:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203bfe:	e398                	sd	a4,0(a5)
ffffffffc0203c00:	cfffd0ef          	jal	ra,ffffffffc02018fe <kfree>
    return listelm->next;
ffffffffc0203c04:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203c06:	fea498e3          	bne	s1,a0,ffffffffc0203bf6 <vmm_init+0x1c0>
    kfree(mm); //kfree mm
ffffffffc0203c0a:	8526                	mv	a0,s1
ffffffffc0203c0c:	cf3fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    }
...
ffffffffc0203c14:	e9050513          	addi	a0,a0,-368 # ffffffffc0206aa0 <default_pmm_manager+0xdf0>
ffffffffc0203c18:	d68fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
...
ffffffffc0203c1c:	ee3fd0ef          	jal	ra,ffffffffc0201afe <nr_free_pages>
ffffffffc0203c20:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203c22:	03000513          	li	a0,48
ffffffffc0203c26:	c29fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203c2a:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203c2c:	2c050363          	beqz	a0,ffffffffc0203ef2 <vmm_init+0x4bc>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203c30:	00013797          	auipc	a5,0x13
ffffffffc0203c34:	9687a783          	lw	a5,-1688(a5) # ffffffffc0216598 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc0203c38:	e508                	sd	a0,8(a0)
ffffffffc0203c3a:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203c3c:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203c40:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203c44:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203c48:	18079263          	bnez	a5,ffffffffc0203dcc <vmm_init+0x396>
        else mm->sm_priv = NULL;
ffffffffc0203c4c:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203c50:	00013917          	auipc	s2,0x13
ffffffffc0203c54:	91093903          	ld	s2,-1776(s2) # ffffffffc0216560 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203c58:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203c5c:	00013717          	auipc	a4,0x13
ffffffffc0203c60:	94873223          	sd	s0,-1724(a4) # ffffffffc02165a0 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203c64:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc0203c68:	36079163          	bnez	a5,ffffffffc0203fca <vmm_init+0x594>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203c6c:	03000513          	li	a0,48
ffffffffc0203c70:	bdffd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203c74:	89aa                	mv	s3,a0
    if (vma != NULL) {
ffffffffc0203c76:	2a050263          	beqz	a0,ffffffffc0203f1a <vmm_init+0x4e4>
        vma->vm_end = vm_end;
ffffffffc0203c7a:	002007b7          	lui	a5,0x200
ffffffffc0203c7e:	00f9b823          	sd	a5,16(s3)
        vma->vm_flags = vm_flags;
ffffffffc0203c82:	4789                	li	a5,2

    struct vma_struct *vma = vma_create(0, PTSIZE, VM_WRITE);
    assert(vma != NULL);

    insert_vma_struct(mm, vma);
ffffffffc0203c84:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc0203c86:	00f9ac23          	sw	a5,24(s3)
    insert_vma_struct(mm, vma);
ffffffffc0203c8a:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203c8c:	0009b423          	sd	zero,8(s3)
    insert_vma_struct(mm, vma);
ffffffffc0203c90:	ca9ff0ef          	jal	ra,ffffffffc0203938 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c94:	10000593          	li	a1,256
ffffffffc0203c98:	8522                	mv	a0,s0
ffffffffc0203c9a:	c5fff0ef          	jal	ra,ffffffffc02038f8 <find_vma>
ffffffffc0203c9e:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203ca2:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203ca6:	28a99a63          	bne	s3,a0,ffffffffc0203f3a <vmm_init+0x504>
        *(char *)(addr + i) = i;
ffffffffc0203caa:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203cae:	0785                	addi	a5,a5,1
ffffffffc0203cb0:	fee79de3          	bne	a5,a4,ffffffffc0203caa <vmm_init+0x274>
        sum += i;
ffffffffc0203cb4:	6705                	lui	a4,0x1
ffffffffc0203cb6:	10000793          	li	a5,256
ffffffffc0203cba:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203cbe:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203cc2:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203cc6:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203cc8:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203cca:	fec79ce3          	bne	a5,a2,ffffffffc0203cc2 <vmm_init+0x28c>
    }
    assert(sum == 0);
ffffffffc0203cce:	28071663          	bnez	a4,ffffffffc0203f5a <vmm_init+0x524>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203cd2:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203cd6:	00013a97          	auipc	s5,0x13
ffffffffc0203cda:	892a8a93          	addi	s5,s5,-1902 # ffffffffc0216568 <npage>
ffffffffc0203cde:	000ab603          	ld	a2,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203ce2:	078a                	slli	a5,a5,0x2
ffffffffc0203ce4:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203ce6:	28c7fa63          	bgeu	a5,a2,ffffffffc0203f7a <vmm_init+0x544>
    return &pages[PPN(pa) - nbase];
ffffffffc0203cea:	00003a17          	auipc	s4,0x3
ffffffffc0203cee:	36ea3a03          	ld	s4,878(s4) # ffffffffc0207058 <nbase>
ffffffffc0203cf2:	414787b3          	sub	a5,a5,s4
ffffffffc0203cf6:	079a                	slli	a5,a5,0x6
    return page - pages + nbase;
ffffffffc0203cf8:	8799                	srai	a5,a5,0x6
ffffffffc0203cfa:	97d2                	add	a5,a5,s4
    return KADDR(page2pa(page));
ffffffffc0203cfc:	00c79713          	slli	a4,a5,0xc
ffffffffc0203d00:	8331                	srli	a4,a4,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203d02:	00c79693          	slli	a3,a5,0xc
    return KADDR(page2pa(page));
ffffffffc0203d06:	28c77663          	bgeu	a4,a2,ffffffffc0203f92 <vmm_init+0x55c>
ffffffffc0203d0a:	00013997          	auipc	s3,0x13
ffffffffc0203d0e:	8769b983          	ld	s3,-1930(s3) # ffffffffc0216580 <va_pa_offset>

    pde_t *pd1=pgdir,*pd0=page2kva(pde2page(pgdir[0]));
    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203d12:	4581                	li	a1,0
ffffffffc0203d14:	854a                	mv	a0,s2
ffffffffc0203d16:	99b6                	add	s3,s3,a3
ffffffffc0203d18:	846fe0ef          	jal	ra,ffffffffc0201d5e <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203d1c:	0009b783          	ld	a5,0(s3)
    if (PPN(pa) >= npage) {
ffffffffc0203d20:	000ab703          	ld	a4,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203d24:	078a                	slli	a5,a5,0x2
ffffffffc0203d26:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203d28:	24e7f963          	bgeu	a5,a4,ffffffffc0203f7a <vmm_init+0x544>
    return &pages[PPN(pa) - nbase];
ffffffffc0203d2c:	00013997          	auipc	s3,0x13
ffffffffc0203d30:	84498993          	addi	s3,s3,-1980 # ffffffffc0216570 <pages>
ffffffffc0203d34:	0009b503          	ld	a0,0(s3)
ffffffffc0203d38:	414787b3          	sub	a5,a5,s4
ffffffffc0203d3c:	079a                	slli	a5,a5,0x6
    free_page(pde2page(pd0[0]));
ffffffffc0203d3e:	953e                	add	a0,a0,a5
ffffffffc0203d40:	4585                	li	a1,1
ffffffffc0203d42:	d7dfd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203d46:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203d4a:	000ab703          	ld	a4,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203d4e:	078a                	slli	a5,a5,0x2
ffffffffc0203d50:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203d52:	22e7f463          	bgeu	a5,a4,ffffffffc0203f7a <vmm_init+0x544>
    return &pages[PPN(pa) - nbase];
ffffffffc0203d56:	0009b503          	ld	a0,0(s3)
ffffffffc0203d5a:	414787b3          	sub	a5,a5,s4
ffffffffc0203d5e:	079a                	slli	a5,a5,0x6
    free_page(pde2page(pd1[0]));
ffffffffc0203d60:	4585                	li	a1,1
ffffffffc0203d62:	953e                	add	a0,a0,a5
ffffffffc0203d64:	d5bfd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    pgdir[0] = 0;
ffffffffc0203d68:	00093023          	sd	zero,0(s2)
  asm volatile("sfence.vma");
ffffffffc0203d6c:	12000073          	sfence.vma
    return listelm->next;
ffffffffc0203d70:	6408                	ld	a0,8(s0)
    flush_tlb();

    mm->pgdir = NULL;
ffffffffc0203d72:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203d76:	00a40c63          	beq	s0,a0,ffffffffc0203d8e <vmm_init+0x358>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203d7a:	6118                	ld	a4,0(a0)
ffffffffc0203d7c:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link));  //kfree vma        
ffffffffc0203d7e:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203d80:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203d82:	e398                	sd	a4,0(a5)
ffffffffc0203d84:	b7bfd0ef          	jal	ra,ffffffffc02018fe <kfree>
    return listelm->next;
ffffffffc0203d88:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203d8a:	fea418e3          	bne	s0,a0,ffffffffc0203d7a <vmm_init+0x344>
    kfree(mm); //kfree mm
ffffffffc0203d8e:	8522                	mv	a0,s0
ffffffffc0203d90:	b6ffd0ef          	jal	ra,ffffffffc02018fe <kfree>
    mm_destroy(mm);
    check_mm_struct = NULL;
ffffffffc0203d94:	00013797          	auipc	a5,0x13
ffffffffc0203d98:	8007b623          	sd	zero,-2036(a5) # ffffffffc02165a0 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203d9c:	d63fd0ef          	jal	ra,ffffffffc0201afe <nr_free_pages>
ffffffffc0203da0:	20a49563          	bne	s1,a0,ffffffffc0203faa <vmm_init+0x574>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203da4:	00003517          	auipc	a0,0x3
ffffffffc0203da8:	d7450513          	addi	a0,a0,-652 # ffffffffc0206b18 <default_pmm_manager+0xe68>
ffffffffc0203dac:	bd4fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
}
ffffffffc0203db0:	7442                	ld	s0,48(sp)
ffffffffc0203db2:	70e2                	ld	ra,56(sp)
ffffffffc0203db4:	74a2                	ld	s1,40(sp)
ffffffffc0203db6:	7902                	ld	s2,32(sp)
ffffffffc0203db8:	69e2                	ld	s3,24(sp)
ffffffffc0203dba:	6a42                	ld	s4,16(sp)
ffffffffc0203dbc:	6aa2                	ld	s5,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203dbe:	00003517          	auipc	a0,0x3
ffffffffc0203dc2:	d7a50513          	addi	a0,a0,-646 # ffffffffc0206b38 <default_pmm_manager+0xe88>
}
ffffffffc0203dc6:	6121                	addi	sp,sp,64
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203dc8:	bb8fc06f          	j	ffffffffc0200180 <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203dcc:	cd2ff0ef          	jal	ra,ffffffffc020329e <swap_init_mm>
ffffffffc0203dd0:	b541                	j	ffffffffc0203c50 <vmm_init+0x21a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203dd2:	00003697          	auipc	a3,0x3
ffffffffc0203dd6:	ba668693          	addi	a3,a3,-1114 # ffffffffc0206978 <default_pmm_manager+0xcc8>
ffffffffc0203dda:	00002617          	auipc	a2,0x2
ffffffffc0203dde:	b2660613          	addi	a2,a2,-1242 # ffffffffc0205900 <commands+0x738>
ffffffffc0203de2:	0d800593          	li	a1,216
ffffffffc0203de6:	00003517          	auipc	a0,0x3
ffffffffc0203dea:	b0a50513          	addi	a0,a0,-1270 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203dee:	e58fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203df2:	00003697          	auipc	a3,0x3
ffffffffc0203df6:	c0e68693          	addi	a3,a3,-1010 # ffffffffc0206a00 <default_pmm_manager+0xd50>
ffffffffc0203dfa:	00002617          	auipc	a2,0x2
ffffffffc0203dfe:	b0660613          	addi	a2,a2,-1274 # ffffffffc0205900 <commands+0x738>
ffffffffc0203e02:	0e800593          	li	a1,232
ffffffffc0203e06:	00003517          	auipc	a0,0x3
ffffffffc0203e0a:	aea50513          	addi	a0,a0,-1302 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203e0e:	e38fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203e12:	00003697          	auipc	a3,0x3
ffffffffc0203e16:	c1e68693          	addi	a3,a3,-994 # ffffffffc0206a30 <default_pmm_manager+0xd80>
ffffffffc0203e1a:	00002617          	auipc	a2,0x2
ffffffffc0203e1e:	ae660613          	addi	a2,a2,-1306 # ffffffffc0205900 <commands+0x738>
ffffffffc0203e22:	0e900593          	li	a1,233
ffffffffc0203e26:	00003517          	auipc	a0,0x3
ffffffffc0203e2a:	aca50513          	addi	a0,a0,-1334 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203e2e:	e18fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e32:	00003697          	auipc	a3,0x3
ffffffffc0203e36:	b2e68693          	addi	a3,a3,-1234 # ffffffffc0206960 <default_pmm_manager+0xcb0>
ffffffffc0203e3a:	00002617          	auipc	a2,0x2
ffffffffc0203e3e:	ac660613          	addi	a2,a2,-1338 # ffffffffc0205900 <commands+0x738>
ffffffffc0203e42:	0d600593          	li	a1,214
ffffffffc0203e46:	00003517          	auipc	a0,0x3
ffffffffc0203e4a:	aaa50513          	addi	a0,a0,-1366 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203e4e:	df8fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e52:	00003697          	auipc	a3,0x3
ffffffffc0203e56:	b8e68693          	addi	a3,a3,-1138 # ffffffffc02069e0 <default_pmm_manager+0xd30>
ffffffffc0203e5a:	00002617          	auipc	a2,0x2
ffffffffc0203e5e:	aa660613          	addi	a2,a2,-1370 # ffffffffc0205900 <commands+0x738>
ffffffffc0203e62:	0e400593          	li	a1,228
ffffffffc0203e66:	00003517          	auipc	a0,0x3
ffffffffc0203e6a:	a8a50513          	addi	a0,a0,-1398 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203e6e:	dd8fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e72:	00003697          	auipc	a3,0x3
ffffffffc0203e76:	b7e68693          	addi	a3,a3,-1154 # ffffffffc02069f0 <default_pmm_manager+0xd40>
ffffffffc0203e7a:	00002617          	auipc	a2,0x2
ffffffffc0203e7e:	a8660613          	addi	a2,a2,-1402 # ffffffffc0205900 <commands+0x738>
ffffffffc0203e82:	0e600593          	li	a1,230
ffffffffc0203e86:	00003517          	auipc	a0,0x3
ffffffffc0203e8a:	a6a50513          	addi	a0,a0,-1430 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203e8e:	db8fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e92:	00003697          	auipc	a3,0x3
ffffffffc0203e96:	b1e68693          	addi	a3,a3,-1250 # ffffffffc02069b0 <default_pmm_manager+0xd00>
ffffffffc0203e9a:	00002617          	auipc	a2,0x2
ffffffffc0203e9e:	a6660613          	addi	a2,a2,-1434 # ffffffffc0205900 <commands+0x738>
ffffffffc0203ea2:	0de00593          	li	a1,222
ffffffffc0203ea6:	00003517          	auipc	a0,0x3
ffffffffc0203eaa:	a4a50513          	addi	a0,a0,-1462 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203eae:	d98fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203eb2:	00003697          	auipc	a3,0x3
ffffffffc0203eb6:	b0e68693          	addi	a3,a3,-1266 # ffffffffc02069c0 <default_pmm_manager+0xd10>
ffffffffc0203eba:	00002617          	auipc	a2,0x2
ffffffffc0203ebe:	a4660613          	addi	a2,a2,-1466 # ffffffffc0205900 <commands+0x738>
ffffffffc0203ec2:	0e000593          	li	a1,224
ffffffffc0203ec6:	00003517          	auipc	a0,0x3
ffffffffc0203eca:	a2a50513          	addi	a0,a0,-1494 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203ece:	d78fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ed2:	00003697          	auipc	a3,0x3
ffffffffc0203ed6:	afe68693          	addi	a3,a3,-1282 # ffffffffc02069d0 <default_pmm_manager+0xd20>
ffffffffc0203eda:	00002617          	auipc	a2,0x2
ffffffffc0203ede:	a2660613          	addi	a2,a2,-1498 # ffffffffc0205900 <commands+0x738>
ffffffffc0203ee2:	0e200593          	li	a1,226
ffffffffc0203ee6:	00003517          	auipc	a0,0x3
ffffffffc0203eea:	a0a50513          	addi	a0,a0,-1526 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203eee:	d58fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ef2:	00003697          	auipc	a3,0x3
ffffffffc0203ef6:	c5e68693          	addi	a3,a3,-930 # ffffffffc0206b50 <default_pmm_manager+0xea0>
ffffffffc0203efa:	00002617          	auipc	a2,0x2
ffffffffc0203efe:	a0660613          	addi	a2,a2,-1530 # ffffffffc0205900 <commands+0x738>
ffffffffc0203f02:	10100593          	li	a1,257
ffffffffc0203f06:	00003517          	auipc	a0,0x3
ffffffffc0203f0a:	9ea50513          	addi	a0,a0,-1558 # ffffffffc02068f0 <default_pmm_manager+0xc40>
    check_mm_struct = mm_create();
ffffffffc0203f0e:	00012797          	auipc	a5,0x12
ffffffffc0203f12:	6807b923          	sd	zero,1682(a5) # ffffffffc02165a0 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203f16:	d30fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(vma != NULL);
ffffffffc0203f1a:	00002697          	auipc	a3,0x2
ffffffffc0203f1e:	4de68693          	addi	a3,a3,1246 # ffffffffc02063f8 <default_pmm_manager+0x748>
ffffffffc0203f22:	00002617          	auipc	a2,0x2
ffffffffc0203f26:	9de60613          	addi	a2,a2,-1570 # ffffffffc0205900 <commands+0x738>
ffffffffc0203f2a:	10800593          	li	a1,264
ffffffffc0203f2e:	00003517          	auipc	a0,0x3
ffffffffc0203f32:	9c250513          	addi	a0,a0,-1598 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203f36:	d10fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f3a:	00003697          	auipc	a3,0x3
ffffffffc0203f3e:	b8668693          	addi	a3,a3,-1146 # ffffffffc0206ac0 <default_pmm_manager+0xe10>
ffffffffc0203f42:	00002617          	auipc	a2,0x2
ffffffffc0203f46:	9be60613          	addi	a2,a2,-1602 # ffffffffc0205900 <commands+0x738>
ffffffffc0203f4a:	10d00593          	li	a1,269
ffffffffc0203f4e:	00003517          	auipc	a0,0x3
ffffffffc0203f52:	9a250513          	addi	a0,a0,-1630 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203f56:	cf0fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f5a:	00003697          	auipc	a3,0x3
ffffffffc0203f5e:	b8668693          	addi	a3,a3,-1146 # ffffffffc0206ae0 <default_pmm_manager+0xe30>
ffffffffc0203f62:	00002617          	auipc	a2,0x2
ffffffffc0203f66:	99e60613          	addi	a2,a2,-1634 # ffffffffc0205900 <commands+0x738>
ffffffffc0203f6a:	11700593          	li	a1,279
ffffffffc0203f6e:	00003517          	auipc	a0,0x3
ffffffffc0203f72:	98250513          	addi	a0,a0,-1662 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203f76:	cd0fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f7a:	00002617          	auipc	a2,0x2
ffffffffc0203f7e:	e3e60613          	addi	a2,a2,-450 # ffffffffc0205db8 <default_pmm_manager+0x108>
ffffffffc0203f82:	06200593          	li	a1,98
ffffffffc0203f86:	00002517          	auipc	a0,0x2
ffffffffc0203f8a:	d8a50513          	addi	a0,a0,-630 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc0203f8e:	cb8fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f92:	00002617          	auipc	a2,0x2
ffffffffc0203f96:	d5660613          	addi	a2,a2,-682 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc0203f9a:	06900593          	li	a1,105
ffffffffc0203f9e:	00002517          	auipc	a0,0x2
ffffffffc0203fa2:	d7250513          	addi	a0,a0,-654 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc0203fa6:	ca0fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203faa:	00003697          	auipc	a3,0x3
ffffffffc0203fae:	b4668693          	addi	a3,a3,-1210 # ffffffffc0206af0 <default_pmm_manager+0xe40>
ffffffffc0203fb2:	00002617          	auipc	a2,0x2
ffffffffc0203fb6:	94e60613          	addi	a2,a2,-1714 # ffffffffc0205900 <commands+0x738>
ffffffffc0203fba:	12400593          	li	a1,292
ffffffffc0203fbe:	00003517          	auipc	a0,0x3
ffffffffc0203fc2:	93250513          	addi	a0,a0,-1742 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203fc6:	c80fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203fca:	00002697          	auipc	a3,0x2
ffffffffc0203fce:	41e68693          	addi	a3,a3,1054 # ffffffffc02063e8 <default_pmm_manager+0x738>
ffffffffc0203fd2:	00002617          	auipc	a2,0x2
ffffffffc0203fd6:	92e60613          	addi	a2,a2,-1746 # ffffffffc0205900 <commands+0x738>
ffffffffc0203fda:	10500593          	li	a1,261
ffffffffc0203fde:	00003517          	auipc	a0,0x3
ffffffffc0203fe2:	91250513          	addi	a0,a0,-1774 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0203fe6:	c60fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fea:	00002697          	auipc	a3,0x2
ffffffffc0203fee:	3d668693          	addi	a3,a3,982 # ffffffffc02063c0 <default_pmm_manager+0x710>
ffffffffc0203ff2:	00002617          	auipc	a2,0x2
ffffffffc0203ff6:	90e60613          	addi	a2,a2,-1778 # ffffffffc0205900 <commands+0x738>
ffffffffc0203ffa:	0c200593          	li	a1,194
ffffffffc0203ffe:	00003517          	auipc	a0,0x3
ffffffffc0204002:	8f250513          	addi	a0,a0,-1806 # ffffffffc02068f0 <default_pmm_manager+0xc40>
ffffffffc0204006:	c40fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020400a <do_pgfault>:
...
ffffffffc020400a:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc020400c:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint32_t error_code, uintptr_t addr) {
...
ffffffffc0204018:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc020401a:	8dfff0ef          	jal	ra,ffffffffc02038f8 <find_vma>

    pgfault_num++;
ffffffffc020401e:	00012797          	auipc	a5,0x12
ffffffffc0204022:	58a7a783          	lw	a5,1418(a5) # ffffffffc02165a8 <pgfault_num>
ffffffffc0204026:	2785                	addiw	a5,a5,1
ffffffffc0204028:	00012717          	auipc	a4,0x12
ffffffffc020402c:	58f72023          	sw	a5,1408(a4) # ffffffffc02165a8 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0204030:	c541                	beqz	a0,ffffffffc02040b8 <do_pgfault+0xae>
ffffffffc0204032:	651c                	ld	a5,8(a0)
ffffffffc0204034:	08f46263          	bltu	s0,a5,ffffffffc02040b8 <do_pgfault+0xae>
...
ffffffffc0204038:	4d1c                	lw	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc020403a:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc020403c:	8b89                	andi	a5,a5,2
ffffffffc020403e:	ebb9                	bnez	a5,ffffffffc0204094 <do_pgfault+0x8a>
        perm |= READ_WRITE;
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0204040:	75fd                	lui	a1,0xfffff
...
ffffffffc0204042:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0204044:	8c6d                	and	s0,s0,a1
    if ((ptep = get_pte(mm->pgdir, addr, 1)) == NULL) {
ffffffffc0204046:	4605                	li	a2,1
ffffffffc0204048:	85a2                	mv	a1,s0
ffffffffc020404a:	aeffd0ef          	jal	ra,ffffffffc0201b38 <get_pte>
ffffffffc020404e:	c551                	beqz	a0,ffffffffc02040da <do_pgfault+0xd0>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0204050:	610c                	ld	a1,0(a0)
ffffffffc0204052:	c1b9                	beqz	a1,ffffffffc0204098 <do_pgfault+0x8e>
        ...
        */
        if (swap_init_ok) {
ffffffffc0204054:	00012797          	auipc	a5,0x12
ffffffffc0204058:	5447a783          	lw	a5,1348(a5) # ffffffffc0216598 <swap_init_ok>
ffffffffc020405c:	c7bd                	beqz	a5,ffffffffc02040ca <do_pgfault+0xc0>
            struct Page *page = NULL;
            swap_in(mm, addr, &page); 
ffffffffc020405e:	85a2                	mv	a1,s0
ffffffffc0204060:	0030                	addi	a2,sp,8
ffffffffc0204062:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0204064:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page); 
ffffffffc0204066:	b64ff0ef          	jal	ra,ffffffffc02033ca <swap_in>
            page_insert(mm->pgdir, page, addr, perm); 
ffffffffc020406a:	65a2                	ld	a1,8(sp)
ffffffffc020406c:	6c88                	ld	a0,24(s1)
ffffffffc020406e:	86ca                	mv	a3,s2
ffffffffc0204070:	8622                	mv	a2,s0
ffffffffc0204072:	d89fd0ef          	jal	ra,ffffffffc0201dfa <page_insert>
            swap_map_swappable(mm, addr, page, 1);  
ffffffffc0204076:	6622                	ld	a2,8(sp)
ffffffffc0204078:	4685                	li	a3,1
ffffffffc020407a:	85a2                	mv	a1,s0
ffffffffc020407c:	8526                	mv	a0,s1
ffffffffc020407e:	a2cff0ef          	jal	ra,ffffffffc02032aa <swap_map_swappable>
            page->pra_vaddr = addr;
...
ffffffffc0204084:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0204086:	ff80                	sd	s0,56(a5)
failed:
    return ret;
}
ffffffffc0204088:	70a2                	ld	ra,40(sp)
ffffffffc020408a:	7402                	ld	s0,32(sp)
ffffffffc020408c:	64e2                	ld	s1,24(sp)
ffffffffc020408e:	6942                	ld	s2,16(sp)
ffffffffc0204090:	6145                	addi	sp,sp,48
ffffffffc0204092:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0204094:	495d                	li	s2,23
ffffffffc0204096:	b76d                	j	ffffffffc0204040 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204098:	6c88                	ld	a0,24(s1)
ffffffffc020409a:	864a                	mv	a2,s2
ffffffffc020409c:	85a2                	mv	a1,s0
ffffffffc020409e:	9f3fe0ef          	jal	ra,ffffffffc0202a90 <pgdir_alloc_page>
ffffffffc02040a2:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc02040a4:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc02040a6:	f3ed                	bnez	a5,ffffffffc0204088 <do_pgfault+0x7e>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc02040a8:	00003517          	auipc	a0,0x3
ffffffffc02040ac:	b1050513          	addi	a0,a0,-1264 # ffffffffc0206bb8 <default_pmm_manager+0xf08>
ffffffffc02040b0:	8d0fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040b4:	5571                	li	a0,-4
            goto failed;
ffffffffc02040b6:	bfc9                	j	ffffffffc0204088 <do_pgfault+0x7e>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc02040b8:	85a2                	mv	a1,s0
ffffffffc02040ba:	00003517          	auipc	a0,0x3
ffffffffc02040be:	aae50513          	addi	a0,a0,-1362 # ffffffffc0206b68 <default_pmm_manager+0xeb8>
ffffffffc02040c2:	8befc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc02040c6:	5575                	li	a0,-3
        goto failed;
ffffffffc02040c8:	b7c1                	j	ffffffffc0204088 <do_pgfault+0x7e>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc02040ca:	00003517          	auipc	a0,0x3
ffffffffc02040ce:	b1650513          	addi	a0,a0,-1258 # ffffffffc0206be0 <default_pmm_manager+0xf30>
ffffffffc02040d2:	8aefc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040d6:	5571                	li	a0,-4
            goto failed;
ffffffffc02040d8:	bf45                	j	ffffffffc0204088 <do_pgfault+0x7e>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040da:	00003517          	auipc	a0,0x3
ffffffffc02040de:	abe50513          	addi	a0,a0,-1346 # ffffffffc0206b98 <default_pmm_manager+0xee8>
ffffffffc02040e2:	89efc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040e6:	5571                	li	a0,-4
        goto failed;
ffffffffc02040e8:	b745                	j	ffffffffc0204088 <do_pgfault+0x7e>
...
ffffffffc0204110:	afc60613          	addi	a2,a2,-1284 # ffffffffc0206c08 <default_pmm_manager+0xf58>
ffffffffc0204114:	45b5                	li	a1,13
ffffffffc0204116:	00003517          	auipc	a0,0x3
ffffffffc020411a:	b1250513          	addi	a0,a0,-1262 # ffffffffc0206c28 <default_pmm_manager+0xf78>
...
ffffffffc020414a:	f1273703          	ld	a4,-238(a4) # ffffffffc0207058 <nbase>
...
ffffffffc0204184:	ac060613          	addi	a2,a2,-1344 # ffffffffc0206c40 <default_pmm_manager+0xf90>
ffffffffc0204188:	45d1                	li	a1,20
ffffffffc020418a:	00003517          	auipc	a0,0x3
ffffffffc020418e:	a9e50513          	addi	a0,a0,-1378 # ffffffffc0206c28 <default_pmm_manager+0xf78>
...
ffffffffc02041a0:	b4c60613          	addi	a2,a2,-1204 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc02041a4:	00002517          	auipc	a0,0x2
ffffffffc02041a8:	b6c50513          	addi	a0,a0,-1172 # ffffffffc0205d10 <default_pmm_manager+0x60>
...
ffffffffc02041d8:	e8473703          	ld	a4,-380(a4) # ffffffffc0207058 <nbase>
...
ffffffffc0204212:	a3260613          	addi	a2,a2,-1486 # ffffffffc0206c40 <default_pmm_manager+0xf90>
ffffffffc0204216:	45e5                	li	a1,25
ffffffffc0204218:	00003517          	auipc	a0,0x3
ffffffffc020421c:	a1050513          	addi	a0,a0,-1520 # ffffffffc0206c28 <default_pmm_manager+0xf78>
...
ffffffffc020422e:	abe60613          	addi	a2,a2,-1346 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc0204232:	00002517          	auipc	a0,0x2
ffffffffc0204236:	ade50513          	addi	a0,a0,-1314 # ffffffffc0205d10 <default_pmm_manager+0x60>
...
ffffffffc0204240:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204242:	494000ef          	jal	ra,ffffffffc02046d6 <do_exit>
...
ffffffffc0204254:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204256:	c539                	beqz	a0,ffffffffc02042a4 <alloc_proc+0x5e>
...
ffffffffc020427c:	491000ef          	jal	ra,ffffffffc0204f0c <memset>
    proc->tf = NULL;                        
    proc->cr3 = boot_cr3;                   
...
ffffffffc0204292:	0b440793          	addi	a5,s0,180
ffffffffc0204296:	0c440713          	addi	a4,s0,196
    proc->name[i] =0; }
ffffffffc020429a:	00078023          	sb	zero,0(a5)
    for (int i = 0; i < PROC_NAME_LEN + 1; i++) {
ffffffffc020429e:	0785                	addi	a5,a5,1
ffffffffc02042a0:	fee79de3          	bne	a5,a4,ffffffffc020429a <alloc_proc+0x54>
    }
    return proc;
}
ffffffffc02042a4:	60a2                	ld	ra,8(sp)
ffffffffc02042a6:	8522                	mv	a0,s0
ffffffffc02042a8:	6402                	ld	s0,0(sp)
ffffffffc02042aa:	0141                	addi	sp,sp,16
ffffffffc02042ac:	8082                	ret

ffffffffc02042ae <forkret>:
...
forkret(void) {
    forkrets(current->tf);
ffffffffc02042ae:	00012797          	auipc	a5,0x12
ffffffffc02042b2:	3027b783          	ld	a5,770(a5) # ffffffffc02165b0 <current>
ffffffffc02042b6:	73c8                	ld	a0,160(a5)
ffffffffc02042b8:	8b5fc06f          	j	ffffffffc0200b6c <forkrets>

ffffffffc02042bc <init_main>:
    panic("process exit!!.\n");
}
...
ffffffffc02042c0:	00012497          	auipc	s1,0x12
ffffffffc02042c4:	25848493          	addi	s1,s1,600 # ffffffffc0216518 <name.2>
init_main(void *arg) {
ffffffffc02042c8:	f022                	sd	s0,32(sp)
ffffffffc02042ca:	e84a                	sd	s2,16(sp)
ffffffffc02042cc:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042ce:	00012917          	auipc	s2,0x12
ffffffffc02042d2:	2e293903          	ld	s2,738(s2) # ffffffffc02165b0 <current>
    memset(name, 0, sizeof(name));
ffffffffc02042d6:	4641                	li	a2,16
ffffffffc02042d8:	4581                	li	a1,0
ffffffffc02042da:	8526                	mv	a0,s1
init_main(void *arg) {
ffffffffc02042dc:	f406                	sd	ra,40(sp)
ffffffffc02042de:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042e0:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc02042e4:	429000ef          	jal	ra,ffffffffc0204f0c <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042e8:	0b490593          	addi	a1,s2,180
ffffffffc02042ec:	463d                	li	a2,15
ffffffffc02042ee:	8526                	mv	a0,s1
ffffffffc02042f0:	42f000ef          	jal	ra,ffffffffc0204f1e <memcpy>
ffffffffc02042f4:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042f6:	85ce                	mv	a1,s3
ffffffffc02042f8:	00003517          	auipc	a0,0x3
ffffffffc02042fc:	96850513          	addi	a0,a0,-1688 # ffffffffc0206c60 <default_pmm_manager+0xfb0>
ffffffffc0204300:	e81fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc0204304:	85a2                	mv	a1,s0
ffffffffc0204306:	00003517          	auipc	a0,0x3
ffffffffc020430a:	98250513          	addi	a0,a0,-1662 # ffffffffc0206c88 <default_pmm_manager+0xfd8>
ffffffffc020430e:	e73fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204312:	00003517          	auipc	a0,0x3
ffffffffc0204316:	98650513          	addi	a0,a0,-1658 # ffffffffc0206c98 <default_pmm_manager+0xfe8>
ffffffffc020431a:	e67fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc020431e:	70a2                	ld	ra,40(sp)
ffffffffc0204320:	7402                	ld	s0,32(sp)
ffffffffc0204322:	64e2                	ld	s1,24(sp)
ffffffffc0204324:	6942                	ld	s2,16(sp)
ffffffffc0204326:	69a2                	ld	s3,8(sp)
ffffffffc0204328:	4501                	li	a0,0
ffffffffc020432a:	6145                	addi	sp,sp,48
ffffffffc020432c:	8082                	ret

ffffffffc020432e <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc020432e:	7179                	addi	sp,sp,-48
ffffffffc0204330:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204332:	00012497          	auipc	s1,0x12
ffffffffc0204336:	27e48493          	addi	s1,s1,638 # ffffffffc02165b0 <current>
ffffffffc020433a:	6098                	ld	a4,0(s1)
proc_run(struct proc_struct *proc) {
ffffffffc020433c:	f406                	sd	ra,40(sp)
ffffffffc020433e:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204340:	02a70863          	beq	a4,a0,ffffffffc0204370 <proc_run+0x42>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204344:	100027f3          	csrr	a5,sstatus
ffffffffc0204348:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020434a:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020434c:	ef8d                	bnez	a5,ffffffffc0204386 <proc_run+0x58>
        lcr3(proc->cr3); 
...
ffffffffc0204350:	800006b7          	lui	a3,0x80000
        current = proc; 
ffffffffc0204354:	e088                	sd	a0,0(s1)
ffffffffc0204356:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc020435a:	8fd5                	or	a5,a5,a3
ffffffffc020435c:	18079073          	csrw	satp,a5
        switch_to(&(a->context), &(b->context)); 
ffffffffc0204360:	03050593          	addi	a1,a0,48
ffffffffc0204364:	03070513          	addi	a0,a4,48
ffffffffc0204368:	5f4000ef          	jal	ra,ffffffffc020495c <switch_to>
    if (flag) {
ffffffffc020436c:	00091763          	bnez	s2,ffffffffc020437a <proc_run+0x4c>
}
ffffffffc0204370:	70a2                	ld	ra,40(sp)
ffffffffc0204372:	7482                	ld	s1,32(sp)
ffffffffc0204374:	6962                	ld	s2,24(sp)
ffffffffc0204376:	6145                	addi	sp,sp,48
ffffffffc0204378:	8082                	ret
ffffffffc020437a:	70a2                	ld	ra,40(sp)
ffffffffc020437c:	7482                	ld	s1,32(sp)
ffffffffc020437e:	6962                	ld	s2,24(sp)
...
ffffffffc020438c:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc020438e:	6522                	ld	a0,8(sp)
ffffffffc0204390:	4905                	li	s2,1
ffffffffc0204392:	bf75                	j	ffffffffc020434e <proc_run+0x20>
...
ffffffffc0204398:	00012497          	auipc	s1,0x12
ffffffffc020439c:	23048493          	addi	s1,s1,560 # ffffffffc02165c8 <nr_process>
ffffffffc02043a0:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
...
ffffffffc02043ae:	26f75163          	bge	a4,a5,ffffffffc0204610 <do_fork+0x27c>
ffffffffc02043b2:	892e                	mv	s2,a1
ffffffffc02043b4:	8432                	mv	s0,a2
    proc = alloc_proc();    
ffffffffc02043b6:	e91ff0ef          	jal	ra,ffffffffc0204246 <alloc_proc>
ffffffffc02043ba:	89aa                	mv	s3,a0
    if (proc == NULL) { 
ffffffffc02043bc:	24050f63          	beqz	a0,ffffffffc020461a <do_fork+0x286>
    proc->parent = current;
ffffffffc02043c0:	00012a17          	auipc	s4,0x12
ffffffffc02043c4:	1f0a0a13          	addi	s4,s4,496 # ffffffffc02165b0 <current>
ffffffffc02043c8:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043cc:	4509                	li	a0,2
    proc->parent = current;
ffffffffc02043ce:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043d2:	e5afd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043d6:	1e050763          	beqz	a0,ffffffffc02045c4 <do_fork+0x230>
    return page - pages + nbase;
ffffffffc02043da:	00012697          	auipc	a3,0x12
ffffffffc02043de:	1966b683          	ld	a3,406(a3) # ffffffffc0216570 <pages>
ffffffffc02043e2:	40d506b3          	sub	a3,a0,a3
ffffffffc02043e6:	8699                	srai	a3,a3,0x6
ffffffffc02043e8:	00003517          	auipc	a0,0x3
ffffffffc02043ec:	c7053503          	ld	a0,-912(a0) # ffffffffc0207058 <nbase>
ffffffffc02043f0:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043f2:	00c69793          	slli	a5,a3,0xc
ffffffffc02043f6:	83b1                	srli	a5,a5,0xc
ffffffffc02043f8:	00012717          	auipc	a4,0x12
ffffffffc02043fc:	17073703          	ld	a4,368(a4) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc0204400:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204402:	22e7fe63          	bgeu	a5,a4,ffffffffc020463e <do_fork+0x2aa>
    assert(current->mm == NULL);
ffffffffc0204406:	000a3783          	ld	a5,0(s4)
ffffffffc020440a:	00012717          	auipc	a4,0x12
ffffffffc020440e:	17673703          	ld	a4,374(a4) # ffffffffc0216580 <va_pa_offset>
ffffffffc0204412:	96ba                	add	a3,a3,a4
ffffffffc0204414:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204416:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc020441a:	20079263          	bnez	a5,ffffffffc020461e <do_fork+0x28a>
...
ffffffffc0204426:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204428:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
...
ffffffffc0204456:	12090563          	beqz	s2,ffffffffc0204580 <do_fork+0x1ec>
ffffffffc020445a:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020445e:	00000797          	auipc	a5,0x0
ffffffffc0204462:	e5078793          	addi	a5,a5,-432 # ffffffffc02042ae <forkret>
ffffffffc0204466:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020446a:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0204474:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204476:	12079663          	bnez	a5,ffffffffc02045a2 <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc020447a:	00007817          	auipc	a6,0x7
ffffffffc020447e:	bde80813          	addi	a6,a6,-1058 # ffffffffc020b058 <last_pid.1>
ffffffffc0204482:	00082783          	lw	a5,0(a6)
ffffffffc0204486:	6709                	lui	a4,0x2
ffffffffc0204488:	0017851b          	addiw	a0,a5,1
ffffffffc020448c:	00a82023          	sw	a0,0(a6)
ffffffffc0204490:	08e55163          	bge	a0,a4,ffffffffc0204512 <do_fork+0x17e>
    if (last_pid >= next_safe) {
ffffffffc0204494:	00007317          	auipc	t1,0x7
ffffffffc0204498:	bc830313          	addi	t1,t1,-1080 # ffffffffc020b05c <next_safe.0>
ffffffffc020449c:	00032783          	lw	a5,0(t1)
ffffffffc02044a0:	00012417          	auipc	s0,0x12
ffffffffc02044a4:	08840413          	addi	s0,s0,136 # ffffffffc0216528 <proc_list>
ffffffffc02044a8:	06f55d63          	bge	a0,a5,ffffffffc0204522 <do_fork+0x18e>
    proc->pid = get_pid(); 
ffffffffc02044ac:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02044b0:	45a9                	li	a1,10
ffffffffc02044b2:	2501                	sext.w	a0,a0
ffffffffc02044b4:	5d8000ef          	jal	ra,ffffffffc0204a8c <hash32>
ffffffffc02044b8:	02051793          	slli	a5,a0,0x20
ffffffffc02044bc:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044c0:	0000e797          	auipc	a5,0xe
ffffffffc02044c4:	05878793          	addi	a5,a5,88 # ffffffffc0212518 <hash_list>
ffffffffc02044c8:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044ca:	6510                	ld	a2,8(a0)
ffffffffc02044cc:	0d898793          	addi	a5,s3,216
ffffffffc02044d0:	6414                	ld	a3,8(s0)
    nr_process++;
ffffffffc02044d2:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02044d4:	e21c                	sd	a5,0(a2)
ffffffffc02044d6:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02044d8:	0ec9b023          	sd	a2,224(s3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc02044dc:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc02044e0:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02044e4:	e29c                	sd	a5,0(a3)
    nr_process++;
ffffffffc02044e6:	2705                	addiw	a4,a4,1
ffffffffc02044e8:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044ea:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044ee:	0c89b423          	sd	s0,200(s3)
ffffffffc02044f2:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044f4:	0a091b63          	bnez	s2,ffffffffc02045aa <do_fork+0x216>
    wakeup_proc(proc);
ffffffffc02044f8:	854e                	mv	a0,s3
ffffffffc02044fa:	4cc000ef          	jal	ra,ffffffffc02049c6 <wakeup_proc>
    ret = proc->pid;
...
ffffffffc020450c:	6a02                	ld	s4,0(sp)
ffffffffc020450e:	6145                	addi	sp,sp,48
ffffffffc0204510:	8082                	ret
        last_pid = 1;
ffffffffc0204512:	4785                	li	a5,1
ffffffffc0204514:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc0204518:	4505                	li	a0,1
ffffffffc020451a:	00007317          	auipc	t1,0x7
ffffffffc020451e:	b4230313          	addi	t1,t1,-1214 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc0204522:	00012417          	auipc	s0,0x12
ffffffffc0204526:	00640413          	addi	s0,s0,6 # ffffffffc0216528 <proc_list>
ffffffffc020452a:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc020452e:	6789                	lui	a5,0x2
ffffffffc0204530:	00f32023          	sw	a5,0(t1)
ffffffffc0204534:	86aa                	mv	a3,a0
ffffffffc0204536:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc0204538:	6e89                	lui	t4,0x2
ffffffffc020453a:	088e0063          	beq	t3,s0,ffffffffc02045ba <do_fork+0x226>
ffffffffc020453e:	88ae                	mv	a7,a1
ffffffffc0204540:	87f2                	mv	a5,t3
ffffffffc0204542:	6609                	lui	a2,0x2
ffffffffc0204544:	a811                	j	ffffffffc0204558 <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204546:	00e6d663          	bge	a3,a4,ffffffffc0204552 <do_fork+0x1be>
ffffffffc020454a:	00c75463          	bge	a4,a2,ffffffffc0204552 <do_fork+0x1be>
ffffffffc020454e:	863a                	mv	a2,a4
ffffffffc0204550:	4885                	li	a7,1
ffffffffc0204552:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204554:	00878d63          	beq	a5,s0,ffffffffc020456e <do_fork+0x1da>
            if (proc->pid == last_pid) {
ffffffffc0204558:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020455c:	fed715e3          	bne	a4,a3,ffffffffc0204546 <do_fork+0x1b2>
                if (++ last_pid >= next_safe) {
ffffffffc0204560:	2685                	addiw	a3,a3,1
ffffffffc0204562:	04c6d763          	bge	a3,a2,ffffffffc02045b0 <do_fork+0x21c>
ffffffffc0204566:	679c                	ld	a5,8(a5)
ffffffffc0204568:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020456a:	fe8797e3          	bne	a5,s0,ffffffffc0204558 <do_fork+0x1c4>
ffffffffc020456e:	c581                	beqz	a1,ffffffffc0204576 <do_fork+0x1e2>
ffffffffc0204570:	00d82023          	sw	a3,0(a6)
ffffffffc0204574:	8536                	mv	a0,a3
ffffffffc0204576:	f2088be3          	beqz	a7,ffffffffc02044ac <do_fork+0x118>
ffffffffc020457a:	00c32023          	sw	a2,0(t1)
ffffffffc020457e:	b73d                	j	ffffffffc02044ac <do_fork+0x118>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204580:	8936                	mv	s2,a3
ffffffffc0204582:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204586:	00000797          	auipc	a5,0x0
ffffffffc020458a:	d2878793          	addi	a5,a5,-728 # ffffffffc02042ae <forkret>
ffffffffc020458e:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204592:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204596:	100027f3          	csrr	a5,sstatus
ffffffffc020459a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020459c:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020459e:	ec078ee3          	beqz	a5,ffffffffc020447a <do_fork+0xe6>
        intr_disable();
ffffffffc02045a2:	820fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc02045a6:	4905                	li	s2,1
ffffffffc02045a8:	bdc9                	j	ffffffffc020447a <do_fork+0xe6>
        intr_enable();
ffffffffc02045aa:	812fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc02045ae:	b7a9                	j	ffffffffc02044f8 <do_fork+0x164>
                    if (last_pid >= MAX_PID) {
ffffffffc02045b0:	01d6c363          	blt	a3,t4,ffffffffc02045b6 <do_fork+0x222>
                        last_pid = 1;
ffffffffc02045b4:	4685                	li	a3,1
                    goto repeat;
ffffffffc02045b6:	4585                	li	a1,1
ffffffffc02045b8:	b749                	j	ffffffffc020453a <do_fork+0x1a6>
ffffffffc02045ba:	cda9                	beqz	a1,ffffffffc0204614 <do_fork+0x280>
ffffffffc02045bc:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02045c0:	8536                	mv	a0,a3
ffffffffc02045c2:	b5ed                	j	ffffffffc02044ac <do_fork+0x118>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02045c4:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc02045c8:	c02007b7          	lui	a5,0xc0200
ffffffffc02045cc:	0af6e163          	bltu	a3,a5,ffffffffc020466e <do_fork+0x2da>
ffffffffc02045d0:	00012797          	auipc	a5,0x12
ffffffffc02045d4:	fb07b783          	ld	a5,-80(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02045d8:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02045dc:	83b1                	srli	a5,a5,0xc
ffffffffc02045de:	00012717          	auipc	a4,0x12
ffffffffc02045e2:	f8a73703          	ld	a4,-118(a4) # ffffffffc0216568 <npage>
ffffffffc02045e6:	06e7f863          	bgeu	a5,a4,ffffffffc0204656 <do_fork+0x2c2>
    return &pages[PPN(pa) - nbase];
ffffffffc02045ea:	00003717          	auipc	a4,0x3
ffffffffc02045ee:	a6e73703          	ld	a4,-1426(a4) # ffffffffc0207058 <nbase>
ffffffffc02045f2:	8f99                	sub	a5,a5,a4
ffffffffc02045f4:	079a                	slli	a5,a5,0x6
ffffffffc02045f6:	00012517          	auipc	a0,0x12
ffffffffc02045fa:	f7a53503          	ld	a0,-134(a0) # ffffffffc0216570 <pages>
ffffffffc02045fe:	953e                	add	a0,a0,a5
ffffffffc0204600:	4589                	li	a1,2
ffffffffc0204602:	cbcfd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc0204606:	854e                	mv	a0,s3
ffffffffc0204608:	af6fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc020460c:	5571                	li	a0,-4
    goto fork_out;
ffffffffc020460e:	bdd5                	j	ffffffffc0204502 <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc0204610:	556d                	li	a0,-5
ffffffffc0204612:	bdc5                	j	ffffffffc0204502 <do_fork+0x16e>
    return last_pid;
ffffffffc0204614:	00082503          	lw	a0,0(a6)
ffffffffc0204618:	bd51                	j	ffffffffc02044ac <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc020461a:	5571                	li	a0,-4
    return ret;
ffffffffc020461c:	b5dd                	j	ffffffffc0204502 <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc020461e:	00002697          	auipc	a3,0x2
ffffffffc0204622:	69a68693          	addi	a3,a3,1690 # ffffffffc0206cb8 <default_pmm_manager+0x1008>
ffffffffc0204626:	00001617          	auipc	a2,0x1
ffffffffc020462a:	2da60613          	addi	a2,a2,730 # ffffffffc0205900 <commands+0x738>
ffffffffc020462e:	10500593          	li	a1,261
ffffffffc0204632:	00002517          	auipc	a0,0x2
ffffffffc0204636:	69e50513          	addi	a0,a0,1694 # ffffffffc0206cd0 <default_pmm_manager+0x1020>
ffffffffc020463a:	e0dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020463e:	00001617          	auipc	a2,0x1
ffffffffc0204642:	6aa60613          	addi	a2,a2,1706 # ffffffffc0205ce8 <default_pmm_manager+0x38>
ffffffffc0204646:	06900593          	li	a1,105
ffffffffc020464a:	00001517          	auipc	a0,0x1
ffffffffc020464e:	6c650513          	addi	a0,a0,1734 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc0204652:	df5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204656:	00001617          	auipc	a2,0x1
ffffffffc020465a:	76260613          	addi	a2,a2,1890 # ffffffffc0205db8 <default_pmm_manager+0x108>
ffffffffc020465e:	06200593          	li	a1,98
ffffffffc0204662:	00001517          	auipc	a0,0x1
ffffffffc0204666:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc020466a:	dddfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc020466e:	00001617          	auipc	a2,0x1
ffffffffc0204672:	72260613          	addi	a2,a2,1826 # ffffffffc0205d90 <default_pmm_manager+0xe0>
ffffffffc0204676:	06e00593          	li	a1,110
ffffffffc020467a:	00001517          	auipc	a0,0x1
ffffffffc020467e:	69650513          	addi	a0,a0,1686 # ffffffffc0205d10 <default_pmm_manager+0x60>
ffffffffc0204682:	dc5fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204686 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204686:	7129                	addi	sp,sp,-320
ffffffffc0204688:	fa22                	sd	s0,304(sp)
ffffffffc020468a:	f626                	sd	s1,296(sp)
ffffffffc020468c:	f24a                	sd	s2,288(sp)
ffffffffc020468e:	84ae                	mv	s1,a1
ffffffffc0204690:	892a                	mv	s2,a0
ffffffffc0204692:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204694:	4581                	li	a1,0
ffffffffc0204696:	12000613          	li	a2,288
ffffffffc020469a:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020469c:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020469e:	06f000ef          	jal	ra,ffffffffc0204f0c <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02046a2:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02046a4:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02046a6:	100027f3          	csrr	a5,sstatus
ffffffffc02046aa:	edd7f793          	andi	a5,a5,-291
ffffffffc02046ae:	1207e793          	ori	a5,a5,288
ffffffffc02046b2:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046b4:	860a                	mv	a2,sp
ffffffffc02046b6:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02046ba:	00000797          	auipc	a5,0x0
ffffffffc02046be:	b8478793          	addi	a5,a5,-1148 # ffffffffc020423e <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046c2:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02046c4:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046c6:	ccfff0ef          	jal	ra,ffffffffc0204394 <do_fork>
}
ffffffffc02046ca:	70f2                	ld	ra,312(sp)
ffffffffc02046cc:	7452                	ld	s0,304(sp)
ffffffffc02046ce:	74b2                	ld	s1,296(sp)
ffffffffc02046d0:	7912                	ld	s2,288(sp)
ffffffffc02046d2:	6131                	addi	sp,sp,320
ffffffffc02046d4:	8082                	ret

ffffffffc02046d6 <do_exit>:
do_exit(int error_code) {
ffffffffc02046d6:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02046d8:	00002617          	auipc	a2,0x2
ffffffffc02046dc:	61060613          	addi	a2,a2,1552 # ffffffffc0206ce8 <default_pmm_manager+0x1038>
ffffffffc02046e0:	16800593          	li	a1,360
ffffffffc02046e4:	00002517          	auipc	a0,0x2
ffffffffc02046e8:	5ec50513          	addi	a0,a0,1516 # ffffffffc0206cd0 <default_pmm_manager+0x1020>
do_exit(int error_code) {
ffffffffc02046ec:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046ee:	d59fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02046f2 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc02046f2:	7179                	addi	sp,sp,-48
ffffffffc02046f4:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046f6:	00012797          	auipc	a5,0x12
ffffffffc02046fa:	e3278793          	addi	a5,a5,-462 # ffffffffc0216528 <proc_list>
ffffffffc02046fe:	f406                	sd	ra,40(sp)
ffffffffc0204700:	f022                	sd	s0,32(sp)
ffffffffc0204702:	e84a                	sd	s2,16(sp)
ffffffffc0204704:	e44e                	sd	s3,8(sp)
ffffffffc0204706:	0000e497          	auipc	s1,0xe
ffffffffc020470a:	e1248493          	addi	s1,s1,-494 # ffffffffc0212518 <hash_list>
...
ffffffffc0204716:	e0670713          	addi	a4,a4,-506 # ffffffffc0216518 <name.2>
ffffffffc020471a:	87a6                	mv	a5,s1
ffffffffc020471c:	e79c                	sd	a5,8(a5)
ffffffffc020471e:	e39c                	sd	a5,0(a5)
ffffffffc0204720:	07c1                	addi	a5,a5,16
ffffffffc0204722:	fef71de3          	bne	a4,a5,ffffffffc020471c <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204726:	b21ff0ef          	jal	ra,ffffffffc0204246 <alloc_proc>
ffffffffc020472a:	00012917          	auipc	s2,0x12
ffffffffc020472e:	e8e90913          	addi	s2,s2,-370 # ffffffffc02165b8 <idleproc>
ffffffffc0204732:	00a93023          	sd	a0,0(s2)
ffffffffc0204736:	18050d63          	beqz	a0,ffffffffc02048d0 <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020473a:	07000513          	li	a0,112
ffffffffc020473e:	910fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204742:	07000613          	li	a2,112
ffffffffc0204746:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc0204748:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020474a:	7c2000ef          	jal	ra,ffffffffc0204f0c <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc020474e:	00093503          	ld	a0,0(s2)
ffffffffc0204752:	85a2                	mv	a1,s0
ffffffffc0204754:	07000613          	li	a2,112
ffffffffc0204758:	03050513          	addi	a0,a0,48
ffffffffc020475c:	7da000ef          	jal	ra,ffffffffc0204f36 <memcmp>
ffffffffc0204760:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204762:	453d                	li	a0,15
ffffffffc0204764:	8eafd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc020476c:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020476e:	79e000ef          	jal	ra,ffffffffc0204f0c <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204772:	00093503          	ld	a0,0(s2)
ffffffffc0204776:	463d                	li	a2,15
ffffffffc0204778:	85a2                	mv	a1,s0
ffffffffc020477a:	0b450513          	addi	a0,a0,180
ffffffffc020477e:	7b8000ef          	jal	ra,ffffffffc0204f36 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204782:	00093783          	ld	a5,0(s2)
ffffffffc0204786:	00012717          	auipc	a4,0x12
ffffffffc020478a:	dd273703          	ld	a4,-558(a4) # ffffffffc0216558 <boot_cr3>
ffffffffc020478e:	77d4                	ld	a3,168(a5)
ffffffffc0204790:	0ee68463          	beq	a3,a4,ffffffffc0204878 <proc_init+0x186>
...
ffffffffc0204798:	00004717          	auipc	a4,0x4
ffffffffc020479c:	86870713          	addi	a4,a4,-1944 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047a0:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02047a4:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc02047a6:	4705                	li	a4,1
ffffffffc02047a8:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047aa:	4641                	li	a2,16
ffffffffc02047ac:	4581                	li	a1,0
ffffffffc02047ae:	8522                	mv	a0,s0
ffffffffc02047b0:	75c000ef          	jal	ra,ffffffffc0204f0c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047b4:	463d                	li	a2,15
ffffffffc02047b6:	00002597          	auipc	a1,0x2
ffffffffc02047ba:	57a58593          	addi	a1,a1,1402 # ffffffffc0206d30 <default_pmm_manager+0x1080>
ffffffffc02047be:	8522                	mv	a0,s0
ffffffffc02047c0:	75e000ef          	jal	ra,ffffffffc0204f1e <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc02047c4:	00012717          	auipc	a4,0x12
ffffffffc02047c8:	e0470713          	addi	a4,a4,-508 # ffffffffc02165c8 <nr_process>
ffffffffc02047cc:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02047ce:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047d2:	4601                	li	a2,0
    nr_process ++;
ffffffffc02047d4:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047d6:	00002597          	auipc	a1,0x2
ffffffffc02047da:	56258593          	addi	a1,a1,1378 # ffffffffc0206d38 <default_pmm_manager+0x1088>
ffffffffc02047de:	00000517          	auipc	a0,0x0
ffffffffc02047e2:	ade50513          	addi	a0,a0,-1314 # ffffffffc02042bc <init_main>
    nr_process ++;
ffffffffc02047e6:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02047e8:	00012797          	auipc	a5,0x12
ffffffffc02047ec:	dcd7b423          	sd	a3,-568(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047f0:	e97ff0ef          	jal	ra,ffffffffc0204686 <kernel_thread>
ffffffffc02047f4:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047f6:	0ea05963          	blez	a0,ffffffffc02048e8 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047fa:	6789                	lui	a5,0x2
ffffffffc02047fc:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204800:	17f9                	addi	a5,a5,-2
ffffffffc0204802:	2501                	sext.w	a0,a0
ffffffffc0204804:	02e7e363          	bltu	a5,a4,ffffffffc020482a <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204808:	45a9                	li	a1,10
ffffffffc020480a:	282000ef          	jal	ra,ffffffffc0204a8c <hash32>
ffffffffc020480e:	02051793          	slli	a5,a0,0x20
ffffffffc0204812:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204816:	96a6                	add	a3,a3,s1
ffffffffc0204818:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc020481a:	a029                	j	ffffffffc0204824 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc020481c:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0204820:	0a870563          	beq	a4,s0,ffffffffc02048ca <proc_init+0x1d8>
    return listelm->next;
ffffffffc0204824:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204826:	fef69be3          	bne	a3,a5,ffffffffc020481c <proc_init+0x12a>
    return NULL;
ffffffffc020482a:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020482c:	0b478493          	addi	s1,a5,180
...
ffffffffc0204834:	00012417          	auipc	s0,0x12
ffffffffc0204838:	d8c40413          	addi	s0,s0,-628 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020483c:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc020483e:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204840:	6cc000ef          	jal	ra,ffffffffc0204f0c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204844:	463d                	li	a2,15
ffffffffc0204846:	00002597          	auipc	a1,0x2
ffffffffc020484a:	52258593          	addi	a1,a1,1314 # ffffffffc0206d68 <default_pmm_manager+0x10b8>
ffffffffc020484e:	8526                	mv	a0,s1
ffffffffc0204850:	6ce000ef          	jal	ra,ffffffffc0204f1e <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204854:	00093783          	ld	a5,0(s2)
ffffffffc0204858:	c7e1                	beqz	a5,ffffffffc0204920 <proc_init+0x22e>
ffffffffc020485a:	43dc                	lw	a5,4(a5)
ffffffffc020485c:	e3f1                	bnez	a5,ffffffffc0204920 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020485e:	601c                	ld	a5,0(s0)
ffffffffc0204860:	c3c5                	beqz	a5,ffffffffc0204900 <proc_init+0x20e>
ffffffffc0204862:	43d8                	lw	a4,4(a5)
ffffffffc0204864:	4785                	li	a5,1
ffffffffc0204866:	08f71d63          	bne	a4,a5,ffffffffc0204900 <proc_init+0x20e>
}
ffffffffc020486a:	70a2                	ld	ra,40(sp)
ffffffffc020486c:	7402                	ld	s0,32(sp)
ffffffffc020486e:	64e2                	ld	s1,24(sp)
ffffffffc0204870:	6942                	ld	s2,16(sp)
ffffffffc0204872:	69a2                	ld	s3,8(sp)
ffffffffc0204874:	6145                	addi	sp,sp,48
ffffffffc0204876:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204878:	73d8                	ld	a4,160(a5)
ffffffffc020487a:	ff09                	bnez	a4,ffffffffc0204794 <proc_init+0xa2>
ffffffffc020487c:	f0099ce3          	bnez	s3,ffffffffc0204794 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204880:	6394                	ld	a3,0(a5)
ffffffffc0204882:	577d                	li	a4,-1
ffffffffc0204884:	1702                	slli	a4,a4,0x20
ffffffffc0204886:	f0e697e3          	bne	a3,a4,ffffffffc0204794 <proc_init+0xa2>
ffffffffc020488a:	4798                	lw	a4,8(a5)
ffffffffc020488c:	f00714e3          	bnez	a4,ffffffffc0204794 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204890:	6b98                	ld	a4,16(a5)
ffffffffc0204892:	f00711e3          	bnez	a4,ffffffffc0204794 <proc_init+0xa2>
ffffffffc0204896:	4f98                	lw	a4,24(a5)
ffffffffc0204898:	2701                	sext.w	a4,a4
ffffffffc020489a:	ee071de3          	bnez	a4,ffffffffc0204794 <proc_init+0xa2>
ffffffffc020489e:	7398                	ld	a4,32(a5)
ffffffffc02048a0:	ee071ae3          	bnez	a4,ffffffffc0204794 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc02048a4:	7798                	ld	a4,40(a5)
ffffffffc02048a6:	ee0717e3          	bnez	a4,ffffffffc0204794 <proc_init+0xa2>
ffffffffc02048aa:	0b07a703          	lw	a4,176(a5)
ffffffffc02048ae:	8d59                	or	a0,a0,a4
ffffffffc02048b0:	0005071b          	sext.w	a4,a0
ffffffffc02048b4:	ee0710e3          	bnez	a4,ffffffffc0204794 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02048b8:	00002517          	auipc	a0,0x2
ffffffffc02048bc:	46050513          	addi	a0,a0,1120 # ffffffffc0206d18 <default_pmm_manager+0x1068>
ffffffffc02048c0:	8c1fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc02048c4:	00093783          	ld	a5,0(s2)
ffffffffc02048c8:	b5f1                	j	ffffffffc0204794 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02048ca:	f2878793          	addi	a5,a5,-216
ffffffffc02048ce:	bfb9                	j	ffffffffc020482c <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02048d0:	00002617          	auipc	a2,0x2
ffffffffc02048d4:	43060613          	addi	a2,a2,1072 # ffffffffc0206d00 <default_pmm_manager+0x1050>
ffffffffc02048d8:	18000593          	li	a1,384
ffffffffc02048dc:	00002517          	auipc	a0,0x2
ffffffffc02048e0:	3f450513          	addi	a0,a0,1012 # ffffffffc0206cd0 <default_pmm_manager+0x1020>
ffffffffc02048e4:	b63fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048e8:	00002617          	auipc	a2,0x2
ffffffffc02048ec:	46060613          	addi	a2,a2,1120 # ffffffffc0206d48 <default_pmm_manager+0x1098>
ffffffffc02048f0:	1a000593          	li	a1,416
ffffffffc02048f4:	00002517          	auipc	a0,0x2
ffffffffc02048f8:	3dc50513          	addi	a0,a0,988 # ffffffffc0206cd0 <default_pmm_manager+0x1020>
ffffffffc02048fc:	b4bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204900:	00002697          	auipc	a3,0x2
ffffffffc0204904:	49868693          	addi	a3,a3,1176 # ffffffffc0206d98 <default_pmm_manager+0x10e8>
ffffffffc0204908:	00001617          	auipc	a2,0x1
ffffffffc020490c:	ff860613          	addi	a2,a2,-8 # ffffffffc0205900 <commands+0x738>
ffffffffc0204910:	1a700593          	li	a1,423
ffffffffc0204914:	00002517          	auipc	a0,0x2
ffffffffc0204918:	3bc50513          	addi	a0,a0,956 # ffffffffc0206cd0 <default_pmm_manager+0x1020>
ffffffffc020491c:	b2bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204920:	00002697          	auipc	a3,0x2
ffffffffc0204924:	45068693          	addi	a3,a3,1104 # ffffffffc0206d70 <default_pmm_manager+0x10c0>
ffffffffc0204928:	00001617          	auipc	a2,0x1
ffffffffc020492c:	fd860613          	addi	a2,a2,-40 # ffffffffc0205900 <commands+0x738>
ffffffffc0204930:	1a600593          	li	a1,422
ffffffffc0204934:	00002517          	auipc	a0,0x2
ffffffffc0204938:	39c50513          	addi	a0,a0,924 # ffffffffc0206cd0 <default_pmm_manager+0x1020>
ffffffffc020493c:	b0bfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204940 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204940:	1141                	addi	sp,sp,-16
ffffffffc0204942:	e022                	sd	s0,0(sp)
ffffffffc0204944:	e406                	sd	ra,8(sp)
ffffffffc0204946:	00012417          	auipc	s0,0x12
ffffffffc020494a:	c6a40413          	addi	s0,s0,-918 # ffffffffc02165b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc020494e:	6018                	ld	a4,0(s0)
ffffffffc0204950:	4f1c                	lw	a5,24(a4)
ffffffffc0204952:	2781                	sext.w	a5,a5
ffffffffc0204954:	dff5                	beqz	a5,ffffffffc0204950 <cpu_idle+0x10>
            schedule();
ffffffffc0204956:	0a2000ef          	jal	ra,ffffffffc02049f8 <schedule>
ffffffffc020495a:	bfd5                	j	ffffffffc020494e <cpu_idle+0xe>

ffffffffc020495c <switch_to>:
.text
...
ffffffffc020495c:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204960:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204964:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204966:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204968:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020496c:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204970:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204974:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204978:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020497c:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204980:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204984:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204988:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020498c:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204990:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204994:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204998:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020499a:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020499c:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02049a0:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02049a4:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02049a8:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02049ac:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02049b0:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02049b4:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02049b8:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02049bc:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02049c0:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02049c4:	8082                	ret

ffffffffc02049c6 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02049c6:	411c                	lw	a5,0(a0)
ffffffffc02049c8:	4705                	li	a4,1
ffffffffc02049ca:	37f9                	addiw	a5,a5,-2
ffffffffc02049cc:	00f77563          	bgeu	a4,a5,ffffffffc02049d6 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02049d0:	4789                	li	a5,2
ffffffffc02049d2:	c11c                	sw	a5,0(a0)
ffffffffc02049d4:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049d6:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049d8:	00002697          	auipc	a3,0x2
ffffffffc02049dc:	3e868693          	addi	a3,a3,1000 # ffffffffc0206dc0 <default_pmm_manager+0x1110>
ffffffffc02049e0:	00001617          	auipc	a2,0x1
ffffffffc02049e4:	f2060613          	addi	a2,a2,-224 # ffffffffc0205900 <commands+0x738>
ffffffffc02049e8:	45a5                	li	a1,9
ffffffffc02049ea:	00002517          	auipc	a0,0x2
ffffffffc02049ee:	41650513          	addi	a0,a0,1046 # ffffffffc0206e00 <default_pmm_manager+0x1150>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049f2:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049f4:	a53fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049f8 <schedule>:
}
...
ffffffffc02049fc:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049fe:	100027f3          	csrr	a5,sstatus
ffffffffc0204a02:	8b89                	andi	a5,a5,2
ffffffffc0204a04:	4401                	li	s0,0
ffffffffc0204a06:	efbd                	bnez	a5,ffffffffc0204a84 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0204a08:	00012897          	auipc	a7,0x12
ffffffffc0204a0c:	ba88b883          	ld	a7,-1112(a7) # ffffffffc02165b0 <current>
ffffffffc0204a10:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a14:	00012517          	auipc	a0,0x12
ffffffffc0204a18:	ba453503          	ld	a0,-1116(a0) # ffffffffc02165b8 <idleproc>
ffffffffc0204a1c:	04a88e63          	beq	a7,a0,ffffffffc0204a78 <schedule+0x80>
ffffffffc0204a20:	0c888693          	addi	a3,a7,200
ffffffffc0204a24:	00012617          	auipc	a2,0x12
ffffffffc0204a28:	b0460613          	addi	a2,a2,-1276 # ffffffffc0216528 <proc_list>
        le = last;
ffffffffc0204a2c:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0204a30:	4809                	li	a6,2
ffffffffc0204a32:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204a34:	00c78863          	beq	a5,a2,ffffffffc0204a44 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a38:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204a3c:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a40:	03070163          	beq	a4,a6,ffffffffc0204a62 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204a44:	fef697e3          	bne	a3,a5,ffffffffc0204a32 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a48:	ed89                	bnez	a1,ffffffffc0204a62 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204a4a:	451c                	lw	a5,8(a0)
ffffffffc0204a4c:	2785                	addiw	a5,a5,1
ffffffffc0204a4e:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a50:	00a88463          	beq	a7,a0,ffffffffc0204a58 <schedule+0x60>
            proc_run(next);
ffffffffc0204a54:	8dbff0ef          	jal	ra,ffffffffc020432e <proc_run>
    if (flag) {
ffffffffc0204a58:	e819                	bnez	s0,ffffffffc0204a6e <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204a5a:	60a2                	ld	ra,8(sp)
ffffffffc0204a5c:	6402                	ld	s0,0(sp)
ffffffffc0204a5e:	0141                	addi	sp,sp,16
ffffffffc0204a60:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a62:	4198                	lw	a4,0(a1)
ffffffffc0204a64:	4789                	li	a5,2
ffffffffc0204a66:	fef712e3          	bne	a4,a5,ffffffffc0204a4a <schedule+0x52>
ffffffffc0204a6a:	852e                	mv	a0,a1
ffffffffc0204a6c:	bff9                	j	ffffffffc0204a4a <schedule+0x52>
}
ffffffffc0204a6e:	6402                	ld	s0,0(sp)
ffffffffc0204a70:	60a2                	ld	ra,8(sp)
ffffffffc0204a72:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a74:	b49fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a78:	00012617          	auipc	a2,0x12
ffffffffc0204a7c:	ab060613          	addi	a2,a2,-1360 # ffffffffc0216528 <proc_list>
ffffffffc0204a80:	86b2                	mv	a3,a2
ffffffffc0204a82:	b76d                	j	ffffffffc0204a2c <schedule+0x34>
        intr_disable();
ffffffffc0204a84:	b3ffb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a88:	4405                	li	s0,1
ffffffffc0204a8a:	bfbd                	j	ffffffffc0204a08 <schedule+0x10>

ffffffffc0204a8c <hash32>:
 *
...
ffffffffc0204a8c:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a90:	2785                	addiw	a5,a5,1
ffffffffc0204a92:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a96:	02000793          	li	a5,32
ffffffffc0204a9a:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a9c:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204aa0:	8082                	ret

ffffffffc0204aa2 <printnum>:
 * */
static void
...
ffffffffc0204aa2:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204aa6:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204aa8:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204aac:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204aae:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204ab2:	f022                	sd	s0,32(sp)
ffffffffc0204ab4:	ec26                	sd	s1,24(sp)
ffffffffc0204ab6:	e84a                	sd	s2,16(sp)
ffffffffc0204ab8:	f406                	sd	ra,40(sp)
ffffffffc0204aba:	e44e                	sd	s3,8(sp)
ffffffffc0204abc:	84aa                	mv	s1,a0
ffffffffc0204abe:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204ac0:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204ac4:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204ac6:	03067e63          	bgeu	a2,a6,ffffffffc0204b02 <printnum+0x60>
ffffffffc0204aca:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204acc:	00805763          	blez	s0,ffffffffc0204ada <printnum+0x38>
ffffffffc0204ad0:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204ad2:	85ca                	mv	a1,s2
ffffffffc0204ad4:	854e                	mv	a0,s3
ffffffffc0204ad6:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204ad8:	fc65                	bnez	s0,ffffffffc0204ad0 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ada:	1a02                	slli	s4,s4,0x20
ffffffffc0204adc:	00002797          	auipc	a5,0x2
ffffffffc0204ae0:	33c78793          	addi	a5,a5,828 # ffffffffc0206e18 <default_pmm_manager+0x1168>
ffffffffc0204ae4:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204ae8:	9a3e                	add	s4,s4,a5
}
ffffffffc0204aea:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aec:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204af0:	70a2                	ld	ra,40(sp)
ffffffffc0204af2:	69a2                	ld	s3,8(sp)
ffffffffc0204af4:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204af6:	85ca                	mv	a1,s2
ffffffffc0204af8:	87a6                	mv	a5,s1
}
ffffffffc0204afa:	6942                	ld	s2,16(sp)
ffffffffc0204afc:	64e2                	ld	s1,24(sp)
ffffffffc0204afe:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204b00:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204b02:	03065633          	divu	a2,a2,a6
ffffffffc0204b06:	8722                	mv	a4,s0
ffffffffc0204b08:	f9bff0ef          	jal	ra,ffffffffc0204aa2 <printnum>
ffffffffc0204b0c:	b7f9                	j	ffffffffc0204ada <printnum+0x38>

ffffffffc0204b0e <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204b0e:	7119                	addi	sp,sp,-128
ffffffffc0204b10:	f4a6                	sd	s1,104(sp)
ffffffffc0204b12:	f0ca                	sd	s2,96(sp)
ffffffffc0204b14:	ecce                	sd	s3,88(sp)
...
ffffffffc0204b1e:	f06a                	sd	s10,32(sp)
ffffffffc0204b20:	fc86                	sd	ra,120(sp)
ffffffffc0204b22:	f8a2                	sd	s0,112(sp)
ffffffffc0204b24:	f862                	sd	s8,48(sp)
ffffffffc0204b26:	f466                	sd	s9,40(sp)
ffffffffc0204b28:	ec6e                	sd	s11,24(sp)
ffffffffc0204b2a:	892a                	mv	s2,a0
ffffffffc0204b2c:	84ae                	mv	s1,a1
ffffffffc0204b2e:	8d32                	mv	s10,a2
ffffffffc0204b30:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204b32:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204b36:	5b7d                	li	s6,-1
ffffffffc0204b38:	00002a97          	auipc	s5,0x2
ffffffffc0204b3c:	30ca8a93          	addi	s5,s5,780 # ffffffffc0206e44 <default_pmm_manager+0x1194>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204b40:	00002b97          	auipc	s7,0x2
ffffffffc0204b44:	4e0b8b93          	addi	s7,s7,1248 # ffffffffc0207020 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b48:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b4c:	001d0413          	addi	s0,s10,1
ffffffffc0204b50:	01350a63          	beq	a0,s3,ffffffffc0204b64 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b54:	c121                	beqz	a0,ffffffffc0204b94 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204b56:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b58:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204b5a:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b5c:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204b60:	ff351ae3          	bne	a0,s3,ffffffffc0204b54 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b64:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b68:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b6c:	4c81                	li	s9,0
ffffffffc0204b6e:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b70:	5c7d                	li	s8,-1
ffffffffc0204b72:	5dfd                	li	s11,-1
ffffffffc0204b74:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b78:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b7a:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b7e:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b82:	00140d13          	addi	s10,s0,1
ffffffffc0204b86:	04b56263          	bltu	a0,a1,ffffffffc0204bca <vprintfmt+0xbc>
ffffffffc0204b8a:	058a                	slli	a1,a1,0x2
ffffffffc0204b8c:	95d6                	add	a1,a1,s5
ffffffffc0204b8e:	4194                	lw	a3,0(a1)
ffffffffc0204b90:	96d6                	add	a3,a3,s5
ffffffffc0204b92:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b94:	70e6                	ld	ra,120(sp)
ffffffffc0204b96:	7446                	ld	s0,112(sp)
ffffffffc0204b98:	74a6                	ld	s1,104(sp)
ffffffffc0204b9a:	7906                	ld	s2,96(sp)
ffffffffc0204b9c:	69e6                	ld	s3,88(sp)
ffffffffc0204b9e:	6a46                	ld	s4,80(sp)
ffffffffc0204ba0:	6aa6                	ld	s5,72(sp)
ffffffffc0204ba2:	6b06                	ld	s6,64(sp)
ffffffffc0204ba4:	7be2                	ld	s7,56(sp)
ffffffffc0204ba6:	7c42                	ld	s8,48(sp)
ffffffffc0204ba8:	7ca2                	ld	s9,40(sp)
ffffffffc0204baa:	7d02                	ld	s10,32(sp)
ffffffffc0204bac:	6de2                	ld	s11,24(sp)
ffffffffc0204bae:	6109                	addi	sp,sp,128
ffffffffc0204bb0:	8082                	ret
            padc = '0';
ffffffffc0204bb2:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204bb4:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bb8:	846a                	mv	s0,s10
ffffffffc0204bba:	00140d13          	addi	s10,s0,1
ffffffffc0204bbe:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204bc2:	0ff5f593          	zext.b	a1,a1
ffffffffc0204bc6:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b8a <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204bca:	85a6                	mv	a1,s1
ffffffffc0204bcc:	02500513          	li	a0,37
ffffffffc0204bd0:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204bd2:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bd6:	8d22                	mv	s10,s0
ffffffffc0204bd8:	f73788e3          	beq	a5,s3,ffffffffc0204b48 <vprintfmt+0x3a>
ffffffffc0204bdc:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204be0:	1d7d                	addi	s10,s10,-1
ffffffffc0204be2:	ff379de3          	bne	a5,s3,ffffffffc0204bdc <vprintfmt+0xce>
ffffffffc0204be6:	b78d                	j	ffffffffc0204b48 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204be8:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204bec:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bf0:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204bf2:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204bf6:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bfa:	02d86463          	bltu	a6,a3,ffffffffc0204c22 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bfe:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204c02:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204c06:	0186873b          	addw	a4,a3,s8
ffffffffc0204c0a:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204c0e:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204c10:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204c14:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204c16:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204c1a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c1e:	fed870e3          	bgeu	a6,a3,ffffffffc0204bfe <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204c22:	f40ddce3          	bgez	s11,ffffffffc0204b7a <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204c26:	8de2                	mv	s11,s8
ffffffffc0204c28:	5c7d                	li	s8,-1
ffffffffc0204c2a:	bf81                	j	ffffffffc0204b7a <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204c2c:	fffdc693          	not	a3,s11
ffffffffc0204c30:	96fd                	srai	a3,a3,0x3f
ffffffffc0204c32:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c36:	00144603          	lbu	a2,1(s0)
ffffffffc0204c3a:	2d81                	sext.w	s11,s11
ffffffffc0204c3c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c3e:	bf35                	j	ffffffffc0204b7a <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204c40:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c44:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c48:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c4a:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c4c:	bfd9                	j	ffffffffc0204c22 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c4e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c50:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c54:	01174463          	blt	a4,a7,ffffffffc0204c5c <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c58:	1a088e63          	beqz	a7,ffffffffc0204e14 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c5c:	000a3603          	ld	a2,0(s4)
ffffffffc0204c60:	46c1                	li	a3,16
ffffffffc0204c62:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c64:	2781                	sext.w	a5,a5
ffffffffc0204c66:	876e                	mv	a4,s11
ffffffffc0204c68:	85a6                	mv	a1,s1
ffffffffc0204c6a:	854a                	mv	a0,s2
ffffffffc0204c6c:	e37ff0ef          	jal	ra,ffffffffc0204aa2 <printnum>
            break;
ffffffffc0204c70:	bde1                	j	ffffffffc0204b48 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c72:	000a2503          	lw	a0,0(s4)
ffffffffc0204c76:	85a6                	mv	a1,s1
ffffffffc0204c78:	0a21                	addi	s4,s4,8
ffffffffc0204c7a:	9902                	jalr	s2
            break;
ffffffffc0204c7c:	b5f1                	j	ffffffffc0204b48 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c7e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c80:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c84:	01174463          	blt	a4,a7,ffffffffc0204c8c <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c88:	18088163          	beqz	a7,ffffffffc0204e0a <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c8c:	000a3603          	ld	a2,0(s4)
ffffffffc0204c90:	46a9                	li	a3,10
ffffffffc0204c92:	8a2e                	mv	s4,a1
ffffffffc0204c94:	bfc1                	j	ffffffffc0204c64 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c96:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c9a:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c9c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c9e:	bdf1                	j	ffffffffc0204b7a <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204ca0:	85a6                	mv	a1,s1
ffffffffc0204ca2:	02500513          	li	a0,37
ffffffffc0204ca6:	9902                	jalr	s2
            break;
ffffffffc0204ca8:	b545                	j	ffffffffc0204b48 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204caa:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204cae:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cb0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204cb2:	b5e1                	j	ffffffffc0204b7a <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204cb4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cb6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204cba:	01174463          	blt	a4,a7,ffffffffc0204cc2 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204cbe:	14088163          	beqz	a7,ffffffffc0204e00 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204cc2:	000a3603          	ld	a2,0(s4)
ffffffffc0204cc6:	46a1                	li	a3,8
ffffffffc0204cc8:	8a2e                	mv	s4,a1
ffffffffc0204cca:	bf69                	j	ffffffffc0204c64 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204ccc:	03000513          	li	a0,48
ffffffffc0204cd0:	85a6                	mv	a1,s1
ffffffffc0204cd2:	e03e                	sd	a5,0(sp)
ffffffffc0204cd4:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204cd6:	85a6                	mv	a1,s1
ffffffffc0204cd8:	07800513          	li	a0,120
ffffffffc0204cdc:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cde:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204ce0:	6782                	ld	a5,0(sp)
ffffffffc0204ce2:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204ce4:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204ce8:	bfb5                	j	ffffffffc0204c64 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cea:	000a3403          	ld	s0,0(s4)
ffffffffc0204cee:	008a0713          	addi	a4,s4,8
ffffffffc0204cf2:	e03a                	sd	a4,0(sp)
ffffffffc0204cf4:	14040263          	beqz	s0,ffffffffc0204e38 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204cf8:	0fb05763          	blez	s11,ffffffffc0204de6 <vprintfmt+0x2d8>
ffffffffc0204cfc:	02d00693          	li	a3,45
ffffffffc0204d00:	0cd79163          	bne	a5,a3,ffffffffc0204dc2 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d04:	00044783          	lbu	a5,0(s0)
ffffffffc0204d08:	0007851b          	sext.w	a0,a5
ffffffffc0204d0c:	cf85                	beqz	a5,ffffffffc0204d44 <vprintfmt+0x236>
ffffffffc0204d0e:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d12:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d16:	000c4563          	bltz	s8,ffffffffc0204d20 <vprintfmt+0x212>
ffffffffc0204d1a:	3c7d                	addiw	s8,s8,-1
ffffffffc0204d1c:	036c0263          	beq	s8,s6,ffffffffc0204d40 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204d20:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d22:	0e0c8e63          	beqz	s9,ffffffffc0204e1e <vprintfmt+0x310>
ffffffffc0204d26:	3781                	addiw	a5,a5,-32
ffffffffc0204d28:	0ef47b63          	bgeu	s0,a5,ffffffffc0204e1e <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204d2c:	03f00513          	li	a0,63
ffffffffc0204d30:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d32:	000a4783          	lbu	a5,0(s4)
ffffffffc0204d36:	3dfd                	addiw	s11,s11,-1
ffffffffc0204d38:	0a05                	addi	s4,s4,1
ffffffffc0204d3a:	0007851b          	sext.w	a0,a5
ffffffffc0204d3e:	ffe1                	bnez	a5,ffffffffc0204d16 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204d40:	01b05963          	blez	s11,ffffffffc0204d52 <vprintfmt+0x244>
ffffffffc0204d44:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204d46:	85a6                	mv	a1,s1
ffffffffc0204d48:	02000513          	li	a0,32
ffffffffc0204d4c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d4e:	fe0d9be3          	bnez	s11,ffffffffc0204d44 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d52:	6a02                	ld	s4,0(sp)
ffffffffc0204d54:	bbd5                	j	ffffffffc0204b48 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d56:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d58:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d5c:	01174463          	blt	a4,a7,ffffffffc0204d64 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d60:	08088d63          	beqz	a7,ffffffffc0204dfa <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d64:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d68:	0a044d63          	bltz	s0,ffffffffc0204e22 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d6c:	8622                	mv	a2,s0
ffffffffc0204d6e:	8a66                	mv	s4,s9
ffffffffc0204d70:	46a9                	li	a3,10
ffffffffc0204d72:	bdcd                	j	ffffffffc0204c64 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d74:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d78:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d7a:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d7c:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d80:	8fb5                	xor	a5,a5,a3
ffffffffc0204d82:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d86:	02d74163          	blt	a4,a3,ffffffffc0204da8 <vprintfmt+0x29a>
ffffffffc0204d8a:	00369793          	slli	a5,a3,0x3
ffffffffc0204d8e:	97de                	add	a5,a5,s7
ffffffffc0204d90:	639c                	ld	a5,0(a5)
ffffffffc0204d92:	cb99                	beqz	a5,ffffffffc0204da8 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d94:	86be                	mv	a3,a5
ffffffffc0204d96:	00000617          	auipc	a2,0x0
ffffffffc0204d9a:	1f260613          	addi	a2,a2,498 # ffffffffc0204f88 <etext+0x2e>
ffffffffc0204d9e:	85a6                	mv	a1,s1
ffffffffc0204da0:	854a                	mv	a0,s2
ffffffffc0204da2:	0ce000ef          	jal	ra,ffffffffc0204e70 <printfmt>
ffffffffc0204da6:	b34d                	j	ffffffffc0204b48 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204da8:	00002617          	auipc	a2,0x2
ffffffffc0204dac:	09060613          	addi	a2,a2,144 # ffffffffc0206e38 <default_pmm_manager+0x1188>
ffffffffc0204db0:	85a6                	mv	a1,s1
ffffffffc0204db2:	854a                	mv	a0,s2
ffffffffc0204db4:	0bc000ef          	jal	ra,ffffffffc0204e70 <printfmt>
ffffffffc0204db8:	bb41                	j	ffffffffc0204b48 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204dba:	00002417          	auipc	s0,0x2
ffffffffc0204dbe:	07640413          	addi	s0,s0,118 # ffffffffc0206e30 <default_pmm_manager+0x1180>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dc2:	85e2                	mv	a1,s8
ffffffffc0204dc4:	8522                	mv	a0,s0
ffffffffc0204dc6:	e43e                	sd	a5,8(sp)
ffffffffc0204dc8:	0e2000ef          	jal	ra,ffffffffc0204eaa <strnlen>
ffffffffc0204dcc:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204dd0:	01b05b63          	blez	s11,ffffffffc0204de6 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204dd4:	67a2                	ld	a5,8(sp)
ffffffffc0204dd6:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dda:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204ddc:	85a6                	mv	a1,s1
ffffffffc0204dde:	8552                	mv	a0,s4
ffffffffc0204de0:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204de2:	fe0d9ce3          	bnez	s11,ffffffffc0204dda <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204de6:	00044783          	lbu	a5,0(s0)
ffffffffc0204dea:	00140a13          	addi	s4,s0,1
ffffffffc0204dee:	0007851b          	sext.w	a0,a5
ffffffffc0204df2:	d3a5                	beqz	a5,ffffffffc0204d52 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204df4:	05e00413          	li	s0,94
ffffffffc0204df8:	bf39                	j	ffffffffc0204d16 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dfa:	000a2403          	lw	s0,0(s4)
ffffffffc0204dfe:	b7ad                	j	ffffffffc0204d68 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204e00:	000a6603          	lwu	a2,0(s4)
ffffffffc0204e04:	46a1                	li	a3,8
ffffffffc0204e06:	8a2e                	mv	s4,a1
ffffffffc0204e08:	bdb1                	j	ffffffffc0204c64 <vprintfmt+0x156>
ffffffffc0204e0a:	000a6603          	lwu	a2,0(s4)
ffffffffc0204e0e:	46a9                	li	a3,10
ffffffffc0204e10:	8a2e                	mv	s4,a1
ffffffffc0204e12:	bd89                	j	ffffffffc0204c64 <vprintfmt+0x156>
ffffffffc0204e14:	000a6603          	lwu	a2,0(s4)
ffffffffc0204e18:	46c1                	li	a3,16
ffffffffc0204e1a:	8a2e                	mv	s4,a1
ffffffffc0204e1c:	b5a1                	j	ffffffffc0204c64 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204e1e:	9902                	jalr	s2
ffffffffc0204e20:	bf09                	j	ffffffffc0204d32 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204e22:	85a6                	mv	a1,s1
ffffffffc0204e24:	02d00513          	li	a0,45
ffffffffc0204e28:	e03e                	sd	a5,0(sp)
ffffffffc0204e2a:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204e2c:	6782                	ld	a5,0(sp)
ffffffffc0204e2e:	8a66                	mv	s4,s9
ffffffffc0204e30:	40800633          	neg	a2,s0
ffffffffc0204e34:	46a9                	li	a3,10
ffffffffc0204e36:	b53d                	j	ffffffffc0204c64 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204e38:	03b05163          	blez	s11,ffffffffc0204e5a <vprintfmt+0x34c>
ffffffffc0204e3c:	02d00693          	li	a3,45
ffffffffc0204e40:	f6d79de3          	bne	a5,a3,ffffffffc0204dba <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204e44:	00002417          	auipc	s0,0x2
ffffffffc0204e48:	fec40413          	addi	s0,s0,-20 # ffffffffc0206e30 <default_pmm_manager+0x1180>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e4c:	02800793          	li	a5,40
ffffffffc0204e50:	02800513          	li	a0,40
ffffffffc0204e54:	00140a13          	addi	s4,s0,1
ffffffffc0204e58:	bd6d                	j	ffffffffc0204d12 <vprintfmt+0x204>
ffffffffc0204e5a:	00002a17          	auipc	s4,0x2
ffffffffc0204e5e:	fd7a0a13          	addi	s4,s4,-41 # ffffffffc0206e31 <default_pmm_manager+0x1181>
ffffffffc0204e62:	02800513          	li	a0,40
ffffffffc0204e66:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e6a:	05e00413          	li	s0,94
ffffffffc0204e6e:	b565                	j	ffffffffc0204d16 <vprintfmt+0x208>
...
strlen(const char *s) {
ffffffffc0204e94:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e96:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e98:	cb81                	beqz	a5,ffffffffc0204ea8 <strlen+0x18>
        cnt ++;
ffffffffc0204e9a:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e9c:	00a707b3          	add	a5,a4,a0
ffffffffc0204ea0:	0007c783          	lbu	a5,0(a5)
ffffffffc0204ea4:	fbfd                	bnez	a5,ffffffffc0204e9a <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204eaa:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204eac:	e589                	bnez	a1,ffffffffc0204eb6 <strnlen+0xc>
ffffffffc0204eae:	a811                	j	ffffffffc0204ec2 <strnlen+0x18>
        cnt ++;
ffffffffc0204eb0:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204eb2:	00f58863          	beq	a1,a5,ffffffffc0204ec2 <strnlen+0x18>
ffffffffc0204eb6:	00f50733          	add	a4,a0,a5
ffffffffc0204eba:	00074703          	lbu	a4,0(a4)
ffffffffc0204ebe:	fb6d                	bnez	a4,ffffffffc0204eb0 <strnlen+0x6>
ffffffffc0204ec0:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204ec2:	852e                	mv	a0,a1
ffffffffc0204ec4:	8082                	ret

ffffffffc0204ec6 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204ec6:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204ec8:	0005c703          	lbu	a4,0(a1)
ffffffffc0204ecc:	0785                	addi	a5,a5,1
ffffffffc0204ece:	0585                	addi	a1,a1,1
ffffffffc0204ed0:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204ed4:	fb75                	bnez	a4,ffffffffc0204ec8 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204edc:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ee0:	cb89                	beqz	a5,ffffffffc0204ef2 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204ee2:	0505                	addi	a0,a0,1
ffffffffc0204ee4:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ee6:	fee789e3          	beq	a5,a4,ffffffffc0204ed8 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eea:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204eee:	9d19                	subw	a0,a0,a4
ffffffffc0204ef0:	8082                	ret
ffffffffc0204ef2:	4501                	li	a0,0
ffffffffc0204ef4:	bfed                	j	ffffffffc0204eee <strcmp+0x16>

ffffffffc0204ef6 <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204ef6:	00054783          	lbu	a5,0(a0)
ffffffffc0204efa:	c799                	beqz	a5,ffffffffc0204f08 <strchr+0x12>
        if (*s == c) {
ffffffffc0204efc:	00f58763          	beq	a1,a5,ffffffffc0204f0a <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204f00:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204f04:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204f06:	fbfd                	bnez	a5,ffffffffc0204efc <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204f0c:	ca01                	beqz	a2,ffffffffc0204f1c <memset+0x10>
ffffffffc0204f0e:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204f10:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204f12:	0785                	addi	a5,a5,1
ffffffffc0204f14:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204f18:	fec79de3          	bne	a5,a2,ffffffffc0204f12 <memset+0x6>
    }
    return s;
...
ffffffffc0204f1e <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204f1e:	ca19                	beqz	a2,ffffffffc0204f34 <memcpy+0x16>
ffffffffc0204f20:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204f22:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204f24:	0005c703          	lbu	a4,0(a1)
ffffffffc0204f28:	0585                	addi	a1,a1,1
ffffffffc0204f2a:	0785                	addi	a5,a5,1
ffffffffc0204f2c:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204f30:	fec59ae3          	bne	a1,a2,ffffffffc0204f24 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204f36:	c205                	beqz	a2,ffffffffc0204f56 <memcmp+0x20>
ffffffffc0204f38:	962e                	add	a2,a2,a1
ffffffffc0204f3a:	a019                	j	ffffffffc0204f40 <memcmp+0xa>
ffffffffc0204f3c:	00c58d63          	beq	a1,a2,ffffffffc0204f56 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204f44:	0005c703          	lbu	a4,0(a1)
        ...
        s1 ++, s2 ++;
ffffffffc0204f48:	0505                	addi	a0,a0,1
ffffffffc0204f4a:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204f4c:	fee788e3          	beq	a5,a4,ffffffffc0204f3c <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f50:	40e7853b          	subw	a0,a5,a4
ffffffffc0204f54:	8082                	ret
    }
    return 0;
ffffffffc0204f56:	4501                	li	a0,0
}
